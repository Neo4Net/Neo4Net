 ...
 */
namespace Org.Neo4j.Kernel.stresstests.transaction.log
{
	...
	using Builder = Org.Neo4j.Kernel.impl.transaction.log.stresstest.TransactionAppenderStressTest.Builder;
	using TransactionIdChecker = Org.Neo4j.Kernel.impl.transaction.log.stresstest.TransactionAppenderStressTest.TransactionIdChecker;
