...
namespace Org.Neo4j.tools.txlog.checktypes
{
	...
	public abstract class CheckType<C, R> where C : Org.Neo4j.Kernel.impl.transaction.command.Command where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	{
