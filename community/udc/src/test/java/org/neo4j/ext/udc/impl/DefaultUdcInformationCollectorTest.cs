...
//JAVA TO C# CONVERTER TODO TASK: Most Java stream collectors are not converted by Java to C# Converter:
			  return java.util.files.Select( file => new StoreFileMetadata( file, Org.Neo4j.Kernel.impl.store.format.RecordFormat_Fields.NO_RECORD_SIZE ) ).collect( Collectors.toCollection( HashSet<object>::new ) );
		 }
