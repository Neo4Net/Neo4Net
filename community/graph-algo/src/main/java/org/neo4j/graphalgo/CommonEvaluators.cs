...
namespace Org.Neo4j.Graphalgo
{
	...
	using DoubleEvaluatorWithDefault = Org.Neo4j.Graphalgo.impl.util.DoubleEvaluatorWithDefault;
	using GeoEstimateEvaluator = Org.Neo4j.Graphalgo.impl.util.GeoEstimateEvaluator;
	using IntegerEvaluator = Org.Neo4j.Graphalgo.impl.util.IntegerEvaluator;
