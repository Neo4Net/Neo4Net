...
{
	using AStar = Org.Neo4j.Graphalgo.impl.path.AStar;
	using AllPaths = Org.Neo4j.Graphalgo.impl.path.AllPaths;
	using AllSimplePaths = Org.Neo4j.Graphalgo.impl.path.AllSimplePaths;
	...
	using ExactDepthPathFinder = Org.Neo4j.Graphalgo.impl.path.ExactDepthPathFinder;
	using ShortestPath = Org.Neo4j.Graphalgo.impl.path.ShortestPath;
	using DoubleEvaluator = Org.Neo4j.Graphalgo.impl.util.DoubleEvaluator;
