...
namespace Org.Neo4j.Graphalgo.impl.path
{
	...
	using Org.Neo4j.Graphalgo;
	using DijkstraBranchCollisionDetector = Org.Neo4j.Graphalgo.impl.util.DijkstraBranchCollisionDetector;
	...
	using TopFetchingWeightedPathIterator = Org.Neo4j.Graphalgo.impl.util.TopFetchingWeightedPathIterator;
...
//ORIGINAL LINE: final org.apache.commons.lang3.mutable.MutableDouble endSideShortest = new org.apache.commons.lang3.mutable.MutableDouble(0);
		 ...
		 private class DijkstraBidirectionalEvaluator : Org.Neo4j.Graphdb.traversal.PathEvaluator_Adapter<double>
		 {
