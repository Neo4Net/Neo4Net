...
//ORIGINAL LINE: long read(long filePageId, long bufferAddress, int bufferSize) throws java.io.IOException;
		 long Read( long filePageId, long bufferAddress, int bufferSize );
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: long read(long startFilePageId, long[] bufferAddresses, int bufferSize, int arrayOffset, int length) throws java.io.IOException;
		 long Read( long startFilePageId, long[] bufferAddresses, int bufferSize, int arrayOffset, int length );
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: long write(long filePageId, long bufferAddress) throws java.io.IOException;
		 long Write( long filePageId, long bufferAddress );
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: long write(long startFilePageId, long[] bufferAddresses, int arrayOffset, int length) throws java.io.IOException;
		 long Write( long startFilePageId, long[] bufferAddresses, int arrayOffset, int length );
...
//ORIGINAL LINE: void close() throws java.io.IOException;
		 ...
		 /// <summary>
		 /// Close and release all resources associated with the file underlying this PageSwapper, and then delete that file. </summary>
		 /// <exception cref="IOException"> If an <seealso cref="IOException"/> occurs during either the closing or the deleting of the file. This
		 /// may leave the file on the file system. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void closeAndDelete() throws java.io.IOException;
		 void CloseAndDelete();
		 ...
		 /// <para>
		 /// This method has no effect if the <seealso cref="PageSwapperFactory.syncDevice()"/> method forces the writes for all
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void force() throws java.io.IOException;
		 void Force();
...
//ORIGINAL LINE: long getLastPageId() throws java.io.IOException;
		 ...
		 /// <seealso cref="getLastPageId()"/> returns -1.
		 /// <para>
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void truncate() throws java.io.IOException;
		 void Truncate();
	}
