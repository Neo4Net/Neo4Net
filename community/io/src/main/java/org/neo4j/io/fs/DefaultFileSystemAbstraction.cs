...
namespace Org.Neo4j.Io.fs
{
	...
	using DefaultFileSystemWatcher = Org.Neo4j.Io.fs.watcher.DefaultFileSystemWatcher;
	...
	{
		 internal const string UNABLE_TO_CREATE_DIRECTORY_FORMAT = "Unable to create directory path [%s] for Neo4j store.";
