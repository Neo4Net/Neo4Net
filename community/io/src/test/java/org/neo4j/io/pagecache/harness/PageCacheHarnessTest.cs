...
namespace Org.Neo4j.Io.pagecache.harness
{
	...
	using PageCountRecordFormat = Org.Neo4j.Io.pagecache.randomharness.PageCountRecordFormat;
	using Phase = Org.Neo4j.Io.pagecache.randomharness.Phase;
	using RandomPageCacheTestHarness = Org.Neo4j.Io.pagecache.randomharness.RandomPageCacheTestHarness;
	using RecordFormat = Org.Neo4j.Io.pagecache.randomharness.RecordFormat;
	...
	using ProfilerExtension = Org.Neo4j.Test.extension.ProfilerExtension;
...
//ORIGINAL LINE: @ExtendWith({TestDirectoryExtension.class, ProfilerExtension.class}) abstract class PageCacheHarnessTest<T extends org.neo4j.io.pagecache.PageCache> extends org.neo4j.io.pagecache.PageCacheTestSupport<T>
	internal abstract class PageCacheHarnessTest<T> : PageCacheTestSupport<T> where T : Org.Neo4j.Io.pagecache.PageCache
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
