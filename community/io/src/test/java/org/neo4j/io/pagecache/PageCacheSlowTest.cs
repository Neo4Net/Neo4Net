...
namespace Org.Neo4j.Io.pagecache
{
	...
	using LinearHistoryTracerFactory = Org.Neo4j.Io.pagecache.tracing.linear.LinearHistoryTracerFactory;
	using LinearTracers = Org.Neo4j.Io.pagecache.tracing.linear.LinearTracers;
...
//            }
		 ...
		 private class UpdateWorkerAnonymousInnerClass : UpdateWorker
		 {
			 ...
			 private new Org.Neo4j.Io.pagecache.PagedFile _pagedFile;
...
//ORIGINAL LINE: @RepeatedTest(100) void mustNotLoseUpdatesWhenOpeningMultiplePageCursorsPerThread()
		 ...
		 private class UpdateWorkerAnonymousInnerClass2 : UpdateWorker
		 {
			 ...
			 public UpdateWorkerAnonymousInnerClass2( PageCacheSlowTest<T> outerInstance, int i, int filePages, AtomicBoolean shouldStop, Org.Neo4j.Io.pagecache.PagedFile pagedFile, int maxCursorsPerThread ) : base( i, filePages, shouldStop, pagedFile )
			 {
				 this.outerInstance = outerInstance;
				 this._shouldStop = shouldStop;
				 this._filePages = filePages;
