...
//	import static org.hamcrest.Matchers.isOneOf;
	...
	internal class CommandPrimer
	{
		 ...
		 public virtual Action Prime( Command command )
		 {
			  ...
			  {
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.FlushCache:
				  return FlushCache();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.FlushFile:
				  return FlushFile();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.MapFile:
				  return MapFile();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.UnmapFile:
				  return UnmapFile();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.ReadRecord:
				  return ReadRecord();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.WriteRecord:
				  return WriteRecord();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.ReadMulti:
				  return ReadMulti();
			  case Org.Neo4j.Io.pagecache.randomharness.Command.InnerEnum.WriteMulti:
				  return WriteMulti();
			  default:
