...
namespace Org.Neo4j.Io.pagecache
{
	...
	using FileIsNotMappedException = Org.Neo4j.Io.pagecache.impl.FileIsNotMappedException;
	using SingleFilePageSwapperFactory = Org.Neo4j.Io.pagecache.impl.SingleFilePageSwapperFactory;
	using Record = Org.Neo4j.Io.pagecache.randomharness.Record;
	using StandardRecordFormat = Org.Neo4j.Io.pagecache.randomharness.StandardRecordFormat;
	using Org.Neo4j.Io.pagecache.tracing;
	...
	using PinEvent = Org.Neo4j.Io.pagecache.tracing.PinEvent;
	using DefaultPageCursorTracer = Org.Neo4j.Io.pagecache.tracing.cursor.DefaultPageCursorTracer;
...
//ORIGINAL LINE: @Test void mustHaveAtLeastTwoPages()
		 ...
		 {
			  assertThrows( typeof( System.ArgumentException ), () => getPageCache(fs, 1, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null) );
		 }
...
//ORIGINAL LINE: @Test void mustAcceptTwoPagesAsMinimumConfiguration()
		 ...
		 {
			  getPageCache( fs, 2, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 internal virtual void MustClosePageSwapperFactoryOnPageCacheClose()
		 {
			  ...
			  PageCache cache = createPageCache( swapperFactory, maxPages, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null, EmptyVersionContextSupplier.EMPTY );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 internal virtual void PageCacheFlushAndForceMustQueryTheGivenIOPSLimiter()
		 {
			  ...
			  PageCache cache = getPageCache( fs, NextPowerOf2( 2 * pagesToDirty ), PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  int pagesToDirty = 10_000;
			  PageCache cache = getPageCache( fs, NextPowerOf2( pagesToDirty ), PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null );
...
//ORIGINAL LINE: final java.util.concurrent.atomic.AtomicInteger forceCounter = new java.util.concurrent.atomic.AtomicInteger();
			  ...
			  getPageCache( fs, maxPages, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  getPageCache( fs, 5, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null );
...
//ORIGINAL LINE: public PageSwapper createPageSwapper(java.io.File file, int filePageSize, PageEvictionCallback onEviction, boolean createIfNotExist, boolean noChannelStriping) throws java.io.IOException
			 ...
			 private class DelegatingPageSwapperAnonymousInnerClass : DelegatingPageSwapper
			 {
				 ...
				 public DelegatingPageSwapperAnonymousInnerClass( SingleFilePageSwapperFactoryAnonymousInnerClass3 outerInstance, Org.Neo4j.Io.pagecache.PageSwapper @delegate ) : base( @delegate )
				 {
					 this.outerInstance = outerInstance;
				 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 internal virtual void FileMappedWithDeleteOnCloseShouldNotFlushDirtyPagesOnClose()
		 {
			  ...
			  File file = file( "a" );
			  using ( PageCache cache = createPageCache( swapperFactory, maxPages, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null, EmptyVersionContextSupplier.EMPTY ), PagedFile pf = cache.Map( file, filePageSize, DELETE_ON_CLOSE ), PageCursor cursor = pf.Io( 0, PF_SHARED_WRITE_LOCK ) )
			  {
					writeRecords( cursor );
					assertTrue( cursor.Next() );
			  }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 internal virtual void MustFlushAllDirtyPagesWhenClosingPagedFileThatIsNotMappedWithDeleteOnClose()
		 {
			  ...
			  swapperFactory.Open( fs, Configuration.EMPTY );
			  File file = file( "a" );
			  using ( PageCache cache = createPageCache( swapperFactory, maxPages, PageCacheTracer.NULL, Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorTracerSupplier_Fields.Null, EmptyVersionContextSupplier.EMPTY ), PagedFile pf = cache.Map( file, filePageSize ), PageCursor cursor = pf.Io( 0, PF_SHARED_WRITE_LOCK ) )
			  {
					writeRecords( cursor );
					assertTrue( cursor.Next() );
			  }
...
//ORIGINAL LINE: public PageSwapper createPageSwapper(java.io.File file, int filePageSize, PageEvictionCallback onEviction, boolean createIfNotExist, boolean noChannelStriping) throws java.io.IOException
			 ...
			 private class DelegatingPageSwapperAnonymousInnerClass2 : DelegatingPageSwapper
			 {
				 ...
				 public DelegatingPageSwapperAnonymousInnerClass2( SingleFilePageSwapperFactoryAnonymousInnerClass4 outerInstance, Org.Neo4j.Io.pagecache.PageSwapper swapper ) : base( swapper )
				 {
					 this.outerInstance = outerInstance;
				 }
