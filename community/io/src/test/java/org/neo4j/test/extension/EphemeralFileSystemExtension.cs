...
namespace Org.Neo4j.Test.extension
{
	...
	{
		 protected internal override Type<EphemeralFileSystemAbstraction> FieldType
		 {
			 get
			 {
				  return typeof( EphemeralFileSystemAbstraction );
			 }
		 }

		 protected internal override EphemeralFileSystemAbstraction CreateField( ExtensionContext extensionContext )
		 {
