...
namespace Org.Neo4j.Kernel.Api.Impl.Fulltext.analyzer.providers
{
	...
	using RomanianAnalyzer = org.apache.lucene.analysis.ro.RomanianAnalyzer;
...
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Romanian extends org.neo4j.graphdb.index.fulltext.AnalyzerProvider
