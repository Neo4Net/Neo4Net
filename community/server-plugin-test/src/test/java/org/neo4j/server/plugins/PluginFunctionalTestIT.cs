...
namespace Org.Neo4j.Server.plugins
{
	...
	using RegExp = Org.Neo4j.Server.plugins.PluginFunctionalTestHelper.RegExp;
	...
	using NodeRepresentationTest = Org.Neo4j.Server.rest.repr.NodeRepresentationTest;
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public class PluginFunctionalTestIT extends org.neo4j.test.server.SharedServerTestBase
