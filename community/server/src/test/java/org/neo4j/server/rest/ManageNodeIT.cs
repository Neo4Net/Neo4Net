...
namespace Org.Neo4j.Server.rest
{
	...
	using RootService = Org.Neo4j.Server.rest.management.RootService;
	...
	using ConsoleSessionFactory = Org.Neo4j.Server.rest.management.console.ConsoleSessionFactory;
	using ScriptSession = Org.Neo4j.Server.rest.management.console.ScriptSession;
