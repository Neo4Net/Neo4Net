...
namespace Org.Neo4j.Server.rest.batch
{
	...
	using RequestData = Org.Neo4j.Server.rest.web.InternalJettyServletRequest.RequestData;
	using InternalJettyServletResponse = Org.Neo4j.Server.rest.web.InternalJettyServletResponse;
