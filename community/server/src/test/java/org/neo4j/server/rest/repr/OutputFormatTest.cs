...
//ORIGINAL LINE: @Test public void shouldReturnAbsoluteURIForSeeOther() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldReturnAbsoluteURIForSeeOther()
		 {
			  ...
			  assertEquals( new URI( "http://base.local:8765/test/path" ), response.Metadata.getFirst( "Location" ) );
		 }
	}
