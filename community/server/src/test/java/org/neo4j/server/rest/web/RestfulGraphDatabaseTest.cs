...
namespace Org.Neo4j.Server.rest.web
{
	...
	using Status_Request = Org.Neo4j.Kernel.Api.Exceptions.Status_Request;
	using Status_Schema = Org.Neo4j.Kernel.Api.Exceptions.Status_Schema;
	using Status_Statement = Org.Neo4j.Kernel.Api.Exceptions.Status_Statement;
	...
	using RelationshipDirection = Org.Neo4j.Server.rest.web.DatabaseActions.RelationshipDirection;
	using AmpersandSeparatedCollection = Org.Neo4j.Server.rest.web.RestfulGraphDatabase.AmpersandSeparatedCollection;
