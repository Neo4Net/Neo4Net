...
namespace Org.Neo4j.Server.plugins
{
	...
	internal class DoubleTypeCaster : TypeCaster
	{
...
//ORIGINAL LINE: @Override @SuppressWarnings("boxing") double[] convert(Object[] data)
		 internal override double[] Convert( object[] data )
		 {
