...
namespace Org.Neo4j.Server.rest.management
{
	...
	using Kernel = Org.Neo4j.Jmx.Kernel;
	...
	using JmxDomainRepresentation = Org.Neo4j.Server.rest.management.repr.JmxDomainRepresentation;
	using JmxMBeanRepresentation = Org.Neo4j.Server.rest.management.repr.JmxMBeanRepresentation;
	using ServiceDefinitionRepresentation = Org.Neo4j.Server.rest.management.repr.ServiceDefinitionRepresentation;
