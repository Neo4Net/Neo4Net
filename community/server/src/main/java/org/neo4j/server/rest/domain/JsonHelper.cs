...
namespace Org.Neo4j.Server.rest.domain
{
	...
	using PropertyValueException = Org.Neo4j.Server.rest.web.PropertyValueException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static Object assertSupportedPropertyValue(Object jsonObject) throws org.neo4j.server.rest.web.PropertyValueException
