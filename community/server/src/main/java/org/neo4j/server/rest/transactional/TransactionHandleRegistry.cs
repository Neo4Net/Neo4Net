...
namespace Org.Neo4j.Server.rest.transactional
{
	...
	using InvalidTransactionId = Org.Neo4j.Server.rest.transactional.error.InvalidTransactionId;
...
//ORIGINAL LINE: abstract SuspendedTransaction getSuspendedTransaction() throws org.neo4j.server.rest.transactional.error.InvalidConcurrentTransactionAccess;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: SuspendedTransaction getSuspendedTransaction() throws org.neo4j.server.rest.transactional.error.InvalidConcurrentTransactionAccess
