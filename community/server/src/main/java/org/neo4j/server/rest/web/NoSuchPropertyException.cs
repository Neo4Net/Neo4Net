...
namespace Org.Neo4j.Server.rest.web
{
	...
	public class NoSuchPropertyException : Exception, Org.Neo4j.Kernel.Api.Exceptions.Status_HasStatus
	{
		 ...
		 {
			  return Org.Neo4j.Kernel.Api.Exceptions.Status_Statement.PropertyNotFound;
		 }
	}
