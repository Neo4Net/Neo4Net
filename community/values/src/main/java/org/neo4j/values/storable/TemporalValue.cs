...
namespace Org.Neo4j.Values.Storable
{
	...
	using TemporalArithmeticException = Org.Neo4j.Values.utils.TemporalArithmeticException;
...
//           epochMillis { void assign(Builder<JavaToDotNetGenericWildcard> builder, org.neo4j.values.AnyValue value) { if(!builder.supportsEpoch()) { throw new org.neo4j.values.utils.UnsupportedTemporalUnitException("Not supported: " + name()); } if(builder.state == null) { builder.state = new DateTimeBuilder(); } builder.state = builder.state.assign(this, value); } boolean isGroupSelector() { return true; } };
			  ...
			  internal void Assign<T1>( Builder<T1> builder, Org.Neo4j.Values.AnyValue value )
			  {
		 ...
		 private sealed class ConstructTime
		 {
			  ...
			  internal void Assign( TemporalFields field, AnyValue value )
			  {
					...
					{
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.hour:
						 Hour = Assignment( field, Hour, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.minute:
						 Minute = Assignment( field, Minute, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.second:
						 Second = Assignment( field, Second, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.millisecond:
						 Millisecond = Assignment( field, Millisecond, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.microsecond:
						 Microsecond = Assignment( field, Microsecond, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.nanosecond:
						 Nanosecond = Assignment( field, Nanosecond, value );
						 break;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.time:
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.datetime:
		 ...
		 private class ConstructDate : DateBuilder
		 {
			  ...
			  internal override ConstructDate Assign( TemporalFields field, AnyValue value )
			  {
					switch ( field.innerEnumValue )
					{
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.year:
						 Year = Assignment( field, Year, value );
						 return this;
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.quarter:
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.dayOfQuarter:
						 return ( new QuarterDate( Year, Date ) ).assign( field, value );
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.month:
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.day:
						 return ( new CalendarDate( Year, Date ) ).assign( field, value );
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.week:
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.dayOfWeek:
						 return ( new WeekDate( Year, Date ) ).assign( field, value );
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.ordinalDay:
						 return ( new OrdinalDate( Year, Date ) ).assign( field, value );
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.date:
					case Org.Neo4j.Values.Storable.TemporalValue.TemporalFields.InnerEnum.datetime:
