...
namespace Org.Neo4j.Values.Storable
{
	...
	public class ByteArray : IntegralArray
	{
		 private readonly sbyte[] _value;

		 internal ByteArray( sbyte[] value )
		 {
...
//ORIGINAL LINE: public <E extends Exception> void writeTo(ValueWriter<E> writer) throws E
		 ...
		 public override sbyte[] AsObjectCopy()
		 {
			  return _value.Clone();
		 }

		 [Obsolete]
		 public override sbyte[] AsObject()
		 {
			  return _value;
		 }
		 ...
		 {
			  return Values.ByteValue( _value[offset] );
		 }
