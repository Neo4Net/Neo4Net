...
namespace Org.Neo4j.Values.Storable
{
	...
	public class DateTimeArray : TemporalArray<ZonedDateTime, DateTimeValue>
	{
		 private readonly ZonedDateTime[] _value;

		 internal DateTimeArray( ZonedDateTime[] value )
		 {
			  Debug.Assert( value != null );
			  this._value = value;
		 }

		 protected internal override ZonedDateTime[] Value()
		 {
			  return _value;
		 }
		 ...
		 public override bool Equals( ZonedDateTime[] x )
		 {
...
//ORIGINAL LINE: public <E extends Exception> void writeTo(ValueWriter<E> writer) throws E
		 ...
		 {
			  WriteTo( writer, ValueWriter_ArrayType.ZonedDateTime, _value );
		 }

		 public override ValueGroup ValueGroup()
		 {
			  return ValueGroup.ZonedDateTimeArray;
		 }
