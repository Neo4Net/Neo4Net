...
namespace Org.Neo4j.Values.Storable
{
	...
	public abstract class ArrayValue : Value, SequenceValue
	{
		...
		public abstract AnyValue Value( int offset );
		 ...
		 public override Org.Neo4j.Values.SequenceValue_IterationPreference IterationPreference()
		 {
			  return Org.Neo4j.Values.SequenceValue_IterationPreference.RandomAccess;
		 }
