...
//JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
		 ...
		 public static Value MinValue( ValueGroup valueGroup, Value value )
		 {
			  ...
			  {
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.TEXT:
				  return MinString;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.NUMBER:
				  return MinNumber;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.GEOMETRY:
				  return MinPointValue( ( PointValue )value );
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.DATE:
				  return DateValue.MinValue;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.LOCAL_DATE_TIME:
				  return LocalDateTimeValue.MinValue;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.ZONED_DATE_TIME:
				  return DateTimeValue.MinValue;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.LOCAL_TIME:
				  return LocalTimeValue.MinValue;
			  case Org.Neo4j.Values.Storable.ValueGroup.InnerEnum.ZONED_TIME:
