...
namespace Org.Neo4j.Server.rest.repr
{
	...
	using Org.Neo4j.Server.helpers;
...
//ORIGINAL LINE: public static ValueRepresentation uri(final String path)
		 ...
		 private class ValueRepresentationAnonymousInnerClass : ValueRepresentation
		 {
			 ...
			 public ValueRepresentationAnonymousInnerClass( Org.Neo4j.Server.rest.repr.RepresentationType uri, string path ) : base( uri, null )
			 {
				 this._path = path;
			 }
...
//ORIGINAL LINE: public static ValueRepresentation template(final String path)
		 ...
		 private class ValueRepresentationAnonymousInnerClass2 : ValueRepresentation
		 {
			 ...
			 public ValueRepresentationAnonymousInnerClass2( Org.Neo4j.Server.rest.repr.RepresentationType template, string path ) : base( template, null )
			 {
				 this._path = path;
			 }
