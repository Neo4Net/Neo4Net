...
namespace Org.Neo4j.Codegen
{
	...
	using ByteCode = Org.Neo4j.Codegen.bytecode.ByteCode;
	using SourceCode = Org.Neo4j.Codegen.source.SourceCode;
...
//ORIGINAL LINE: private static MethodHandle constructor(Class target, Class... parameters) throws Exception
		 ...
		 public const string PACKAGE = "org.neo4j.codegen.test";
