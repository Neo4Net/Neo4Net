...
//ORIGINAL LINE: public static Expression gt(final Expression lhs, final Expression rhs)
		 ...
		 {
			 private Org.Neo4j.Codegen.Expression _lhs;
			 private Org.Neo4j.Codegen.Expression _rhs;

			 public ExpressionAnonymousInnerClass3( UnknownType boolean, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( boolean )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression gte(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass4 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass4( UnknownType boolean, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( boolean )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression lt(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass5 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass5( UnknownType boolean, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( boolean )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression lte(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass6 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass6( UnknownType boolean, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( boolean )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression equal(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass( UnknownType boolean, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( boolean )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression isNull(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass2 : Expression
		 {
			 private Org.Neo4j.Codegen.Expression _expression;

			 public ExpressionAnonymousInnerClass2( UnknownType boolean, Org.Neo4j.Codegen.Expression expression ) : base( boolean )
			 {
...
//ORIGINAL LINE: public static Expression notNull(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass3 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass3( UnknownType boolean, Org.Neo4j.Codegen.Expression expression ) : base( boolean )
			 {
				 this._expression = expression;
			 }
...
//ORIGINAL LINE: public static Expression load(final LocalVariable variable)
		 ...
		 private class ExpressionAnonymousInnerClass5 : Expression
		 {
			 private Org.Neo4j.Codegen.LocalVariable _variable;

			 public ExpressionAnonymousInnerClass5( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.LocalVariable variable ) : base( type )
			 {
...
//ORIGINAL LINE: public static Expression add(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass6 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass6( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( type )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression subtract(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass7 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass7( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( type )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression multiply(final Expression lhs, final Expression rhs)
		 ...
		 private class ExpressionAnonymousInnerClass8 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass8( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression lhs, Org.Neo4j.Codegen.Expression rhs ) : base( type )
			 {
				 this._lhs = lhs;
				 this._rhs = rhs;
			 }
...
//ORIGINAL LINE: public static Expression constant(final Object value)
		 ...
		 private class ExpressionAnonymousInnerClass9 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass9( Org.Neo4j.Codegen.TypeReference reference, object value ) : base( reference )
			 {
				 this._value = value;
			 }
		 ...
		 private class ExpressionAnonymousInnerClass : Expression
		 {
			 private Org.Neo4j.Codegen.TypeReference _baseType;
			 private Org.Neo4j.Codegen.Expression[] _constants;

			 public ExpressionAnonymousInnerClass( UnknownType arrayOf, Org.Neo4j.Codegen.TypeReference baseType, Org.Neo4j.Codegen.Expression[] constants ) : base( arrayOf )
			 {
...
//ORIGINAL LINE: public static Expression get(final Expression target, final FieldReference field)
		 ...
		 private class ExpressionAnonymousInnerClass2 : Expression
		 {
			 private Org.Neo4j.Codegen.Expression _target;
			 private Org.Neo4j.Codegen.FieldReference _field;

			 public ExpressionAnonymousInnerClass2( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression target, Org.Neo4j.Codegen.FieldReference field ) : base( type )
			 {
				 this._target = target;
				 this._field = field;
			 }
...
//ORIGINAL LINE: public static Expression box(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass3 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass3( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression expression ) : base( type )
			 {
				 this._expression = expression;
			 }
...
//ORIGINAL LINE: public static Expression unbox(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass4 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass4( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression expression ) : base( type )
			 {
				 this._expression = expression;
			 }
...
//ORIGINAL LINE: public static Expression getStatic(final FieldReference field)
		 ...
		 private class ExpressionAnonymousInnerClass5 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass5( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.FieldReference field ) : base( type )
			 {
				 this._field = field;
			 }
...
//ORIGINAL LINE: public static Expression ternary(final Expression test, final Expression onTrue, final Expression onFalse)
		 ...
		 private class ExpressionAnonymousInnerClass6 : Expression
		 {
			 private Org.Neo4j.Codegen.Expression _test;
			 private Org.Neo4j.Codegen.Expression _onTrue;
			 private Org.Neo4j.Codegen.Expression _onFalse;

			 public ExpressionAnonymousInnerClass6( Org.Neo4j.Codegen.TypeReference reference, Org.Neo4j.Codegen.Expression test, Org.Neo4j.Codegen.Expression onTrue, Org.Neo4j.Codegen.Expression onFalse ) : base( reference )
			 {
				 this._test = test;
				 this._onTrue = onTrue;
...
//ORIGINAL LINE: public static Expression invoke(final Expression target, final MethodReference method, final Expression... arguments)
		 ...
		 {
			 private Org.Neo4j.Codegen.Expression _target;
			 private Org.Neo4j.Codegen.MethodReference _method;
			 private Org.Neo4j.Codegen.Expression[] _arguments;

			 public ExpressionAnonymousInnerClass7( Org.Neo4j.Codegen.TypeReference returns, Org.Neo4j.Codegen.Expression target, Org.Neo4j.Codegen.MethodReference method, Org.Neo4j.Codegen.Expression[] arguments ) : base( returns )
			 {
				 this._target = target;
				 this._method = method;
...
//ORIGINAL LINE: public static Expression invoke(final MethodReference method, final Expression... parameters)
		 ...
		 {
			 private Org.Neo4j.Codegen.MethodReference _method;
			 private Org.Neo4j.Codegen.Expression[] _parameters;

			 public ExpressionAnonymousInnerClass8( Org.Neo4j.Codegen.TypeReference returns, Org.Neo4j.Codegen.MethodReference method, Org.Neo4j.Codegen.Expression[] parameters ) : base( returns )
			 {
				 this._method = method;
...
//ORIGINAL LINE: public static Expression invokeSuper(TypeReference parent, final Expression... parameters)
		 ...
		 private class ExpressionAnonymousInnerClass9 : Expression
		 {
			 private Org.Neo4j.Codegen.TypeReference _parent;
			 private Org.Neo4j.Codegen.Expression[] _parameters;
			 private Org.Neo4j.Codegen.TypeReference[] _parameterTypes;

			 public ExpressionAnonymousInnerClass9( UnknownType @object, Org.Neo4j.Codegen.TypeReference parent, Org.Neo4j.Codegen.Expression[] parameters, Org.Neo4j.Codegen.TypeReference[] parameterTypes ) : base( @object )
			 {
				 this._parent = parent;
				 this._parameters = parameters;
...
//ORIGINAL LINE: public static Expression instanceOf(final TypeReference typeToCheck, Expression expression)
		 ...
		 {
			 private Org.Neo4j.Codegen.TypeReference _typeToCheck;
			 private Org.Neo4j.Codegen.Expression _expression;

			 public ExpressionAnonymousInnerClass10( UnknownType typeReference, Org.Neo4j.Codegen.TypeReference typeToCheck, Org.Neo4j.Codegen.Expression expression ) : base( typeReference )
			 {
...
//ORIGINAL LINE: public static Expression cast(final TypeReference type, Expression expression)
		 ...
		 {
			 private new Org.Neo4j.Codegen.TypeReference _type;
			 private Org.Neo4j.Codegen.Expression _expression;

			 public ExpressionAnonymousInnerClass11( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression expression ) : base( type )
			 {
				 this._type = type;
				 this._expression = expression;
			 }
...
//ORIGINAL LINE: public static Expression newInstance(final TypeReference type)
		 ...
		 private class ExpressionAnonymousInnerClass12 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass12( Org.Neo4j.Codegen.TypeReference type ) : base( type )
			 {
				 this._type = type;
			 }
...
//ORIGINAL LINE: private static Expression notExpr(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass13 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass13( UnknownType boolean, Org.Neo4j.Codegen.Expression expression ) : base( boolean )
			 {
				 this._expression = expression;
			 }
...
//ORIGINAL LINE: public static Expression toDouble(final Expression expression)
		 ...
		 private class ExpressionAnonymousInnerClass14 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass14( UnknownType @double, Org.Neo4j.Codegen.Expression expression ) : base( @double )
			 {
				 this._expression = expression;
			 }
		 ...
		 private class ExpressionAnonymousInnerClass15 : Expression
		 {
			 ...
			 public ExpressionAnonymousInnerClass15( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Expression expression ) : base( type )
			 {
				 this._expression = expression;
			 }
