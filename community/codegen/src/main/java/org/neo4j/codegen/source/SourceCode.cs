...
//	import static org.neo4j.codegen.source.ClasspathHelper.fullClasspathStringFor;
	...
	public sealed class SourceCode : CodeGeneratorOption
	{
		 ...
		 private static Org.Neo4j.Codegen.CodeGeneratorOption PrintWarningsTo( java.io.PrintStream err )
		 {
...
//		 private static class SourceVisitorAnonymousInnerClass extends SourceVisitor
	...
	//	 }
		 ...
		 public static Org.Neo4j.Codegen.CodeGeneratorOption AnnotationProcessor( javax.annotation.processing.Processor processor )
		 {
			  return new AnnotationProcessorOption( requireNonNull( processor ) );
		 }

		 public static Org.Neo4j.Codegen.CodeGeneratorOption SourceLocation( java.nio.file.Path path )
		 {
			  return new SourceLocationOption( requireNonNull( path ) );
		 }

		 public static Org.Neo4j.Codegen.CodeGeneratorOption TemporarySourceCodeLocation()
		 {
			  try
			  {
