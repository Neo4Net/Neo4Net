...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 {
			 public ExpressionTemplateAnonymousInnerClass( Org.Neo4j.Codegen.TypeReference type ) : base( type )
			 {
			 }
...
//ORIGINAL LINE: public static ExpressionTemplate invoke(final MethodReference method, final ExpressionTemplate... arguments)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass2 : ExpressionTemplate
		 {
			 ...
			 private Org.Neo4j.Codegen.ExpressionTemplate[] _arguments;

			 public ExpressionTemplateAnonymousInnerClass2( Org.Neo4j.Codegen.TypeReference returns, Org.Neo4j.Codegen.MethodReference method, Org.Neo4j.Codegen.ExpressionTemplate[] arguments ) : base( returns )
			 {
				 this._method = method;
...
//ORIGINAL LINE: public static ExpressionTemplate invoke(final ExpressionTemplate target, final MethodReference method, final ExpressionTemplate... arguments)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass3 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass3( Org.Neo4j.Codegen.TypeReference returns, Org.Neo4j.Codegen.ExpressionTemplate target, Org.Neo4j.Codegen.MethodReference method, Org.Neo4j.Codegen.ExpressionTemplate[] arguments ) : base( returns )
			 {
				 this._target = target;
				 this._method = method;
				 this._arguments = arguments;
...
//ORIGINAL LINE: public static ExpressionTemplate load(final String name, final TypeReference type)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass4 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass4( Org.Neo4j.Codegen.TypeReference type, string name ) : base( type )
			 {
				 this._name = name;
			 }
...
//ORIGINAL LINE: public static ExpressionTemplate get(final ExpressionTemplate target, final FieldReference field)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass5 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass5( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.ExpressionTemplate target, Org.Neo4j.Codegen.FieldReference field ) : base( type )
			 {
				 this._target = target;
				 this._field = field;
			 }
...
//ORIGINAL LINE: public static ExpressionTemplate get(final ExpressionTemplate target, final Lookup<FieldReference> field, TypeReference type)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass6 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass6( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.ExpressionTemplate target, Org.Neo4j.Codegen.Lookup<FieldReference> field ) : base( type )
			 {
				 this._target = target;
				 this._field = field;
			 }
...
//ORIGINAL LINE: public static ExpressionTemplate get(final Lookup<FieldReference> field, TypeReference type)
		 ...
		 private class ExpressionTemplateAnonymousInnerClass7 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass7( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.Lookup<FieldReference> field ) : base( type )
			 {
				 this._field = field;
			 }
...
//ORIGINAL LINE: Expression materialize(final CodeBlock method)
		 ...
		 private class ExpressionAnonymousInnerClass : Expression
		 {
			 ...
			 private Org.Neo4j.Codegen.CodeBlock _method;
		 ...
		 private class ExpressionTemplateAnonymousInnerClass8 : ExpressionTemplate
		 {
			 ...
			 public ExpressionTemplateAnonymousInnerClass8( Org.Neo4j.Codegen.TypeReference type, Org.Neo4j.Codegen.ExpressionTemplate expression ) : base( type )
			 {
				 this._type = type;
...
//ORIGINAL LINE: public static ExpressionTemplate invokeSuperConstructor(final ExpressionTemplate[] parameters, final TypeReference[] parameterTypes)
		 ...
		 {
			 private Org.Neo4j.Codegen.ExpressionTemplate[] _parameters;
			 private Org.Neo4j.Codegen.TypeReference[] _parameterTypes;

			 public ExpressionTemplateAnonymousInnerClass9( UnknownType @object, Org.Neo4j.Codegen.ExpressionTemplate[] parameters, Org.Neo4j.Codegen.TypeReference[] parameterTypes ) : base( @object )
			 {
