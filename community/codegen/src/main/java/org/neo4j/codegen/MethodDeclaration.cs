...
//ORIGINAL LINE: public static Builder method(final TypeReference returnType, final String name, Parameter... parameters)
		 ...
		 {
			 private Org.Neo4j.Codegen.TypeReference _returnType;
			 private string _name;
			 private new Org.Neo4j.Codegen.Parameter[] _parameters;

			 public BuilderAnonymousInnerClass( Org.Neo4j.Codegen.Parameter[] parameters, Org.Neo4j.Codegen.TypeReference returnType, string name ) : base( parameters )
			 {
		 ...
		 private class BuilderAnonymousInnerClass2 : Builder
		 {
			 ...
			 public BuilderAnonymousInnerClass2( Org.Neo4j.Codegen.Parameter[] parameters ) : base( parameters )
			 {
				 this._parameters = parameters;
			 }
...
//JAVA TO C# CONVERTER NOTE: Members cannot have the same name as their enclosing type:
		 ...
		 private class MethodDeclarationAnonymousInnerClass : MethodDeclaration
		 {
			 ...
			 public MethodDeclarationAnonymousInnerClass( Org.Neo4j.Codegen.TypeReference owner, Org.Neo4j.Codegen.Parameter[] parameters, Org.Neo4j.Codegen.TypeReference[] exceptions, int modifiers, Org.Neo4j.Codegen.MethodDeclaration.TypeParameter[] typeParameters, Org.Neo4j.Codegen.TypeReference returnType, string name, bool isConstructor ) : base( owner, parameters, exceptions, modifiers, typeParameters )
			 {
				 this._returnType = returnType;
				 this._name = name;
