...
namespace Org.Neo4j.Graphdb.security
{
	...
	/// </summary>
	public class AuthorizationExpiredException : Exception, Org.Neo4j.Kernel.Api.Exceptions.Status_HasStatus
	{
		 private const Status STATUS_CODE = Org.Neo4j.Kernel.Api.Exceptions.Status_Security.AuthorizationExpired;
