...
namespace Org.Neo4j.Graphdb
{
	...
	/// <seealso cref="Node.getRelationships() relationship operations"/> on Node.
	/// <para>
	...
	/// <pre>
	/// <code>
	/// enum MyRelationshipTypes implements <seealso cref="RelationshipType"/>
	/// {
	///     CONTAINED_IN, KNOWS
	/// }
	/// </code>
	...
	/// createRelationshipTo}( anotherNode, <seealso cref="RelationshipType MyRelationshipTypes.KNOWS"/> );
	/// for ( <seealso cref="Relationship"/> rel : node.{@link Node#getRelationships(RelationshipType...)
	...
	public interface RelationshipType
	{
		 ...
		 /// <summary>
		 /// Instantiates a new <seealso cref="RelationshipType"/> with the given name.
		 /// </summary>
		 /// <param name="name"> the name of the dynamic relationship type </param>
		 /// <returns> a <seealso cref="RelationshipType"/> with the given name </returns>
