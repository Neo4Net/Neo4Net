...
namespace Org.Neo4j.Graphdb.index
{
	...
	public abstract class UniqueFactory<T> where T : Org.Neo4j.Graphdb.PropertyContainer
	{
		 private readonly Index<T> _index;

		 [Obsolete]
		 public class UniqueEntity<T> where T : Org.Neo4j.Graphdb.PropertyContainer
		 {
