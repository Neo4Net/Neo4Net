...
namespace Org.Neo4j.Graphdb.security
{
	...
	/// </summary>
	public class AuthorizationViolationException : Exception, Org.Neo4j.Kernel.Api.Exceptions.Status_HasStatus
	{
		 public const string PERMISSION_DENIED = "Permission denied.";

		 private Status _statusCode = Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Forbidden;
