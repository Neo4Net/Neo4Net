...
{
	/// <summary>
	/// A label is a grouping facility for <seealso cref="Node"/> where all nodes having a label
	...
	/// the <seealso cref="Label"/> instances. A consequence of this is that you can NOT
	/// use <seealso cref="Label"/> instances in hashed collections such as
	...
	/// <seealso cref="Node.hasLabel(Label)"/> method.
	/// 
	...
	public interface Label
	{
		 ...
		 /// <summary>
		 /// Instantiates a new <seealso cref="Label"/> with the given name.
		 /// </summary>
		 /// <param name="name"> the name of the label </param>
		 /// <returns> a <seealso cref="Label"/> instance for the given name </returns>
