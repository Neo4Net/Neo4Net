...
namespace Org.Neo4j.@unsafe.Impl.Batchimport.cache.idmapping
{
	...
	/// </summary>
	public interface IdMapper : Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable, AutoCloseable
	{
		 ...
		 Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable MemoryEstimation( long numberOfNodes );
