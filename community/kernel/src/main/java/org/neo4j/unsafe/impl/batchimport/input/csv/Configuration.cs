...
namespace Org.Neo4j.@unsafe.Impl.Batchimport.input.csv
{
	...
	/// </summary>
	public interface Configuration : Org.Neo4j.Csv.Reader.Configuration
	{
		 /// <summary>
	...
	//	 };
	 ...
	 public abstract class Configuration_Default : Org.Neo4j.Csv.Reader.Configuration_Default, Configuration
	 {
		 public abstract long CalculateMaxMemoryFromPercent( int percent );
		 public abstract bool CanDetectFreeMemory();
		 public abstract Configuration WithBatchSize( Org.Neo4j.@unsafe.Impl.Batchimport.Configuration config, int batchSize );
	 ...
	 public class Configuration_Overridden : Org.Neo4j.Csv.Reader.Configuration_Overridden, Configuration
	 {
