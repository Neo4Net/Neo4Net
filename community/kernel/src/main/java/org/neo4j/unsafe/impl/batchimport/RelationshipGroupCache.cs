...
namespace Org.Neo4j.@unsafe.Impl.Batchimport
{
	...
	using LongArray = Org.Neo4j.@unsafe.Impl.Batchimport.cache.LongArray;
...
//	import static org.neo4j.helpers.Format.bytes;
	...
	public class RelationshipGroupCache : IEnumerable<RelationshipGroupRecord>, AutoCloseable, Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable
	{
