...
//	import static org.neo4j.@unsafe.impl.batchimport.cache.GatheringMemoryStatsVisitor.totalMemoryUsageOf;
	...
	/// <seealso cref="org.neo4j.unsafe.impl.batchimport.input.Input.Estimates"/>. The reason why we're trying so hard to calculate
	...
	{
		 public static long EstimatedStoreSize( Org.Neo4j.@unsafe.Impl.Batchimport.input.Input_Estimates estimates, RecordFormats recordFormats )
		 {
		 ...
		 public static long EstimatedCacheSize( Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable baseMemory, params Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable[] memoryUsers )
		 {
		 ...
		 public static long OptimalMinimalHeapSize( Org.Neo4j.@unsafe.Impl.Batchimport.input.Input_Estimates estimates, RecordFormats recordFormats )
		 {
		 ...
		 public static long DefensivelyPadMemoryEstimate( params Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable[] memoryUsers )
		 {
