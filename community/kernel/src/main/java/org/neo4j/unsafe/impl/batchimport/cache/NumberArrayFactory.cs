...
namespace Org.Neo4j.@unsafe.Impl.Batchimport.cache
{
	...
	using NativeMemoryAllocationRefusedError = Org.Neo4j.@unsafe.Impl.@internal.Dragons.NativeMemoryAllocationRefusedError;
...
//		 static NumberArrayFactory auto(org.neo4j.io.pagecache.PageCache pageCache, java.io.File dir, boolean allowHeapAllocation, NumberArrayFactory_Monitor monitor)
	//	 {
