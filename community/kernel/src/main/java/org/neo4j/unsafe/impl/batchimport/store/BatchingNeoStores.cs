...
namespace Org.Neo4j.@unsafe.Impl.Batchimport.store
{
	...
	using IoTracer = Org.Neo4j.@unsafe.Impl.Batchimport.store.io.IoTracer;
...
//	import static org.neo4j.kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_COMMIT_TIMESTAMP;
	...
	/// </summary>
	public class BatchingNeoStores : AutoCloseable, Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable
	{
