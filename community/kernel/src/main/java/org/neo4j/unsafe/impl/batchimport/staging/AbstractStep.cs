...
namespace Org.Neo4j.@unsafe.Impl.Batchimport.staging
{
	...
	using MovingAverage = Org.Neo4j.Kernel.impl.util.MovingAverage;
	using ParkStrategy = Org.Neo4j.@unsafe.Impl.Batchimport.executor.ParkStrategy;
	using ProcessingStats = Org.Neo4j.@unsafe.Impl.Batchimport.stats.ProcessingStats;
...
//	import static org.apache.commons.lang3.SystemUtils.IS_OS_WINDOWS;
	...
	public abstract class AbstractStep<T> : Step<T>
	{
		...
		public abstract long Receive( long ticket, T batch );
		 public static readonly ParkStrategy Park = new Org.Neo4j.@unsafe.Impl.Batchimport.executor.ParkStrategy_Park( IS_OS_WINDOWS ? 10_000 : 500, MICROSECONDS );
