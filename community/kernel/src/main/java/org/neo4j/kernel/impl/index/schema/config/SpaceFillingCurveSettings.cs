...
namespace Org.Neo4j.Kernel.Impl.Index.Schema.config
{
	...
	using HilbertSpaceFillingCurve2D = Org.Neo4j.Gis.Spatial.Index.curves.HilbertSpaceFillingCurve2D;
	using HilbertSpaceFillingCurve3D = Org.Neo4j.Gis.Spatial.Index.curves.HilbertSpaceFillingCurve3D;
