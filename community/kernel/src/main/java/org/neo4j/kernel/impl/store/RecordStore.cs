...
namespace Org.Neo4j.Kernel.impl.store
{
	...
	public interface RecordStore<RECORD> : IdSequence where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	{
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
	 ...
	 public class RecordStore_Delegator<R> : RecordStore<R> where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	 {
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		  public virtual void ApplyFiltered<R>( RecordStore<R> store, params System.Predicate<object>[] filters ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		  {
				Apply( store, Org.Neo4j.Helpers.progress.ProgressListener_Fields.None, filters );
		  }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		  public virtual void ApplyFiltered<R>( RecordStore<R> store, ProgressListener progressListener, params System.Predicate<object>[] filters ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		  {
