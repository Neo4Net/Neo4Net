...
namespace Org.Neo4j.Kernel.Impl.Index.Schema
{
	...
	internal class LocalDateTimeArrayType : AbstractArrayType<DateTime>
	{
		 ...
		 internal LocalDateTimeArrayType( sbyte typeId ) : base( ValueGroup.LOCAL_DATE_TIME_ARRAY, typeId, ( o1, o2, i ) -> LocalDateTimeType.Compare( o1.long0Array[i], o1.long1Array[i], o2.long0Array[i], o2.long1Array[i] ), ( k, i ) -> LocalDateTimeType.AsValueRaw( k.long0Array[i], k.long1Array[i] ), ( c, k, i ) -> LocalDateTimeType.put( c, k.long0Array[i], k.long1Array[i] ), LocalDateTimeType.read, DateTime[]::new, org.neo4j.values.storable.ValueWriter_ArrayType.LocalDateTime )
		 {
