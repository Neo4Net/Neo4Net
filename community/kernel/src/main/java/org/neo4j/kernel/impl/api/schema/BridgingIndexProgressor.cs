 ...
 */
namespace Org.Neo4j.Kernel.Impl.Api.schema
{
	...
	/// </summary>
	public class BridgingIndexProgressor : Org.Neo4j.Storageengine.Api.schema.IndexProgressor_NodeValueClient, IndexProgressor
	{
		 ...
		 public BridgingIndexProgressor( Org.Neo4j.Storageengine.Api.schema.IndexProgressor_NodeValueClient client, int[] keys )
		 {
			  this._client = client;
			  this._keys = keys;
		 }
