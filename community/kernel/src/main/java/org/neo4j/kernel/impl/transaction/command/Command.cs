...
namespace Org.Neo4j.Kernel.impl.transaction.command
{
	...
	using PropertyRecordChange = Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.PropertyRecordChange;
...
//ORIGINAL LINE: void writeDynamicRecord(org.neo4j.storageengine.api.WritableChannel channel, org.neo4j.kernel.impl.store.record.DynamicRecord record) throws java.io.IOException
		 ...
		 public abstract class BaseCommand<RECORD> : Command where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
...
//ORIGINAL LINE: private void writePropertyBlock(org.neo4j.storageengine.api.WritableChannel channel, org.neo4j.kernel.impl.store.record.PropertyBlock block) throws java.io.IOException
		 ...
		 public abstract class TokenCommand<RECORD> : BaseCommand<RECORD> where RECORD : Org.Neo4j.Kernel.impl.store.record.TokenRecord
		 {
