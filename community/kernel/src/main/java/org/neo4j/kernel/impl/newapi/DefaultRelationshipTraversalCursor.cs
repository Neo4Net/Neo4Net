...
//           NONE(org.neo4j.storageengine.api.RelationshipDirection.ERROR) { boolean check(long source, long target, long origin) { return true; } };
			  ...
			  internal readonly Org.Neo4j.Storageengine.Api.RelationshipDirection direction;
		 ...
		 public override Org.Neo4j.@internal.Kernel.Api.RelationshipTraversalCursor_Position Suspend()
		 {
			  throw new System.NotSupportedException( "not implemented" );
		 }

		 public override void Resume( Org.Neo4j.@internal.Kernel.Api.RelationshipTraversalCursor_Position position )
		 {
			  throw new System.NotSupportedException( "not implemented" );
		 }
