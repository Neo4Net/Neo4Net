...
namespace Org.Neo4j.Kernel.Impl.Index.Schema
{
	...
	internal class Types
	{
		 ...
		 /// </summary>
		 internal static readonly AbstractArrayType[] ByArrayType = new AbstractArrayType[Enum.GetValues( typeof( Org.Neo4j.Values.Storable.ValueWriter_ArrayType ) ).length];
		 ...
		 static Types()
		 {
			  ...
			  foreach ( Org.Neo4j.Values.Storable.ValueWriter_ArrayType arrayType in Enum.GetValues( typeof( Org.Neo4j.Values.Storable.ValueWriter_ArrayType ) ) )
			  {
...
//ORIGINAL LINE: private static AbstractArrayType<?> typeOf(org.neo4j.values.storable.ValueWriter_ArrayType arrayType)
		 private static AbstractArrayType<object> TypeOf( Org.Neo4j.Values.Storable.ValueWriter_ArrayType arrayType )
		 {
			  switch ( arrayType )
			  {
