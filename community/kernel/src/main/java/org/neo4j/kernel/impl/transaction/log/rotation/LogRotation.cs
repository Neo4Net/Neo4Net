 ...
 */
namespace Org.Neo4j.Kernel.impl.transaction.log.rotation
{
...
//ORIGINAL LINE: boolean rotateLogIfNeeded(org.neo4j.kernel.impl.transaction.tracing.LogAppendEvent logAppendEvent) throws java.io.IOException;
