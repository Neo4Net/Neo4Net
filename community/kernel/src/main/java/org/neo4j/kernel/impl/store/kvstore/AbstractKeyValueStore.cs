...
//ORIGINAL LINE: public DataProvider filter(final DataProvider provider)
			  ...
			  private class DataProviderAnonymousInnerClass : DataProvider
			  {
				  ...
				  private Org.Neo4j.Kernel.impl.store.kvstore.DataProvider _provider;

				  public DataProviderAnonymousInnerClass( Format outerInstance, Org.Neo4j.Kernel.impl.store.kvstore.DataProvider provider )
				  {
