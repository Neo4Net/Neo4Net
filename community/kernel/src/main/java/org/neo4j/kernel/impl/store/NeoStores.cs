...
namespace Org.Neo4j.Kernel.impl.store
{
	...
	using ReadOnlyCountsTracker = Org.Neo4j.Kernel.impl.store.counts.ReadOnlyCountsTracker;
...
//ORIGINAL LINE: public void startCountStore() throws java.io.IOException
		 ...
		 private class DataInitializerAnonymousInnerClass : DataInitializer<Org.Neo4j.Kernel.Impl.Api.CountsAccessor_Updater>
		 {
			 private readonly NeoStores _outerInstance;

			 private Org.Neo4j.Kernel.impl.store.NeoStores _neoStores;
			 ...
			 public void initialize( Org.Neo4j.Kernel.Impl.Api.CountsAccessor_Updater updater )
			 {
