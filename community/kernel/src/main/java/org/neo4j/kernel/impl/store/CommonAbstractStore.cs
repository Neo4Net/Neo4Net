...
//	import static org.neo4j.kernel.impl.store.record.RecordLoad.NORMAL;
	...
	/// </summary>
	public abstract class CommonAbstractStore<RECORD, HEADER> : RecordStore<RECORD>, AutoCloseable where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where HEADER : StoreHeader
	{
