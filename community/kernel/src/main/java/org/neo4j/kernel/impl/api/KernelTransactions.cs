...
namespace Org.Neo4j.Kernel.Impl.Api
{
	...
	using IndexingProvidersService = Org.Neo4j.Kernel.Impl.Api.index.IndexingProvidersService;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java stream collectors are not converted by Java to C# Converter:
		 ...
		 private void MarkAllTransactionsAsTerminated()
		 {
			  ...
			  _allTransactions.forEach( tx => tx.markForTermination( Org.Neo4j.Kernel.Api.Exceptions.Status_General.DatabaseUnavailable ) );
		 }
