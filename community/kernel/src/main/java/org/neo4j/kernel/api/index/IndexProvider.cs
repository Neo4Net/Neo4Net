...
namespace Org.Neo4j.Kernel.Api.Index
{
	...
	public abstract class IndexProvider : LifecycleAdapter
	{
		 ...
		 {
			 public IndexProviderAnonymousInnerClass( Org.Neo4j.Kernel.Api.Index.IndexDirectoryStructure.Factory none ) : base( new IndexProviderDescriptor( "no-index-provider", "1.0" ), none )
			 {
			 }
