...
namespace Org.Neo4j.Kernel.impl.util
{
	...
	public class ReadAndDeleteTransactionConflictException : Exception, Org.Neo4j.Kernel.Api.Exceptions.Status_HasStatus
	{
		 ...
		 {
			  return _deletedInThisTransaction ? Org.Neo4j.Kernel.Api.Exceptions.Status_Statement.EntityNotFound : Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.Outdated;
		 }
	}
