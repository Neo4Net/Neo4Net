...
namespace Org.Neo4j.Kernel.Impl.Index.Schema
{
	...
	internal class ZonedTimeArrayType : AbstractArrayType<OffsetTime>
	{
		 ...
		 internal ZonedTimeArrayType( sbyte typeId ) : base( ValueGroup.ZONED_TIME_ARRAY, typeId, ( o1, o2, i ) -> ZonedTimeType.Compare( o1.long0Array[i], o1.long1Array[i], o2.long0Array[i], o2.long1Array[i] ), ( k, i ) -> ZonedTimeType.AsValueRaw( k.long0Array[i], k.long1Array[i] ), ( c, k, i ) -> ZonedTimeType.put( c, k.long0Array[i], k.long1Array[i] ), ZonedTimeType.read, OffsetTime[]::new, org.neo4j.values.storable.ValueWriter_ArrayType.ZonedTime )
		 {
