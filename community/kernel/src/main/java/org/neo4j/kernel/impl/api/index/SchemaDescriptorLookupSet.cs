...
//	import static org.neo4j.@internal.kernel.api.schema.SchemaDescriptor_PropertySchemaType.PARTIAL_ANY_TOKEN;
	...
	/// </para>
	/// </summary>
	public class SchemaDescriptorLookupSet<T> where T : Org.Neo4j.@internal.Kernel.Api.schema.SchemaDescriptorSupplier
	{
		 ...
		 private class PropertyMultiSet
		 {
			 ...
			 public PropertyMultiSet( SchemaDescriptorLookupSet<T> outerInstance )
			 {
			  ...
			  internal virtual void Add( T schemaDescriptor )
			  {
					...
					Org.Neo4j.@internal.Kernel.Api.schema.SchemaDescriptor_PropertySchemaType propertySchemaType = schemaDescriptor.schema().propertySchemaType();
