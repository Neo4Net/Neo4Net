...
namespace Org.Neo4j.Kernel.impl.store.format.standard
{
	...
	public class NoRecordFormat<RECORD> : RecordFormat<RECORD> where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	{
		 ...
		 {
			  return Org.Neo4j.Kernel.impl.store.format.RecordFormat_Fields.NO_RECORD_SIZE;
		 }
