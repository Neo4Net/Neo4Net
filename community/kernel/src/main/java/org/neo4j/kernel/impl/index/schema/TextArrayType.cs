...
//JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
		 ...
		 internal override void InitializeArray( GenericKey key, int length, Org.Neo4j.Values.Storable.ValueWriter_ArrayType arrayType )
		 {
			  ...
			  setCharType( key, arrayType == Org.Neo4j.Values.Storable.ValueWriter_ArrayType.Char );
		 }
		 ...
		 internal override bool ReadValue( PageCursor cursor, int size, GenericKey into )
		 {
			  ...
			  into.BeginArray( into.ArrayLength, isCharType ? Org.Neo4j.Values.Storable.ValueWriter_ArrayType.Char : Org.Neo4j.Values.Storable.ValueWriter_ArrayType.String );
