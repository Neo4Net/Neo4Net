...
//       META_DATA(org.neo4j.io.layout.DatabaseFile.METADATA_STORE, true, true) { public CommonAbstractStore open(NeoStores neoStores) { return neoStores.createMetadataStore(); } };
		 ...
		 private readonly Org.Neo4j.Io.layout.DatabaseFile databaseFile;

		 internal StoreType( Org.Neo4j.Io.layout.DatabaseFile databaseFile, bool recordStore, bool limitedIdStore ) { this.databaseFile = databaseFile; this.recordStore = recordStore; this.limitedIdStore = limitedIdStore; } abstract object open( NeoStores neoStores );
		 ...
		 public Org.Neo4j.Io.layout.DatabaseFile DatabaseFile
		 {
			 get
			 {
