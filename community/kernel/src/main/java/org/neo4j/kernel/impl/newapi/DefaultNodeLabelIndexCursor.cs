...
namespace Org.Neo4j.Kernel.Impl.Newapi
{
	...
	using LabelScanValueIndexProgressor = Org.Neo4j.Kernel.impl.index.labelscan.LabelScanValueIndexProgressor;
	using IndexProgressor = Org.Neo4j.Storageengine.Api.schema.IndexProgressor;
	using IndexProgressor_NodeLabelClient = Org.Neo4j.Storageengine.Api.schema.IndexProgressor_NodeLabelClient;
