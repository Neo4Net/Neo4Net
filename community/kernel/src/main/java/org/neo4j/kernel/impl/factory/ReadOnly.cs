...
namespace Org.Neo4j.Kernel.impl.factory
{
	...
	public class ReadOnly : AccessCapability
	{
		 ...
		 {
			  throw new WriteOperationsNotAllowedException( "No write operations are allowed on this database. This is a read only Neo4j instance.", Org.Neo4j.Kernel.Api.Exceptions.Status_General.ForbiddenOnReadOnlyDatabase );
		 }
	}
