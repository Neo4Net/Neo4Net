...
namespace Org.Neo4j.Kernel.Impl.Newapi
{
	...
	using AutoCloseablePlus = Org.Neo4j.@internal.Kernel.Api.AutoCloseablePlus;
...
//	import static org.neo4j.util.FeatureToggles.flag;
	...
	public class DefaultCursors : CursorFactory
	{
		 ...
		 private T Trace<T>( T closeable ) where T : Org.Neo4j.@internal.Kernel.Api.AutoCloseablePlus
		 {
			  if ( _debugClosing )
			  {
