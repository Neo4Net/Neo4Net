...
namespace Org.Neo4j.Kernel.impl.transaction.log
{
	...
	public class LoggingLogFileMonitor : LogFileCreationMonitor, Org.Neo4j.Kernel.impl.transaction.log.rotation.LogRotation_Monitor, RecoveryMonitor, RecoveryStartInformationProvider.Monitor
	{
