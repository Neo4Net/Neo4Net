...
namespace Org.Neo4j.Kernel.impl.transaction.log
{
	...
	using LogHeaderVisitor = Org.Neo4j.Kernel.impl.transaction.log.files.LogHeaderVisitor;
	using ReversedMultiFileTransactionCursor = Org.Neo4j.Kernel.impl.transaction.log.reverse.ReversedMultiFileTransactionCursor;
	using ReversedTransactionCursorMonitor = Org.Neo4j.Kernel.impl.transaction.log.reverse.ReversedTransactionCursorMonitor;
...
//ORIGINAL LINE: public boolean existsOnDisk(long transactionId) throws java.io.IOException
		 ...
		 public class TransactionPositionLocator : Org.Neo4j.Kernel.impl.transaction.log.files.LogFile_LogFileVisitor
		 {
