...
namespace Org.Neo4j.Kernel.impl.storemigration.participant
{
	...
	using AdditionalInitialIds = Org.Neo4j.@unsafe.Impl.Batchimport.AdditionalInitialIds;
	...
	using CoarseBoundedProgressExecutionMonitor = Org.Neo4j.@unsafe.Impl.Batchimport.staging.CoarseBoundedProgressExecutionMonitor;
...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.neo4j.kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_LOG_BYTE_OFFSET;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.neo4j.kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_LOG_VERSION;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.neo4j.kernel.impl.transaction.log.TransactionIdStore_Fields.UNKNOWN_TX_CHECKSUM;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void writeLastTxLogPosition(org.neo4j.io.layout.DatabaseLayout migrationStructure, org.neo4j.kernel.impl.transaction.log.LogPosition lastTxLogPosition) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: org.neo4j.kernel.impl.store.TransactionId readLastTxInformation(org.neo4j.io.layout.DatabaseLayout migrationStructure) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: org.neo4j.kernel.impl.transaction.log.LogPosition readLastTxLogPosition(org.neo4j.io.layout.DatabaseLayout migrationStructure) throws java.io.IOException
...
//ORIGINAL LINE: org.neo4j.kernel.impl.store.TransactionId extractTransactionIdInformation(java.io.File neoStore, long lastTransactionId) throws java.io.IOException
		 ...
		 {
			  return lastTransactionId == Org.Neo4j.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_ID ? new TransactionId( lastTransactionId, BASE_TX_CHECKSUM, BASE_TX_COMMIT_TIMESTAMP ) : new TransactionId( lastTransactionId, UNKNOWN_TX_CHECKSUM, UNKNOWN_TX_COMMIT_TIMESTAMP );
		 }
...
//ORIGINAL LINE: private void migrateWithBatchImporter(org.neo4j.io.layout.DatabaseLayout sourceDirectoryStructure, org.neo4j.io.layout.DatabaseLayout migrationDirectoryStructure, long lastTxId, long lastTxChecksum, long lastTxLogVersion, long lastTxLogByteOffset, org.neo4j.kernel.impl.util.monitoring.ProgressReporter progressReporter, org.neo4j.kernel.impl.store.format.RecordFormats oldFormat, org.neo4j.kernel.impl.store.format.RecordFormats newFormat) throws java.io.IOException
		 private void MigrateWithBatchImporter( DatabaseLayout sourceDirectoryStructure, DatabaseLayout migrationDirectoryStructure, long lastTxId, long lastTxChecksum, long lastTxLogVersion, long lastTxLogByteOffset, ProgressReporter progressReporter, RecordFormats oldFormat, RecordFormats newFormat )
		 {
			  ...
			  File badFile = sourceDirectoryStructure.File( Org.Neo4j.@unsafe.Impl.Batchimport.Configuration_Fields.BAD_FILE_NAME );
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass : Org.Neo4j.@unsafe.Impl.Batchimport.Configuration_Overridden
		 {
...
//ORIGINAL LINE: private static org.neo4j.unsafe.impl.batchimport.AdditionalInitialIds readAdditionalIds(final long lastTxId, final long lastTxChecksum, final long lastTxLogVersion, final long lastTxLogByteOffset)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private static org.neo4j.unsafe.impl.batchimport.staging.ExecutionMonitor migrationBatchImporterMonitor(org.neo4j.kernel.impl.store.NeoStores legacyStore, final org.neo4j.kernel.impl.util.monitoring.ProgressReporter progressReporter, org.neo4j.unsafe.impl.batchimport.Configuration config)
		 ...
		 private class StoreScanAsInputIteratorAnonymousInnerClass2 : StoreScanAsInputIterator<NodeRecord>
		 {
			 ...
			 public StoreScanAsInputIteratorAnonymousInnerClass2( Org.Neo4j.Kernel.impl.store.NodeStore getNodeStore, NeoStores legacyStore, bool requiresPropertyMigration ) : base( getNodeStore )
			 {
				 this._legacyStore = legacyStore;
				 this._requiresPropertyMigration = requiresPropertyMigration;
			 }
