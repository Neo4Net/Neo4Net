...
namespace Org.Neo4j.Kernel.impl.storemigration
{
	...
	using DatabaseNotCleanlyShutDownException = Org.Neo4j.Kernel.impl.storemigration.StoreUpgrader.DatabaseNotCleanlyShutDownException;
	...
	using UnexpectedUpgradingStoreVersionException = Org.Neo4j.Kernel.impl.storemigration.StoreUpgrader.UnexpectedUpgradingStoreVersionException;
	using UpgradeMissingStoreFilesException = Org.Neo4j.Kernel.impl.storemigration.StoreUpgrader.UpgradeMissingStoreFilesException;
	using UpgradingStoreVersionNotFoundException = Org.Neo4j.Kernel.impl.storemigration.StoreUpgrader.UpgradingStoreVersionNotFoundException;
	using Result = Org.Neo4j.Kernel.impl.storemigration.StoreVersionCheck.Result;
	using Outcome = Org.Neo4j.Kernel.impl.storemigration.StoreVersionCheck.Result.Outcome;
