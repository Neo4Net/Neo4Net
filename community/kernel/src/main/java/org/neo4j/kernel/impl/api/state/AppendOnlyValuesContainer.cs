...
namespace Org.Neo4j.Kernel.Impl.Api.state
{
	...
	using Memory = Org.Neo4j.Kernel.impl.util.collection.Memory;
	using MemoryAllocator = Org.Neo4j.Kernel.impl.util.collection.MemoryAllocator;
	...
	using NoValue = Org.Neo4j.Values.Storable.NoValue;
...
//           NO_VALUE(org.neo4j.values.storable.NoValue.class, (unused, unused2) -> org.neo4j.values.storable.NoValue.NO_VALUE),
			  public static readonly ValueType Boolean = new ValueType( "Boolean", InnerEnum.Boolean, typeof( Org.Neo4j.Values.Storable.BooleanValue ), AppendOnlyValuesContainer.readBoolean );
			  public static readonly ValueType BooleanArray = new ValueType( "BooleanArray", InnerEnum.BooleanArray, typeof( Org.Neo4j.Values.Storable.BooleanArray ), AppendOnlyValuesContainer.readBooleanArray );
			  public static readonly ValueType Byte = new ValueType( "Byte", InnerEnum.Byte, typeof( Org.Neo4j.Values.Storable.ByteValue ), AppendOnlyValuesContainer.readByte );
			  public static readonly ValueType ByteArray = new ValueType( "ByteArray", InnerEnum.ByteArray, typeof( Org.Neo4j.Values.Storable.ByteArray ), AppendOnlyValuesContainer.readByteArray );
			  public static readonly ValueType Short = new ValueType( "Short", InnerEnum.Short, typeof( Org.Neo4j.Values.Storable.ShortValue ), AppendOnlyValuesContainer.readShort );
			  public static readonly ValueType ShortArray = new ValueType( "ShortArray", InnerEnum.ShortArray, typeof( Org.Neo4j.Values.Storable.ShortArray ), AppendOnlyValuesContainer.readShortArray );
			  public static readonly ValueType Int = new ValueType( "Int", InnerEnum.Int, typeof( Org.Neo4j.Values.Storable.IntValue ), AppendOnlyValuesContainer.readInt );
			  public static readonly ValueType IntArray = new ValueType( "IntArray", InnerEnum.IntArray, typeof( Org.Neo4j.Values.Storable.IntArray ), AppendOnlyValuesContainer.readIntArray );
			  public static readonly ValueType Long = new ValueType( "Long", InnerEnum.Long, typeof( Org.Neo4j.Values.Storable.LongValue ), AppendOnlyValuesContainer.readLong );
			  public static readonly ValueType LongArray = new ValueType( "LongArray", InnerEnum.LongArray, typeof( Org.Neo4j.Values.Storable.LongArray ), AppendOnlyValuesContainer.readLongArray );
			  public static readonly ValueType Float = new ValueType( "Float", InnerEnum.Float, typeof( Org.Neo4j.Values.Storable.FloatValue ), AppendOnlyValuesContainer.readFloat );
			  public static readonly ValueType FloatArray = new ValueType( "FloatArray", InnerEnum.FloatArray, typeof( Org.Neo4j.Values.Storable.FloatArray ), AppendOnlyValuesContainer.readFloatArray );
			  public static readonly ValueType Double = new ValueType( "Double", InnerEnum.Double, typeof( Org.Neo4j.Values.Storable.DoubleValue ), AppendOnlyValuesContainer.readDouble );
			  public static readonly ValueType DoubleArray = new ValueType( "DoubleArray", InnerEnum.DoubleArray, typeof( Org.Neo4j.Values.Storable.DoubleArray ), AppendOnlyValuesContainer.readDoubleArray );
			  public static readonly ValueType String = new ValueType( "String", InnerEnum.String, typeof( Org.Neo4j.Values.Storable.StringValue ), AppendOnlyValuesContainer.readString );
			  public static readonly ValueType StringArray = new ValueType( "StringArray", InnerEnum.StringArray, typeof( Org.Neo4j.Values.Storable.StringArray ), AppendOnlyValuesContainer.readStringArray );
			  public static readonly ValueType Char = new ValueType( "Char", InnerEnum.Char, typeof( Org.Neo4j.Values.Storable.CharValue ), AppendOnlyValuesContainer.readChar );
			  public static readonly ValueType CharArray = new ValueType( "CharArray", InnerEnum.CharArray, typeof( Org.Neo4j.Values.Storable.CharArray ), AppendOnlyValuesContainer.readCharArray );
			  public static readonly ValueType Point = new ValueType( "Point", InnerEnum.Point, typeof( Org.Neo4j.Values.Storable.PointValue ), AppendOnlyValuesContainer.readPoint );
			  public static readonly ValueType PointArray = new ValueType( "PointArray", InnerEnum.PointArray, typeof( Org.Neo4j.Values.Storable.PointArray ), AppendOnlyValuesContainer.readPointArray );
			  public static readonly ValueType Duration = new ValueType( "Duration", InnerEnum.Duration, typeof( Org.Neo4j.Values.Storable.DurationValue ), AppendOnlyValuesContainer.readDuration );
			  public static readonly ValueType DurationArray = new ValueType( "DurationArray", InnerEnum.DurationArray, typeof( Org.Neo4j.Values.Storable.DurationArray ), AppendOnlyValuesContainer.readDurationArray );
			  public static readonly ValueType Date = new ValueType( "Date", InnerEnum.Date, typeof( Org.Neo4j.Values.Storable.DateValue ), AppendOnlyValuesContainer.readDate );
			  public static readonly ValueType DateArray = new ValueType( "DateArray", InnerEnum.DateArray, typeof( Org.Neo4j.Values.Storable.DateArray ), AppendOnlyValuesContainer.readDateArray );
			  public static readonly ValueType Time = new ValueType( "Time", InnerEnum.Time, typeof( Org.Neo4j.Values.Storable.TimeValue ), AppendOnlyValuesContainer.readTime );
			  public static readonly ValueType TimeArray = new ValueType( "TimeArray", InnerEnum.TimeArray, typeof( Org.Neo4j.Values.Storable.TimeArray ), AppendOnlyValuesContainer.readTimeArray );
			  public static readonly ValueType DateTime = new ValueType( "DateTime", InnerEnum.DateTime, typeof( Org.Neo4j.Values.Storable.DateTimeValue ), AppendOnlyValuesContainer.readDateTime );
			  public static readonly ValueType DateTimeArray = new ValueType( "DateTimeArray", InnerEnum.DateTimeArray, typeof( Org.Neo4j.Values.Storable.DateTimeArray ), AppendOnlyValuesContainer.readDateTimeArray );
			  public static readonly ValueType LocalTime = new ValueType( "LocalTime", InnerEnum.LocalTime, typeof( Org.Neo4j.Values.Storable.LocalTimeValue ), AppendOnlyValuesContainer.readLocalTime );
			  public static readonly ValueType LocalTimeArray = new ValueType( "LocalTimeArray", InnerEnum.LocalTimeArray, typeof( Org.Neo4j.Values.Storable.LocalTimeArray ), AppendOnlyValuesContainer.readLocalTimeArray );
			  public static readonly ValueType LocalDateTime = new ValueType( "LocalDateTime", InnerEnum.LocalDateTime, typeof( Org.Neo4j.Values.Storable.LocalDateTimeValue ), AppendOnlyValuesContainer.readLocalDateTime );
			  public static readonly ValueType LocalDateTimeArray = new ValueType( "LocalDateTimeArray", InnerEnum.LocalDateTimeArray, typeof( Org.Neo4j.Values.Storable.LocalDateTimeArray ), AppendOnlyValuesContainer.readLocalDateTimeArray );
			  ...
			  internal static ValueType ForValue( Org.Neo4j.Values.Storable.Value value )
			  {
		 ...
		 internal interface ValueReader<T> where T : Org.Neo4j.Values.Storable.Value
		 {
