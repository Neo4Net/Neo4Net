...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
		 ...
		 private abstract class TokenIterator<T> : PrefetchingResourceIterator<T>
		 {
			  ...
			  {
				  private new Org.Neo4j.Kernel.Impl.Api.TokenAccess<T> _access;

				  public TokenIteratorAnonymousInnerClass2( KernelTransaction transaction, Org.Neo4j.Kernel.Impl.Api.TokenAccess<T> access ) : base( transaction, access )
				  {
					  this._access = access;
				  }
