...
namespace Org.Neo4j.Kernel.api.security
{
	...
	public class AnonymousContext : LoginContext
	{
		 ...
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.None );
		 }

		 public static AnonymousContext Read()
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Read );
		 }

		 public static AnonymousContext Write()
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Write );
		 }

		 public static AnonymousContext WriteToken()
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.TokenWrite );
		 }

		 public static AnonymousContext WriteOnly()
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.WriteOnly );
		 }

		 public static AnonymousContext Full()
		 {
			  return new AnonymousContext( Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Full );
		 }
