...
//	import static org.neo4j.kernel.impl.store.record.AbstractBaseRecord.NO_ID;
	...
	internal class DefaultRelationshipGroupCursor : RelationshipGroupCursor
	{
		 ...
		 public override Org.Neo4j.@internal.Kernel.Api.RelationshipGroupCursor_Position Suspend()
		 {
			  throw new System.NotSupportedException( "not implemented" );
		 }

		 public override void Resume( Org.Neo4j.@internal.Kernel.Api.RelationshipGroupCursor_Position position )
		 {
			  throw new System.NotSupportedException( "not implemented" );
		 }
