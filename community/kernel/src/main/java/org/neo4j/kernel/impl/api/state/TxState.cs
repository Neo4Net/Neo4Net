...
namespace Org.Neo4j.Kernel.Impl.Api.state
{
	...
	using Org.Neo4j.Kernel.impl.util.diffsets;
	using Org.Neo4j.Kernel.impl.util.diffsets;
	...
	using GraphState = Org.Neo4j.Storageengine.Api.txstate.GraphState;
	using LongDiffSets = Org.Neo4j.Storageengine.Api.txstate.LongDiffSets;
	using NodeState = Org.Neo4j.Storageengine.Api.txstate.NodeState;
...
//	import static org.neo4j.values.storable.Values.NO_VALUE;
	...
	/// </para>
	/// </summary>
	public class TxState : TransactionState, Org.Neo4j.Storageengine.Api.RelationshipVisitor_Home
	{
		 /// <summary>
...
//ORIGINAL LINE: final org.neo4j.storageengine.api.txstate.LongDiffSets labelDiffSets = nodeState.labelDiffSets();
		 ...
		 {
			  return Org.Neo4j.Storageengine.Api.txstate.DiffSets_Empty.IfNull( _indexChanges );
		 }
...
//ORIGINAL LINE: @VisibleForTesting GraphStateImpl getOrCreateGraphState()
		 ...
		 {
			  return Org.Neo4j.Storageengine.Api.txstate.DiffSets_Empty.IfNull( _constraintsChanges );
		 }
