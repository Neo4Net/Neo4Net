...
namespace Org.Neo4j.Kernel.impl.context
{
	...
	using EmptyVersionContext = Org.Neo4j.Io.pagecache.tracing.cursor.context.EmptyVersionContext;
	...
	/// <summary>
	/// <seealso cref="VersionContextSupplier"/> that supplier thread bound version context that should be used in a context of
	/// transaction(Committing or reading).
	/// </summary>
	public class TransactionVersionContextSupplier : VersionContextSupplier
	{
		 protected internal ThreadLocal<VersionContext> CursorContext;
