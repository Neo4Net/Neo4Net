...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 [Procedure(name : "db.schema.nodeTypeProperties", mode : Org.Neo4j.Procedure.Mode.READ), Description("Show the derived property schema of the nodes in tabular form.")]
		 ...
		 [Procedure(name : "db.schema.relTypeProperties", mode : Org.Neo4j.Procedure.Mode.READ), Description("Show the derived property schema of the relationships in tabular form.")]
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 public virtual Stream<NodeResult> NodeManualIndexSeek( string explicitIndexName, string key, object value )
		 {
			  ...
			  {
					throw new ProcedureException( Org.Neo4j.Kernel.Api.Exceptions.Status_LegacyIndex.LegacyIndexNotFound, "Node index %s not found", explicitIndexName );
			  }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 public virtual Stream<WeightedNodeResult> NodeManualIndexSearch( string manualIndexName, object query )
		 {
			  ...
			  {
					throw new ProcedureException( Org.Neo4j.Kernel.Api.Exceptions.Status_LegacyIndex.LegacyIndexNotFound, "Node index %s not found", manualIndexName );
			  }
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 public virtual Stream<RelationshipResult> RelationshipManualIndexSeek( string manualIndexName, string key, object value )
		 {
			  ...
			  {
					throw new ProcedureException( Org.Neo4j.Kernel.Api.Exceptions.Status_LegacyIndex.LegacyIndexNotFound, "Relationship index %s not found", manualIndexName );
			  }
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 public virtual Stream<WeightedRelationshipResult> RelationshipManualIndexSearchWithBoundStartNode( string indexName, Node @in, object query )
		 {
			  ...
			  {
					throw new ProcedureException( Org.Neo4j.Kernel.Api.Exceptions.Status_LegacyIndex.LegacyIndexNotFound, "Relationship index %s not found", indexName );
			  }
		 }
...
//ORIGINAL LINE: @Deprecated @Description("Remove a relationship from an explicit index with an optional key") @Procedure(name = "db.index.explicit.removeRelationship", mode = WRITE, deprecatedBy = EXPLICIT_INDEX_DEPRECATION) public java.util.stream.Stream<BooleanResult> relationshipManualIndexRemove(@Name("indexName") String explicitIndexName, @Name("relationship") org.neo4j.graphdb.Relationship relationship, @Name(value = "key", defaultValue = DEFAULT_KEY) String key)
		 ...
		 private sealed class IndexType
		 {
			  ...
			  internal static IndexType GetIndexTypeOf( Org.Neo4j.@internal.Kernel.Api.IndexReference index )
			  {
