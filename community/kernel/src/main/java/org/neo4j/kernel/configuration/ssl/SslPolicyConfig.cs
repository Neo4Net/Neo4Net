...
namespace Org.Neo4j.Kernel.configuration.ssl
{
	...
	using ClientAuth = Org.Neo4j.Ssl.ClientAuth;
...
//ORIGINAL LINE: @Internal @Description("The password for the private key.") public final org.neo4j.graphdb.config.Setting<String> private_key_password;
