...
namespace Org.Neo4j.Kernel.@internal
{
	...
	using TxStateTransactionDataSnapshot = Org.Neo4j.Kernel.impl.coreapi.TxStateTransactionDataSnapshot;
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 public class TransactionHandlerState : Org.Neo4j.Kernel.api.TransactionHook_Outcome
		 {
