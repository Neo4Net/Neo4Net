...
//	import static org.neo4j.@unsafe.impl.batchimport.input.Inputs.knownEstimates;
	...
	public class HeapSizeSanityCheckerTest
	{
		...
		private void InitializeInstanceFields()
		{
		 ...
		 private Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable _baseMemory;
		 private readonly System.Func<long> _memoryUser1Supplier = mock( typeof( System.Func<long> ) );
		 private Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable _memoryUser1;
		 private readonly System.Func<long> _memoryUser2Supplier = mock( typeof( System.Func<long> ) );
		 private Org.Neo4j.@unsafe.Impl.Batchimport.cache.MemoryStatsVisitor_Visitable _memoryUser2;
...
//ORIGINAL LINE: @Test public void shouldReportInsufficientAvailableMemory()
		 public virtual void ShouldReportInsufficientAvailableMemory()
		 {
			  ...
			  Org.Neo4j.@unsafe.Impl.Batchimport.input.Input_Estimates estimates = knownEstimates( 1_000_000_000, 10_000_000_000L, 2_000_000_000L, 0, gibiBytes( 50 ), gibiBytes( 100 ), 0 );
