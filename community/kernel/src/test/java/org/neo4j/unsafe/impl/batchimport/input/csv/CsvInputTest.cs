...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.neo4j.@unsafe.impl.batchimport.input.csv.CsvInput.NO_MONITOR;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private DataFactory given(final org.neo4j.csv.reader.CharReadable data)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private DataFactory data(final org.neo4j.csv.reader.CharReadable data, final Decorator decorator)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private static Data dataItem(final org.neo4j.csv.reader.CharReadable data, final Decorator decorator)
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertNextRelationship(org.neo4j.unsafe.impl.batchimport.InputIterator relationship, Object startNode, Object endNode, String type, Object[] properties) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertRelationship(org.neo4j.unsafe.impl.batchimport.InputIterator data, org.neo4j.unsafe.impl.batchimport.input.Group startNodeGroup, Object startNode, org.neo4j.unsafe.impl.batchimport.input.Group endNodeGroup, Object endNode, String type, Object[] properties) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertNextNode(org.neo4j.unsafe.impl.batchimport.InputIterator data, Object id, Object[] properties, java.util.Set<String> labels) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertNextNode(org.neo4j.unsafe.impl.batchimport.InputIterator data, org.neo4j.unsafe.impl.batchimport.input.Group group, Object id, Object[] properties, java.util.Set<String> labels) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private boolean readNext(org.neo4j.unsafe.impl.batchimport.InputIterator data) throws java.io.IOException
...
//ORIGINAL LINE: private Header.Factory header(final Header.Entry... entries)
		 ...
		 private class FactoryAnonymousInnerClass : Header.Factory
		 {
			 ...
			 private Org.Neo4j.@unsafe.Impl.Batchimport.input.csv.Header.Entry[] _entries;

			 public FactoryAnonymousInnerClass( CsvInputTest outerInstance, Org.Neo4j.@unsafe.Impl.Batchimport.input.csv.Header.Entry[] entries )
			 {
				 this.outerInstance = outerInstance;
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 private class FailingNodeDecorator : Decorator
		 {
			  ...
			  private class InputEntityVisitor_DelegateAnonymousInnerClass : Org.Neo4j.@unsafe.Impl.Batchimport.input.InputEntityVisitor_Delegate
			  {
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass( CsvInputTest outerInstance, Org.Neo4j.@unsafe.Impl.Batchimport.Configuration config ) : base( config )
			 {
				 this.outerInstance = outerInstance;
			 }
