...
//ORIGINAL LINE: final java.util.concurrent.Future<int> realFuture = org.neo4j.helpers.FutureAdapter.processFuture(process);
		 ...
		 {
			 private Org.Neo4j.Test.ProcessStreamHandler _processOutput;
			 private Future<int> _realFuture;

			 public FutureAnonymousInnerClass( Org.Neo4j.Test.ProcessStreamHandler processOutput, Future<int> realFuture )
			 {
