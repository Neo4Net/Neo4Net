...
//ORIGINAL LINE: final GraphDescription graph = GraphDescription.create(g);
		 ...
		 private class StatementAnonymousInnerClass : Statement
		 {
			 ...
			 private Org.Neo4j.Test.GraphDescription _graph;

			 public StatementAnonymousInnerClass( TestData<T> outerInstance, Statement @base, Description description, Title title, Documented doc, Org.Neo4j.Test.GraphDescription graph )
			 {
