...
//           STARTED { void initialize(org.neo4j.kernel.lifecycle.LifeRule life) { life.start(); } };
			  ...
			  internal abstract void initialize( Org.Neo4j.Kernel.Lifecycle.LifeRule life );
...
//ORIGINAL LINE: private org.junit.runners.model.Statement initialise(final org.junit.runners.model.Statement super, final InitialLifecycle initialLifecycle)
		 ...
		 private class StatementAnonymousInnerClass : Statement
		 {
			 ...
			 private Org.Neo4j.Test.rule.Resources.InitialLifecycle _initialLifecycle;

			 public StatementAnonymousInnerClass( Resources outerInstance, Statement @base, Org.Neo4j.Test.rule.Resources.InitialLifecycle initialLifecycle )
			 {
