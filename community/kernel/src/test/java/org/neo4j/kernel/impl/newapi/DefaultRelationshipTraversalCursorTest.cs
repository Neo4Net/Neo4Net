...
//JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
		 ...
		 private class StorageRelationshipTraversalCursorAnonymousInnerClass : StorageRelationshipTraversalCursor
		 {
			 ...
			 private Org.Neo4j.Kernel.Impl.Newapi.DefaultRelationshipTraversalCursorTest.Rel[] _rels;

			 public StorageRelationshipTraversalCursorAnonymousInnerClass( DefaultRelationshipTraversalCursorTest outerInstance, Org.Neo4j.Kernel.Impl.Newapi.DefaultRelationshipTraversalCursorTest.Rel[] rels )
			 {
