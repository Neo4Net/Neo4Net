...
//ORIGINAL LINE: static DataProvider provider(final Pair... data)
		 ...
		 {
			 private Org.Neo4j.Kernel.impl.store.kvstore.KeyValueMergerTest.Pair[] _data;

			 public DataProviderAnonymousInnerClass( Org.Neo4j.Kernel.impl.store.kvstore.KeyValueMergerTest.Pair[] data )
			 {
				 this._data = data;
			 }
