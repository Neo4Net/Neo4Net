...
//ORIGINAL LINE: @Test public void shouldReportCorrectValidationErrorsOnRandomlyGeneratedValues()
		 ...
		 {
			  return new IndexSpecificSpaceFillingCurveSettingsCache( new ConfiguredSpaceFillingCurveSettingsCache( Config.defaults() ), new Dictionary<Org.Neo4j.Values.Storable.CoordinateReferenceSystem, SpaceFillingCurveSettings>() );
		 }
