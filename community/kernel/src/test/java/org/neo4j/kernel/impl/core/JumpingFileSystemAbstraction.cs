...
namespace Org.Neo4j.Kernel.impl.core
{
	...
	using RelationshipGroupRecordFormat = Org.Neo4j.Kernel.impl.store.format.standard.RelationshipGroupRecordFormat;
	using RelationshipRecordFormat = Org.Neo4j.Kernel.impl.store.format.standard.RelationshipRecordFormat;
