...
namespace Org.Neo4j.Kernel.Impl.Api.state
{
	...
	using MutableLongDiffSets = Org.Neo4j.Kernel.impl.util.diffsets.MutableLongDiffSets;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass2 : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass3 : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass4 : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass5 : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass6 : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.util.diffsets.MutableLongDiffSets diffSets = state.getOrCreateIndexUpdatesForSeek(new java.util.HashMap<>(), org.neo4j.values.storable.ValueTuple.of(stringValue("test")));
		 ...
		 internal abstract class VisitationOrder : Org.Neo4j.Storageengine.Api.txstate.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
