...
//ORIGINAL LINE: private org.neo4j.kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<System.Collections.Generic.IEnumerable<JavaToDotNetGenericWildcard extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord>> nodes;
			 private Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<IEnumerable<AbstractBaseRecord>> _nodes;
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private org.neo4j.kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<System.Collections.Generic.IEnumerable<JavaToDotNetGenericWildcard extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord>> rels;
			 private Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<IEnumerable<AbstractBaseRecord>> _rels;
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private org.neo4j.kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<System.Collections.Generic.IEnumerable<JavaToDotNetGenericWildcard extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord>> groups;
			 private Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<IEnumerable<AbstractBaseRecord>> _groups;

			 public DiffMatcherAnonymousInnerClass<T1, T2, T3>( AbstractBaseRecord[] expectedChanges, Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<T1> nodes, Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<T2> rels, Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.RecordMatchers.DiffMatcher<T3> groups ) where T1 : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where T2 : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where T3 : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
			 {
...
//ORIGINAL LINE: public static DiffMatcher<Iterable<? extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord>> containsRecords(String recordPlural, java.util.stream.Stream<? extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord> expected)
		 public static DiffMatcher<IEnumerable<AbstractBaseRecord>> ContainsRecords<T1>( string recordPlural, Stream<T1> expected ) where T1 : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
...
//ORIGINAL LINE: return new DiffMatcher<Iterable<? extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord>>()
		 ...
		 private class DiffMatcherAnonymousInnerClass2 : DiffMatcher<IEnumerable<JavaToDotNetGenericWildcard extends AbstractBaseRecord>>
		 {
			 ...
			 internal string diff<T1>( IEnumerable<T1> actual ) where T1 : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
			 {
