...
namespace Org.Neo4j.Kernel.impl.locking
{
	...
	using ParameterizedSuiteRunner = Org.Neo4j.Test.runner.ParameterizedSuiteRunner;
...
//ORIGINAL LINE: protected LockCommand acquireExclusive(final Locks_Client client, final org.neo4j.storageengine.api.lock.LockTracer tracer, final org.neo4j.storageengine.api.lock.ResourceType resourceType, final long key)
			  ...
			  private class LockCommandAnonymousInnerClass : LockCommand
			  {
				  ...
				  private Org.Neo4j.Kernel.impl.locking.Locks_Client _client;
				  private LockTracer _tracer;
				  private ResourceType _resourceType;
				  private long _key;

				  public LockCommandAnonymousInnerClass( Compatibility outerInstance, OtherThreadRule<Void> get, Org.Neo4j.Kernel.impl.locking.Locks_Client client, LockTracer tracer, ResourceType resourceType, long key ) : base( outerInstance, get, client )
				  {
...
//ORIGINAL LINE: protected LockCommand acquireShared(Locks_Client client, final org.neo4j.storageengine.api.lock.LockTracer tracer, final org.neo4j.storageengine.api.lock.ResourceType resourceType, final long key)
			  ...
			  private class LockCommandAnonymousInnerClass2 : LockCommand
			  {
				  ...
				  public LockCommandAnonymousInnerClass2( Compatibility outerInstance, OtherThreadRule<Void> get, Org.Neo4j.Kernel.impl.locking.Locks_Client client, LockTracer tracer, ResourceType resourceType, long key ) : base( outerInstance, get, client )
				  {
					  this.outerInstance = outerInstance;
					  this._client = client;
					  this._tracer = tracer;
