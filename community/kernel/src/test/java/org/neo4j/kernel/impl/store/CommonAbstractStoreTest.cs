...
namespace Org.Neo4j.Kernel.impl.store
{
	...
	using IdCapacityExceededException = Org.Neo4j.Kernel.impl.store.id.validation.IdCapacityExceededException;
	using NegativeIdException = Org.Neo4j.Kernel.impl.store.id.validation.NegativeIdException;
	using ReservedIdException = Org.Neo4j.Kernel.impl.store.id.validation.ReservedIdException;
