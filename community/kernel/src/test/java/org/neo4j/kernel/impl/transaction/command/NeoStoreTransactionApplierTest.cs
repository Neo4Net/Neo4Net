...
namespace Org.Neo4j.Kernel.impl.transaction.command
{
	...
	using ApplyFunction = Org.Neo4j.Kernel.impl.transaction.command.CommandHandlerContract.ApplyFunction;
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
...
//ORIGINAL LINE: final Command.NodeCommand command = new Command.NodeCommand(before, after);
			  ...
			  verify( _lockService, times( 1 ) ).acquireNodeLock( command.Key, Org.Neo4j.Kernel.impl.locking.LockService_LockType.WriteLock );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyNodeCommandToTheStoreInRecoveryMode()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(true);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipRecord before = new org.neo4j.kernel.impl.store.record.RelationshipRecord(12);
			  RelationshipRecord before = new RelationshipRecord( 12 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipRecord record = new org.neo4j.kernel.impl.store.record.RelationshipRecord(12, 3, 4, 5);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.PropertyRecord before = new org.neo4j.kernel.impl.store.record.PropertyRecord(11);
			  PropertyRecord before = new PropertyRecord( 11 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.PropertyRecord after = new org.neo4j.kernel.impl.store.record.PropertyRecord(12);
...
//ORIGINAL LINE: final Command command = new Command.PropertyCommand(before, after);
			  ...
			  verify( _lockService, times( 1 ) ).acquireNodeLock( 42, Org.Neo4j.Kernel.impl.locking.LockService_LockType.WriteLock );
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  ...
			  // when
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipGroupRecord before = new org.neo4j.kernel.impl.store.record.RelationshipGroupRecord(42, 1);
			  RelationshipGroupRecord before = new RelationshipGroupRecord( 42, 1 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipGroupRecord after = new org.neo4j.kernel.impl.store.record.RelationshipGroupRecord(42, 1, 2, 3, 4, 5, 6, true);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipTypeTokenRecord before = new org.neo4j.kernel.impl.store.record.RelationshipTypeTokenRecord(42);
			  RelationshipTypeTokenRecord before = new RelationshipTypeTokenRecord( 42 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.RelationshipTypeTokenRecord after = new org.neo4j.kernel.impl.store.record.RelationshipTypeTokenRecord(42);
			  RelationshipTypeTokenRecord after = new RelationshipTypeTokenRecord( 42 );
			  after.InUse = true;
			  after.NameId = 323;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Command command = new org.neo4j.kernel.impl.transaction.command.Command.RelationshipTypeTokenCommand(before, after);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.internal.kernel.api.NamedToken token = new org.neo4j.internal.kernel.api.NamedToken("token", 21);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.LabelTokenRecord before = new org.neo4j.kernel.impl.store.record.LabelTokenRecord(42);
			  LabelTokenRecord before = new LabelTokenRecord( 42 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.LabelTokenRecord after = new org.neo4j.kernel.impl.store.record.LabelTokenRecord(42);
			  LabelTokenRecord after = new LabelTokenRecord( 42 );
			  after.InUse = true;
			  after.NameId = 323;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Command command = new org.neo4j.kernel.impl.transaction.command.Command.LabelTokenCommand(before, after);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.PropertyKeyTokenRecord before = new org.neo4j.kernel.impl.store.record.PropertyKeyTokenRecord(42);
			  PropertyKeyTokenRecord before = new PropertyKeyTokenRecord( 42 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.PropertyKeyTokenRecord after = new org.neo4j.kernel.impl.store.record.PropertyKeyTokenRecord(42);
			  PropertyKeyTokenRecord after = new PropertyKeyTokenRecord( 42 );
			  after.InUse = true;
			  after.NameId = 323;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Command command = new org.neo4j.kernel.impl.transaction.command.Command.PropertyKeyTokenCommand(before, after);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyCreateIndexRuleSchemaRuleCommandToTheStore()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplierFacade(newApplier(false), newIndexApplier());
			  BatchTransactionApplier applier = NewApplierFacade( NewApplier( false ), NewIndexApplier() );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.DynamicRecord record = org.neo4j.kernel.impl.store.record.DynamicRecord.dynamicRecord(21, true);
			  DynamicRecord record = DynamicRecord.dynamicRecord( 21, true );
			  record.SetCreated();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.Collection<org.neo4j.kernel.impl.store.record.DynamicRecord> recordsAfter = singletonList(record);
			  ICollection<DynamicRecord> recordsAfter = singletonList( record );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.storageengine.api.schema.StoreIndexDescriptor rule = indexRule(0, 1, 2, new org.neo4j.internal.kernel.api.schema.IndexProviderDescriptor("K", "X.Y"));
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyCreateIndexRuleSchemaRuleCommandToTheStoreInRecovery()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplierFacade(newIndexApplier(), newApplier(true));
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyUpdateIndexRuleSchemaRuleCommandToTheStore()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplierFacade(newIndexApplier(), newApplier(false));
...
//ORIGINAL LINE: final java.util.Collection<org.neo4j.kernel.impl.store.record.DynamicRecord> recordsAfter = singletonList(record);
			  ICollection<DynamicRecord> recordsAfter = singletonList( record );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.storageengine.api.schema.StoreIndexDescriptor rule = constraintIndexRule(0, 1, 2, new org.neo4j.internal.kernel.api.schema.IndexProviderDescriptor("K", "X.Y"), 42L);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyUpdateIndexRuleSchemaRuleCommandToTheStoreThrowingIndexProblem()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newIndexApplier();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApplyDeleteIndexRuleSchemaRuleCommandToTheStore()
		 {
			  // given
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier super = newApplier(false);
			  BatchTransactionApplier @base = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier indexApplier = newIndexApplier();
			  BatchTransactionApplier indexApplier = NewIndexApplier();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplierFacade applier = new org.neo4j.kernel.impl.api.BatchTransactionApplierFacade(super, indexApplier);
...
//ORIGINAL LINE: final java.util.Collection<org.neo4j.kernel.impl.store.record.DynamicRecord> recordsAfter = singletonList(record);
			  ICollection<DynamicRecord> recordsAfter = singletonList( record );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.ConstraintRule rule = uniquenessConstraintRule(0L, 1, 2, 3L);
...
//ORIGINAL LINE: final org.neo4j.kernel.impl.api.BatchTransactionApplier applier = newApplier(false);
			  BatchTransactionApplier applier = NewApplier( false );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.NeoStoreRecord before = new org.neo4j.kernel.impl.store.record.NeoStoreRecord();
			  NeoStoreRecord before = new NeoStoreRecord();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.kernel.impl.store.record.NeoStoreRecord after = new org.neo4j.kernel.impl.store.record.NeoStoreRecord();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private boolean apply(org.neo4j.kernel.impl.api.BatchTransactionApplier applier, org.neo4j.kernel.impl.transaction.command.CommandHandlerContract.ApplyFunction function, org.neo4j.kernel.impl.api.TransactionToApply transactionToApply) throws Exception
