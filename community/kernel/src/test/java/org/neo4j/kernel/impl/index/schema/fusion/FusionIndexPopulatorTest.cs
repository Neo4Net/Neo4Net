...
//ORIGINAL LINE: @Before public void setup()
		 ...
		 private void InitiateMocks()
		 {
			  ...
			  fill( _populators, Org.Neo4j.Kernel.Api.Index.IndexPopulator_Fields.Empty );
...
//ORIGINAL LINE: @Test public void shouldIncludeSampleOnCorrectPopulator()
		 ...
		 {
			  return populator != Org.Neo4j.Kernel.Api.Index.IndexPopulator_Fields.Empty ? populator : _populators[LUCENE];
		 }
	}
