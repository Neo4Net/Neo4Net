...
//ORIGINAL LINE: @RunWith(value = Parameterized.class) public abstract class IndexProviderApprovalTest
	public abstract class IndexProviderApprovalTest
	{
		 ...
		 public sealed class TestValue
		 {
			  ...
			  public static readonly TestValue CharUpperA = new TestValue( "CharUpperA", InnerEnum.CharUpperA, 'A' );
			  public static readonly TestValue CharLowerA = new TestValue( "CharLowerA", InnerEnum.CharLowerA, 'a' );
			  public static readonly TestValue Int_42 = new TestValue( "Int_42", InnerEnum.Int_42, 42 );
			  public static readonly TestValue Long_42 = new TestValue( "Long_42", InnerEnum.Long_42, ( long ) 42 );
			  ...
			  public static readonly TestValue Byte_42 = new TestValue( "Byte_42", InnerEnum.Byte_42, ( sbyte ) 42 );
			  public static readonly TestValue Double_42 = new TestValue( "Double_42", InnerEnum.Double_42, ( double ) 42 );
			  public static readonly TestValue DOUBLE_42andAHalf = new TestValue( "DOUBLE_42andAHalf", InnerEnum.DOUBLE_42andAHalf, 42.5d );
			  public static readonly TestValue Short_42 = new TestValue( "Short_42", InnerEnum.Short_42, ( short ) 42 );
			  public static readonly TestValue Float_42 = new TestValue( "Float_42", InnerEnum.Float_42, ( float ) 42 );
			  public static readonly TestValue FLOAT_42andAHalf = new TestValue( "FLOAT_42andAHalf", InnerEnum.FLOAT_42andAHalf, 42.5f );
			  public static readonly TestValue Point_123456Gps = new TestValue( "Point_123456Gps", InnerEnum.Point_123456Gps, Org.Neo4j.Values.Storable.Values.PointValue( Org.Neo4j.Values.Storable.CoordinateReferenceSystem.Wgs84, 12.3, 45.6 ) );
			  public static readonly TestValue Point_123456Car = new TestValue( "Point_123456Car", InnerEnum.Point_123456Car, Org.Neo4j.Values.Storable.Values.PointValue( Org.Neo4j.Values.Storable.CoordinateReferenceSystem.Cartesian, 123, 456 ) );
			  public static readonly TestValue Point_123456Gps_3d = new TestValue( "Point_123456Gps_3d", InnerEnum.Point_123456Gps_3d, Org.Neo4j.Values.Storable.Values.PointValue( Org.Neo4j.Values.Storable.CoordinateReferenceSystem.Wgs84_3d, 12.3, 45.6, 78.9 ) );
			  public static readonly TestValue Point_123456Car_3d = new TestValue( "Point_123456Car_3d", InnerEnum.Point_123456Car_3d, Org.Neo4j.Values.Storable.Values.PointValue( Org.Neo4j.Values.Storable.CoordinateReferenceSystem.Cartesian_3D, 123, 456, 789 ) );
...
//           ARRAY_OF_STRING(new String[]{"1", "2", "3"}),
			  public static readonly TestValue EmptyArrayOfInts = new TestValue( "EmptyArrayOfInts", InnerEnum.EmptyArrayOfInts, new int[0] );
			  public static readonly TestValue EmptyArrayOfLongs = new TestValue( "EmptyArrayOfLongs", InnerEnum.EmptyArrayOfLongs, new long[0] );
			  public static readonly TestValue EmptyArrayOfBools = new TestValue( "EmptyArrayOfBools", InnerEnum.EmptyArrayOfBools, new bool[0] );
			  public static readonly TestValue EmptyArrayOfDoubles = new TestValue( "EmptyArrayOfDoubles", InnerEnum.EmptyArrayOfDoubles, new double[0] );
...
//           ARRAY_OF_POINTS_CAR_3D(new org.neo4j.values.storable.PointValue[]{org.neo4j.values.storable.Values.pointValue(org.neo4j.values.storable.CoordinateReferenceSystem.Cartesian_3D, 123, 456, 789)});
			  ...
			  static TestValue()
			  {
				  ...
				  valueList.Add( EmptyArrayOfInts );
				  valueList.Add( EmptyArrayOfLongs );
				  valueList.Add( EmptyArrayOfBools );
				  valueList.Add( EmptyArrayOfDoubles );
		 ...
		 private static IDictionary<TestValue, ISet<object>> _indexRun;
...
//ORIGINAL LINE: @BeforeClass public static void init()
		 public static void Init()
		 {
			  ...
			  _indexRun = RunFindByLabelAndProperty( db );
			  Db.shutdown();
		 }
...
//ORIGINAL LINE: @Test public void test()
		 public virtual void Test()
		 {
			  ...
			  ISet<object> indexResult = Iterables.asSet( _indexRun[_currentValue] );
