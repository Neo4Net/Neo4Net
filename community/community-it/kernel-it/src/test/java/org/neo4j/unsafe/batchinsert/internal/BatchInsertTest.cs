...
namespace Org.Neo4j.@unsafe.Batchinsert.@internal
{
	...
	using TestIndexProviderDescriptor = Org.Neo4j.Kernel.Impl.Api.index.TestIndexProviderDescriptor;
...
//ORIGINAL LINE: private org.neo4j.unsafe.batchinsert.BatchInserter newBatchInserterWithIndexProvider(org.neo4j.kernel.extension.KernelExtensionFactory<?> provider, org.neo4j.internal.kernel.api.schema.IndexProviderDescriptor providerDescriptor) throws Exception
		 ...
		 private LabelScanStore LabelScanStore
		 {
			 get
			 {
				  ...
				  return new NativeLabelScanStore( PageCacheRule.getPageCache( fs ), LocalTestDirectory.databaseLayout(), fs, Org.Neo4j.Kernel.Impl.Api.scan.FullStoreChangeStream_Fields.Empty, true, new Monitors(), RecoveryCleanupWorkCollector.immediate() );
			 }
		 }
