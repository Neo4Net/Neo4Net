...
namespace Org.Neo4j.Kernel.impl.store
{
	...
	using Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.TransactionRecordState;
...
//ORIGINAL LINE: @Before public void setUpNeoStores()
		 public virtual void SetUpNeoStores()
		 {
			  ...
			  _propertyKeyTokenHolder = new DelegatingTokenHolder( this.createPropertyKeyToken, Org.Neo4j.Kernel.impl.core.TokenHolder_Fields.TYPE_PROPERTY_KEY );
		 }
...
//ORIGINAL LINE: @Test public void testSetLatestConstraintTx()
		 public virtual void TestSetLatestConstraintTx()
		 {
			  ...
			  // when
			  neoStores.Flush( Org.Neo4j.Io.pagecache.IOLimiter_Fields.Unlimited );
			  neoStores.Close();
...
//ORIGINAL LINE: @Test public void shouldInitializeTheTxIdToOne()
		 public virtual void ShouldInitializeTheTxIdToOne()
		 {
			  ...
			  using ( NeoStores neoStores = factory.OpenAllNeoStores() )
			  {
					...
					assertEquals( Org.Neo4j.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_ID, lastCommittedTransactionId );
			  }
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void initializeStores(org.neo4j.io.layout.DatabaseLayout databaseLayout, java.util.Map<String,String> additionalConfig) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void startTx() throws org.neo4j.internal.kernel.api.exceptions.TransactionFailureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void commitTx() throws org.neo4j.internal.kernel.api.exceptions.TransactionFailureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void validateNodeRel1(long node, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long rel1, long rel2, int relType1, int relType2) throws java.io.IOException, org.neo4j.kernel.impl.core.TokenNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void validateNodeRel2(long node, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long rel1, long rel2, int relType1, int relType2) throws java.io.IOException, RuntimeException, org.neo4j.kernel.impl.core.TokenNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void validateRel1(long rel, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long firstNode, long secondNode, int relType) throws java.io.IOException, org.neo4j.kernel.impl.core.TokenNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void validateRel2(long rel, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long firstNode, long secondNode, int relType) throws java.io.IOException, org.neo4j.kernel.impl.core.TokenNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void deleteRel1(long rel, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long firstNode, long secondNode, int relType) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void deleteRel2(long rel, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3, long firstNode, long secondNode, int relType) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void deleteNode1(long node, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3) throws java.io.IOException, org.neo4j.kernel.impl.core.TokenNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void deleteNode2(long node, org.neo4j.storageengine.api.StorageProperty prop1, org.neo4j.storageengine.api.StorageProperty prop2, org.neo4j.storageengine.api.StorageProperty prop3) throws java.io.IOException, org.neo4j.kernel.impl.core.TokenNotFoundException
		 ...
		 private void NodeLoadProperties<RECEIVER>( long nodeId, RECEIVER receiver ) where RECEIVER : Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.TransactionRecordState.PropertyReceiver
		 {
			  NodeRecord nodeRecord = _nodeStore.getRecord( nodeId, _nodeStore.newRecord(), NORMAL );
			  LoadProperties( nodeRecord.NextProp, receiver );
		 }

		 private void RelLoadProperties<RECEIVER>( long relId, RECEIVER receiver ) where RECEIVER : Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.TransactionRecordState.PropertyReceiver
		 {
		 ...
		 private void LoadProperties<RECEIVER>( long nextProp, RECEIVER receiver ) where RECEIVER : Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.TransactionRecordState.PropertyReceiver
		 {
			  ICollection<PropertyRecord> chain = _pStore.getPropertyRecordChain( nextProp );
			  ReceivePropertyChain( receiver, chain );
		 }

		 private void ReceivePropertyChain<RECEIVER>( RECEIVER receiver, ICollection<PropertyRecord> chain ) where RECEIVER : Org.Neo4j.Kernel.impl.storageengine.impl.recordstorage.TransactionRecordState.PropertyReceiver
		 {
			  if ( chain != null )
			  {
