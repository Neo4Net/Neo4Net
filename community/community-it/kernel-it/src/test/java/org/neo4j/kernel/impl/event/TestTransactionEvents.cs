...
namespace Org.Neo4j.Kernel.Impl.@event
{
	...
	using LabelEntry = Org.Neo4j.Graphdb.@event.LabelEntry;
...
//ORIGINAL LINE: final org.neo4j.graphdb.Node node;
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<Void>
		 {
...
//ORIGINAL LINE: @Test public void nodeCanBecomeSchemaIndexableInBeforeCommitByAddingProperty()
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass2 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<object>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: final org.neo4j.graphdb.Label label = label("Label");
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass3 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<object>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: final java.util.Map<long,RelationshipData> expectedRelationshipData = new java.util.HashMap<>();
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass4 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<Void>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: final java.util.Set<String> changedRelationships = new java.util.HashSet<>();
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass5 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<Void>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: final java.util.concurrent.atomic.AtomicInteger counter = new java.util.concurrent.atomic.AtomicInteger();
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass6 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<Void>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: final org.neo4j.graphdb.Node node = createNode("one", "Two", "three", "Four");
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass7 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<object>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: @Test public void shouldAllowToStringOnCreatedRelationshipInAfterCommit()
		 ...
		 private class TransactionEventHandler_AdapterAnonymousInnerClass8 : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<object>
		 {
			 private readonly TestTransactionEvents _outerInstance;
...
//ORIGINAL LINE: @Test public void shouldGetCallToAfterRollbackEvenIfBeforeCommitFailed()
		 ...
		 private sealed class ChangedLabels : Org.Neo4j.Graphdb.@event.TransactionEventHandler_Adapter<Void>
		 {
