...
//ORIGINAL LINE: @Test public void defaultExceptionsForExit()
		 public virtual void DefaultExceptionsForExit()
		 {
			  ...
			  TransactionTerminatedException terminatedException = new TransactionTerminatedException( Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.Terminated );
...
//ORIGINAL LINE: @Test public void overrideRetryShouldOverrideDefaults()
		 public virtual void OverrideRetryShouldOverrideDefaults()
		 {
			  ...
			  TransactionTerminatedException fakeException = new TransactionTerminatedException( Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.Terminated );
