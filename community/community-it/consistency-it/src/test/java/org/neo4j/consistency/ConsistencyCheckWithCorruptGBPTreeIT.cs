...
namespace Org.Neo4j.Consistency
{
	...
	using GBPTreeBootstrapper = Org.Neo4j.Index.@internal.gbptree.GBPTreeBootstrapper;
	using GBPTreeCorruption = Org.Neo4j.Index.@internal.gbptree.GBPTreeCorruption;
	using Org.Neo4j.Index.@internal.gbptree;
	using GBPTreePointerType = Org.Neo4j.Index.@internal.gbptree.GBPTreePointerType;
	using Org.Neo4j.Index.@internal.gbptree;
	...
	using SchemaLayouts = Org.Neo4j.Kernel.Impl.Index.Schema.SchemaLayouts;
