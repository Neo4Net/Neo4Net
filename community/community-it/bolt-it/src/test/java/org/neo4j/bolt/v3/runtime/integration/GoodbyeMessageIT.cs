...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldCloseConnectionInFailed()
		 {
			  ...
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Statement.SyntaxError, string.Format( "Invalid input 'I': expected <init> (line 1, column 1 (offset: 0))%n" + "\"I am sending you to failed state!\"%n" + " ^" ) ) ) );
