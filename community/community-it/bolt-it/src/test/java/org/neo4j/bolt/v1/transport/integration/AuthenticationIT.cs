...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailIfWrongCredentials()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceivesSelectedProtocolVersion() );
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Unauthorized, "The client is unauthorized due to authentication failure." ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailIfMalformedAuthTokenWrongType()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceivesSelectedProtocolVersion() );
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Unauthorized, "Unsupported authentication token, the value associated with the key `principal` " + "must be a String but was: ArrayList" ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailIfMalformedAuthTokenMissingKey()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceivesSelectedProtocolVersion() );
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Unauthorized, "Unsupported authentication token, missing key `credentials`" ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailIfMalformedAuthTokenMissingScheme()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceivesSelectedProtocolVersion() );
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Unauthorized, "Unsupported authentication token, missing key `scheme`" ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailIfMalformedAuthTokenUnknownScheme()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceivesSelectedProtocolVersion() );
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.Unauthorized, "Unsupported authentication token, scheme 'unknown' is not supported." ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailWhenReusingTheSamePassword()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_General.InvalidArguments, "Old password and new password cannot be the same." ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailWhenSubmittingEmptyPassword()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_General.InvalidArguments, "A password cannot be empty." ) ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldNotBeAbleToReadWhenPasswordChangeRequired()
		 {
			  ...
			  // Then
			  assertThat( Connection, Util.eventuallyReceives( msgFailure( Org.Neo4j.Kernel.Api.Exceptions.Status_Security.CredentialsExpired, "The credentials you provided were valid, but must be changed before you can use this instance." ) ) );
