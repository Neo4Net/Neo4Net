...
//ORIGINAL LINE: private static CannedLocator cannedCommand(final String name, AdminCommand command)
		 ...
		 {
			 private Org.Neo4j.Commandline.admin.AdminCommand _command;

			 public AdminCommand_ProviderAnonymousInnerClass( string name, Org.Neo4j.Commandline.admin.AdminCommand command ) : base( name )
			 {
