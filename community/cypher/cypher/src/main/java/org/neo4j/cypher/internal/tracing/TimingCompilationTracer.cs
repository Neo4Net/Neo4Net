...
namespace Org.Neo4j.Cypher.@internal.tracing
{
	...
	public class TimingCompilationTracer : CompilationTracer
	{
		 ...
		 {
			  Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhase Phase();
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
			  ...
			  public override Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhaseEvent BeginPhase( Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhase phase )
			  {
...
//JAVA TO C# CONVERTER NOTE: Members cannot have the same name as their enclosing type:
		 ...
		 private class Phase : Event, PhaseEvent, Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhaseEvent
		 {
			  internal readonly Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhase CompilationPhase;

			  internal Phase( Clock clock, Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhase phase ) : base( clock )
			  {
...
//JAVA TO C# CONVERTER NOTE: Members cannot have the same name as their enclosing type:
			  public override Org.Neo4j.Cypher.@internal.v3_5.frontend.phases.CompilationPhaseTracer_CompilationPhase PhaseConflict()
			  {
