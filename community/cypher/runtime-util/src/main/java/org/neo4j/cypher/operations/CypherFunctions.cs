...
namespace Org.Neo4j.Cypher.operations
{
	...
	using InvalidArgumentException = Org.Neo4j.Cypher.@internal.v3_5.util.InvalidArgumentException;
	using ParameterWrongTypeException = Org.Neo4j.Cypher.@internal.v3_5.util.ParameterWrongTypeException;
