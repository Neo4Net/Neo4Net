...
namespace Org.Neo4j.Index.@internal.gbptree
{
	...
	using Factory = Org.Neo4j.Index.@internal.gbptree.TreeNodeSelector.Factory;
...
//ORIGINAL LINE: static Meta read(org.neo4j.io.pagecache.PageCursor cursor, Layout<?,?> layout) throws java.io.IOException
