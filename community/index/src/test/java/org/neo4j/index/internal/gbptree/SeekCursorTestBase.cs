...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class DelegatingPageCursorAnonymousInnerClass : DelegatingPageCursor
		 {
			 ...
			 public DelegatingPageCursorAnonymousInnerClass( SeekCursorTestBase<KEY, VALUE> outerInstance, Org.Neo4j.Index.@internal.gbptree.PageAwareByteArrayCursor cursor, AtomicBoolean nextCalled ) : base( cursor )
			 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void insert(long key, long value, org.neo4j.io.pagecache.PageCursor cursor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private SeekCursor<KEY,VALUE> seekCursor(long fromInclusive, long toExclusive, org.neo4j.io.pagecache.PageCursor pageCursor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private SeekCursor<KEY,VALUE> seekCursor(long fromInclusive, long toExclusive, org.neo4j.io.pagecache.PageCursor pageCursor, long stableGeneration, long unstableGeneration) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private SeekCursor<KEY,VALUE> seekCursor(long fromInclusive, long toExclusive, org.neo4j.io.pagecache.PageCursor pageCursor, long stableGeneration, long unstableGeneration, RootCatchup rootCatchup) throws java.io.IOException
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private long createRightSibling(org.neo4j.io.pagecache.PageCursor pageCursor) throws java.io.IOException
