...
//ORIGINAL LINE: private org.neo4j.io.pagecache.PageCache pageCacheWithBarrierInClose(final java.util.concurrent.atomic.AtomicBoolean enabled, final org.neo4j.test.Barrier_Control barrier)
		 private PageCache PageCacheWithBarrierInClose( AtomicBoolean enabled, Org.Neo4j.Test.Barrier_Control barrier )
		 {
		 ...
		 private class DelegatingPageCacheAnonymousInnerClass : DelegatingPageCache
		 {
			 ...
			 public DelegatingPageCacheAnonymousInnerClass( GBPTreeTest outerInstance, PageCache createPageCache, AtomicBoolean enabled, Org.Neo4j.Test.Barrier_Control barrier ) : base( createPageCache )
			 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void CleanerShouldDieSilentlyOnClose()
		 {
			  ...
			  Org.Neo4j.Test.Barrier_Control control = new Org.Neo4j.Test.Barrier_Control();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  MustRecognizeFailedCleaning( index => index.checkpoint( Org.Neo4j.Io.pagecache.IOLimiter_Fields.Unlimited ) );
		 }
...
//ORIGINAL LINE: private void shouldWait(java.util.concurrent.Future<?> future) throws InterruptedException, java.util.concurrent.ExecutionException
		 ...
		 private class CleanJobControlledMonitor : Org.Neo4j.Index.@internal.gbptree.GBPTree.Monitor_Adaptor
		 {
		 ...
		 private class CheckpointControlledMonitor : Org.Neo4j.Index.@internal.gbptree.GBPTree.Monitor_Adaptor
		 {
			  internal readonly Org.Neo4j.Test.Barrier_Control Barrier = new Org.Neo4j.Test.Barrier_Control();
		 ...
		 private class CheckpointCounter : Org.Neo4j.Index.@internal.gbptree.GBPTree.Monitor_Adaptor
		 {
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 private class MonitorDirty : Org.Neo4j.Index.@internal.gbptree.GBPTree.Monitor_Adaptor
		 {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 private class MonitorCleanup : Org.Neo4j.Index.@internal.gbptree.GBPTree.Monitor_Adaptor
		 {
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
