...
//           OLDEST { TreeState select(org.apache.commons.lang3.tuple.Pair<TreeState, TreeState> states) { return TreeStatePair.selectOldestOrInvalid(states); } };
		 ...
		 {
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           EMPTY { void write(org.neo4j.io.pagecache.PageCursor cursor) { } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           BROKEN { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 1, 2, 3, 4, 5, 6, 7, 8, 9, true); cursor.rewind(); long someOfTheBits = cursor.getLong(cursor.getOffset()); cursor.putLong(cursor.getOffset(), ~someOfTheBits); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           VALID { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 5, 6, 7, 8, 9, 10, 11, 12, 13, true); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           CRASH_VALID { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 5, 7, 7, 8, 9, 10, 11, 12, 13, true); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           WIDE_VALID { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 4, 8, 9, 10, 11, 12, 13, 14, 15, true); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           OLD_VALID { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 2, 3, 4, 5, 6, 7, 8, 9, 10, true); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           VALID_DIRTY { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 5, 6, 7, 8, 9, 10, 11, 12, 13, false); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           CRASH_VALID_DIRTY { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 5, 7, 7, 8, 9, 10, 11, 12, 13, false); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           WIDE_VALID_DIRTY { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 4, 8, 9, 10, 11, 12, 13, 14, 15, false); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           OLD_VALID_DIRTY { void write(org.neo4j.io.pagecache.PageCursor cursor) { TreeState.write(cursor, 2, 3, 4, 5, 6, 7, 8, 9, 10, false); } };
			  ...
			  internal abstract void write( Org.Neo4j.Io.pagecache.PageCursor cursor );
