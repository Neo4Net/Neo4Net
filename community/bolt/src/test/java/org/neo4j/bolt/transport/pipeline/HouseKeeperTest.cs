...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			 private Org.Neo4j.Bolt.transport.pipeline.HouseKeeper _houseKeeper;

			 public ChannelInitializerAnonymousInnerClass( Org.Neo4j.Bolt.transport.pipeline.HouseKeeper houseKeeper )
			 {
