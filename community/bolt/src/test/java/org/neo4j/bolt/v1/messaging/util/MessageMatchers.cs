 ...
 */
namespace Org.Neo4j.Bolt.v1.messaging.util
{
	...
	using BufferedChannelInput = Org.Neo4j.Bolt.v1.packstream.BufferedChannelInput;
	using BufferedChannelOutput = Org.Neo4j.Bolt.v1.packstream.BufferedChannelOutput;
	using TestNotification = Org.Neo4j.Bolt.v1.transport.integration.TestNotification;
...
//ORIGINAL LINE: public static org.hamcrest.Matcher<org.neo4j.bolt.messaging.ResponseMessage> msgRecord(final org.hamcrest.Matcher<org.neo4j.cypher.result.QueryResult_Record> matcher)
		 public static Matcher<ResponseMessage> MsgRecord( Matcher<Org.Neo4j.Cypher.result.QueryResult_Record> matcher )
		 {
		 ...
		 {
			 private Matcher<Org.Neo4j.Cypher.result.QueryResult_Record> _matcher;

			 public TypeSafeMatcherAnonymousInnerClass8( Matcher<Org.Neo4j.Cypher.result.QueryResult_Record> matcher )
			 {
				 this._matcher = matcher;
			 }
