...
namespace Org.Neo4j.Bolt.v1.messaging
{
	...
	{
		 protected internal readonly Org.Neo4j.Bolt.messaging.Neo4jPack_Packer Packer;

		 public BoltRequestMessageWriter( Org.Neo4j.Bolt.messaging.Neo4jPack_Packer packer )
		 {
			  this.Packer = packer;
		 }
