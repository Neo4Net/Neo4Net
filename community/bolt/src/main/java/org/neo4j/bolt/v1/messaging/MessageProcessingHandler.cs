...
//	import static org.neo4j.bolt.v1.messaging.response.IgnoredMessage.IGNORED_MESSAGE;
	...
	public class MessageProcessingHandler : BoltResponseHandler
	{
		 ...
		 private static readonly ISet<Status> _clientMidOpDisconnectErrors = new HashSet<Status>( Arrays.asList( Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.Terminated, Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.LockClientStopped ) );
