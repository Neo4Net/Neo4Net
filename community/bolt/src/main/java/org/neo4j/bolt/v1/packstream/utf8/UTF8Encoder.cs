 ...
 */
namespace Org.Neo4j.Bolt.v1.packstream.utf8
{
	...
	{
		 /// <returns> a ByteBuffer with the encoded string. This will be overwritten
		 ///         the next time you call this method, so use it or loose it! </returns>
