...
namespace Org.Neo4j.Bolt.v1.runtime
{
	...
	using BoltProtocolBreachFatality = Org.Neo4j.Bolt.runtime.BoltProtocolBreachFatality;
	...
	using BoltStateMachineV1Context = Org.Neo4j.Bolt.v1.messaging.BoltStateMachineV1Context;
