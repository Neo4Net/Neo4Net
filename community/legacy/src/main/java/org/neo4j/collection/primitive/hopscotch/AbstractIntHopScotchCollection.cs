...
{
	using PrimitiveIntBaseIterator = Org.Neo4j.Collection.primitive.PrimitiveIntCollections.PrimitiveIntBaseIterator;
...
//ORIGINAL LINE: final TableKeyIterator<VALUE> longIterator = new TableKeyIterator<>(table, this);
		 ...
		 private class PrimitiveIntBaseIteratorAnonymousInnerClass : PrimitiveIntBaseIterator
		 {
			 ...
			 private Org.Neo4j.Collection.primitive.hopscotch.TableKeyIterator<VALUE> _longIterator;

			 public PrimitiveIntBaseIteratorAnonymousInnerClass( AbstractIntHopScotchCollection<VALUE> outerInstance, Org.Neo4j.Collection.primitive.hopscotch.TableKeyIterator<VALUE> longIterator )
			 {
