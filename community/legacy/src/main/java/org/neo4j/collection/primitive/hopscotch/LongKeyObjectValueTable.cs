...
//	import static Arrays.fill;
	...
	public class LongKeyObjectValueTable<VALUE> : LongKeyTable<VALUE>
	{
		 private VALUE[] _values;

		 public LongKeyObjectValueTable( int capacity ) : base( capacity, null )
		 {
		 }
		 ...
		 protected internal override LongKeyObjectValueTable<VALUE> NewInstance( int newCapacity )
		 {
