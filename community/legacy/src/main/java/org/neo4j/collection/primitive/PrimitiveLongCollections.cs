...
//ORIGINAL LINE: public static PrimitiveLongIterator filter(PrimitiveLongIterator source, final System.Func<long, boolean> filter)
		 ...
		 private class PrimitiveLongFilteringIteratorAnonymousInnerClass : PrimitiveLongFilteringIterator
		 {
			 ...
			 public PrimitiveLongFilteringIteratorAnonymousInnerClass( Org.Neo4j.Collection.primitive.PrimitiveLongIterator source, System.Func<long, bool> filter ) : base( source )
			 {
				 this._filter = filter;
			 }
...
//ORIGINAL LINE: public static PrimitiveLongResourceIterator filter(PrimitiveLongResourceIterator source, final System.Func<long, boolean> filter)
		 ...
		 private class PrimitiveLongResourceFilteringIteratorAnonymousInnerClass : PrimitiveLongResourceFilteringIterator
		 {
			 ...
			 public PrimitiveLongResourceFilteringIteratorAnonymousInnerClass( Org.Neo4j.Collection.PrimitiveLongResourceIterator source, System.Func<long, bool> filter ) : base( source )
			 {
				 this._filter = filter;
			 }
...
//ORIGINAL LINE: public static <T> java.util.Iterator<T> map(final System.Func<long, T> mapFunction, final PrimitiveLongIterator source)
		 ...
		 private class IteratorAnonymousInnerClass : IEnumerator<T>
		 {
			 ...
			 private Org.Neo4j.Collection.primitive.PrimitiveLongIterator _source;

			 public IteratorAnonymousInnerClass( System.Func<long, T> mapFunction, Org.Neo4j.Collection.primitive.PrimitiveLongIterator source )
			 {
...
//ORIGINAL LINE: public static java.util.Iterator<long> toIterator(final PrimitiveLongIterator primIterator)
		 ...
		 {
			 private Org.Neo4j.Collection.primitive.PrimitiveLongIterator _primIterator;

			 public IteratorAnonymousInnerClass2( Org.Neo4j.Collection.primitive.PrimitiveLongIterator primIterator )
			 {
...
//ORIGINAL LINE: public static PrimitiveLongResourceIterator resourceIterator(final PrimitiveLongIterator iterator, final org.neo4j.graphdb.Resource resource)
		 ...
		 {
			 private Org.Neo4j.Collection.primitive.PrimitiveLongIterator _iterator;
			 private Resource _resource;

			 public PrimitiveLongResourceIteratorAnonymousInnerClass( Org.Neo4j.Collection.primitive.PrimitiveLongIterator iterator, Resource resource )
			 {
				 this._iterator = iterator;
