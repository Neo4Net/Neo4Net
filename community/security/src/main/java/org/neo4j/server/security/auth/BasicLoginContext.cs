	...
	public class BasicLoginContext : LoginContext
	{
		 ...
		 public BasicLoginContext( User user, AuthenticationResult authenticationResult )
		 {
			  ...
			  case AuthenticationResult.SUCCESS:
					_accessMode = Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Full;
					break;
			  case AuthenticationResult.PASSWORD_CHANGE_REQUIRED:
					_accessMode = Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.CredentialsExpired;
					break;
			  default:
					_accessMode = Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.None;
				break;
			  }
		 }
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
			  ...
			  public override void SetPasswordChangeNoLongerRequired()
			  {
					if ( AuthenticationResultConflict == PASSWORD_CHANGE_REQUIRED )
					{
						 ...
						 outerInstance.accessMode = Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Full;
					}
			  }
