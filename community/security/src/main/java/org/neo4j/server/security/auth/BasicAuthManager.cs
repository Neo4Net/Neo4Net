...
//ORIGINAL LINE: public void start() throws Throwable
		 public override void Start()
		 {
			  ...
			  if ( UserRepository.numberOfUsers() == 0 )
			  {
					...
					{
						 User user = _initialUserRepository.getUserByName( Org.Neo4j.Kernel.api.security.UserManager_Fields.INITIAL_USER_NAME );
						 if ( user != null )
						 {
...
//ORIGINAL LINE: private void assertValidScheme(java.util.Map<String,Object> token) throws org.neo4j.kernel.api.security.exception.InvalidAuthTokenException
		 ...
		 {
			  string scheme = AuthToken.safeCast( Org.Neo4j.Kernel.api.security.AuthToken_Fields.SCHEME_KEY, token );
