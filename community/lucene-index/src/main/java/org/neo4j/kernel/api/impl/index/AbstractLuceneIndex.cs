...
namespace Org.Neo4j.Kernel.Api.Impl.Index
{
	...
	using WritableIndexSnapshotFileIterator = Org.Neo4j.Kernel.Api.Impl.Index.backup.WritableIndexSnapshotFileIterator;
	...
	using PartitionedIndexWriter = Org.Neo4j.Kernel.Api.Impl.Schema.writer.PartitionedIndexWriter;
	...
	public abstract class AbstractLuceneIndex<READER> where READER : Org.Neo4j.Storageengine.Api.schema.IndexReader
	{
