...
namespace Org.Neo4j.Kernel.Api.Impl.Index
{
	...
	public abstract class ReadOnlyAbstractDatabaseIndex<INDEX, READER> : AbstractDatabaseIndex<INDEX, READER> where INDEX : AbstractLuceneIndex<READER> where READER : Org.Neo4j.Storageengine.Api.schema.IndexReader
	{
