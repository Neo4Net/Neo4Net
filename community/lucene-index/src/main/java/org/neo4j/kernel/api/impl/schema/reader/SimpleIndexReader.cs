...
namespace Org.Neo4j.Kernel.Api.Impl.Schema.reader
{
	...
	using IndexQueryType = Org.Neo4j.@internal.Kernel.Api.IndexQuery.IndexQueryType;
	...
	using NonUniqueLuceneIndexSampler = Org.Neo4j.Kernel.Api.Impl.Schema.sampler.NonUniqueLuceneIndexSampler;
	using UniqueLuceneIndexSampler = Org.Neo4j.Kernel.Api.Impl.Schema.sampler.UniqueLuceneIndexSampler;
