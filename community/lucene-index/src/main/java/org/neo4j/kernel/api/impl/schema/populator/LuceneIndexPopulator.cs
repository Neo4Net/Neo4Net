...
namespace Org.Neo4j.Kernel.Api.Impl.Schema.populator
{
	...
	public abstract class LuceneIndexPopulator<INDEX> : IndexPopulator
	{
		...
		public abstract Org.Neo4j.Storageengine.Api.schema.IndexSample SampleResult();
		...
		public abstract void VerifyDeferredConstraints( Org.Neo4j.Storageengine.Api.NodePropertyAccessor nodePropertyAccessor );
		 ...
		 private bool UpdatesForCorrectIndex<T1>( ICollection<T1> updates ) where T1 : Org.Neo4j.Kernel.Api.Index.IndexEntryUpdate<T1>
		 {
