...
namespace Org.Neo4j.Kernel.Api.Impl.Index
{
	...
	/// </summary>
	internal abstract class AbstractDatabaseIndex<INDEX, READER> : DatabaseIndex<READER> where INDEX : AbstractLuceneIndex<READER> where READER : Org.Neo4j.Storageengine.Api.schema.IndexReader
	{
		public abstract void MarkAsOnline();
		public abstract Org.Neo4j.Kernel.Api.Impl.Schema.writer.LuceneIndexWriter IndexWriter { get; }
		public abstract void MaybeRefreshBlocking();
		public abstract Org.Neo4j.Graphdb.ResourceIterator<java.io.File> Snapshot();
