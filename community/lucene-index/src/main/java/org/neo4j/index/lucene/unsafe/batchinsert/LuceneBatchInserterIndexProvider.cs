 ...
 */
namespace Org.Neo4j.Index.lucene.@unsafe.batchinsert
{

	using Org.Neo4j.Graphdb.index;
	using LuceneBatchInserterIndexProviderNewImpl = Org.Neo4j.Index.impl.lucene.@explicit.LuceneBatchInserterIndexProviderNewImpl;
