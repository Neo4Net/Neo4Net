...
namespace Org.Neo4j.Kernel.Api.Impl.Schema.sampler
{
	...
	using IndexReaderStub = Org.Neo4j.Kernel.Api.Impl.Index.IndexReaderStub;
	...
	using WritableIndexPartition = Org.Neo4j.Kernel.Api.Impl.Index.partition.WritableIndexPartition;
