...
namespace Org.Neo4j.Kernel.Api.Impl.Schema.verification
{
	...
	using BucketsDuplicateCheckStrategy = Org.Neo4j.Kernel.Api.Impl.Schema.verification.DuplicateCheckStrategy.BucketsDuplicateCheckStrategy;
	using MapDuplicateCheckStrategy = Org.Neo4j.Kernel.Api.Impl.Schema.verification.DuplicateCheckStrategy.MapDuplicateCheckStrategy;
