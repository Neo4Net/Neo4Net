...
namespace Org.Neo4j.Logging.async
{
	...
	using AsyncEvent = Org.Neo4j.Util.concurrent.AsyncEvent;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: static AsyncLogEvent bulkLogEvent(@Nonnull Log log, @Nonnull final java.util.function.Consumer<org.neo4j.logging.Log> consumer)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: static AsyncLogEvent bulkLogEvent(@Nonnull Logger logger, @Nonnull final java.util.function.Consumer<org.neo4j.logging.Logger> consumer)
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
