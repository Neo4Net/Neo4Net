...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class AddWorkAnonymousInnerClass : AddWork
		 {
			 ...
			 private Org.Neo4j.Util.concurrent.BinaryLatch _startLatch;
			 private Org.Neo4j.Util.concurrent.BinaryLatch _blockLatch;

			 public AddWorkAnonymousInnerClass( WorkSyncTest outerInstance, Org.Neo4j.Util.concurrent.BinaryLatch startLatch, Org.Neo4j.Util.concurrent.BinaryLatch blockLatch ) : base( 1 )
			 {
