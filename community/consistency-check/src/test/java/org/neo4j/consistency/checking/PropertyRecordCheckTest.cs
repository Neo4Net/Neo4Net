...
namespace Org.Neo4j.Consistency.checking
{
	...
	using GeometryType = Org.Neo4j.Kernel.impl.store.GeometryType;
	using PropertyType = Org.Neo4j.Kernel.impl.store.PropertyType;
	using TemporalType = Org.Neo4j.Kernel.impl.store.TemporalType;
...
//	import static org.mockito.Mockito.verifyNoMoreInteractions;
	...
	internal class PropertyRecordCheckTest : RecordCheckTestBase<PropertyRecord, Org.Neo4j.Consistency.report.ConsistencyReport_PropertyConsistencyReport, PropertyRecordCheck>
	{
