...
namespace Org.Neo4j.Consistency.checking
{
	...
	using LabelsField = Org.Neo4j.Consistency.checking.NodeRecordCheck.LabelsField;
	using RelationshipField = Org.Neo4j.Consistency.checking.NodeRecordCheck.RelationshipField;
...
//	import static org.mockito.Mockito.verifyNoMoreInteractions;
	...
	internal class NodeRecordCheckTest : RecordCheckTestBase<NodeRecord, Org.Neo4j.Consistency.report.ConsistencyReport_NodeConsistencyReport, NodeRecordCheck>
	{
...
//ORIGINAL LINE: @Test void shouldNotReportAnythingForNodeNotInUse()
		 internal virtual void ShouldNotReportAnythingForNodeNotInUse()
		 {
			  ...
			  // when
			  Org.Neo4j.Consistency.report.ConsistencyReport_NodeConsistencyReport report = Check( node );
