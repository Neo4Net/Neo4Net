...
//ORIGINAL LINE: public <RECORD extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord, REPORT extends org.neo4j.consistency.report.ConsistencyReport> org.neo4j.consistency.checking.CheckerEngine<RECORD, REPORT> engine(final RECORD record, final REPORT report)
		 public virtual CheckerEngine<RECORD, REPORT> Engine<RECORD, REPORT>( RECORD record, REPORT report ) where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Org.Neo4j.Consistency.report.ConsistencyReport
		 {
...
//ORIGINAL LINE: public <RECORD extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord, REPORT extends org.neo4j.consistency.report.ConsistencyReport> org.neo4j.consistency.checking.CheckerEngine<RECORD, REPORT> engine(final RECORD oldRecord, final RECORD newRecord, REPORT report)
		 public virtual CheckerEngine<RECORD, REPORT> Engine<RECORD, REPORT>( RECORD oldRecord, RECORD newRecord, REPORT report ) where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Org.Neo4j.Consistency.report.ConsistencyReport
		 {
...
//ORIGINAL LINE: @Override @SuppressWarnings("unchecked") void checkReference(org.neo4j.consistency.checking.ComparativeRecordChecker checker, org.neo4j.kernel.impl.store.record.AbstractBaseRecord oldReference, org.neo4j.kernel.impl.store.record.AbstractBaseRecord newReference)
		 ...
		 private abstract class Engine<RECORD, REPORT> : CheckerEngine<RECORD, REPORT> where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Org.Neo4j.Consistency.report.ConsistencyReport
		 {
			 private readonly RecordAccessStub _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
		 ...
		 private class Delta<R> where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
...
//           NEW { <R> R get(Delta<R> delta) { return delta.oldRecord == null ? null : delta.newRecord; } };
		 ...
		 private static R Add<R>( IDictionary<long, Delta<R>> records, R record ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
			  records[record.Id] = new Delta<R>( record );
			  return record;
		 }

		 private static void Add<R>( IDictionary<long, Delta<R>> records, R oldRecord, R newRecord ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
		 ...
		 public virtual R AddChange<R>( R oldRecord, R newRecord ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
		 ...
		 public virtual R Add<R>( R record ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
		 ...
		 private DirectRecordReference<R> Reference<R>( IDictionary<long, Delta<R>> records, long id, Version version ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
			  return new DirectRecordReference<R>( Record( records, id, version ), this );
		 }

		 private static R Record<R>( IDictionary<long, Delta<R>> records, long id, Version version ) where R : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
