...
//	import static org.neo4j.kernel.impl.store.record.RecordLoad.FORCE;
	...
	internal class CountsBuilderDecorator : Org.Neo4j.Consistency.checking.CheckDecorator_Adapter
	{
...
//ORIGINAL LINE: final org.neo4j.helpers.progress.ProgressListener listener = progressFactory.singlePart("Checking node and relationship counts", total);
		 ...
		 private class CountsVisitor_AdapterAnonymousInnerClass : Org.Neo4j.Kernel.Impl.Api.CountsVisitor_Adapter
		 {
...
//ORIGINAL LINE: final int type = record.getType();
		 ...
		 private class MultiPassAvoidanceCondition<T> : System.Predicate<T> where T : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
		 {
