...
namespace Org.Neo4j.Consistency.checking
{
	...
	public interface CheckerEngine<RECORD, REPORT> where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Org.Neo4j.Consistency.report.ConsistencyReport
	{
