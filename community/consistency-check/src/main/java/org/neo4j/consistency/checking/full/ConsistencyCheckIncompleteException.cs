...
namespace Org.Neo4j.Consistency.checking.full
{
	...
	public class ConsistencyCheckIncompleteException : Exception
	{
		 public ConsistencyCheckIncompleteException( Exception cause ) : base( "Full consistency check did not complete", cause )
		 {
		 }
