...
namespace Org.Neo4j.Consistency.checking
{
	...
	public class RelationshipTypeTokenRecordCheck : TokenRecordCheck<RelationshipTypeTokenRecord, Org.Neo4j.Consistency.report.ConsistencyReport_RelationshipTypeConsistencyReport>
	{
