...
//	import static org.neo4j.consistency.checking.DynamicStore.SCHEMA;
	...
	public abstract class AbstractStoreProcessor : Org.Neo4j.Kernel.impl.store.RecordStore_Processor<Exception>
	{
		 ...
		 protected internal abstract void CheckDynamic( RecordType type, RecordStore<DynamicRecord> store, DynamicRecord @string, RecordCheck<DynamicRecord, Org.Neo4j.Consistency.report.ConsistencyReport_DynamicConsistencyReport> checker );
