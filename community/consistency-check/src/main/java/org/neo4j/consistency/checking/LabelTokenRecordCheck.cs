...
namespace Org.Neo4j.Consistency.checking
{
	...
	public class LabelTokenRecordCheck : TokenRecordCheck<LabelTokenRecord, Org.Neo4j.Consistency.report.ConsistencyReport_LabelTokenConsistencyReport>
	{
		 ...
		 internal override void NameNotInUse( Org.Neo4j.Consistency.report.ConsistencyReport_LabelTokenConsistencyReport report, DynamicRecord name )
		 {
			  report.NameBlockNotInUse( name );
		 }

		 internal override void EmptyName( Org.Neo4j.Consistency.report.ConsistencyReport_LabelTokenConsistencyReport report, DynamicRecord name )
		 {
