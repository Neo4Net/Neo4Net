...
namespace Org.Neo4j.Tooling.procedure.visitors
{
	...
	using FinalContextMisuse = Org.Neo4j.Tooling.procedure.visitors.examples.FinalContextMisuse;
	using NonPublicContextMisuse = Org.Neo4j.Tooling.procedure.visitors.examples.NonPublicContextMisuse;
	using StaticContextMisuse = Org.Neo4j.Tooling.procedure.visitors.examples.StaticContextMisuse;
	using RestrictedContextTypes = Org.Neo4j.Tooling.procedure.visitors.examples.RestrictedContextTypes;
	using UnknownContextType = Org.Neo4j.Tooling.procedure.visitors.examples.UnknownContextType;
