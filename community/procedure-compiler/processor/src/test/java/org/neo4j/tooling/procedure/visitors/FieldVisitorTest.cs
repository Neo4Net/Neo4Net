...
namespace Org.Neo4j.Tooling.procedure.visitors
{
	...
	using GoodContextUse = Org.Neo4j.Tooling.procedure.visitors.examples.GoodContextUse;
	using StaticNonContextMisuse = Org.Neo4j.Tooling.procedure.visitors.examples.StaticNonContextMisuse;
