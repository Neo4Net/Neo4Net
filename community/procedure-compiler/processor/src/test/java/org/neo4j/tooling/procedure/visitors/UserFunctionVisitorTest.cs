...
namespace Org.Neo4j.Tooling.procedure.visitors
{
	...
	using UserFunctionsExamples = Org.Neo4j.Tooling.procedure.visitors.examples.UserFunctionsExamples;
...
//ORIGINAL LINE: @Test public void functions_with_non_annotated_parameters_are_invalid()
		 public virtual void FunctionsWithNonAnnotatedParametersAreInvalid()
		 {
			  ...
			  string errorMessage = JRE.JAVA_11.CurrentVersion ? "@org.neo4j.procedure.Name usage error: missing on parameter <oops>" : "@org.neo4j.procedure.Name usage error: missing on parameter <arg1>";
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
