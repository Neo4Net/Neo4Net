...
namespace Migration
{
	...
	using NativeLuceneFusionIndexProviderFactory10 = Org.Neo4j.Kernel.Api.Impl.Schema.NativeLuceneFusionIndexProviderFactory10;
...
//ORIGINAL LINE: @ExtendWith(TestDirectoryExtension.class) class StartOldDbOnCurrentVersionAndCreateFusionIndexIT
	internal class StartOldDbOnCurrentVersionAndCreateFusionIndexIT
	{
		 ...
		 private sealed class Provider
		 {
			  ...
			  public static readonly Provider Lucene_10 = new Provider( "Lucene_10", InnerEnum.Lucene_10, "Label1", Org.Neo4j.Graphdb.factory.GraphDatabaseSettings.SchemaIndex.Lucene10, Org.Neo4j.Kernel.Api.Impl.Schema.LuceneIndexProviderFactory.ProviderDescriptor );
			  public static readonly Provider Fusion_10 = new Provider( "Fusion_10", InnerEnum.Fusion_10, "Label2", Org.Neo4j.Graphdb.factory.GraphDatabaseSettings.SchemaIndex.Native10, Org.Neo4j.Kernel.Api.Impl.Schema.NativeLuceneFusionIndexProviderFactory10.Descriptor );
			  public static readonly Provider Fusion_20 = new Provider( "Fusion_20", InnerEnum.Fusion_20, "Label3", Org.Neo4j.Graphdb.factory.GraphDatabaseSettings.SchemaIndex.Native20, Org.Neo4j.Kernel.Api.Impl.Schema.NativeLuceneFusionIndexProviderFactory20.Descriptor );
			  public static readonly Provider Btree_10 = new Provider( "Btree_10", InnerEnum.Btree_10, "Label4", Org.Neo4j.Graphdb.factory.GraphDatabaseSettings.SchemaIndex.NativeBtree10, Org.Neo4j.Kernel.Impl.Index.Schema.GenericNativeIndexProvider.Descriptor );
			  ...
			  internal Provider( string name, InnerEnum innerEnum, string labelName, Org.Neo4j.Graphdb.factory.GraphDatabaseSettings.SchemaIndex setting, Org.Neo4j.@internal.Kernel.Api.schema.IndexProviderDescriptor descriptor )
			  {
