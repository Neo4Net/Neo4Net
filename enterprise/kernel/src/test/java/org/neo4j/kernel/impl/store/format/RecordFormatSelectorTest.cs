...
namespace Org.Neo4j.Kernel.impl.store.format
{
	...
	using HighLimitV3_0_6 = Org.Neo4j.Kernel.impl.store.format.highlimit.v306.HighLimitV3_0_6;
	using HighLimitV3_1_0 = Org.Neo4j.Kernel.impl.store.format.highlimit.v310.HighLimitV3_1_0;
	using HighLimitV3_2_0 = Org.Neo4j.Kernel.impl.store.format.highlimit.v320.HighLimitV3_2_0;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void SelectForStoreWithThrowingPageCache()
		 {
			  ...
			  when( pageCache.PageSize() ).thenReturn(Org.Neo4j.Io.pagecache.PageCache_Fields.PAGE_SIZE);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifySelectForStore(org.neo4j.io.pagecache.PageCache pageCache, RecordFormats format) throws java.io.IOException
