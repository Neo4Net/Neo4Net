...
//ORIGINAL LINE: private static void runTest(Fixture fixture) throws InterruptedException, java.util.concurrent.ExecutionException
		 ...
		 private static void WorkloadA( Fixture fixture, Org.Neo4j.Kernel.impl.locking.Locks_Client a, ResourceType resourceType, int iterations )
		 {
		 ...
		 private static void WorkloadB( Fixture fixture, Org.Neo4j.Kernel.impl.locking.Locks_Client b, ResourceType resourceType, int iterations )
		 {
			  for ( int i = 0; i < iterations; i++ )
			  {
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
			  ...
			  internal virtual void AcquireAX( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeAX.acquire( client, resourceType, 1 );
			  }

			  internal virtual void ReleaseAX( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeAX.release( client, resourceType, 1 );
			  }

			  internal virtual void AcquireAY( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeAY.acquire( client, resourceType, 2 );
			  }

			  internal virtual void ReleaseAY( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeAY.release( client, resourceType, 2 );
			  }

			  internal virtual void AcquireBX( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeBX.acquire( client, resourceType, 1 );
			  }

			  internal virtual void ReleaseBX( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeBX.release( client, resourceType, 1 );
			  }

			  internal virtual void AcquireBY( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
					LockTypeBY.acquire( client, resourceType, 2 );
			  }

			  internal virtual void ReleaseBY( Org.Neo4j.Kernel.impl.locking.Locks_Client client, ResourceType resourceType )
			  {
...
//           EXCLUSIVE { public void acquire(org.neo4j.kernel.impl.locking.Locks_Client client, org.neo4j.storageengine.api.lock.ResourceType resourceType, int resource) { client.acquireExclusive(org.neo4j.storageengine.api.lock.LockTracer.NONE, resourceType, resource); } public void release(org.neo4j.kernel.impl.locking.Locks_Client client, org.neo4j.storageengine.api.lock.ResourceType resourceType, int resource) { client.releaseExclusive(resourceType, resource); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           SHARED { public void acquire(org.neo4j.kernel.impl.locking.Locks_Client client, org.neo4j.storageengine.api.lock.ResourceType resourceType, int resource) { client.acquireShared(org.neo4j.storageengine.api.lock.LockTracer.NONE, resourceType, resource); } public void release(org.neo4j.kernel.impl.locking.Locks_Client client, org.neo4j.storageengine.api.lock.ResourceType resourceType, int resource) { client.releaseShared(resourceType, resource); } };
			  ...
			  public abstract void acquire( Org.Neo4j.Kernel.impl.locking.Locks_Client client, Org.Neo4j.Storageengine.Api.@lock.ResourceType resourceType, int resource );

			  public abstract void release( Org.Neo4j.Kernel.impl.locking.Locks_Client client, Org.Neo4j.Storageengine.Api.@lock.ResourceType resourceType, int resource );
		 ...
		 {
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           COMMUNITY { public org.neo4j.kernel.impl.locking.Locks create(org.neo4j.storageengine.api.lock.ResourceType resourceType) { return new org.neo4j.kernel.impl.locking.community.CommunityLockManger(org.neo4j.kernel.configuration.Config.defaults(), java.time.Clock.systemDefaultZone()); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           FORSETI { public org.neo4j.kernel.impl.locking.Locks create(org.neo4j.storageengine.api.lock.ResourceType resourceType) { return new ForsetiLockManager(org.neo4j.kernel.configuration.Config.defaults(), java.time.Clock.systemDefaultZone(), resourceType); } };
			  ...
			  public abstract Org.Neo4j.Kernel.impl.locking.Locks create( Org.Neo4j.Storageengine.Api.@lock.ResourceType resourceType );
