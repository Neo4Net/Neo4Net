...
//ORIGINAL LINE: @ExtendWith(TestDirectoryExtension.class) class EnterpriseEditionModuleTest
	internal class EnterpriseEditionModuleTest
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Test void fileWatcherFileNameFilter()
		 internal virtual void FileWatcherFileNameFilter()
		 {
			  ...
			  System.Predicate<string> filter = EnterpriseEditionModule.EnterpriseNonClusterFileWatcherFileNameFilter();
