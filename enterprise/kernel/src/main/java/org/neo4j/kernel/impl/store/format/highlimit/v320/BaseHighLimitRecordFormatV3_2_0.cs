...
//	import static org.neo4j.kernel.impl.store.RecordPageLocationCalculator.pageIdForRecord;
	...
	internal abstract class BaseHighLimitRecordFormatV3_2_0<RECORD> : BaseOneByteHeaderRecordFormat<RECORD> where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	{
		 ...
		 protected internal BaseHighLimitRecordFormatV3_2_0( System.Func<StoreHeader, int> recordSize, int recordHeaderSize, int maxIdBits ) : base( recordSize, recordHeaderSize, IN_USE_BIT, maxIdBits )
		 {
		 }
