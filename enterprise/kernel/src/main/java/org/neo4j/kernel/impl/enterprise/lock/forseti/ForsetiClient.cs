...
namespace Org.Neo4j.Kernel.impl.enterprise.@lock.forseti
{
	...
	using DeadlockResolutionStrategy = Org.Neo4j.Kernel.impl.enterprise.@lock.forseti.ForsetiLockManager.DeadlockResolutionStrategy;
	...
	using LockClientStateHolder = Org.Neo4j.Kernel.impl.locking.LockClientStateHolder;
	...
	using LockWaitEvent = Org.Neo4j.Storageengine.Api.@lock.LockWaitEvent;
	...
	/// global lock manager.
	/// </summary>
	public class ForsetiClient : Org.Neo4j.Kernel.impl.locking.Locks_Client
	{
...
//ORIGINAL LINE: public void acquireExclusive(org.neo4j.storageengine.api.lock.LockTracer tracer, org.neo4j.storageengine.api.lock.ResourceType resourceType, long... resourceIds) throws org.neo4j.storageengine.api.lock.AcquireLockTimeoutException
		 ...
		 public override Stream<ActiveLock> ActiveLocks()
		 {
			  ...
			  CollectActiveLocks( _exclusiveLockCounts, locks, Org.Neo4j.Kernel.impl.locking.ActiveLock_Factory_Fields.ExclusiveLock );
			  CollectActiveLocks( _sharedLockCounts, locks, Org.Neo4j.Kernel.impl.locking.ActiveLock_Factory_Fields.SharedLock );
			  return locks.stream();
		 }
