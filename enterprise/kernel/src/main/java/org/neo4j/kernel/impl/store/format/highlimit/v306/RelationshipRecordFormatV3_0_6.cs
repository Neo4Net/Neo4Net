 ...
 */
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v306
{
...
//	import static org.neo4j.kernel.impl.store.format.highlimit.Reference.toRelative;
	...
	/// => 28B
	/// </summary>
	internal class RelationshipRecordFormatV3_0_6 : BaseHighLimitRecordFormatV3_0_6<RelationshipRecord>
	{
		 ...
		 internal RelationshipRecordFormatV3_0_6() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipRecordFormatV3_0_6( int recordSize ) : base( fixedRecordSize( recordSize ), 0 )
		 {
		 }
