...
//	import static org.neo4j.kernel.impl.store.RecordPageLocationCalculator.pageIdForRecord;
	...
	internal abstract class BaseHighLimitRecordFormatV3_0_6<RECORD> : BaseOneByteHeaderRecordFormat<RECORD> where RECORD : Org.Neo4j.Kernel.impl.store.record.AbstractBaseRecord
	{
		 ...
		 protected internal BaseHighLimitRecordFormatV3_0_6( System.Func<StoreHeader, int> recordSize, int recordHeaderSize ) : base( recordSize, recordHeaderSize, IN_USE_BIT, HighLimitV3_0_6.DEFAULT_MAXIMUM_BITS_PER_ID )
		 {
		 }
