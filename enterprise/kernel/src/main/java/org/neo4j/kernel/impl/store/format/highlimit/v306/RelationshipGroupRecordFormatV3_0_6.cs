...
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v306
{
	...
	/// => 24B
	/// </summary>
	internal class RelationshipGroupRecordFormatV3_0_6 : BaseHighLimitRecordFormatV3_0_6<RelationshipGroupRecord>
	{
		 internal const int RECORD_SIZE = 32;
		 internal static readonly int FixedFormatRecordSize = HeaderByte + Byte.BYTES + Short.BYTES + Integer.BYTES + Integer.BYTES + Integer.BYTES + Integer.BYTES + Integer.BYTES;
		 ...
		 internal RelationshipGroupRecordFormatV3_0_6() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipGroupRecordFormatV3_0_6( int recordSize ) : base( fixedRecordSize( recordSize ), 0 )
		 {
		 }
