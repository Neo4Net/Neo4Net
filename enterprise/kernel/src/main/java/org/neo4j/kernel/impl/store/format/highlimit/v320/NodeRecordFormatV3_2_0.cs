...
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v320
{
	...
	/// => 15B
	/// </summary>
	internal class NodeRecordFormatV3_2_0 : BaseHighLimitRecordFormatV3_2_0<NodeRecord>
	{
		 ...
		 internal NodeRecordFormatV3_2_0() : this(RECORD_SIZE)
		 {
		 }

		 internal NodeRecordFormatV3_2_0( int recordSize ) : base( fixedRecordSize( recordSize ), 0, HighLimitFormatSettingsV3_2_0.NODE_MAXIMUM_ID_BITS )
		 {
		 }
