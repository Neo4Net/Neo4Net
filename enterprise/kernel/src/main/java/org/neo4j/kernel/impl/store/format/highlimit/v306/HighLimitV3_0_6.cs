...
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v306
{
	...
	/// </summary>
	/// <seealso cref= BaseHighLimitRecordFormatV3_0_6 </seealso>
	public class HighLimitV3_0_6 : BaseRecordFormats
	{
		 /// <summary>
		 ...
		 public static readonly string StoreVersion = StoreVersion.HIGH_LIMIT_V3_0_6.versionString();
		 public static readonly RecordFormats RecordFormats = new HighLimitV3_0_6();
		 public const string NAME = "high_limitV3_0_6";

		 public HighLimitV3_0_6() : base(StoreVersion, StoreVersion.HIGH_LIMIT_V3_0_6.introductionVersion(), 2, Capability.DENSE_NODES, Capability.SCHEMA, Capability.LUCENE_5, Capability.SECONDARY_RECORD_UNITS)
		 {
		 }
