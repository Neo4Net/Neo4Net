 ...
 */
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v320
{
...
//ORIGINAL LINE: @SuppressWarnings("unused") static final int PROPERTY_TOKEN_MAXIMUM_ID_BITS = org.neo4j.kernel.impl.store.format.standard.StandardFormatSettings.PROPERTY_TOKEN_MAXIMUM_ID_BITS;
		 internal const int PROPERTY_TOKEN_MAXIMUM_ID_BITS = StandardFormatSettings.PROPERTY_TOKEN_MAXIMUM_ID_BITS;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") static final int LABEL_TOKEN_MAXIMUM_ID_BITS = org.neo4j.kernel.impl.store.format.standard.StandardFormatSettings.LABEL_TOKEN_MAXIMUM_ID_BITS;
		 internal const int LABEL_TOKEN_MAXIMUM_ID_BITS = StandardFormatSettings.LABEL_TOKEN_MAXIMUM_ID_BITS;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") static final int RELATIONSHIP_TYPE_TOKEN_MAXIMUM_ID_BITS = org.neo4j.kernel.impl.store.format.standard.StandardFormatSettings.RELATIONSHIP_TYPE_TOKEN_MAXIMUM_ID_BITS;
