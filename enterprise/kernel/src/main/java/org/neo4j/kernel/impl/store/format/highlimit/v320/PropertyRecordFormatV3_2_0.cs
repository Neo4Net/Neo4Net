...
//	import static org.neo4j.kernel.impl.store.format.highlimit.v320.BaseHighLimitRecordFormatV3_2_0.NULL;
	...
	/// 
	/// </pre>
	/// Unlike other high limit records <seealso cref="BaseHighLimitRecordFormatV3_2_0"/> fixed reference marker in property record
	/// format header is not inverted: 1 - fixed reference format used; 0 - variable length format used.
	/// </summary>
	internal class PropertyRecordFormatV3_2_0 : BaseOneByteHeaderRecordFormat<PropertyRecord>
	{
		 ...
		 protected internal PropertyRecordFormatV3_2_0() : base(fixedRecordSize(RECORD_SIZE), 0, IN_USE_BIT, HighLimitFormatSettingsV3_2_0.PROPERTY_MAXIMUM_ID_BITS)
		 {
		 }
