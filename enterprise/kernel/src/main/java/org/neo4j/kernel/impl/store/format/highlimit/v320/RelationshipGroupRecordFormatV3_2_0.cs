...
namespace Org.Neo4j.Kernel.impl.store.format.highlimit.v320
{
	...
	/// => 24B
	/// </summary>
	internal class RelationshipGroupRecordFormatV3_2_0 : BaseHighLimitRecordFormatV3_2_0<RelationshipGroupRecord>
	{
		 ...
		 internal RelationshipGroupRecordFormatV3_2_0() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipGroupRecordFormatV3_2_0( int recordSize ) : base( fixedRecordSize( recordSize ), 0, HighLimitFormatSettingsV3_2_0.RELATIONSHIP_GROUP_MAXIMUM_ID_BITS )
		 {
		 }
