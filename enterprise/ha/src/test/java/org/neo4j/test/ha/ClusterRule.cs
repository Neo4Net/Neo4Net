...
namespace Org.Neo4j.Test.ha
{
	...
	using Cluster = Org.Neo4j.cluster.client.Cluster;
	using GraphDatabaseService = Org.Neo4j.Graphdb.GraphDatabaseService;
	using Org.Neo4j.Graphdb.config;
	using HighlyAvailableGraphDatabaseFactory = Org.Neo4j.Graphdb.factory.HighlyAvailableGraphDatabaseFactory;
	using FileUtils = Org.Neo4j.Io.fs.FileUtils;
	using ClusterManager = Org.Neo4j.Kernel.impl.ha.ClusterManager;
	using Builder = Org.Neo4j.Kernel.impl.ha.ClusterManager.Builder;
	using Org.Neo4j.Kernel.impl.ha.ClusterManager;
	using ManagedCluster = Org.Neo4j.Kernel.impl.ha.ClusterManager.ManagedCluster;
	using StoreDirInitializer = Org.Neo4j.Kernel.impl.ha.ClusterManager.StoreDirInitializer;
