...
//ORIGINAL LINE: public static org.hamcrest.Matcher<ClusterMember> sameMemberAs(final ClusterMember clusterMember)
		 ...
		 {
			 private Org.Neo4j.Kernel.ha.cluster.member.ClusterMember _clusterMember;

			 public BaseMatcherAnonymousInnerClass( Org.Neo4j.Kernel.ha.cluster.member.ClusterMember clusterMember )
			 {
