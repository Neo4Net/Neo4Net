...
//ORIGINAL LINE: @RunWith(MockitoJUnitRunner.class) public class ConversationTest
	...
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Mock private org.neo4j.kernel.impl.locking.Locks_Client client;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Rule public org.neo4j.test.rule.concurrent.ThreadingRule threadingRule = new org.neo4j.test.rule.concurrent.ThreadingRule();
