...
namespace Org.Neo4j.Kernel.impl.ha
{
	...
	internal class ParallelLifecycle : LifecycleAdapter
	{
		 ...
		 public virtual T Add<T>( T lifecycle ) where T : Org.Neo4j.Kernel.Lifecycle.Lifecycle
		 {
...
//ORIGINAL LINE: for (java.util.concurrent.Future<?> future : futures)
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void act(org.neo4j.kernel.lifecycle.Lifecycle lifecycle) throws Throwable;
