...
namespace Org.Neo4j.Kernel.ha
{
	...
	using LogMatcher = Org.Neo4j.Logging.AssertableLogProvider.LogMatcher;
...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
			  ...
			  public override Response<Void> PullUpdates( long txId )
			  {
					...
					return new TransactionStreamResponse<Void>( null, newStoreIdForCurrentVersion(), Org.Neo4j.com.TransactionStream_Fields.Empty, Org.Neo4j.com.ResourceReleaser_Fields.NoOp );
			  }
