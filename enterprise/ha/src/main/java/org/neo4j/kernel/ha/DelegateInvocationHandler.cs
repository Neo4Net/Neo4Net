...
//ORIGINAL LINE: public Object invoke(Object proxy, Method method, Object[] args) throws Throwable
		 ...
		 /// </summary>
		 internal class StateChangedTransactionFailureException : TransactionFailureException, Org.Neo4j.Kernel.Api.Exceptions.Status_HasStatus
		 {
			  ...
			  {
					return Org.Neo4j.Kernel.Api.Exceptions.Status_Transaction.InstanceStateChanged;
			  }
		 }
	}
