...
namespace Org.Neo4j.Kernel.ha
{
	...
	/// </summary>
	public class StoreOutOfDateException : StoreUnableToParticipateInClusterException
	{
		 public StoreOutOfDateException() : base()
		 {
		 }

		 public StoreOutOfDateException( string message, Exception cause ) : base( message, cause )
		 {
		 }
	}
