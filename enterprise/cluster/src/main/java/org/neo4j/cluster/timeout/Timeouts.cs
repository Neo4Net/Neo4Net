 ...
 */
namespace Org.Neo4j.cluster.timeout
{
	...
	public class Timeouts : MessageSource
	{
		 ...
		 public virtual void SetTimeout<T1>( object key, Message<T1> timeoutMessage ) where T1 : Org.Neo4j.cluster.com.message.MessageType
		 {
			  long timeoutAt = _now + _timeoutStrategy.timeoutFor( timeoutMessage );
			  _timeouts[key] = new Timeout( this, timeoutAt, timeoutMessage );
		 }

		 public virtual long GetTimeoutFor<T1>( Message<T1> timeoutMessage ) where T1 : Org.Neo4j.cluster.com.message.MessageType
		 {
...
//ORIGINAL LINE: private org.neo4j.cluster.com.message.Message<? extends org.neo4j.cluster.com.message.MessageType> timeoutMessage;
			  ...
			  public Timeout<T1>( Timeouts outerInstance, long timeout, Message<T1> timeoutMessage ) where T1 : Org.Neo4j.cluster.com.message.MessageType
			  {
