...
namespace Org.Neo4j.cluster.timeout
{
	...
	/// <summary>
	/// A <seealso cref="TimeoutStrategy"/> that sets timeouts to a given fixed value.
	/// </summary>
	public class FixedTimeoutStrategy : TimeoutStrategy
	{

		 protected internal readonly long Timeout;
