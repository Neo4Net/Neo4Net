...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 public override Org.Neo4j.cluster.protocol.election.ElectionContext_VoteRequest VoteRequestForRole( ElectionRole role )
		 {
			  return new Org.Neo4j.cluster.protocol.election.ElectionContext_VoteRequest( role.Name, _clusterContext.LastElectorVersion );
		 }
