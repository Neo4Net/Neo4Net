...
namespace Org.Neo4j.cluster
{
	...
	using StateMachineConversations = Org.Neo4j.cluster.statemachine.StateMachineConversations;
	using StateMachineProxyFactory = Org.Neo4j.cluster.statemachine.StateMachineProxyFactory;
