...
namespace Org.Neo4j.cluster.member.paxos
{
	...
	using AtomicBroadcastListener = Org.Neo4j.cluster.protocol.atomicbroadcast.AtomicBroadcastListener;
	...
	using Snapshot = Org.Neo4j.cluster.protocol.snapshot.Snapshot;
	using SnapshotProvider = Org.Neo4j.cluster.protocol.snapshot.SnapshotProvider;
...
//	import static org.neo4j.helpers.collection.Iterables.filter;
	...
	/// <summary>
	/// Paxos based implementation of <seealso cref="org.neo4j.cluster.member.ClusterMemberEvents"/>
	/// </summary>
	public class PaxosClusterMemberEvents : ClusterMemberEvents, Lifecycle
	{
		 ...
		 private Org.Neo4j.cluster.protocol.cluster.ClusterListener_Adapter _clusterListener;
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public void unavailableMember(final org.neo4j.cluster.InstanceId member)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public void unavailableMember(final java.net.URI member, final org.neo4j.cluster.InstanceId id, final String role)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public Iterable<MemberIsAvailable> getCurrentAvailable(final org.neo4j.cluster.InstanceId memberId)
		 ...
		 private class ClusterListenerImpl : Org.Neo4j.cluster.protocol.cluster.ClusterListener_Adapter
		 {
			 private readonly PaxosClusterMemberEvents _outerInstance;
