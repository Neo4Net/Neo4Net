...
//ORIGINAL LINE: final ClusterAssertion realThis = this;
		 ...
		 private class InstanceAssertionAnonymousInnerClass : InstanceAssertion
		 {
			 ...
			 private Org.Neo4j.cluster.ClusterAssertion.InstanceAssertion _current;
		 ...
		 private class ClusterAssertionAnonymousInnerClass2 : ClusterAssertion
		 {
			 ...
			 private IDictionary<int, InstanceAssertion> _newIn;
			 private Org.Neo4j.cluster.ClusterAssertion _realThis;

			 public ClusterAssertionAnonymousInnerClass2( ClusterAssertion outerInstance, IDictionary<int, InstanceAssertion> newIn, Org.Neo4j.cluster.ClusterAssertion realThis )
			 {
				 this.outerInstance = outerInstance;
				 this._newIn = newIn;
...
//ORIGINAL LINE: final ClusterAssertion realThis = this;
		 ...
		 private class InstanceAssertionAnonymousInnerClass2 : InstanceAssertion
		 {
			 ...
			 private Org.Neo4j.cluster.ClusterAssertion.InstanceAssertion _assertion;
