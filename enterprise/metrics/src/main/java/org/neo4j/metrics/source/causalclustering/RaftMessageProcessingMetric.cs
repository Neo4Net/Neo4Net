...
namespace Org.Neo4j.metrics.source.causalclustering
{
	...
	using RaftMessageProcessingMonitor = Org.Neo4j.causalclustering.core.consensus.RaftMessageProcessingMonitor;
	...
	public class RaftMessageProcessingMetric : RaftMessageProcessingMonitor
	{
		 ...
		 private readonly IDictionary<Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type, Timer> _typeTimers = new Dictionary<Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type, Timer>( typeof( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type ) );
...
//JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
		 ...
		 {
			  foreach ( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type type in Enum.GetValues( typeof( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type ) ) )
			  {
		 ...
		 public virtual Timer Timer( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type type )
		 {
			  return _typeTimers[type];
		 }

		 public override void UpdateTimer( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type type, Duration duration )
		 {
