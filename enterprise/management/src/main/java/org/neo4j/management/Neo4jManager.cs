...
namespace Org.Neo4j.management
{
	...
	using Primitives = Org.Neo4j.Jmx.Primitives;
	using StoreFile = Org.Neo4j.Jmx.StoreFile;
	using ConfigurationBean = Org.Neo4j.Jmx.impl.ConfigurationBean;
	using KernelProxy = Org.Neo4j.management.impl.KernelProxy;
