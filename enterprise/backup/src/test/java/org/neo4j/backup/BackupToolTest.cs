...
namespace Org.Neo4j.backup
{
	...
	using ConsistencyCheckSettings = Org.Neo4j.Consistency.ConsistencyCheckSettings;
	using HostnamePort = Org.Neo4j.Helpers.HostnamePort;
	using DatabaseLayout = Org.Neo4j.Io.layout.DatabaseLayout;
	using Config = Org.Neo4j.Kernel.configuration.Config;
	using ConfigLoadIOException = Org.Neo4j.Kernel.configuration.ConfigLoadIOException;
