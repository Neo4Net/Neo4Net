...
namespace Org.Neo4j.Test.causalclustering
{
	...
	using DiscoveryServiceType = Org.Neo4j.causalclustering.scenarios.DiscoveryServiceType;
	using EnterpriseDiscoveryServiceType = Org.Neo4j.causalclustering.scenarios.EnterpriseDiscoveryServiceType;
