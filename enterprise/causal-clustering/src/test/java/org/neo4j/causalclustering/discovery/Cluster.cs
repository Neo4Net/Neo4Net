...
namespace Org.Neo4j.causalclustering.discovery
{
	...
	using LeaderCanWrite = Org.Neo4j.causalclustering.core.LeaderCanWrite;
	...
	using IdGenerationException = Org.Neo4j.causalclustering.core.state.machines.id.IdGenerationException;
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") private static void shutdownMembers(java.util.Collection<? extends ClusterMember> clusterMembers, org.neo4j.causalclustering.helper.ErrorHandler errorHandler)
		 ...
		 private static IList<Future<R>> InvokeAll<X, T, R>( string threadName, ICollection<T> members, System.Func<T, R> call ) where X : Org.Neo4j.Kernel.@internal.GraphDatabaseAPI where T : ClusterMember<X>
		 {
...
//ORIGINAL LINE: private CoreClusterMember leaderTx(String dbName, System.Action<org.neo4j.causalclustering.core.CoreGraphDatabase,org.neo4j.graphdb.Transaction> op, int timeout, java.util.concurrent.TimeUnit timeUnit) throws Exception
		 ...
		 {
			  return e is TransactionFailureException && e.InnerException is Org.Neo4j.@internal.Kernel.Api.exceptions.TransactionFailureException && ( ( Org.Neo4j.@internal.Kernel.Api.exceptions.TransactionFailureException ) e.InnerException ).Status() == LockSessionExpired;
		 }
