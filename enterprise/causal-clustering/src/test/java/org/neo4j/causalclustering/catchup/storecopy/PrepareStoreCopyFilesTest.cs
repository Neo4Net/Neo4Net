...
namespace Org.Neo4j.causalclustering.catchup.storecopy
{
	...
	using NeoStoreFileIndexListing = Org.Neo4j.Kernel.impl.transaction.state.NeoStoreFileIndexListing;
...
//ORIGINAL LINE: @Rule public final org.neo4j.test.rule.TestDirectory testDirectory = org.neo4j.test.rule.TestDirectory.testDirectory(fileSystemAbstraction);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void setExpectedFiles(org.neo4j.storageengine.api.StoreFileMetadata[] expectedFiles) throws java.io.IOException
