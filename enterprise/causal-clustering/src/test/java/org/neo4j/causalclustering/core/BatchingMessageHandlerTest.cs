...
namespace Org.Neo4j.causalclustering.core
{
	...
	using ReplicatedString = Org.Neo4j.causalclustering.core.consensus.ReplicatedString;
...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
	using static Org.Neo4j.causalclustering.core.consensus.RaftMessages_Heartbeat;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
	using static Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
	using static Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") private org.neo4j.causalclustering.messaging.LifecycleMessageHandler<org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<?>> downstreamHandler = mock(org.neo4j.causalclustering.messaging.LifecycleMessageHandler.class);
