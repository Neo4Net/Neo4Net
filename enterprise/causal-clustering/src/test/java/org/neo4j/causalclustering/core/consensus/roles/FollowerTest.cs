...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
	using static Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldInstigateAnElectionAfterTimeout()
		 {
			  ...
			  // then
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest, messageFor( outcome, _member1 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest, messageFor( outcome, _member2 ).type() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void FollowerReceivingHeartbeatIndicatingClusterIsAheadShouldElicitAppendResponse()
		 {
			  ...
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.AppendEntriesResponse, outgoing.Type() );
			  Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Response response = ( AppendEntries.Response ) outgoing;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldNotRenewElectionTimeoutOnReceiptOfHeartbeatInLowerTerm()
		 {
			  ...
			  Outcome outcome = follower.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_Heartbeat( _myself, 1, 1, 1 ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldAcknowledgeHeartbeats()
		 {
			  ...
			  Outcome outcome = follower.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_Heartbeat( state.Leader(), 2, 2, 2 ), state, Log() );

			  // then
			  ICollection<Org.Neo4j.causalclustering.core.consensus.RaftMessages_Directed> outgoingMessages = outcome.OutgoingMessages;
			  assertTrue( outgoingMessages.Contains( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_Directed( state.Leader(), new Org.Neo4j.causalclustering.core.consensus.RaftMessages_HeartbeatResponse(_myself) ) ) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldRespondPositivelyToPreVoteRequestsIfWouldVoteForCandidate()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member1, 0, _member1, 0, 0), raftState, Log());

			  // then
			  RaftMessages_RaftMessage raftMessage = messageFor( outcome, _member1 );
			  assertThat( raftMessage.Type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteResponse) );
			  assertThat( ( ( Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response )raftMessage ).VoteGranted(), equalTo(true) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldRespondPositivelyToPreVoteRequestsEvenIfAlreadyVotedInRealElection()
		 {
			  // given
			  RaftState raftState = PreElectionActive();
			  raftState.Update( ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_Vote_Request(_member1, 0, _member1, 0, 0), raftState, Log()) );

			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member2, 0, _member2, 0, 0), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldRespondNegativelyToPreVoteRequestsIfNotInPreVoteMyself()
		 {
			  ...
			  RaftMessages_RaftMessage raftMessage = messageFor( outcome, _member1 );
			  assertThat( raftMessage.Type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteResponse) );
			  assertThat( ( ( Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response )raftMessage ).VoteGranted(), equalTo(false) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldRespondPositivelyToPreVoteRequestsToMultipleMembersIfWouldVoteForAny()
		 {
			  ...
			  // when
			  Outcome outcome1 = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member1, 0, _member1, 0, 0), raftState, Log());
			  raftState.Update( outcome1 );
			  Outcome outcome2 = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member2, 0, _member2, 0, 0), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldUseTermFromPreVoteRequestIfHigherThanOwn()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member1, newTerm, _member1, 0, 0), raftState, Log());

			  // then
			  RaftMessages_RaftMessage raftMessage = messageFor( outcome, _member1 );

			  assertThat( raftMessage.Type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteResponse) );
			  assertThat( ( ( Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response )raftMessage ).Term(), equalTo(newTerm) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldInstigatePreElectionIfSupportedAndNotActiveAndReceiveTimeout()
		 {
			  ...
			  // then
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest, messageFor( outcome, _member1 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest, messageFor( outcome, _member2 ).type() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldInstigatePreElectionIfSupportedAndActiveAndReceiveTimeout()
		 {
			  ...
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest, messageFor( outcome, _member1 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest, messageFor( outcome, _member2 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest, messageFor( outcome, _member3 ).type() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldAbortPreElectionIfReceivePreVoteResponseFromNewerTerm()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, newTerm, false), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldIgnoreVotesFromEarlierTerms()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, oldTerm, true), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldIgnoreVotesDeclining()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, raftState.Term(), false), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldAddVoteFromADifferentMember()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, raftState.Term(), true), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldNotAddVoteFromMyself()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_myself, raftState.Term(), true), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldTransitionToCandidateIfHaveReachedQuorum()
		 {
			  ...
			  // when
			  Outcome outcome1 = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, raftState.Term(), true), raftState, Log());
			  raftState.Update( outcome1 );
			  Outcome outcome2 = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member2, raftState.Term(), true), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldInstigateElectionIfHaveReachedQuorum()
		 {
			  ...
			  // then
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest, messageFor( outcome2, _member1 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest, messageFor( outcome2, _member2 ).type() );
			  assertEquals( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest, messageFor( outcome2, _member3 ).type() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldIgnorePreVoteRequestsIfPreVoteUnsupported()
		 {
			  ...
			  // when
			  Outcome outcome = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Request(_member1, raftState.Term(), _member1, 0, 0), raftState, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldApprovePreVoteRequestIfPreElectionActiveAndRefusesToLead()
		 {
			  ...
			  // then
			  assertTrue( ( ( Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response ) messageFor( outcome, _member1 ) ).voteGranted() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldSendPreVoteRequestsOnElectionTimeout()
		 {
			  ...
			  // then
			  assertThat( messageFor( outcome, _member1 ).type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest) );
			  assertThat( messageFor( outcome, _member2 ).type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.PreVoteRequest) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldProceedToRealElectionIfReceiveQuorumOfPositivePreVoteResponses()
		 {
			  ...
			  // when
			  Outcome outcome2 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member1, 0L, true ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldIgnorePositivePreVoteResponsesIfNotInPreVotingStage()
		 {
			  ...
			  // when
			  Outcome outcome = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member1, 0L, true ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldMoveToRealElectionWithPreVoteQuorumOf5()
		 {
			  ...
			  Outcome outcome3 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member2, 0L, true ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldNotCountPreVotesVotesFromSameMemberTwice()
		 {
			  ...
			  Outcome outcome2 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member1, 0L, true ), state, Log() );
			  state.Update( outcome2 );
			  Outcome outcome3 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member1, 0L, true ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldResetPreVotesWhenMovingBackToFollower()
		 {
			  ...
			  state.Update( outcome1 );
			  Outcome outcome2 = ( new Follower() ).Handle(new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response(_member1, 0L, true), state, Log());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldSendRealVoteRequestsIfReceivePositivePreVoteResponses()
		 {
			  ...
			  // then
			  assertThat( messageFor( outcome2, _member1 ).type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest) );
			  assertThat( messageFor( outcome2, _member2 ).type(), equalTo(Org.Neo4j.causalclustering.core.consensus.RaftMessages_Type.VoteRequest) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldNotProceedToRealElectionIfReceiveNegativePreVoteResponses()
		 {
			  ...
			  // when
			  Outcome outcome2 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member1, 0L, false ), state, Log() );
			  state.Update( outcome2 );
			  Outcome outcome3 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PreVote_Response( _member2, 0L, false ), state, Log() );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldResetPreVoteIfReceiveHeartbeatFromLeader()
		 {
			  ...
			  // when
			  Outcome outcome2 = underTest.Handle( new Org.Neo4j.causalclustering.core.consensus.RaftMessages_Heartbeat( _member1, 0L, 0L, 0L ), state, Log() );
