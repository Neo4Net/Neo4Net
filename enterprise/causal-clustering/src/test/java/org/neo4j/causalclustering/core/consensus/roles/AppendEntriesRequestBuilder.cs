...
namespace Org.Neo4j.causalclustering.core.consensus.roles
{
	...
	public class AppendEntriesRequestBuilder
	{
		 ...
		 public virtual Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request Build()
		 {
			  return new Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request( _from, _leaderTerm, _prevLogIndex, _prevLogTerm, _logEntries.ToArray(), _leaderCommit );
		 }
