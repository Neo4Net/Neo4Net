...
//ORIGINAL LINE: @Parameterized.Parameter() public org.neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage raftMessage;
		 public Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage RaftMessage;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
...
//ORIGINAL LINE: @Parameterized.Parameters(name = "Raft v{1} with message {0}") public static Object[] data()
		 ...
		 private static object[] setUpParams( Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage[] messages )
		 {
...
//ORIGINAL LINE: return java.util.Arrays.stream(messages).flatMap((System.Func<org.neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage,java.util.stream.Stream<?>>) RaftMessageEncoderDecoderTest::params).toArray();
			  return Arrays.stream( messages ).flatMap( ( System.Func<Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage, Stream<object>> ) RaftMessageEncoderDecoderTest.@params ).toArray();
		 }
...
//ORIGINAL LINE: private static void encode(io.netty.buffer.ByteBuf buffer, io.netty.handler.stream.ChunkedInput<io.netty.buffer.ByteBuf> marshal) throws Exception
		 ...
		 internal class RaftMessageHandler : SimpleChannelInboundHandler<Org.Neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage>>
		 {
			 ...
			 public RaftMessageHandler( RaftMessageEncoderDecoderTest outerInstance )
			 {
			  ...
			  internal Org.Neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage> Msg;
			  ...
			  internal virtual Org.Neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage> RaftMessage
			  {
				  get
				  {
						return Msg;
