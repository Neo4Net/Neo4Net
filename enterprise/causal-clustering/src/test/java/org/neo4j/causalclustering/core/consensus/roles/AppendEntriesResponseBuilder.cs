...
namespace Org.Neo4j.causalclustering.core.consensus.roles
{
	...
	public class AppendEntriesResponseBuilder
	{
		 ...
		 public virtual Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Response Build()
		 {
			  // a response of false should always have a match index of -1
			  Debug.Assert( _success || _matchIndex == -1 );
			  return new Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Response( _from, _term, _success, _matchIndex, _appendIndex );
		 }
