...
namespace Org.Neo4j.causalclustering.core
{
	...
	using Org.Neo4j.causalclustering.protocol.handshake;
...
//ORIGINAL LINE: @Test public void shouldReturnRaftProtocol()
		 public virtual void ShouldReturnRaftProtocol()
		 {
			  ...
			  // then
			  assertThat( supportedRaftProtocol.Identifier(), equalTo(Org.Neo4j.causalclustering.protocol.Protocol_ApplicationProtocolCategory.Raft) );
		 }
