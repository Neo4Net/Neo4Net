...
//ORIGINAL LINE: @Test public void shouldThrowExceptionIfUnrecognizedObjectIsFound()
		 ...
		 private Org.Neo4j.causalclustering.core.consensus.RaftMessages_PruneRequest DummyRequest()
		 {
			  return new Org.Neo4j.causalclustering.core.consensus.RaftMessages_PruneRequest( 1 );
		 }
