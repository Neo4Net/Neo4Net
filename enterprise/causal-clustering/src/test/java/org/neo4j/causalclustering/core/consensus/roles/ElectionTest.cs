...
namespace Org.Neo4j.causalclustering.core.consensus.roles
{
	...
	using OnDemandTimerService = Org.Neo4j.causalclustering.core.consensus.schedule.OnDemandTimerService;
...
//ORIGINAL LINE: @Mock private org.neo4j.causalclustering.messaging.Outbound<org.neo4j.causalclustering.identity.MemberId, org.neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage> outbound;
		 private Outbound<MemberId, Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage> _outbound;
