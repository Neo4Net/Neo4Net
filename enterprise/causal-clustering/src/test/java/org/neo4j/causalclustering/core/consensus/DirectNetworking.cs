...
namespace Org.Neo4j.causalclustering.core.consensus
{
	...
	{
		 private readonly IDictionary<MemberId, Org.Neo4j.causalclustering.messaging.Inbound_MessageHandler> _handlers = new Dictionary<MemberId, Org.Neo4j.causalclustering.messaging.Inbound_MessageHandler>();
		 ...
		 public class Outbound : Org.Neo4j.causalclustering.messaging.Outbound<MemberId, RaftMessages_RaftMessage>
		 {
...
//ORIGINAL LINE: public synchronized void send(org.neo4j.causalclustering.identity.MemberId to, final RaftMessages_RaftMessage message, boolean block)
		 ...
		 public class Inbound<M> : Org.Neo4j.causalclustering.messaging.Inbound<M> where M : Org.Neo4j.causalclustering.messaging.Message
		 {
			 private readonly DirectNetworking _outerInstance;
			  ...
			  public override void RegisterHandler( Org.Neo4j.causalclustering.messaging.Inbound_MessageHandler handler )
			  {
