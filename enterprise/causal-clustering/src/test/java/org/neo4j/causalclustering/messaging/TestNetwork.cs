...
namespace Org.Neo4j.causalclustering.messaging
{
	...
	public class TestNetwork<T>
	{
		 ...
		 public class Outbound : Org.Neo4j.causalclustering.messaging.Outbound<T, Message>
		 {
...
//JAVA TO C# CONVERTER TODO TASK: .NET enumerators are read-only:
		 ...
		 public class Inbound : Org.Neo4j.causalclustering.messaging.Inbound<Message>
		 {
			 private readonly TestNetwork<T> _outerInstance;
