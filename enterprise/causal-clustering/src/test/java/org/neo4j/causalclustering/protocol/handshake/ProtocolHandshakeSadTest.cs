...
namespace Org.Neo4j.causalclustering.protocol.handshake
{
	...
	public class ProtocolHandshakeSadTest
	{
		...
		private void InitializeInstanceFields()
		{
		 ...
		 private ApplicationSupportedProtocols _supportedRaftApplicationProtocol = new ApplicationSupportedProtocols( Org.Neo4j.causalclustering.protocol.Protocol_ApplicationProtocolCategory.Raft, emptyList() );
		 private ApplicationSupportedProtocols _supportedCatchupApplicationProtocol = new ApplicationSupportedProtocols( Org.Neo4j.causalclustering.protocol.Protocol_ApplicationProtocolCategory.Catchup, emptyList() );
