...
//ORIGINAL LINE: @RunWith(MockitoJUnitRunner.class) public class RaftGroupMembershipTest
	...
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Mock private org.neo4j.causalclustering.messaging.Outbound<org.neo4j.causalclustering.identity.MemberId, org.neo4j.causalclustering.messaging.Message> outbound;
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId toBeAdded = member(3);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] finalMembers = {leader, stable1, stable2, toBeAdded};
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId toBeRemoved = member(2);
			  MemberId toBeRemoved = member( 2 );

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] initialMembers = {leader, stable, toBeRemoved};
			  MemberId[] initialMembers = new MemberId[] { leader, stable, toBeRemoved };
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] finalMembers = {leader, stable};
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId toBeRemoved3 = member(4);
			  MemberId toBeRemoved3 = member( 4 );

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] initialMembers = {leader, stable, toBeRemoved1, toBeRemoved2, toBeRemoved3};
...
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId leader = member(0);
			  MemberId leader = member( 0 );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId unstable = member(1);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] allMembers = {leader, unstable, stable1, stable2};
			  MemberId[] allMembers = new MemberId[] { leader, unstable, stable1, stable2 };
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.neo4j.causalclustering.identity.MemberId[] fewerMembers = {leader, stable1, stable2};
...
//ORIGINAL LINE: private org.hamcrest.Matcher<? super org.neo4j.causalclustering.core.consensus.RaftTestFixture.Members> hasCurrentMembers(final RaftTestGroup raftGroup)
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		 ...
		 private class TypeSafeMatcherAnonymousInnerClass : TypeSafeMatcher<RaftTestFixture.Members>
		 {
			 ...
			 private Org.Neo4j.causalclustering.core.consensus.membership.RaftTestGroup _raftGroup;

			 public TypeSafeMatcherAnonymousInnerClass( RaftGroupMembershipTest outerInstance, Org.Neo4j.causalclustering.core.consensus.membership.RaftTestGroup raftGroup )
			 {
