...
namespace Org.Neo4j.causalclustering.discovery
{
	...
	using KubernetesType = Org.Neo4j.causalclustering.discovery.kubernetes.KubernetesType;
	using ServiceList = Org.Neo4j.causalclustering.discovery.kubernetes.ServiceList;
	using Status = Org.Neo4j.causalclustering.discovery.kubernetes.Status;
