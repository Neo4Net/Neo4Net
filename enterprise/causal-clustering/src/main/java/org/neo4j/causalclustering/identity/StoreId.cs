...
namespace Org.Neo4j.causalclustering.identity
{
	...
	{
		 public static readonly StoreId Default = new StoreId( Org.Neo4j.Storageengine.Api.StoreId.Default.CreationTime, Org.Neo4j.Storageengine.Api.StoreId.Default.RandomId, Org.Neo4j.Storageengine.Api.StoreId.Default.UpgradeTime, Org.Neo4j.Storageengine.Api.StoreId.Default.UpgradeId );
