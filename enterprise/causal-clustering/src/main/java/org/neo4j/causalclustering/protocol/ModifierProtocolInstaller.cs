...
//	import static org.neo4j.causalclustering.protocol.Protocol_ModifierProtocols.COMPRESSION_GZIP;
	...
	public interface ModifierProtocolInstaller<O> where O : Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation
	{
	...
	{
		 public static readonly IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Server>> ServerCompressionInstallers = new IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Server>>
		 {
		 ...
		 public static readonly IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client>> ClientCompressionInstallers = new IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client>>
		 {
		 ...
		 public static readonly IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client>> AllClientInstallers = ClientCompressionInstallers;
		 public static readonly IList<ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Server>> AllServerInstallers = ServerCompressionInstallers;
	}

	 public abstract class ModifierProtocolInstaller_BaseClientModifier : ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client>
	 {
		  ...
		  public override void Apply<BUILDER>( NettyPipelineBuilder<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client, BUILDER> nettyPipelineBuilder ) where BUILDER : NettyPipelineBuilder<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client,BUILDER>
		  {
				nettyPipelineBuilder.Add( PipelineEncoderName, Encoder.get() );
		  }
	 }

	 public abstract class ModifierProtocolInstaller_BaseServerModifier : ModifierProtocolInstaller<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Server>
	 {
