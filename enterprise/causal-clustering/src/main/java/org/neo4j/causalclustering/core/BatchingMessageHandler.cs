...
namespace Org.Neo4j.causalclustering.core
{
	...
	using Org.Neo4j.causalclustering.core.BoundedPriorityQueue;
	...
	using RaftMessages_AppendEntries = Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries;
	using RaftMessages_NewEntry = Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry;
...
//ORIGINAL LINE: private final org.neo4j.causalclustering.messaging.LifecycleMessageHandler<org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<?>> handler;
		 private readonly LifecycleMessageHandler<RaftMessages_ReceivedInstantClusterIdAwareMessage<object>> _handler;
		 private readonly Log _log;
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private final BoundedPriorityQueue<org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<?>> inQueue;
...
//ORIGINAL LINE: public void stop() throws Throwable
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Optional<org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<?>> baseMessage;
		 ...
		 /// </summary>
		 private Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_BatchRequest BatchNewEntries( Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request first )
		 {
			  _contentBatch.Clear();
			  ...
			  {
					Optional<Removable<Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request>> peeked = PeekNext( typeof( Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request ) );
			   ...
			   */
			  return new Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_BatchRequest( _contentBatch );
		 }

		 private Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request BatchAppendEntries( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request first )
		 {
			  _entryBatch.Clear();
			  ...
			  {
					Optional<Removable<Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request>> peeked = PeekNext( typeof( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request ) );
					...
					Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request = peeked.get().get();
			  ...
			  return new Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request( first.From(), first.LeaderTerm(), first.PrevLogIndex(), first.PrevLogTerm(), _entryBatch.toArray(RaftLogEntry.empty), leaderCommit );
		 }

		 private bool ConsecutiveOrigin( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request first, Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request, int currentSize )
		 {
		 ...
		 private class ContentSize : Org.Neo4j.causalclustering.core.consensus.RaftMessages_HandlerAdaptor<long, Exception>
		 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public System.Nullable<long> handle(org.neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request request) throws RuntimeException
			  public override long? Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request request )
			  {
					return request.Content().size().GetValueOrDefault(0L);
			  }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public System.Nullable<long> handle(org.neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request) throws RuntimeException
			  public override long? Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request )
			  {
					long totalSize = 0L;
		 ...
		 private class MessagePriority : Org.Neo4j.causalclustering.core.consensus.RaftMessages_HandlerAdaptor<int, Exception>, IComparer<RaftMessages_ReceivedInstantClusterIdAwareMessage<JavaToDotNetGenericWildcard>>
		 {
			 ...
			 public MessagePriority( BatchingMessageHandler outerInstance )
			 {
			  ...
			  public override int? Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request )
			  {
			  ...
			  public override int? Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request request )
			  {
					return 30;
			  }
		 ...
		 private class BatchingHandler : Org.Neo4j.causalclustering.core.consensus.RaftMessages_HandlerAdaptor<RaftMessages_ReceivedInstantClusterIdAwareMessage, Exception>
		 {
			 private readonly BatchingMessageHandler _outerInstance;

//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private final org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage<?> baseMessage;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage handle(org.neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request request) throws RuntimeException
			  public override RaftMessages_ReceivedInstantClusterIdAwareMessage Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request request )
			  {
					Org.Neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_BatchRequest newEntryBatch = outerInstance.batchNewEntries( request );
					return RaftMessages_ReceivedInstantClusterIdAwareMessage.of( BaseMessage.receivedAt(), BaseMessage.clusterId(), newEntryBatch );
			  }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public org.neo4j.causalclustering.core.consensus.RaftMessages_ReceivedInstantClusterIdAwareMessage handle(org.neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request) throws RuntimeException
			  public override RaftMessages_ReceivedInstantClusterIdAwareMessage Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request request )
			  {
					...
					Org.Neo4j.causalclustering.core.consensus.RaftMessages_AppendEntries_Request appendEntriesBatch = outerInstance.batchAppendEntries( request );
