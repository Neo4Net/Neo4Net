...
namespace Org.Neo4j.causalclustering.discovery
{
	...
	public abstract class AbstractCoreTopologyService : SafeLifecycle, CoreTopologyService
	{
		...
		public abstract Optional<Org.Neo4j.Helpers.AdvertisedSocketAddress> FindCatchupAddress( MemberId upstream );
		...
		public abstract bool SetClusterId( Org.Neo4j.causalclustering.identity.ClusterId clusterId, string dbName );
