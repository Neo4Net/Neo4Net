 ...
 */
namespace Org.Neo4j.causalclustering.messaging.marshalling.v2.encoding
{
	...
	public class RaftMessageEncoder : MessageToByteEncoder<Org.Neo4j.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage>
	{
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected void encode(io.netty.channel.ChannelHandlerContext ctx, org.neo4j.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage decoratedMessage, io.netty.buffer.ByteBuf out) throws Exception
		 protected internal override void Encode( ChannelHandlerContext ctx, Org.Neo4j.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage decoratedMessage, ByteBuf @out )
		 {
		 ...
		 private class Handler : Org.Neo4j.causalclustering.core.consensus.RaftMessages_Handler<Void, Exception>
		 {
...
//ORIGINAL LINE: public Void handle(org.neo4j.causalclustering.core.consensus.RaftMessages_Vote_Request voteRequest) throws Exception
			  public override Void Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Vote_Request voteRequest )
			  {
			  ...
			  public override Void Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_Vote_Response voteResponse )
			  {
...
//ORIGINAL LINE: public Void handle(org.neo4j.causalclustering.core.consensus.RaftMessages_NewEntry_Request newEntryRequest) throws Exception
			  ...
			  public override Void Handle( Org.Neo4j.causalclustering.core.consensus.RaftMessages_HeartbeatResponse heartbeatResponse )
			  {
