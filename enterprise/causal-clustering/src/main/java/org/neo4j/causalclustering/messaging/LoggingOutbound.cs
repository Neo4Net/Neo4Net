...
namespace Org.Neo4j.causalclustering.messaging
{
	...
	public class LoggingOutbound<MEMBER, MESSAGE> : Outbound<MEMBER, MESSAGE> where MESSAGE : Org.Neo4j.causalclustering.core.consensus.RaftMessages_RaftMessage
	{
		 private readonly Outbound<MEMBER, MESSAGE> _outbound;
		 private readonly MEMBER _me;
		 private readonly MessageLogger<MEMBER> _messageLogger;
