...
namespace Org.Neo4j.causalclustering.protocol.handshake
{
	...
	public abstract class ProtocolRepository<U, T> where U : IComparable<U> where T : Org.Neo4j.causalclustering.protocol.Protocol<U>
	{
...
//JAVA TO C# CONVERTER TODO TASK: Most Java stream collectors are not converted by Java to C# Converter:
		 ...
		 internal static IComparer<T> VersionNumberComparator<U, T>() where U : IComparable<U> where T : Org.Neo4j.causalclustering.protocol.Protocol<U>
		 {
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
