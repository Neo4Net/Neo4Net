...
namespace Org.Neo4j.causalclustering.protocol.handshake
{
	...
	public class NettyHandshakeClient : SimpleChannelInboundHandler<ClientMessage>
	{
		 private readonly HandshakeClient _handler;
		 ...
		 protected internal override void ChannelRead0( ChannelHandlerContext ctx, ClientMessage msg )
		 {
