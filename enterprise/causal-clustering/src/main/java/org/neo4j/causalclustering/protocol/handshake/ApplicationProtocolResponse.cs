...
//	import static org.neo4j.causalclustering.protocol.handshake.StatusCode.FAILURE;
	...
	{
		 public static readonly ApplicationProtocolResponse NoProtocol = new ApplicationProtocolResponse( FAILURE, "", 0 );

		 internal ApplicationProtocolResponse( StatusCode statusCode, string protocolName, int version ) : base( statusCode, protocolName, version )
		 {
		 }
