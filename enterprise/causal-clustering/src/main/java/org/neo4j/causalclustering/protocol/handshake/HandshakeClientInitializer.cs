...
namespace Org.Neo4j.causalclustering.protocol.handshake
{
	...
	using ReconnectingChannel = Org.Neo4j.causalclustering.messaging.ReconnectingChannel;
	...
	public class HandshakeClientInitializer : ChannelInitializer<SocketChannel>
	{
		 ...
		 private readonly ProtocolInstallerRepository<Org.Neo4j.causalclustering.protocol.ProtocolInstaller_Orientation_Client> _protocolInstaller;
