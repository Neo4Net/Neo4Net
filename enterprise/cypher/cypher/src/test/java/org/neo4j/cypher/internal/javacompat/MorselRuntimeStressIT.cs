...
//	import static org.hamcrest.core.IsNull.notNullValue;
	...
	public class MorselRuntimeStressIT
	{
		 ...
		 private static readonly Org.Neo4j.Graphdb.Result_ResultVisitor<Exception> _checkingVisitor = row =>
		 {
		  assertThat( row.get( "n" ), notNullValue() );
		  return true;
		 };
		 private static readonly Org.Neo4j.Graphdb.Result_ResultVisitor<Exception> _throwingVisitor = row =>
		 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private Org.Neo4j.Graphdb.Result_ResultVisitor<Exception> Visitor()
		 {
