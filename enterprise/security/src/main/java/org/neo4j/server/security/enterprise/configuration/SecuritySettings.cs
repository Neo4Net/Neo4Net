 ...
 */
namespace Org.Neo4j.Server.security.enterprise.configuration
{
...
//	import static org.neo4j.kernel.impl.proc.ProcedureConfig.PROC_ALLOWED_SETTING_ROLES;
	...
	public class SecuritySettings : LoadableConfig
	{
		 public const string NATIVE_REALM_NAME = "native";
		 public const string SYSTEM_GRAPH_REALM_NAME = "system-graph";
		 public const string LDAP_REALM_NAME = "ldap";
		 public const string PLUGIN_REALM_NAME_PREFIX = "plugin-";
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authentication via native authentication provider.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> native_authentication_enabled = derivedSetting("dbms.security.native.authentication_enabled", auth_providers, providers -> providers.contains(NATIVE_REALM_NAME) || providers.contains(SYSTEM_GRAPH_REALM_NAME), BOOLEAN);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authorization via native authorization provider.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> native_authorization_enabled = derivedSetting("dbms.security.native.authorization_enabled", auth_providers, providers -> providers.contains(NATIVE_REALM_NAME) || providers.contains(SYSTEM_GRAPH_REALM_NAME), BOOLEAN);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authentication via settings configurable LDAP authentication provider.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> ldap_authentication_enabled = derivedSetting("dbms.security.ldap.authentication_enabled", auth_providers, providers -> providers.contains(LDAP_REALM_NAME), BOOLEAN);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authorization via settings configurable LDAP authorization provider.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> ldap_authorization_enabled = derivedSetting("dbms.security.ldap.authorization_enabled", auth_providers, providers -> providers.contains(LDAP_REALM_NAME), BOOLEAN);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authentication via plugin authentication providers.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> plugin_authentication_enabled = derivedSetting("dbms.security.plugin.authentication_enabled", auth_providers, providers -> providers.stream().anyMatch(r -> r.startsWith(PLUGIN_REALM_NAME_PREFIX)), BOOLEAN);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable authorization via plugin authorization providers.") @Internal public static final org.neo4j.graphdb.config.Setting<bool> plugin_authorization_enabled = derivedSetting("dbms.security.plugin.authorization_enabled", auth_providers, providers -> providers.stream().anyMatch(r -> r.startsWith(PLUGIN_REALM_NAME_PREFIX)), BOOLEAN);
		 ...
		 public static readonly Setting<string> LdapServer = setting( "dbms.security.ldap.host", STRING, "localhost" );
		 ...
		 public static readonly Setting<bool> LdapUseStarttls = setting( "dbms.security.ldap.use_starttls", BOOLEAN, FALSE );
		 ...
		 public static readonly Setting<string> LdapReferral = setting( "dbms.security.ldap.referral", STRING, "follow" );
		 ...
		 public static readonly Setting<Duration> LdapConnectionTimeout = setting( "dbms.security.ldap.connection_timeout", DURATION, "30s" );
		 ...
		 public static readonly Setting<Duration> LdapReadTimeout = setting( "dbms.security.ldap.read_timeout", DURATION, "30s" );
		 ...
		 public static readonly Setting<string> LdapAuthenticationMechanism = setting( "dbms.security.ldap.authentication.mechanism", STRING, "simple" );
		 ...
		 public static readonly Setting<string> LdapAuthenticationUserDnTemplate = setting( "dbms.security.ldap.authentication.user_dn_template", STRING, "uid={0},ou=users,dc=example,dc=com" );
		 ...
		 public static readonly Setting<bool> LdapAuthenticationCacheEnabled = setting( "dbms.security.ldap.authentication.cache_enabled", BOOLEAN, "true" );
		 ...
		 public static readonly Setting<bool> LdapAuthenticationUseSamaccountname = setting( "dbms.security.ldap.authentication.use_samaccountname", BOOLEAN, FALSE );
		 ...
		 public static readonly Setting<bool> LdapAuthorizationUseSystemAccount = setting( "dbms.security.ldap.authorization.use_system_account", BOOLEAN, FALSE );
		 ...
		 public static readonly Setting<string> LdapAuthorizationSystemUsername = setting( "dbms.security.ldap.authorization.system_username", STRING, NO_DEFAULT );
		 ...
		 public static readonly Setting<string> LdapAuthorizationSystemPassword = setting( "dbms.security.ldap.authorization.system_password", STRING, NO_DEFAULT );
		 ...
		 public static readonly Setting<string> LdapAuthorizationUserSearchBase = setting( "dbms.security.ldap.authorization.user_search_base", STRING, "ou=users,dc=example,dc=com" );
		 ...
		 public static readonly Setting<string> LdapAuthorizationUserSearchFilter = setting( "dbms.security.ldap.authorization.user_search_filter", STRING, "(&(objectClass=*)(uid={0}))" );
		 ...
		 public static readonly Setting<IList<string>> LdapAuthorizationGroupMembershipAttributeNames = setting( "dbms.security.ldap.authorization.group_membership_attributes", STRING_LIST, "memberOf" );
		 ...
		 public static readonly Setting<string> LdapAuthorizationGroupToRoleMapping = setting( "dbms.security.ldap.authorization.group_to_role_mapping", STRING, NO_DEFAULT );
		 ...
		 public static readonly Setting<Duration> AuthCacheTtl = setting( "dbms.security.auth_cache_ttl", DURATION, "10m" );
		 ...
		 public static readonly Setting<bool> AuthCacheUseTtl = setting( "dbms.security.auth_cache_use_ttl", BOOLEAN, "true" );

		 [Description("The maximum capacity for authentication and authorization caches (respectively).")]
		 public static readonly Setting<int> AuthCacheMaxCapacity = setting( "dbms.security.auth_cache_max_capacity", INTEGER, "10000" );
		 ...
		 public static readonly Setting<File> SecurityLogFilename = derivedSetting( "dbms.logs.security.path", GraphDatabaseSettings.logs_directory, logs => new File( logs, "security.log" ), PATH );

		 [Description("Security log level threshold.")]
		 public static readonly Setting<Level> SecurityLogLevel = setting( "dbms.logs.security.level", optionsObeyCase( typeof( Level ) ), "INFO" );
		 ...
		 public static readonly Setting<bool> SecurityLogSuccessfulAuthentication = setting( "dbms.security.log_successful_authentication", BOOLEAN, "true" );

		 [Description("Threshold for rotation of the security log.")]
		 public static readonly Setting<long> StoreSecurityLogRotationThreshold = buildSetting( "dbms.logs.security.rotation.size", BYTES, "20m" ).constraint( range( 0L, long.MaxValue ) ).build();

		 [Description("Minimum time interval after last rotation of the security log before it may be rotated again.")]
		 public static readonly Setting<Duration> StoreSecurityLogRotationDelay = setting( "dbms.logs.security.rotation.delay", DURATION, "300s" );

		 [Description("Maximum number of history files for the security log.")]
		 public static readonly Setting<int> StoreSecurityLogMaxArchives = buildSetting( "dbms.logs.security.rotation.keep_number", INTEGER, "7" ).constraint( min( 1 ) ).build();

		 //=========================================================================
		 // Procedure security settings
		 //=========================================================================

		 [Description("The default role that can execute all procedures and user-defined functions that are not covered " + "by the `" + PROC_ALLOWED_SETTING_ROLES + "` setting. If the `" + PROC_ALLOWED_SETTING_DEFAULT_NAME + "` setting is the empty string (default), procedures will be executed according to the same security " + "rules as normal Cypher statements.\n" + "\n" + "Deprecated: This will be replaced by dynamic configuration in the system graph in 4.0, " + "including a migration step for the existing setting value."), Obsolete]
		 public static readonly Setting<string> DefaultAllowed = setting( PROC_ALLOWED_SETTING_DEFAULT_NAME, STRING, "" );
		 ...
		 public static readonly Setting<string> ProcedureRoles = setting( PROC_ALLOWED_SETTING_ROLES, STRING, "" );
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Set to true if connection pooling should be used for authorization searches using the " + "system account.") public static final org.neo4j.graphdb.config.Setting<bool> ldap_authorization_connection_pooling = setting("unsupported.dbms.security.ldap.authorization.connection_pooling", BOOLEAN, "true");
		 ...
		 [Description("Set to true to enable property level security."), Obsolete]
		 public static readonly Setting<bool> PropertyLevelAuthorizationEnabled = setting( "dbms.security.property_level.enabled", BOOLEAN, "false" );
		 ...
		 public static readonly Setting<string> PropertyLevelAuthorizationPermissions = setting( "dbms.security.property_level.blacklist", STRING, NO_DEFAULT );
	}
