...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldMakeNiceDescriptionWithMode()
		 {
			  ...
			  EnterpriseSecurityContext modified = Context().withMode(Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.CredentialsExpired);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldMakeNiceDescriptionRestricted()
		 {
			  ...
			  EnterpriseSecurityContext restricted = context.WithMode( new RestrictedAccessMode( context.Mode(), Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Read ) );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldMakeNiceDescriptionOverridden()
		 {
			  ...
			  EnterpriseSecurityContext context = context();
			  EnterpriseSecurityContext overridden = context.WithMode( new OverriddenAccessMode( context.Mode(), Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Read ) );
...
//ORIGINAL LINE: @Test public void shouldMakeNiceDescriptionAuthDisabledAndRestricted()
		 ...
		 {
			  EnterpriseSecurityContext disabled = EnterpriseSecurityContext.AUTH_DISABLED;
			  EnterpriseSecurityContext restricted = disabled.WithMode( new RestrictedAccessMode( disabled.Mode(), Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Read ) );
