...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void SetUp()
		 {
			  ...
			  EnterpriseSecurityContext adminContext = new EnterpriseSecurityContext( new MockAuthSubject( "admin" ), Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.Full, Collections.emptySet(), true );
			  _matsContext = new EnterpriseSecurityContext( new MockAuthSubject( "mats" ), Org.Neo4j.@internal.Kernel.Api.security.AccessMode_Static.None, Collections.emptySet(), false );
