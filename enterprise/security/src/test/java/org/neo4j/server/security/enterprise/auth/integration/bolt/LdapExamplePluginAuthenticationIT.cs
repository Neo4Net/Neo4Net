...
namespace Org.Neo4j.Server.security.enterprise.auth.integration.bolt
{
	...
	using LdapGroupHasUsersAuthPlugin = Org.Neo4j.Server.security.enterprise.auth.plugin.LdapGroupHasUsersAuthPlugin;
