...
namespace Org.Neo4j.Server.security.enterprise.auth
{
	...
	using TransactionGuardException = Org.Neo4j.Graphdb.TransactionGuardException;
...
//ORIGINAL LINE: @Context public org.neo4j.procedure.TerminationGuard guard;
			  ...
			  [Procedure(name : "test.staticReadProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
			  ...
			  [Procedure(name : "test.staticWriteProcedure", mode : Org.Neo4j.Procedure.Mode.WRITE)]
			  public virtual Stream<AuthProceduresBase.StringResult> StaticWriteProcedure()
			  {
					return Stream.of( new AuthProceduresBase.StringResult( "static" ) );
			  }

			  [Procedure(name : "test.staticSchemaProcedure", mode : Org.Neo4j.Procedure.Mode.SCHEMA)]
			  public virtual Stream<AuthProceduresBase.StringResult> StaticSchemaProcedure()
			  {
					return Stream.of( new AuthProceduresBase.StringResult( "static" ) );
			  }

			  [Procedure(name : "test.allowedReadProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
			  ...
			  [Procedure(name : "test.otherAllowedReadProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
			  ...
			  [Procedure(name : "test.allowedWriteProcedure", mode : Org.Neo4j.Procedure.Mode.WRITE)]
			  ...
			  [Procedure(name : "test.allowedSchemaProcedure", mode : Org.Neo4j.Procedure.Mode.SCHEMA)]
...
//ORIGINAL LINE: @Procedure(name = "test.nestedAllowedProcedure", mode = org.neo4j.procedure.Mode.READ) public java.util.stream.Stream<AuthProceduresBase.StringResult> nestedAllowedProcedure(@Name("nestedProcedure") String nestedProcedure)
			  [Procedure(name : "test.nestedAllowedProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
			  ...
			  [Procedure(name : "test.doubleNestedAllowedProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
			  ...
			  [Procedure(name : "test.failingNestedAllowedWriteProcedure", mode : Org.Neo4j.Procedure.Mode.WRITE)]
...
//ORIGINAL LINE: @Procedure(name = "test.nestedReadProcedure", mode = org.neo4j.procedure.Mode.READ) public java.util.stream.Stream<AuthProceduresBase.StringResult> nestedReadProcedure(@Name("nestedProcedure") String nestedProcedure)
			  [Procedure(name : "test.nestedReadProcedure", mode : Org.Neo4j.Procedure.Mode.READ)]
