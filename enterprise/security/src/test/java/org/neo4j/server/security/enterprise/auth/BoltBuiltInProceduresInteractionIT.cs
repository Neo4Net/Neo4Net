...
namespace Org.Neo4j.Server.security.enterprise.auth
{
	...
	public class BoltBuiltInProceduresInteractionIT : BuiltInProceduresInteractionTestBase<BoltInteraction.BoltSubject>
	{

		 public BoltBuiltInProceduresInteractionIT() : base()
		 {
			  IS_EMBEDDED = false;
		 }
