...
namespace Org.Neo4j.Kernel.impl.query
{
	...
	using PageCursorCounters = Org.Neo4j.Io.pagecache.tracing.cursor.PageCursorCounters;
	using CompilerInfo = Org.Neo4j.Kernel.api.query.CompilerInfo;
	using ExecutingQuery = Org.Neo4j.Kernel.api.query.ExecutingQuery;
	using Config = Org.Neo4j.Kernel.configuration.Config;
	using BoltConnectionInfo = Org.Neo4j.Kernel.impl.query.clientconnection.BoltConnectionInfo;
	...
	using FakeHeapAllocation = Org.Neo4j.Test.FakeHeapAllocation;
...
//ORIGINAL LINE: @Rule public final org.neo4j.test.FakeCpuClock cpuClock = new org.neo4j.test.FakeCpuClock();
		 public readonly FakeCpuClock CpuClock = new FakeCpuClock();
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Rule public final org.neo4j.test.FakeHeapAllocation heapAllocation = new org.neo4j.test.FakeHeapAllocation();
