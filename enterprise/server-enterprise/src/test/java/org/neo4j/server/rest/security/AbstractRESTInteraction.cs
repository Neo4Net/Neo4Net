...
namespace Org.Neo4j.Server.rest.security
{
	...
	using EnterpriseAuthAndUserManager = Org.Neo4j.Server.security.enterprise.auth.EnterpriseAuthAndUserManager;
	using EnterpriseUserManager = Org.Neo4j.Server.security.enterprise.auth.EnterpriseUserManager;
