...
namespace Org.Neo4j.Server.rest.security
{
	...
	using UserServiceTest = Org.Neo4j.Server.rest.dbms.UserServiceTest;
	using AuthenticationStrategy = Org.Neo4j.Server.Security.Auth.AuthenticationStrategy;
	using MultiRealmAuthManagerRule = Org.Neo4j.Server.security.enterprise.auth.MultiRealmAuthManagerRule;
	using ShiroSubject = Org.Neo4j.Server.security.enterprise.auth.ShiroSubject;
