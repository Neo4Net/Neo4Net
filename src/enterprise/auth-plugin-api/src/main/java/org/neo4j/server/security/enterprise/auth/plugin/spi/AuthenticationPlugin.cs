...
//ORIGINAL LINE: AuthenticationInfo authenticate(Neo4Net.server.security.enterprise.auth.plugin.api.AuthToken authToken) throws Neo4Net.server.security.enterprise.auth.plugin.api.AuthenticationException;
