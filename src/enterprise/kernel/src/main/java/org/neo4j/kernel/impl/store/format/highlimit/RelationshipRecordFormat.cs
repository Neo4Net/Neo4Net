...
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.Reference.toRelative;
	...
	/// => 28B
	/// </summary>
	internal class RelationshipRecordFormat : BaseHighLimitRecordFormat<RelationshipRecord>
	{
		 ...
		 internal RelationshipRecordFormat() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipRecordFormat( int recordSize ) : base( fixedRecordSize( recordSize ), 0, HighLimitFormatSettings.RELATIONSHIP_MAXIMUM_ID_BITS )
		 {
		 }
