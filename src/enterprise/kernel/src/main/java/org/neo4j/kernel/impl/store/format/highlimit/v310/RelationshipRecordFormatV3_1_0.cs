...
//	import static org.neo4j.kernel.impl.store.format.highlimit.Reference.toRelative;
	...
	/// => 28B
	/// </summary>
	internal class RelationshipRecordFormatV3_1_0 : BaseHighLimitRecordFormatV3_1_0<RelationshipRecord>
	{
		 ...
		 internal RelationshipRecordFormatV3_1_0() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipRecordFormatV3_1_0( int recordSize ) : base( fixedRecordSize( recordSize ), 0 )
		 {
		 }
