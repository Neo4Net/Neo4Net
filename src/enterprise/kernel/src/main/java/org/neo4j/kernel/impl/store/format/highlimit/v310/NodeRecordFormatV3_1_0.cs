...
namespace Neo4Net.Kernel.impl.store.format.highlimit.v310
{
	...
	/// => 15B
	/// </summary>
	internal class NodeRecordFormatV3_1_0 : BaseHighLimitRecordFormatV3_1_0<NodeRecord>
	{
		 ...
		 internal NodeRecordFormatV3_1_0() : this(RECORD_SIZE)
		 {
		 }

		 internal NodeRecordFormatV3_1_0( int recordSize ) : base( fixedRecordSize( recordSize ), 0 )
		 {
		 }
