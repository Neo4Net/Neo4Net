...
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.BaseHighLimitRecordFormat.HEADER_BIT_FIXED_REFERENCE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.BaseHighLimitRecordFormat.HEADER_BYTE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.Reference.toRelative;
	...
	/// 
	/// </pre>
	/// Unlike other high limit records <seealso cref="BaseHighLimitRecordFormat"/> fixed reference marker in property record
	/// format header is not inverted: 1 - fixed reference format used; 0 - variable length format used.
	/// </summary>
	internal class PropertyRecordFormat : BaseOneByteHeaderRecordFormat<PropertyRecord>
	{
		 ...
		 protected internal PropertyRecordFormat() : base(fixedRecordSize(RECORD_SIZE), 0, IN_USE_BIT, HighLimitFormatSettings.PROPERTY_MAXIMUM_ID_BITS)
		 {
		 }
