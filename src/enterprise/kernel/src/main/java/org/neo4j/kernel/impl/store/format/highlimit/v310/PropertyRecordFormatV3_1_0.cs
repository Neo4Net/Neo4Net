 ...
 */
namespace Neo4Net.Kernel.impl.store.format.highlimit.v310
{
...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.v310.BaseHighLimitRecordFormatV3_1_0.HEADER_BIT_FIXED_REFERENCE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.v310.BaseHighLimitRecordFormatV3_1_0.HEADER_BYTE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.Neo4Net.kernel.impl.store.format.highlimit.v310.BaseHighLimitRecordFormatV3_1_0.NULL;
	...
	/// 
	/// </pre>
	/// Unlike other high limit records <seealso cref="BaseHighLimitRecordFormatV3_1_0"/> fixed reference marker in property record
	/// format header is not inverted: 1 - fixed reference format used; 0 - variable length format used.
	/// </summary>
	internal class PropertyRecordFormatV3_1_0 : BaseOneByteHeaderRecordFormat<PropertyRecord>
	{
		 ...
		 protected internal PropertyRecordFormatV3_1_0() : base(fixedRecordSize(RECORD_SIZE), 0, IN_USE_BIT, HighLimitV3_1_0.DEFAULT_MAXIMUM_BITS_PER_ID)
		 {
		 }
