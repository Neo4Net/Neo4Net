...
namespace Neo4Net.Server.security.enterprise.auth
{
	...
	public class BoltConfiguredAuthScenariosInteractionIT : ConfiguredAuthScenariosInteractionTestBase<BoltInteraction.BoltSubject>
	{
		 public BoltConfiguredAuthScenariosInteractionIT() : base()
		 {
			  IS_EMBEDDED = false;
		 }
