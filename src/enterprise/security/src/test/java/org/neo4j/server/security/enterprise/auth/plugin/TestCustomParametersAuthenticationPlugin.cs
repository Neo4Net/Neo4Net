...
namespace Neo4Net.Server.security.enterprise.auth.plugin
{
	...
	public class TestCustomParametersAuthenticationPlugin : Neo4Net.Server.security.enterprise.auth.plugin.spi.AuthenticationPlugin_Adapter
	{
...
//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the java.util.Collection 'containsAll' method:
			  ...
			  {
					return ( AuthenticationInfo )() => "Neo4Net";
			  }
			  return null;
		 }
	}
