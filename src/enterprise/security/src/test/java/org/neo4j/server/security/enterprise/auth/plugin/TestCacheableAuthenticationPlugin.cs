...
namespace Neo4Net.Server.security.enterprise.auth.plugin
{
	...
	public class TestCacheableAuthenticationPlugin : Neo4Net.Server.security.enterprise.auth.plugin.spi.AuthenticationPlugin_CachingEnabledAdapter
	{
		 ...
		 public override AuthenticationInfo Authenticate( AuthToken authToken )
		 {
			  ...
			  {
					return CacheableAuthenticationInfo.of( "Neo4Net", "Neo4Net".GetBytes() );
			  }
			  return null;
		 }
