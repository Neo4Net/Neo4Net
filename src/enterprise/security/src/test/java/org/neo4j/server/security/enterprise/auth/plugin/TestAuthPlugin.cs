...
namespace Neo4Net.Server.security.enterprise.auth.plugin
{
	...
	public class TestAuthPlugin : Neo4Net.Server.security.enterprise.auth.plugin.spi.AuthPlugin_Adapter
	{
		 ...
		 public override AuthInfo AuthenticateAndAuthorize( AuthToken authToken )
		 {
			  ...
			  {
					return AuthInfo.of( "Neo4Net", Collections.singleton( PredefinedRoles.READER ) );
			  }
			  return null;
		 }
	}
