...
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Configure the Neo4Net Browser to time out logged in users after this idle period. " + "Setting this to 0 indicates no limit.") public static final org.Neo4Net.graphdb.config.Setting<java.time.Duration> browser_credentialTimeout = setting("browser.credential_timeout", DURATION, "0");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Configure the Neo4Net Browser to store or not store user credentials.") public static final org.Neo4Net.graphdb.config.Setting<bool> browser_retainConnectionCredentials = setting("browser.retain_connection_credentials", BOOLEAN, TRUE);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Configure the policy for outgoing Neo4Net Browser connections.") public static final org.Neo4Net.graphdb.config.Setting<bool> browser_allowOutgoingBrowserConnections = setting("browser.allow_outgoing_connections", BOOLEAN, TRUE);
