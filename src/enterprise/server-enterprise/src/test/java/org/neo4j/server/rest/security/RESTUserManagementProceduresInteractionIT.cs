...
//	import static org.Neo4Net.test.rule.SuppressOutput.suppressAll;
	...
	public class RESTUserManagementProceduresInteractionIT : AuthProceduresInteractionTestBase<RESTSubject>
	{
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Rule public org.Neo4Net.test.rule.SuppressOutput suppressOutput = suppressAll();
		 public SuppressOutput SuppressOutput = suppressAll();

		 public RESTUserManagementProceduresInteractionIT() : base()
		 {
