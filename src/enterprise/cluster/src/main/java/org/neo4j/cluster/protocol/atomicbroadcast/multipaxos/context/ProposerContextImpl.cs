...
//	import static Neo4Net.helpers.collection.Iterables.limit;
	...
	internal class ProposerContextImpl : AbstractContextImpl, ProposerContext
	{
		 ...
		 internal ProposerContextImpl( Neo4Net.cluster.InstanceId me, CommonContextState commonState, LogProvider logging, Timeouts timeouts, PaxosInstanceStore paxosInstances, HeartbeatContext heartbeatContext ) : base( me, commonState, logging, timeouts )
		 {
