...
namespace Neo4Net.cluster.protocol.atomicbroadcast.multipaxos
{
	...
	/// <summary>
	/// Context used by <seealso cref="ProposerState"/> state machine.
	/// </summary>
	public interface ProposerContext : TimeoutsContext, LoggingContext, ConfigurationContext
	{
		 ...
		 int GetMinimumQuorumSize( IList<URI> acceptors );
