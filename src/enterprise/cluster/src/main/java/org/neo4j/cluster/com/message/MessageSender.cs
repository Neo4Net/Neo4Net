...
namespace Neo4Net.cluster.com.message
{
	...
	/// </summary>
	public interface MessageSender : MessageProcessor
	{
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: void process(java.util.List<Message<? extends MessageType>> message);
		 void process<T1>( IList<T1> message );
	}
