...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
		 ...
		 internal class ProverTimeout : Timeout
		 {
			 private readonly ProverTimeouts _outerInstance;
			  ...
			  internal ProverTimeout<T1>( ProverTimeouts outerInstance, long timeout, Message<T1> timeoutMessage ) where T1 : Neo4Net.cluster.com.message.MessageType : base( outerInstance, timeout, timeoutMessage )
			  {
