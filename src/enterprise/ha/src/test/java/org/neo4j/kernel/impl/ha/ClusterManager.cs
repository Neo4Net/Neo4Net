...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.io.fs.FileUtils.copyRecursively;
...
//ORIGINAL LINE: void initializeStoreDir(int serverId, java.io.File storeDir) throws java.io.IOException;
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.kernel.ha.HighlyAvailableGraphDatabase repair() throws Throwable;
...
//ORIGINAL LINE: public static System.Predicate<ManagedCluster> masterSeesSlavesAsAvailable(final int count)
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static System.Predicate<ManagedCluster> masterAvailable(final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase... except)
		 public static System.Predicate<ManagedCluster> MasterAvailable( params HighlyAvailableGraphDatabase[] except )
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.Collection<Neo4Net.kernel.ha.HighlyAvailableGraphDatabase> excludedNodes = asList(except);
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static System.Predicate<ClusterManager.ManagedCluster> instanceEvicted(final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase instance)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static System.Predicate<ManagedCluster> memberSeesOtherMemberAsFailed(final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase observer, final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase observed)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static System.Predicate<ManagedCluster> entireClusterSeesMemberAsNotAvailable(final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase observed)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static System.Predicate<ManagedCluster> memberThinksItIsRole(final Neo4Net.kernel.ha.HighlyAvailableGraphDatabase member, final String role)
...
//ORIGINAL LINE: SELF withInstanceSetting(Neo4Net.graphdb.config.Setting<?> setting, System.Func<int, String> valueFunction);
			  ...
			  /// </summary>
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: SELF withSharedSetting(Neo4Net.graphdb.config.Setting<?> setting, String value);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: ManagedCluster(Neo4Net.cluster.client.Cluster spec) throws java.net.URISyntaxException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void consistencyCheck(Neo4Net.io.layout.DatabaseLayout databaseLayout) throws Throwable
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.kernel.ha.HighlyAvailableGraphDatabase startMemberNow(Neo4Net.cluster.InstanceId serverId) throws java.io.IOException, java.net.URISyntaxException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private java.net.URI clusterUri(Neo4Net.cluster.client.Cluster.Member member) throws java.net.URISyntaxException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void startMember(Neo4Net.cluster.InstanceId serverId) throws java.net.URISyntaxException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.kernel.ha.HighlyAvailableGraphDatabase repair() throws Throwable
			  public override HighlyAvailableGraphDatabase Repair()
			  {
