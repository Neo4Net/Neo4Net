...
//	import static Neo4Net.Kernel.Api.StorageEngine.StoreId.DEFAULT;
	...
	public class SlaveLocksClientTest
	{
		 ...
		 private Neo4Net.Kernel.impl.locking.Locks_Client _local;
...
//ORIGINAL LINE: @Before public void setUp()
		 public virtual void SetUp()
		 {
			  ...
			  TransactionStreamResponse<LockResult> responseOk = new TransactionStreamResponse<LockResult>( lockResultOk, null, Neo4Net.com.TransactionStream_Fields.Empty, Neo4Net.com.ResourceReleaser_Fields.NoOp );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  when( _master.newLockSession( Null ) ).thenThrow( new TransactionFailureException( Neo4Net.Kernel.Api.Exceptions.Status_General.DatabaseUnavailable, "Not now" ) );
