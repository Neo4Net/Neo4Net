...
//ORIGINAL LINE: public <T> T makeBlockingRequest(org.neo4j.helpers.AdvertisedSocketAddress upstream, org.neo4j.causalclustering.messaging.CatchUpRequest request, CatchUpResponseCallback<T> responseHandler) throws CatchUpClientException
