...
namespace Neo4Net.causalclustering.catchup.storecopy
{
	...
	public class GetStoreIdResponseHandler : SimpleChannelInboundHandler<GetStoreIdResponse>
	{
...
//ORIGINAL LINE: protected void channelRead0(io.netty.channel.ChannelHandlerContext ctx, final GetStoreIdResponse msg)
		 protected internal override void ChannelRead0( ChannelHandlerContext ctx, GetStoreIdResponse msg )
		 {
			  _handler.onGetStoreIdResponse( msg );
