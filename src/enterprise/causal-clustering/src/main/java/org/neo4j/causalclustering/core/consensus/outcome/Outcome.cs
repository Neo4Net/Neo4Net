...
namespace Neo4Net.causalclustering.core.consensus.outcome
{
	...
	public class Outcome : Message, ConsensusOutcome
	{
		 ...
		 private ICollection<Neo4Net.causalclustering.core.consensus.RaftMessages_Directed> _outgoingMessages = new List<Neo4Net.causalclustering.core.consensus.RaftMessages_Directed>();
		 ...
		 public virtual void AddOutgoingMessage( Neo4Net.causalclustering.core.consensus.RaftMessages_Directed message )
		 {
		 ...
		 public virtual ICollection<Neo4Net.causalclustering.core.consensus.RaftMessages_Directed> OutgoingMessages
		 {
			 get
			 {
