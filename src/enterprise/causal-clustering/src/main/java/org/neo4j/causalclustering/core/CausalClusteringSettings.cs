...
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.GZIP;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.LZ4;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.LZ4_HIGH_COMPRESSION;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.LZ4_HIGH_COMPRESSION_VALIDATING;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.LZ_VALIDATING;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.SNAPPY;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.causalclustering.protocol.Protocol_ModifierProtocols.Implementations.SNAPPY_VALIDATING;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.graphdb.factory.GraphDatabaseSettings.logs_directory;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.ADVERTISED_SOCKET_ADDRESS;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.prefixSetting;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: @Internal @Description("Configures the time after which we give up trying to bind to a cluster formed of the other initial discovery members.") public static final Neo4Net.graphdb.config.Setting<java.time.Duration> cluster_binding_timeout = setting("causal_clustering.cluster_binding_timeout", DURATION, "5m");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Maximum number of entries in the RAFT in-queue") public static final Neo4Net.graphdb.config.Setting<int> raft_in_queue_size = setting("causal_clustering.raft_in_queue_size", INTEGER, "1024");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Largest batch processed by RAFT in number of entries") public static final Neo4Net.graphdb.config.Setting<int> raft_in_queue_max_batch = setting("causal_clustering.raft_in_queue_max_batch", INTEGER, "128");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("The polling interval when attempting to resolve initial_discovery_members from DNS and SRV records.") public static final Neo4Net.graphdb.config.Setting<java.time.Duration> discovery_resolution_retry_interval = setting("causal_clustering.discovery_resolution_retry_interval", DURATION, "5s");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Configures the time after which we give up trying to resolve a DNS/SRV record into a list of initial discovery members.") public static final Neo4Net.graphdb.config.Setting<java.time.Duration> discovery_resolution_timeout = setting("causal_clustering.discovery_resolution_timeout", DURATION, "5m");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Select the middleware used for cluster topology discovery") public static final Neo4Net.graphdb.config.Setting<Neo4Net.causalclustering.discovery.DiscoveryServiceFactorySelector.DiscoveryImplementation> discovery_implementation = setting("causal_clustering.discovery_implementation", optionsIgnoreCase(Neo4Net.causalclustering.discovery.DiscoveryServiceFactorySelector.DiscoveryImplementation.class), Neo4Net.causalclustering.discovery.DiscoveryServiceFactorySelector.DEFAULT.name());
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Hazelcast license key") public static final Neo4Net.graphdb.config.Setting<String> hazelcast_license_key = setting("hazelcast.license_key", STRING, NO_DEFAULT);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Parallelism level of default dispatcher used by Akka based cluster topology discovery, including cluster, replicator, and discovery actors") public static final Neo4Net.graphdb.config.Setting<int> middleware_akka_default_parallelism_level = setting("causal_clustering.middleware.akka.default-parallelism", INTEGER, System.Convert.ToString(4));
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Parallelism level of dispatcher used for communication from Akka based cluster topology discovery ") public static final Neo4Net.graphdb.config.Setting<int> middleware_akka_sink_parallelism_level = setting("causal_clustering.middleware.akka.sink-parallelism", INTEGER, System.Convert.ToString(2));
		  ...
		  */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Akka cluster phi accrual failure detector. " + "How often keep-alive heartbeat messages should be sent to each connection.") public static final Neo4Net.graphdb.config.Setting<java.time.Duration> akka_failure_detector_heartbeat_interval = setting("causal_clustering.middleware.akka.failure_detector.heartbeat_interval", DURATION, "1s");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Akka cluster phi accrual failure detector. " + "Number of the samples of inter-heartbeat arrival times to adaptively " + "calculate the failure timeout for connections.") public static final Neo4Net.graphdb.config.Setting<int> akka_failure_detector_max_sample_size = setting("causal_clustering.middleware.akka.failure_detector.max_sample_size", INTEGER, "1000");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Akka cluster phi accrual failure detector. " + "Number of potentially lost/delayed heartbeats that will be " + "accepted before considering it to be an anomaly. " + "This margin is important to be able to survive sudden, occasional, " + "pauses in heartbeat arrivals, due to for example garbage collect or network drop.") public static final Neo4Net.graphdb.config.Setting<java.time.Duration> akka_failure_detector_acceptable_heartbeat_pause = setting("causal_clustering.middleware.akka.failure_detector.acceptable_heartbeat_pause", DURATION, "4s");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal @Description("Akka cluster phi accrual failure detector. " + "Number of member nodes that each member will send heartbeat messages to, " + "i.e. each node will be monitored by this number of other nodes.") public static final Neo4Net.graphdb.config.Setting<int> akka_failure_detector_monitored_by_nr_of_members = setting("causal_clustering.middleware.akka.failure_detector.monitored_by_nr_of_members", INTEGER, "5");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Enable or disable the dump of all network messages pertaining to the RAFT protocol") @Internal public static final Neo4Net.graphdb.config.Setting<bool> raft_messages_log_enable = setting("causal_clustering.raft_messages_log_enable", BOOLEAN, FALSE);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Path to RAFT messages log.") @Internal public static final Neo4Net.graphdb.config.Setting<java.io.File> raft_messages_log_path = derivedSetting("causal_clustering.raft_messages_log_path", logs_directory, logs -> new java.io.File(logs, "raft-messages.log"), PATH);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Maximum backoff timeout for store copy requests") @Internal public static final Neo4Net.graphdb.config.Setting<java.time.Duration> store_copy_backoff_max_wait = setting("causal_clustering.store_copy_backoff_max_wait", DURATION, "5s");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Maximum transaction batch size for read replicas when applying transactions pulled from core " + "servers.") @Internal public static final Neo4Net.graphdb.config.Setting<int> read_replica_transaction_applier_batch_size = setting("causal_clustering.read_replica_transaction_applier_batch_size", INTEGER, "64");
