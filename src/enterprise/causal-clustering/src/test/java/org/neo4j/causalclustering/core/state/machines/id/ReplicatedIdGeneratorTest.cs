...
namespace Neo4Net.causalclustering.core.state.machines.id
{
	...
	using IdGeneratorContractTest = Neo4Net.Kernel.impl.store.IdGeneratorContractTest;
...
//ORIGINAL LINE: @Rule public org.Neo4Net.test.rule.fs.FileSystemRule fileSystemRule = new org.Neo4Net.test.rule.fs.DefaultFileSystemRule();
