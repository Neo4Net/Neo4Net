...
//ORIGINAL LINE: void start(final ApplicationProtocolRepository applicationProtocolRepository, final ModifierProtocolRepository modifierProtocolRepository)
			  ...
			  private class ChannelInitializerAnonymousInnerClass : ChannelInitializer<SocketChannel>
			  {
				  ...
				  private Neo4Net.causalclustering.protocol.handshake.ApplicationProtocolRepository _applicationProtocolRepository;
				  private Neo4Net.causalclustering.protocol.handshake.ModifierProtocolRepository _modifierProtocolRepository;

				  public ChannelInitializerAnonymousInnerClass( Server outerInstance, Neo4Net.causalclustering.protocol.handshake.ApplicationProtocolRepository applicationProtocolRepository, Neo4Net.causalclustering.protocol.handshake.ModifierProtocolRepository modifierProtocolRepository )
				  {
