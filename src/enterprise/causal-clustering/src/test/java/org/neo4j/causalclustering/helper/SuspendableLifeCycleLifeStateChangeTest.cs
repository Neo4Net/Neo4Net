...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(2) public Neo4Net.causalclustering.helper.SuspendableLifecycleStateTestHelpers.LifeCycleState toLifeCycleState;
		 public LifeCycleState ToLifeCycleState;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(3) public Neo4Net.causalclustering.helper.SuspendableLifecycleStateTestHelpers.LifeCycleState shouldBeRunning;
