...
//ORIGINAL LINE: @Test public void testOnByDefault()
		 public virtual void TestOnByDefault()
		 {
			  ...
			  IGraphDatabaseService db = ( new TestGraphDatabaseFactory() ).newEmbeddedDatabaseBuilder(_storeDir).setConfig(OnlineBackupSettings.online_backup_server, "localhost:" + port).newGraphDatabase();
...
//ORIGINAL LINE: @Test public void testOffByConfig()
		 public virtual void TestOffByConfig()
		 {
			  ...
			  IGraphDatabaseService db = ( new TestGraphDatabaseFactory() ).newEmbeddedDatabaseBuilder(_storeDir).setConfig(OnlineBackupSettings.online_backup_enabled, Settings.FALSE).setConfig(OnlineBackupSettings.online_backup_server, "localhost:" + port).newGraphDatabase();
			  try
			  {
					OnlineBackup.From( HOST_ADDRESS, port ).full( _backupDir );
...
//ORIGINAL LINE: @Test public void testEnableDefaultsInConfig()
		 public virtual void TestEnableDefaultsInConfig()
		 {
			  ...
			  IGraphDatabaseService db = ( new TestGraphDatabaseFactory() ).newEmbeddedDatabaseBuilder(_storeDir).setConfig(OnlineBackupSettings.online_backup_enabled, Settings.TRUE).setConfig(OnlineBackupSettings.online_backup_server, "localhost:" + port).newGraphDatabase();
...
//ORIGINAL LINE: @Test public void testEnableCustomPortInConfig()
		 public virtual void TestEnableCustomPortInConfig()
		 {
			  ...
			  IGraphDatabaseService db = ( new TestGraphDatabaseFactory() ).newEmbeddedDatabaseBuilder(_storeDir).setConfig(OnlineBackupSettings.online_backup_enabled, Settings.TRUE).setConfig(OnlineBackupSettings.online_backup_server, ":" + customPort).newGraphDatabase();
			  try
			  {
