...
//ORIGINAL LINE: @Test void shouldCountUnique()
		 ...
		 {
			  return new BaseMatcherAnonymousInnerClass( this, left, right );
		 }

		 private class BaseMatcherAnonymousInnerClass : BaseMatcher<long>
		 {
			 private readonly PrimitiveArraysTest _outerInstance;

			 private int _left;
			 private int _right;

			 public BaseMatcherAnonymousInnerClass( PrimitiveArraysTest outerInstance, int left, int right )
			 {
