...
{
	public interface PrimitiveLongVisitor<E> where E : Exception
	{
		 /// <summary>
		 /// Visit the given entry.
		 /// </summary>
		 /// <param name="value"> A distinct value from the set. </param>
...
//ORIGINAL LINE: boolean visited(long value) throws E;
		 bool Visited( long value );
	}

	public static class PrimitiveLongVisitor_Fields
	{
		 public static readonly PrimitiveLongVisitor<Exception> Empty = value => false;
	}
