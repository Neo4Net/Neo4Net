...
namespace Neo4Net.Server.rest.web
{
	...
	using BatchOperations = Neo4Net.Server.rest.batch.BatchOperations;
	using StreamingBatchOperationResults = Neo4Net.Server.rest.batch.StreamingBatchOperationResults;
