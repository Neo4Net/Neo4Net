...
/// <seealso cref="org.neo4j.io.pagecache.PageCache.map(java.io.File, int, java.nio.file.OpenOption...) map"/> method gives you a
/// <seealso cref="org.neo4j.io.pagecache.PagedFile"/> object, through which the contents of the file can be accessed. Once a file
...
/// <seealso cref="org.neo4j.io.pagecache.PageSwapper"/>. The {@code Page}s themselves only contain a pointer to their respective
...
/// instantiated for the given file by the <seealso cref="org.neo4j.io.pagecache.PageSwapperFactory"/>.
/// </para>
/// <para>
/// Once a file has been mapped, and a {@code PagedFile} object made available, the
/// <seealso cref="org.neo4j.io.pagecache.PagedFile.io(long, int) io method"/> can be used to interact with the contents of the
/// file. It takes in an initial file page id and a bitmap of intentions, such as what locking behaviour to use, and
/// returns a <seealso cref="org.neo4j.io.pagecache.PageCursor"/> object. The {@code PageCursor} is the window into the data
/// managed by the page cache.
/// </para>
/// <para>
/// Initially, the {@code PageCursor} is not bound to any page. Calling the
/// <seealso cref="org.neo4j.io.pagecache.PageCursor.next()"/> method on the cursor will advance it to its next page. The first
...
/// usually the case, but when <seealso cref="org.neo4j.io.pagecache.PagedFile.PF_SHARED_READ_LOCK"/> or
/// <seealso cref="org.neo4j.io.pagecache.PagedFile.PF_NO_GROW"/> is specified, the {@code next} method will return {@code false}
...
/// <seealso cref="org.neo4j.io.pagecache.PageCursor.shouldRetry()"/> method must be consulted, and the IO must be redone on the
