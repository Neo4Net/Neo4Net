...
//JAVA TO C# CONVERTER TODO TASK: There is no .NET Dictionary equivalent to the Java 'putAll' method:
	...
	//<<<<<<< HEAD
		 ...
		 private void SetPrimitiveProperty<T1>( RecordAccess_RecordProxy<T1> primitiveRecord, string propertyName, object propertyValue ) where T1 : Neo4Net.Kernel.impl.store.record.PrimitiveRecord
		 {
			  int propertyKey = GetOrCreatePropertyKeyId( propertyName );
