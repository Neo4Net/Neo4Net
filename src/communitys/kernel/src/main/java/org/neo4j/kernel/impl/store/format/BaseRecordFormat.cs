...
namespace Neo4Net.Kernel.impl.store.format
{
	...
	public abstract class BaseRecordFormat<RECORD> : RecordFormat<RECORD> where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	{
		public abstract void Write( RECORD record, PageCursor cursor, int recordSize );
		public abstract void Read( RECORD record, PageCursor cursor, Neo4Net.Kernel.impl.store.record.RecordLoad mode, int recordSize );
