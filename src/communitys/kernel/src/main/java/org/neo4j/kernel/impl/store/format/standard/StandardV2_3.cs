...
namespace Neo4Net.Kernel.impl.store.format.standard
{
	...
	public class StandardV2_3 : BaseRecordFormats
	{
		 public static readonly string StoreVersion = StoreVersion.STANDARD_V2_3.versionString();
		 public static readonly RecordFormats RecordFormats = new StandardV2_3();
		 public const string NAME = "standardV2_3_0";

		 public StandardV2_3() : base(StoreVersion, StoreVersion.STANDARD_V2_3.introductionVersion(), 5, Capability.SCHEMA, Capability.DENSE_NODES, Capability.LUCENE_3)
		 {
		 }
