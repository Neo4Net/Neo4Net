...
namespace Neo4Net.Kernel.impl.store.format.standard
{
	...
	public class StandardV3_0 : BaseRecordFormats
	{
		 public static readonly string StoreVersion = StoreVersion.STANDARD_V3_0.versionString();
		 public static readonly RecordFormats RecordFormats = new StandardV3_0();
		 public const string NAME = "standardV3_0_0";

		 public StandardV3_0() : base(StoreVersion, StoreVersion.STANDARD_V3_0.introductionVersion(), 6, Capability.SCHEMA, Capability.DENSE_NODES, Capability.LUCENE_5)
		 {
		 }
