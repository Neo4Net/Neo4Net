...
//	import static org.mockito.Mockito.when;
	...
	public class RelationshipCountsProcessorTest
	{
		 ...
		 private readonly Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater _countsUpdater = mock( typeof( Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater ) );
...
//ORIGINAL LINE: @Test public void testRelationshipCountersUpdates()
		 public virtual void TestRelationshipCountersUpdates()
		 {
			  ...
			  RelationshipCountsProcessor countsProcessor = new RelationshipCountsProcessor( _nodeLabelCache, labels, relationTypes, _countsUpdater, Neo4Net.@unsafe.Impl.Batchimport.cache.NumberArrayFactory_Fields.AutoWithoutPagecache );
