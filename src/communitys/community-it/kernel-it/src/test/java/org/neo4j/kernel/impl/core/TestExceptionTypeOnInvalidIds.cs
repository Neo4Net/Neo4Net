...
//	import static org.neo4j.kernel.configuration.Settings.TRUE;
	...
	public class TestExceptionTypeOnInvalidIds
	{
		 ...
		 private static GraphDatabaseService _graphDbReadOnly;
...
//ORIGINAL LINE: @After public void endTransaction()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeBySmallPositiveInteger()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeBySmallNegativeInteger()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeByBigPositiveInteger()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeByBigNegativeInteger()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeBySmallPositiveLong()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeBySmallNegativeLong()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeByBigPositiveLong()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getNodeByBigNegativeLong()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipBySmallPositiveInteger()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipBySmallNegativeInteger()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipByBigPositiveInteger()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipByBigNegativeInteger()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipBySmallPositiveLong()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipBySmallNegativeLong()
		 ...
		 /* throws IllegalArgumentException instead of NotFoundException */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipByBigPositiveLong()
		 ...
		 /* behaves as expected */
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(expected = org.neo4j.graphdb.NotFoundException.class) public void getRelationshipByBigNegativeLong()
