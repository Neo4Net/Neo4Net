...
{
	internal class SimpleCleanupMonitor : GBPTree.Monitor_Adaptor
	{
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 internal bool CleanupFinishedConflict;
		 internal long NumberOfPagesVisited;
		 internal long NumberOfCleanedCrashPointers;

		 public override void CleanupFinished( long numberOfPagesVisited, long numberOfCleanedCrashPointers, long durationMillis )
		 {
			  CleanupFinishedConflict = true;
