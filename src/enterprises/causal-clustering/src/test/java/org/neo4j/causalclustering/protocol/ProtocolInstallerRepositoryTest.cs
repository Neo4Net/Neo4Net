...
//	import static org.junit.Assert.assertThat;
	...
	public class ProtocolInstallerRepositoryTest
	{
		...
		{
			_clientModifiers = new IList<ModifierProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>>
			{
			...
			_serverModifiers = new IList<ModifierProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server>>
			{
			...
			_clientRepository = new ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>( asList( _raftProtocolClientInstaller ), _clientModifiers );
			_serverRepository = new ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server>( asList( _raftProtocolServerInstaller ), _serverModifiers );
		}

		 private IList<ModifierProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>> _clientModifiers;
		 private IList<ModifierProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server>> _serverModifiers;
		 ...
		 private ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client> _clientRepository;
		 private ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server> _serverRepository;
