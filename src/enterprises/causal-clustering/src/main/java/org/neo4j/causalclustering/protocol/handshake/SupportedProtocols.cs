...
namespace Neo4Net.causalclustering.protocol.handshake
{
	...
	public abstract class SupportedProtocols<U, T> where U : IComparable<U> where T : Neo4Net.causalclustering.protocol.Protocol<U>
	{
		 private readonly Neo4Net.causalclustering.protocol.Protocol_Category<T> _category;
		 ...
		 internal SupportedProtocols( Neo4Net.causalclustering.protocol.Protocol_Category<T> category, IList<U> versions )
		 {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java stream collectors are not converted by Java to C# Converter:
		 ...
		 public virtual Neo4Net.causalclustering.protocol.Protocol_Category<T> Identifier()
		 {
			  return _category;
		 }
