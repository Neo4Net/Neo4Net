...
namespace Neo4Net.tools.txlog.checktypes
{
	...
	public abstract class CheckType<C, R> where C : Neo4Net.Kernel.impl.transaction.command.Command where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	{
