...
//ORIGINAL LINE: @Rule public Neo4Net.test.causalclustering.ClusterRule clusterRule = new Neo4Net.test.causalclustering.ClusterRule().withNumberOfReadReplicas(0).withSharedCoreParam(Neo4Net.ext.udc.UdcSettings.udc_enabled, Neo4Net.kernel.configuration.Settings.FALSE).withSharedCoreParam(Neo4Net.graphdb.factory.GraphDatabaseSettings.pagecache_warmup_profiling_interval, "100ms").withSharedCoreParam(Neo4Net.causalclustering.core.CausalClusteringSettings.multi_dc_license, Neo4Net.kernel.configuration.Settings.TRUE).withSharedCoreParam(Neo4Net.causalclustering.core.CausalClusteringSettings.upstream_selection_strategy, Neo4Net.causalclustering.upstream.strategies.LeaderOnlyStrategy.IDENTITY).withInstanceCoreParam(Neo4Net.causalclustering.core.CausalClusteringSettings.refuse_to_be_leader, id -> id == 0 ? "false" : "true").withSharedReadReplicaParam(Neo4Net.ext.udc.UdcSettings.udc_enabled, Neo4Net.kernel.configuration.Settings.FALSE).withSharedReadReplicaParam(Neo4Net.graphdb.factory.GraphDatabaseSettings.pagecache_warmup_profiling_interval, "100ms").withSharedReadReplicaParam(Neo4Net.causalclustering.core.CausalClusteringSettings.multi_dc_license, Neo4Net.kernel.configuration.Settings.TRUE).withSharedReadReplicaParam(Neo4Net.causalclustering.core.CausalClusteringSettings.pull_interval, "100ms").withSharedReadReplicaParam(Neo4Net.causalclustering.core.CausalClusteringSettings.upstream_selection_strategy, Neo4Net.causalclustering.upstream.strategies.LeaderOnlyStrategy.IDENTITY);
