...
namespace Neo4Net.Harness
{
	...
	public class PortAuthorityPortPickingStrategy : CausalClusterInProcessBuilder.PortPickingStrategy
	{
		 internal IDictionary<int, int> Cache = new Dictionary<int, int>();
