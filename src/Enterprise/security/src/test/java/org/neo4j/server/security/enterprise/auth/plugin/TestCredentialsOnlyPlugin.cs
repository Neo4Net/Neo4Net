...
namespace Neo4Net.Server.security.enterprise.auth.plugin
{
	...
	public class TestCredentialsOnlyPlugin : Neo4Net.Server.security.enterprise.auth.plugin.spi.AuthenticationPlugin_Adapter
	{
		 ...
		 [Serializable]
		 internal class AuthenticationInfo : CustomCacheableAuthenticationInfo, Neo4Net.Server.security.enterprise.auth.plugin.spi.CustomCacheableAuthenticationInfo_CredentialsMatcher
		 {
