...
namespace Neo4Net.Server.security.enterprise.auth
{
	...
	public class BoltUserManagementProceduresInteractionIT : AuthProceduresInteractionTestBase<BoltInteraction.BoltSubject>
	{

		 public BoltUserManagementProceduresInteractionIT() : base()
		 {
			  IsEmbedded = false;
		 }
