...
namespace Neo4Net.management
{
	...
	[ManagementInterface(name : PageCache_Fields.NAME), Description("Information about the Neo4j page cache. " + "All numbers are counts and sums since the Neo4j instance was started")]
