...
namespace Neo4Net.Server.rest.dbms
{
	...
	public class EnterpriseAuthorizationDisabledFilter : AuthorizationDisabledFilter
	{
		 protected internal override EnterpriseLoginContext AuthDisabledLoginContext
		 {
			 get
			 {
