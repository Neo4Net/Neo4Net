...
namespace Neo4Net.causalclustering.core.consensus.protocol.v2
{
	...
	using ContentTypeEncoder = Neo4Net.causalclustering.messaging.marshalling.v2.encoding.ContentTypeEncoder;
	using RaftMessageContentEncoder = Neo4Net.causalclustering.messaging.marshalling.v2.encoding.RaftMessageContentEncoder;
	using RaftMessageEncoder = Neo4Net.causalclustering.messaging.marshalling.v2.encoding.RaftMessageEncoder;
	...
	public class RaftProtocolClientInstallerV2 : ProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>
	{
		 ...
		 public class Factory : Neo4Net.causalclustering.protocol.ProtocolInstaller_Factory<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client, RaftProtocolClientInstallerV2>
		 {
		 ...
		 public RaftProtocolClientInstallerV2( NettyPipelineBuilderFactory clientPipelineBuilderFactory, IList<ModifierProtocolInstaller<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>> modifiers, LogProvider logProvider )
		 {
