...
namespace Neo4Net.causalclustering.discovery
{
	...
	public class NoOpHostnameResolver : HostnameResolver
	{
		 ...
		 public override ICollection<AdvertisedSocketAddress> Resolve( AdvertisedSocketAddress advertisedSocketAddresses )
		 {
