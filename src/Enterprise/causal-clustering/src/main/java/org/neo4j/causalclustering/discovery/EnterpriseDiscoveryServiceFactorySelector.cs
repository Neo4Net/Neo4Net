...
{
	public class EnterpriseDiscoveryServiceFactorySelector : DiscoveryServiceFactorySelector<DiscoveryServiceFactory>
	{
		 protected internal override DiscoveryServiceFactory Select( DiscoveryImplementation middleware )
		 {
			  switch ( middleware )
			  {
			  case Neo4Net.causalclustering.discovery.DiscoveryServiceFactorySelector.DiscoveryImplementation.Hazelcast:
				  return new HazelcastDiscoveryServiceFactory();
			  case Neo4Net.causalclustering.discovery.DiscoveryServiceFactorySelector.DiscoveryImplementation.Akka:
