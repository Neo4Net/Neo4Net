...
//ORIGINAL LINE: public ClusterStateDirectory initialize(org.neo4j.io.fs.FileSystemAbstraction fs) throws ClusterStateException
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void migrateIfNeeded(org.neo4j.io.fs.FileSystemAbstraction fs) throws ClusterStateException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void ensureDirectoryExists(org.neo4j.io.fs.FileSystemAbstraction fs) throws ClusterStateException
