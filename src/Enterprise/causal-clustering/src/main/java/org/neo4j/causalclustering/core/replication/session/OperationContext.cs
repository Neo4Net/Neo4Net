...
{
	/// <summary>
	/// Context for operation. Used for acquirement and release. </summary>
	public class OperationContext
	{
		 private readonly GlobalSession _globalSession;
		 private readonly LocalOperationId _localOperationId;
		 ...
		 public virtual LocalOperationId LocalOperationId()
		 {
			  return _localOperationId;
		 }

		 protected internal virtual LocalSession LocalSession()
		 {
		 ...
		 public override string ToString()
		 {
			  return "OperationContext{" +
						...
						", localOperationId=" + _localOperationId +
						'}';
		 }
	}
