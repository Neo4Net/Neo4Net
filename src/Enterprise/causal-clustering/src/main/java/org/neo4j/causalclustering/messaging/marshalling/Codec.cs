...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: ContentBuilder<CONTENT> decode(io.netty.buffer.ByteBuf byteBuf) throws java.io.IOException, org.neo4j.causalclustering.messaging.EndOfStreamException;
