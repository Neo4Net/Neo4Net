...
namespace Neo4Net.causalclustering.protocol.handshake
{
	...
	public interface ServerHandshakeFinishedEvent
	{
	 ...
	 public class ServerHandshakeFinishedEvent_Created
	 {
		  public readonly SocketAddress AdvertisedSocketAddress;
		  public readonly ProtocolStack ProtocolStack;
	 ...
	 public class ServerHandshakeFinishedEvent_Closed
	 {
		  public readonly SocketAddress AdvertisedSocketAddress;
