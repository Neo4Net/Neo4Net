...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  // given
			  Neo4Net.causalclustering.core.consensus.RaftMessages_Heartbeat raftMessage = new Neo4Net.causalclustering.core.consensus.RaftMessages_Heartbeat( new MemberId( System.Guid.randomUUID() ), 1, 2, 3 );
			  Neo4Net.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage<Neo4Net.causalclustering.core.consensus.RaftMessages_Heartbeat> networkMessage = Neo4Net.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage.of( new ClusterId( System.Guid.randomUUID() ), raftMessage );
...
//ORIGINAL LINE: @Before public void setUp()
		 public virtual void SetUp()
		 {
			  ...
			  ApplicationProtocolRepository applicationProtocolRepository = new ApplicationProtocolRepository( Neo4Net.causalclustering.protocol.Protocol_ApplicationProtocols.values(), _parameters.applicationSupportedProtocol );
...
//ORIGINAL LINE: void start(final ApplicationProtocolRepository applicationProtocolRepository, final ModifierProtocolRepository modifierProtocolRepository, org.neo4j.logging.LogProvider logProvider)
			  internal virtual void Start( ApplicationProtocolRepository applicationProtocolRepository, ModifierProtocolRepository modifierProtocolRepository, LogProvider logProvider )
			  {
					...
					ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server> protocolInstallerRepository = new ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Server>( Arrays.asList( raftFactoryV1, raftFactoryV2 ), Neo4Net.causalclustering.protocol.ModifierProtocolInstaller_Fields.AllServerInstallers );
		 ...
		 internal class Client
		 {
			  ...
			  internal Client( ApplicationProtocolRepository applicationProtocolRepository, ModifierProtocolRepository modifierProtocolRepository, NettyPipelineBuilderFactory pipelineBuilderFactory, Config config, LogProvider logProvider )
			  {
					...
					ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client> protocolInstallerRepository = new ProtocolInstallerRepository<Neo4Net.causalclustering.protocol.ProtocolInstaller_Orientation_Client>( Arrays.asList( raftFactoryV1, raftFactoryV2 ), Neo4Net.causalclustering.protocol.ModifierProtocolInstaller_Fields.AllClientInstallers );
					EventLoopGroup = new NioEventLoopGroup();
...
//ORIGINAL LINE: @SuppressWarnings("SameParameterValue") void connect(int port)
		 ...
		 private Matcher<object> MessageMatches<T1>( Neo4Net.causalclustering.core.consensus.RaftMessages_ClusterIdAwareMessage<T1> expected ) where T1 : Neo4Net.causalclustering.core.consensus.RaftMessages_RaftMessage
		 {
