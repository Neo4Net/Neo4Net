...
//ORIGINAL LINE: @Parameterized.Parameters(name = "{0}") public static java.util.Collection<Object[]> data()
		 public static ICollection<object[]> Data()
		 {
			  ...
			  {
				  new object[] { "[shared discovery, 6 core hosts, 2 databases]", 6, 0, DbNames_1, SHARED },
				  new object[] { "[hazelcast discovery, 6 core hosts, 2 databases]", 6, 0, DbNames_1, HAZELCAST },
				  new object[] { "[shared discovery, 5 core hosts, 1 database]", 5, 0, DbNames_2, SHARED },
				  new object[] { "[hazelcast discovery, 5 core hosts, 1 database]", 5, 0, DbNames_2, HAZELCAST },
				  new object[] { "[hazelcast discovery, 6 core hosts, 3 read replicas, 3 databases]", 9, 3, DbNames_3, HAZELCAST },
				  new object[] { "[shared discovery, 6 core hosts, 3 read replicas, 3 databases]", 8, 2, DbNames_3, SHARED }
			  });
		 }
