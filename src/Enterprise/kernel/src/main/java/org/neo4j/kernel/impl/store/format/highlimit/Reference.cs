...
namespace Neo4Net.Kernel.impl.store.format.highlimit
{
	...
	public sealed class Reference
	{
		 ...
		 private void Encode( long absoluteReference, bool positive, Neo4Net.Io.pagecache.PageCursor source )
		 {
		 ...
		 public static void Encode( long reference, Neo4Net.Io.pagecache.PageCursor target )
		 {
		 ...
		 public static long Decode( Neo4Net.Io.pagecache.PageCursor source )
		 {
