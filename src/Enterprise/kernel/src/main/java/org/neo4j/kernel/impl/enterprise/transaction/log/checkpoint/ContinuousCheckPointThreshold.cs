...
{
	using AbstractCheckPointThreshold = Neo4Net.Kernel.impl.transaction.log.checkpoint.AbstractCheckPointThreshold;

	internal class ContinuousCheckPointThreshold : AbstractCheckPointThreshold
	{
		 private volatile long _nextTransactionIdTarget;

		 internal ContinuousCheckPointThreshold() : base("continuous threshold")
		 {
		 }
		 ...
		 {
			  _nextTransactionIdTarget = transactionId + 1;
		 }
