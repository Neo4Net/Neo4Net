...
namespace Neo4Net.Kernel.impl.store.format.highlimit.v310
{
	...
	/// => 24B
	/// </summary>
	internal class RelationshipGroupRecordFormatV3_1_0 : BaseHighLimitRecordFormatV3_1_0<RelationshipGroupRecord>
	{
		 ...
		 internal RelationshipGroupRecordFormatV3_1_0() : this(RECORD_SIZE)
		 {
		 }

		 internal RelationshipGroupRecordFormatV3_1_0( int recordSize ) : base( fixedRecordSize( recordSize ), 0 )
		 {
		 }
