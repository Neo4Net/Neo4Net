...
//	import static Neo4Net.kernel.impl.store.record.RecordLoad.FORCE;
	...
	public class DumpStore<RECORD, STORE> where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord where STORE : Neo4Net.Kernel.impl.store.RecordStore<RECORD>
	{
...
//ORIGINAL LINE: final Neo4Net.kernel.impl.store.id.DefaultIdGeneratorFactory idGeneratorFactory = new Neo4Net.kernel.impl.store.id.DefaultIdGeneratorFactory(fs);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpFile(System.Func<java.io.File, Neo4Net.kernel.impl.store.StoreFactory> createStoreFactory, String fileName) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static <R extends Neo4Net.kernel.impl.store.record.AbstractBaseRecord, S extends Neo4Net.kernel.impl.store.RecordStore<R>> void dump(IdRange[] ids, S store) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpPropertyKeys(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpLabels(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpRelationshipTypes(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static <R extends Neo4Net.kernel.impl.store.record.TokenRecord> void dumpTokens(final Neo4Net.kernel.impl.store.TokenStore<R> store, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpRelationshipGroups(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpRelationshipStore(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpPropertyStore(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpSchemaStore(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
		 private static void DumpSchemaStore( NeoStores neoStores, IdRange[] ids )
		 {
			  using ( SchemaStore store = neoStores.SchemaStore )
			  {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.store.SchemaStorage storage = new Neo4Net.kernel.impl.store.SchemaStorage(store);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected Object transform(Neo4Net.kernel.impl.store.record.DynamicRecord record) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void dumpNodeStore(Neo4Net.kernel.impl.store.NeoStores neoStores, IdRange[] ids) throws Exception
