...
//           PREV(org.Neo4Net.kernel.impl.store.record.Record.NO_PREVIOUS_PROPERTY) { public long valueFrom(org.Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getPrevProp(); } public long otherReference(org.Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getNextProp(); } public void notInUse(org.Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.prevNotInUse(property); } public void noBackReference(org.Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.previousDoesNotReferenceBack(property); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           NEXT(org.Neo4Net.kernel.impl.store.record.Record.NO_NEXT_PROPERTY) { public long valueFrom(org.Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getNextProp(); } public long otherReference(org.Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getPrevProp(); } public void notInUse(org.Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.nextNotInUse(property); } public void noBackReference(org.Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.nextDoesNotReferenceBack(property); } };
...
//ORIGINAL LINE: private static ComparativeRecordChecker<org.Neo4Net.kernel.impl.store.record.PropertyRecord, org.Neo4Net.kernel.impl.store.record.PropertyKeyTokenRecord, org.Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport> propertyKey(final org.Neo4Net.kernel.impl.store.record.PropertyBlock block)
