...
namespace Neo4Net.Consistency.statistics
{
	...
	public class AccessStatsKeepingStoreAccess : StoreAccess
	{
		 ...
		 protected internal override RecordStore<R> WrapStore<R>( RecordStore<R> store ) where R : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
		 {
		 ...
		 private class AccessStatsKeepingRecordStore<RECORD> : Neo4Net.Kernel.impl.store.RecordStore_Delegator<RECORD> where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
		 {
