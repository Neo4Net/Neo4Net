...
namespace Neo4Net.Consistency.checking.full
{
	...
	public class CloningRecordIterable<R> : IEnumerable<R> where R : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
	{
		 ...
		 public static IEnumerable<R> Cloned<R>( IEnumerable<R> actual ) where R : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
		 {
