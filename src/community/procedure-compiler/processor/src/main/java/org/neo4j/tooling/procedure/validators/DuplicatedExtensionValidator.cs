...
namespace Neo4Net.Tooling.procedure.validators
{
	...
	/// compilation unit, not per Neo4Net instance.
	/// 
	/// Indeed, a Neo4Net instance can aggregate several extension JARs and its duplication detection cannot be entirely
	/// replaced by this.
	/// </summary>
