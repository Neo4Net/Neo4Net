...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Procedure public void works5(@Name("test") java.util.List<java.util.List<java.util.List<Neo4Net.graphdb.Path>>> supported)
		 public virtual void Works5( IList<IList<IList<Path>>> supported )
		 {
		 }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Procedure public void works6(@Name("test") java.util.List<Neo4Net.graphdb.Node> supported)
		 public virtual void Works6( IList<Node> supported )
		 {
		 }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Procedure public void works7(@Name("test") java.util.List<java.util.List<Neo4Net.graphdb.Relationship>> supported)
		 public virtual void Works7( IList<IList<Relationship>> supported )
		 {
		 }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Procedure public void works8(@Name("test") java.util.Map<String,java.util.List<java.util.List<Neo4Net.graphdb.Relationship>>> supported)
		 public virtual void Works8( IDictionary<string, IList<IList<Relationship>>> supported )
		 {
		 }

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Procedure public void works9(@Name("test") java.util.Map<String,java.util.Map<String,java.util.List<Neo4Net.graphdb.Node>>> supported)
