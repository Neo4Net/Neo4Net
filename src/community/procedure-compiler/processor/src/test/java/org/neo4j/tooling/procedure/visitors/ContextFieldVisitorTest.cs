...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		 private static readonly org.assertj.core.groups.Tuple _unknownContextErrorMsg = tuple( Diagnostic.Kind.ERROR, "@Neo4Net.procedure.Context usage error: found unknown type <java.lang.String> on field " + "UnknownContextType#unsupportedType, expected one of: <" + typeof( IGraphDatabaseService ).FullName + ">, <" + typeof( Log ).FullName + ">, <" + typeof( TerminationGuard ).FullName + ">, <" + typeof( SecurityContext ).FullName + ">, <" + typeof( ProcedureTransaction ).FullName + ">" );
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			  assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents ).containsExactly( tuple( Diagnostic.Kind.ERROR, "@Neo4Net.procedure.Context usage error: field NonPublicContextMisuse#arithm should be public, " + "non-static and non-final" ) );
		 }
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			  assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents ).containsExactly( tuple( Diagnostic.Kind.ERROR, "@Neo4Net.procedure.Context usage error: field StaticContextMisuse#db should be public, non-static " + "and non-final" ) );
		 }
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			  assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents ).containsExactly( tuple( Diagnostic.Kind.ERROR, "@Neo4Net.procedure.Context usage error: field FinalContextMisuse#graphDatabaseService should be " + "public, non-static and non-final" ) );
		 }
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
			  assertThat( result ).extracting( CompilationMessage::getCategory, CompilationMessage::getContents ).containsExactlyInAnyOrder( tuple( Diagnostic.Kind.WARNING, Warning( "Neo4Net.kernel.internal.GraphDatabaseAPI", "RestrictedContextTypes#graphDatabaseAPI" ) ), tuple( Diagnostic.Kind.WARNING, Warning( "Neo4Net.kernel.api.KernelTransaction", "RestrictedContextTypes#kernelTransaction" ) ), tuple( Diagnostic.Kind.WARNING, Warning( "Neo4Net.graphdb.DependencyResolver", "RestrictedContextTypes#dependencyResolver" ) ), tuple( Diagnostic.Kind.WARNING, Warning( "Neo4Net.kernel.api.security.UserManager", "RestrictedContextTypes#userManager" ) ) );
		 }
