...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @UserFunction public String works5(@Name("test") java.util.List<java.util.List<java.util.List<org.Neo4Net.graphdb.Path>>> supported)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @UserFunction public String works6(@Name("test") java.util.List<org.Neo4Net.graphdb.Node> supported)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @UserFunction public String works7(@Name("test") java.util.List<java.util.List<org.Neo4Net.graphdb.Relationship>> supported)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @UserFunction public String works8(@Name("test") java.util.Map<String,java.util.List<java.util.List<org.Neo4Net.graphdb.Relationship>>> supported)
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @UserFunction public String works9(@Name("test") java.util.Map<String,java.util.Map<String,java.util.List<org.Neo4Net.graphdb.Node>>> supported)
