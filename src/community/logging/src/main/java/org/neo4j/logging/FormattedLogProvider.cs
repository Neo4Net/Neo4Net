...
//	import static Neo4Net.logging.FormattedLog.OUTPUT_STREAM_CONVERTER;
	...
	public class FormattedLogProvider : AbstractLogProvider<FormattedLog>
	{
		 ...
		 public class Builder
		 {
			  ...
			  /// starts with the specified string will have its level set. For example, setting the level for the context {@code Neo4Net}
			  /// would result in that level being applied to <seealso cref="Log"/>s with the context {@code Neo4Net.Foo}, {@code Neo4Net.foo.Bar}, etc.
			  /// </summary>
