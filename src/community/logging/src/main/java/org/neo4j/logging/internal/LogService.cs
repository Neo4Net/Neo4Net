...
namespace Neo4Net.Logging.Internal
{
	...
	{
		 /// <returns> a <seealso cref="Neo4Net.logging.LogProvider"/> that providers loggers for user visible messages. </returns>
		 ...
		 /// <returns> a <seealso cref="Neo4Net.logging.Log"/> that logs user visible messages with the {@code loggingClass} as context. </returns>
