...
{
	using AStar = Neo4Net.Graphalgo.impl.path.AStar;
	using AllPaths = Neo4Net.Graphalgo.impl.path.AllPaths;
	using AllSimplePaths = Neo4Net.Graphalgo.impl.path.AllSimplePaths;
