...
//	import static org.mockito.Mockito.mock;
	...
	internal class DiscardAllMessageDecoderTest
	{
		private bool InstanceFieldsInitialized = false;

		public DiscardAllMessageDecoderTest()
		{
		...
		{
			_decoder = new DiscardAllMessageDecoder( _responseHandler );
		}
...
//ORIGINAL LINE: @Test void shouldReturnCorrectSignature()
		 ...
		 {
			  assertEquals( DiscardAllMessage.SIGNATURE, _decoder.signature() );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  assertEquals( DiscardAllMessage.INSTANCE, _decoder.decode( mock( typeof( Neo4NetPack_Unpacker ) ) ) );
		 }
	}
