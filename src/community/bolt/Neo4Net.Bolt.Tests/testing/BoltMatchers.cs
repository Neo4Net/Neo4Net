...
namespace Neo4Net.Bolt.testing
{
	...
	using ReadyState = Neo4Net.Bolt.v1.runtime.ReadyState;
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static org.hamcrest.Matcher<RecordedBoltResponse> succeededWithMetadata(final String key, final Neo4Net.values.AnyValue value)
...
//ORIGINAL LINE: final RecordedBoltResponse response = (RecordedBoltResponse) item;
				  RecordedBoltResponse response = ( RecordedBoltResponse ) item;
				  Neo4Net.Cypher.result.QueryResult_Record[] records = response.Records();
...
//ORIGINAL LINE: public boolean matches(final Object item)
			 ...
			 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.bolt.v1.runtime.BoltStateMachineV1 machine = (Neo4Net.bolt.v1.runtime.BoltStateMachineV1) item;
				  BoltStateMachineV1 machine = ( BoltStateMachineV1 ) item;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.bolt.runtime.StatementProcessor statementProcessor = machine.statementProcessor();
...
//ORIGINAL LINE: public boolean matches(final Object item)
			 ...
			 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.bolt.runtime.BoltStateMachine machine = (Neo4Net.bolt.runtime.BoltStateMachine) item;
...
//ORIGINAL LINE: public static void verifyOneResponse(Neo4Net.function.ThrowingBiConsumer<Neo4Net.bolt.runtime.BoltStateMachine,BoltResponseRecorder,Neo4Net.bolt.runtime.BoltConnectionFatality> transition) throws Exception
