...
//ORIGINAL LINE: public RunMessage(String statement) throws Neo4Net.bolt.messaging.BoltIOException
		 public RunMessage( string statement ) : this( statement, VirtualValues.EMPTY_MAP )
		 {
		 }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public RunMessage(String statement, Neo4Net.values.virtual.MapValue params) throws Neo4Net.bolt.messaging.BoltIOException
		 public RunMessage( string statement, MapValue @params ) : this( statement, @params, VirtualValues.EMPTY_MAP )
		 {
		 }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public RunMessage(String statement, Neo4Net.values.virtual.MapValue params, Neo4Net.values.virtual.MapValue meta) throws Neo4Net.bolt.messaging.BoltIOException
