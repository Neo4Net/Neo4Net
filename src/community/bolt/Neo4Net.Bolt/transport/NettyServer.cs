...
namespace Neo4Net.Bolt.transport
{
	...
	using EpollConfigurationProvider = Neo4Net.Bolt.transport.configuration.EpollConfigurationProvider;
	using NioConfigurationProvider = Neo4Net.Bolt.transport.configuration.NioConfigurationProvider;
	using ServerConfigurationProvider = Neo4Net.Bolt.transport.configuration.ServerConfigurationProvider;
