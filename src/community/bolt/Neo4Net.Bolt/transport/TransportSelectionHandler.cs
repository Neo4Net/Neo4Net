...
namespace Neo4Net.Bolt.transport
{
	...
	using ProtocolHandshaker = Neo4Net.Bolt.transport.pipeline.ProtocolHandshaker;
	using WebSocketFrameTranslator = Neo4Net.Bolt.transport.pipeline.WebSocketFrameTranslator;
	using Exceptions = Neo4Net.Helpers.Exceptions;
	using Log = Neo4Net.Logging.Log;
	using LogProvider = Neo4Net.Logging.LogProvider;

//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.bolt.transport.pipeline.ProtocolHandshaker.BOLT_MAGIC_PREAMBLE;
