...
//JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
		 ...
		 public virtual Value NextValueOfType( ValueType type )
		 {
			  ...
			  {
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.BOOLEAN:
					return NextBooleanValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.BYTE:
					return NextByteValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.SHORT:
					return NextShortValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING:
					return NextTextValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.INT:
					return NextIntValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LONG:
					return NextLongValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.FLOAT:
					return NextFloatValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DOUBLE:
					return NextDoubleValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CHAR:
					return NextCharValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_ALPHANUMERIC:
					return NextAlphaNumericTextValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_ASCII:
					return NextAsciiTextValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_BMP:
					return NextBasicMultilingualPlaneTextValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LOCAL_DATE_TIME:
					return NextLocalDateTimeValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DATE:
					return NextDateValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LOCAL_TIME:
					return NextLocalTimeValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.PERIOD:
					return NextPeriod();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DURATION:
					return NextDuration();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.TIME:
					return NextTimeValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DATE_TIME:
					return NextDateTimeValue();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CARTESIAN_POINT:
					return NextCartesianPoint();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CARTESIAN_POINT_3D:
					return NextCartesian3DPoint();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.GEOGRAPHIC_POINT:
					return NextGeographicPoint();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.GEOGRAPHIC_POINT_3D:
					return NextGeographic3DPoint();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.BOOLEAN_ARRAY:
					return NextBooleanArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.BYTE_ARRAY:
					return NextByteArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.SHORT_ARRAY:
					return NextShortArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.INT_ARRAY:
					return NextIntArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LONG_ARRAY:
					return NextLongArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.FLOAT_ARRAY:
					return NextFloatArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DOUBLE_ARRAY:
					return NextDoubleArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CHAR_ARRAY:
					return NextCharArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_ARRAY:
					return NextTextArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_ALPHANUMERIC_ARRAY:
					return NextAlphaNumericTextArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_ASCII_ARRAY:
					return NextAsciiTextArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.STRING_BMP_ARRAY:
					return NextBasicMultilingualPlaneTextArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LOCAL_DATE_TIME_ARRAY:
					return NextLocalDateTimeArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DATE_ARRAY:
					return NextDateArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.LOCAL_TIME_ARRAY:
					return NextLocalTimeArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.PERIOD_ARRAY:
					return NextPeriodArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DURATION_ARRAY:
					return NextDurationArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.TIME_ARRAY:
					return NextTimeArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.DATE_TIME_ARRAY:
					return NextDateTimeArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CARTESIAN_POINT_ARRAY:
					return NextCartesianPointArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.CARTESIAN_POINT_3D_ARRAY:
					return NextCartesian3DPointArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.GEOGRAPHIC_POINT_ARRAY:
					return NextGeographicPointArray();
			  case Neo4Net.Values.Storable.ValueType.InnerEnum.GEOGRAPHIC_POINT_3D_ARRAY:
