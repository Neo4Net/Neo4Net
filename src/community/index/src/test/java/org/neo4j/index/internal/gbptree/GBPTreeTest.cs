...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyHeader(Neo4Net.io.pagecache.PageCache pageCache, byte[] expectedHeader) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void openMustThrowMetadataMismatchExceptionIfFileIsEmpty(Neo4Net.function.ThrowingConsumer<Neo4Net.io.pagecache.PageCache,java.io.IOException> opener) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void openMustThrowMetadataMismatchExceptionIfSomeMetaPageIsMissing(Neo4Net.function.ThrowingConsumer<Neo4Net.io.pagecache.PageCache,java.io.IOException> opener) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void openMustThrowMetadataMismatchExceptionIfStatePagesAreAllZeros(Neo4Net.function.ThrowingConsumer<Neo4Net.io.pagecache.PageCache,java.io.IOException> opener) throws Exception
...
//ORIGINAL LINE: private Neo4Net.io.pagecache.PageCache pageCacheWithBarrierInClose(final java.util.concurrent.atomic.AtomicBoolean enabled, final Neo4Net.test.Barrier_Control barrier)
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void mustRecognizeFailedCleaning(Neo4Net.function.ThrowingConsumer<GBPTree<org.apache.commons.lang3.mutable.MutableLong,org.apache.commons.lang3.mutable.MutableLong>,java.io.IOException> operation) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void corruptTheChild(Neo4Net.io.pagecache.PageCache pageCache, long corruptChild) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private Neo4Net.io.pagecache.PageCache pageCacheThatThrowExceptionWhenToldTo(final java.io.IOException e, final java.util.concurrent.atomic.AtomicBoolean throwOnNextIO)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private Neo4Net.io.pagecache.PageCache pageCacheThatBlockWhenToldTo(final Neo4Net.test.Barrier barrier, final java.util.concurrent.atomic.AtomicBoolean blockOnNextIO)
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void makeDirty(Neo4Net.io.pagecache.PageCache pageCache) throws java.io.IOException
