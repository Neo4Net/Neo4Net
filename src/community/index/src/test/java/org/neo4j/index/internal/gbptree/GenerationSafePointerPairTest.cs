...
//           UNSTABLE(GenerationSafePointerPair.UNSTABLE) { long materialize(Neo4Net.io.pagecache.PageCursor cursor, long pointer) { GenerationSafePointer.write(cursor, UNSTABLE_GENERATION, pointer); return pointer; } };
			  ...
			  internal abstract long materialize( Neo4Net.Io.pagecache.PageCursor cursor, long pointer );
			  ...
			  internal void Verify( Neo4Net.Io.pagecache.PageCursor cursor, long expectedPointer, bool slotA )
			  {
					assertEquals( expectedPointer, slotA ? readSlotA( cursor ) : readSlotB( cursor ) );
			  }

			  public static long ReadGeneration( Neo4Net.Io.pagecache.PageCursor cursor, bool slotA )
			  {
		 ...
		 internal sealed class Success : Slot
		 {
			  ...
			  public void VerifyRead( Neo4Net.Io.pagecache.PageCursor cursor, long result, State stateA, State stateB, long preStatePointerA, long preStatePointerB, long generation )
			  {
			  ...
			  public void VerifyWrite( Neo4Net.Io.pagecache.PageCursor cursor, long result, State stateA, State stateB, long preStatePointerA, long preStatePointerB )
			  {
					AssertSuccess( result );
