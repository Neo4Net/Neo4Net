...
//ORIGINAL LINE: public static void visitHeader(Neo4Net.io.pagecache.PageCache pageCache, java.io.File file, GBPTreeVisitor visitor) throws java.io.IOException
		 public static void VisitHeader( PageCache pageCache, File file, GBPTreeVisitor visitor )
		 {
			  ...
			  {
					using ( PageCursor cursor = pagedFile.Io( IdSpace.STATE_PAGE_A, Neo4Net.Io.pagecache.PagedFile_Fields.PF_SHARED_READ_LOCK ) )
					{
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void visitMeta(Neo4Net.io.pagecache.PageCursor cursor, GBPTreeVisitor visitor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: static void visitTreeState(Neo4Net.io.pagecache.PageCursor cursor, GBPTreeVisitor visitor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void visitTree(Neo4Net.io.pagecache.PageCursor cursor, Neo4Net.io.pagecache.PageCursor writeCursor, GBPTreeVisitor<KEY,VALUE> visitor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void assertOnTreeNode(Neo4Net.io.pagecache.PageCursor cursor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void visitTreeNode(Neo4Net.io.pagecache.PageCursor cursor, GBPTreeVisitor<KEY,VALUE> visitor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private boolean goToLeftmostChild(Neo4Net.io.pagecache.PageCursor readCursor, Neo4Net.io.pagecache.PageCursor writeCursor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void visitLevel(Neo4Net.io.pagecache.PageCursor readCursor, Neo4Net.io.pagecache.PageCursor writeCursor, GBPTreeVisitor<KEY,VALUE> visitor) throws java.io.IOException
