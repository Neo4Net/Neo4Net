...
//ORIGINAL LINE: private final Neo4Net.graphdb.config.SettingGroup<?> settingGroup;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonnull public Neo4Net.graphdb.config.SettingGroup<?> settingGroup()
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
...
//ORIGINAL LINE: @Nonnull public java.util.List<ConfigValue> asConfigValues(@Nonnull Map<String,String> validConfig)
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Map<String,Neo4Net.graphdb.config.Setting<?>> settings = settingGroup.settings(validConfig).stream().collect(java.util.stream.Collectors.toMap(Neo4Net.graphdb.config.Setting::name, s -> s));
