...
namespace Neo4Net.Internal.Diagnostics
{
	...
	public sealed class DiagnosticsPhase
	{
		 ...
		 internal void EmitStart( Neo4Net.Logging.Log log )
		 {
			  log.Info( "--- " + this + " START ---" );
		 }

		 internal void EmitDone( Neo4Net.Logging.Log log )
		 {
			  log.Info( "--- " + this + " END ---" );
		 }

		 internal void EmitStart( Neo4Net.Logging.Log log, DiagnosticsProvider provider )
		 {
			  log.Info( "--- " + this + " for " + provider.DiagnosticsIdentifier + " START ---" );
		 }

		 internal void EmitDone( Neo4Net.Logging.Log log, DiagnosticsProvider provider )
		 {
