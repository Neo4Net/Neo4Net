...
//ORIGINAL LINE: private final java.util.List<Neo4Net.kernel.extension.KernelExtensionFactory<?>> kernelExtensions;
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: public Iterable<Neo4Net.kernel.extension.KernelExtensionFactory<?>> getKernelExtension()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (Neo4Net.kernel.extension.KernelExtensionFactory<?> newKernelExtension : newKernelExtensions)
