...
namespace Neo4Net.Test
{
	...
	///              Neo4Net.graphdb.factory.GraphDatabaseSettings#query_cache_size
	...
	///                   Neo4Net.graphdb.factory.GraphDatabaseSettings#cypher_min_replan_interval
	///                   GraphDatabaseSettings.cypher_min_replan_interval}, "5000" ).<seealso cref="asParameters() asParameters"/>()
	///          );
	///      }
	/// 
	///      public final{@literal @}Rule <seealso cref="Neo4Net.test.rule.DatabaseRule DatabaseRule"/> db;
	/// 
	///      public SomeTest( ConfigBuilder config )
	///      {
	///          this.db = new {@link Neo4Net.test.rule.ImpermanentDatabaseRule
	///          ImpermanentDatabaseRule}().{@link Neo4Net.test.rule.DatabaseRule#withConfiguration(Map)
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private final java.util.Map<Neo4Net.graphdb.config.Setting<?>,String> config;
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: public java.util.Map<Neo4Net.graphdb.config.Setting<?>,String> configuration()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Map<Neo4Net.graphdb.config.Setting<?>,String> config = new java.util.HashMap<>(this.config);
