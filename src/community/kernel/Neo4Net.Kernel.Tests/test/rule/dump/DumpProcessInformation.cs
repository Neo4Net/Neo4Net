...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.io.File doThreadDump(Neo4Net.helpers.collection.Pair<long, String> pid) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public void doHeapDump(Neo4Net.helpers.collection.Pair<long, String> pid) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.Collection<Neo4Net.helpers.collection.Pair<long, String>> getJPids(org.hamcrest.Matcher<String> filter) throws Exception
