...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.test.Barrier_Control phaseA = new Neo4Net.test.Barrier_Control();
			  Neo4Net.Test.Barrier_Control phaseA = new Neo4Net.Test.Barrier_Control();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.test.Barrier_Control phaseB = new Neo4Net.test.Barrier_Control();
			  Neo4Net.Test.Barrier_Control phaseB = new Neo4Net.Test.Barrier_Control();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.test.Barrier_Control phaseC = new Neo4Net.test.Barrier_Control();
