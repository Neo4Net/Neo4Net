...
namespace Neo4Net.@unsafe.Impl.Batchimport
{
	...
	using Group = Neo4Net.@unsafe.Impl.Batchimport.ReadGroupsFromCacheStepTest.Group;
...
//ORIGINAL LINE: final java.util.concurrent.atomic.AtomicLong nextId = new java.util.concurrent.atomic.AtomicLong();
			  ...
			  // WHEN
			  encoder.Start( Neo4Net.@unsafe.Impl.Batchimport.staging.Step_Fields.ORDER_SEND_DOWNSTREAM );
