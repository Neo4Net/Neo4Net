...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static org.Neo4Net.@unsafe.impl.batchimport.cache.idmapping.@string.IntTracker.MAX_ID;
...
//ORIGINAL LINE: @Test public void shouldKeepIdsAndMarkDuplicates()
		 public virtual void ShouldKeepIdsAndMarkDuplicates()
		 {
			  // given
			  int length = 10_000;
			  using ( IntTracker tracker = new IntTracker( NumberArrayFactory.HEAP.newIntArray( length, IntTracker.DEFAULT_VALUE ) ) )
			  {
					// when
