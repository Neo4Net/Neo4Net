...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 {
			  // When/Then
			  assertThat( Call( "dbms.components" ), contains( Record( "Neo4Net Kernel", singletonList( "1.3.37" ), "enterprise" ) ) );
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private java.util.List<Object[]> call(String name, Object... args) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException, Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
