...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") public NativeIndexAccessorTest(String name, AccessorFactory<KEY,VALUE> accessorFactory, Neo4Net.values.storable.ValueType[] supportedTypes, IndexLayoutFactory<KEY,VALUE> indexLayoutFactory, Neo4Net.Kernel.Api.Internal.IndexCapability indexCapability)
...
//ORIGINAL LINE: NativeIndexAccessor<KEY,VALUE> makeAccessor() throws java.io.IOException
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: NativeIndexAccessor<KEY,VALUE> create(Neo4Net.io.pagecache.PageCache pageCache, Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File storeFile, IndexLayout<KEY,VALUE> layout, Neo4Net.index.internal.gbptree.RecoveryCleanupWorkCollector recoveryCleanupWorkCollector, Neo4Net.kernel.api.index.IndexProvider.Monitor monitor, Neo4Net.Kernel.Api.StorageEngine.schema.StoreIndexDescriptor descriptor, Neo4Net.kernel.api.index.IndexDirectoryStructure directory, boolean readOnly) throws java.io.IOException;
