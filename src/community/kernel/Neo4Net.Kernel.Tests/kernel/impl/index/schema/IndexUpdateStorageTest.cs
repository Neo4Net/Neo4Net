...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void storeAll(IndexUpdateStorage<GenericKey,NativeIndexValue> storage, java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<Neo4Net.Kernel.Api.Internal.Schema.SchemaDescriptorSupplier>> expected) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void verify(java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<Neo4Net.Kernel.Api.Internal.Schema.SchemaDescriptorSupplier>> expected, IndexUpdateStorage<GenericKey,NativeIndexValue> storage) throws java.io.IOException
