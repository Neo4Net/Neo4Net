...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(2) public Neo4Net.Kernel.Api.Internal.InternalIndexState expectedStateOnNonExistingSubIndex;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 public InternalIndexState ExpectedStateOnNonExistingSubIndexConflict;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(3) public Neo4Net.values.storable.Value someValue;
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
