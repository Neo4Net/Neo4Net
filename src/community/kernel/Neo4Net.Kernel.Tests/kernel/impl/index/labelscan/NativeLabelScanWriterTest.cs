...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.index.labelscan.NativeLabelScanStoreIT.flipRandom;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.index.labelscan.NativeLabelScanStoreIT.getLabels;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.index.labelscan.NativeLabelScanStoreIT.nodesWithLabel;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") Neo4Net.cursor.RawCursor<Neo4Net.index.internal.gbptree.Hit<LabelScanKey,LabelScanValue>,java.io.IOException> nodesFor(int labelId)
