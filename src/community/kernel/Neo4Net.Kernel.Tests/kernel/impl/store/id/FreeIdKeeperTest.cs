...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.store.id.IdContainer.NO_RESULT;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private FreeIdKeeper getFreeIdKeeperAggressive(Neo4Net.io.fs.StoreChannel channel, int batchSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private FreeIdKeeper getFreeIdKeeper(Neo4Net.io.fs.StoreChannel channel, int batchSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private FreeIdKeeper getFreeIdKeeper(Neo4Net.io.fs.StoreChannel channel, int batchSize, boolean aggressiveMode) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.io.fs.StoreChannel getStoreChannel() throws java.io.IOException
