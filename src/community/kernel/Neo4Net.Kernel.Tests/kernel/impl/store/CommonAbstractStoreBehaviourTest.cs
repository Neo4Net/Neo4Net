...
//ORIGINAL LINE: private void assertThrowsUnderlyingStorageException(Neo4Net.function.ThrowingAction<Exception> action) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertThrowsInvalidRecordException(Neo4Net.function.ThrowingAction<Exception> action) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyExceptionOnOutOfBoundsAccess(Neo4Net.function.ThrowingAction<Exception> access) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyExceptionOnCursorError(Neo4Net.function.ThrowingAction<Exception> access) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void MustFinishInitialisationOfIncompleteStoreHeader()
		 {
			  ...
			  using ( PageCursor cursor = _store.pagedFile.io( 0, Neo4Net.Io.pagecache.PagedFile_Fields.PfSharedWriteLock ) )
			  {
