...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameter public Neo4Net.kernel.impl.util.collection.CollectionsFactorySupplier collectionsFactorySupplier;
		 public CollectionsFactorySupplier CollectionsFactorySupplier;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameters(name = "{0}") public static java.util.List<Neo4Net.kernel.impl.util.collection.CollectionsFactorySupplier> data()
...
//ORIGINAL LINE: org.eclipse.collections.impl.UnmodifiableMap<Neo4Net.values.storable.ValueTuple,? extends Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> diffSets = state.getIndexUpdates(indexOn_1_1.schema());
...
//ORIGINAL LINE: @Test public void shouldComputeSortedIndexUpdatesOnUninitializedTxState()
		 public virtual void ShouldComputeSortedIndexUpdatesOnUninitializedTxState()
		 {
			  // WHEN
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.NavigableMap<Neo4Net.values.storable.ValueTuple,? extends Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> diffSets = state.getSortedIndexUpdates(indexOn_1_1.schema());
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass2 : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass3 : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void doNotVisitNotModifiedPropertiesOnModifiedNodes() throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.ConstraintValidationException, Neo4Net.Kernel.Api.Internal.Exceptions.Schema.CreateConstraintFailureException
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass4 : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void doNotVisitNotModifiedLabelsOnModifiedNodes() throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.ConstraintValidationException, Neo4Net.Kernel.Api.Internal.Exceptions.Schema.CreateConstraintFailureException
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass5 : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class TxStateVisitor_AdapterAnonymousInnerClass6 : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//ORIGINAL LINE: @Test public void getOrCreateLabelStateNodeDiffSets_useCollectionsFactory()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.diffsets.MutableLongDiffSets diffSets = state.getOrCreateLabelStateNodeDiffSets(1);
...
//ORIGINAL LINE: @Test public void getOrCreateIndexUpdatesForSeek_useCollectionsFactory()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.diffsets.MutableLongDiffSets diffSets = state.getOrCreateIndexUpdatesForSeek(new java.util.HashMap<>(), Neo4Net.values.storable.ValueTuple.of(stringValue("test")));
		 ...
		 internal abstract class VisitationOrder : Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Adapter
		 {
			 private readonly TxStateTest _outerInstance;
...
//ORIGINAL LINE: private IndexUpdater addNodesToIndex(final Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor descriptor)
