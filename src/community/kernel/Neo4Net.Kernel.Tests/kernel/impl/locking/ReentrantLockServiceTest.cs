...
//ORIGINAL LINE: @Rule public final Neo4Net.test.rule.concurrent.ThreadRepository threads = new Neo4Net.test.rule.concurrent.ThreadRepository(5, java.util.concurrent.TimeUnit.SECONDS);
