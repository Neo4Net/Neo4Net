...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.CollectionsFactory collectionsFactory = mock(Neo4Net.kernel.impl.util.collection.CollectionsFactory.class);
