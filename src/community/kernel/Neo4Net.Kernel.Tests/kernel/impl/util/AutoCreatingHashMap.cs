...
//ORIGINAL LINE: public static <V> Neo4Net.function.Factory<V> values(final Class<V> valueType)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static <K,V> Neo4Net.function.Factory<java.util.Map<K,V>> nested(Class<K> keyClass, final Neo4Net.function.Factory<V> nested)
