...
//	import static org.mockito.Mockito.verifyNoMoreInteractions;
	...
	public class DbStructureInvocationTracingAcceptanceTest
	{
		...
		private void InitializeInstanceFields()
		{
		 ...
		 private readonly string _packageName = "Neo4Net.kernel.impl.util.data";
...
//ORIGINAL LINE: final Neo4Net.helpers.collection.Visitable<DbStructureVisitor> visitable = compileVisitable(classNameWithPackage, output.toString());
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private Neo4Net.helpers.collection.Visitable<DbStructureVisitor> compileVisitable(final String className, String inputSource)
