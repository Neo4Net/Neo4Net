...
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock block = allocator.allocate(128, memoryTracker);
...
//ORIGINAL LINE: @Test void allocateAndFree()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock block1 = allocator.allocate(128, memoryTracker);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock block2 = allocator.allocate(256, memoryTracker);
...
//ORIGINAL LINE: @ParameterizedTest @ValueSource(longs = {10, 100, 256}) void allocateNonCacheableSize(long bytes)
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock block1 = allocator.allocate(bytes, memoryTracker);
			  OffHeapBlockAllocator_MemoryBlock block1 = _allocator.allocate( bytes, _memoryTracker );
			  _allocator.free( block1, _memoryTracker );

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock block2 = allocator.allocate(bytes, memoryTracker);
...
//ORIGINAL LINE: @Test void cacheCapacityPerBlockSize()
		 internal virtual void CacheCapacityPerBlockSize()
		 {
			  const int extra = 3;
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock> blocks64 = new java.util.ArrayList<>();
			  IList<OffHeapBlockAllocator_MemoryBlock> blocks64 = new List<OffHeapBlockAllocator_MemoryBlock>();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final java.util.List<Neo4Net.kernel.impl.util.collection.OffHeapBlockAllocator_MemoryBlock> blocks128 = new java.util.ArrayList<>();
