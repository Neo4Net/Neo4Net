 ...
 */
namespace Neo4Net.Kernel.Api.exception
{
...
//ORIGINAL LINE: @Test public void eachStatusCodeHasAUniqueCode()
		 public virtual void EachStatusCodeHasAUniqueCode()
		 {
			  ...
			  // when
			  foreach ( Status status in Neo4Net.Kernel.Api.Exceptions.Status_Code.All() )
			  {
			  ...
			  assertEquals( Neo4Net.Kernel.Api.Exceptions.Status_Code.All().Count, codes.Count );
		 }
	}
