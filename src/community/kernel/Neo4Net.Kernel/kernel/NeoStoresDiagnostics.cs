...
//       NEO_STORE_VERSIONS("Store versions:") { void dump(Neo4Net.kernel.impl.store.NeoStores source, Neo4Net.logging.Logger logger) { source.logVersions(logger); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       NEO_STORE_ID_USAGE("Id usage:") { void dump(Neo4Net.kernel.impl.store.NeoStores source, Neo4Net.logging.Logger logger) { source.logIdUsage(logger); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       NEO_STORE_RECORDS("Neostore records:") { void dump(Neo4Net.kernel.impl.store.NeoStores source, Neo4Net.logging.Logger logger) { source.getMetaDataStore().logRecords(logger); } };
...
//ORIGINAL LINE: public void dumpDiagnostics(final Neo4Net.kernel.impl.store.NeoStores source, Neo4Net.internal.diagnostics.DiagnosticsPhase phase, Neo4Net.logging.Logger logger)
