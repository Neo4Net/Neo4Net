...
namespace Neo4Net.Kernel.Api.Index
{
	...
	/// Neo4Nets logical log. As such, the implementation needs to behave under some rather strict rules.
	/// 
	...
	/// 
	/// The index will be notified, through the <seealso cref="Neo4Net.kernel.api.index.IndexPopulator.close(bool)"/>
	...
	/// <seealso cref="Neo4Net.kernel.api.index.IndexPopulator.close(bool) close method"/>.
	/// 
...
//ORIGINAL LINE: public Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor bless(Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.MisconfiguredIndexException
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract IndexAccessor getOnlineAccessor(Neo4Net.Kernel.Api.StorageEngine.schema.StoreIndexDescriptor descriptor, Neo4Net.kernel.impl.api.index.sampling.IndexSamplingConfig samplingConfig) throws java.io.IOException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract String getPopulationFailure(Neo4Net.Kernel.Api.StorageEngine.schema.StoreIndexDescriptor descriptor) throws IllegalStateException;
