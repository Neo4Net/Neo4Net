...
namespace Neo4Net.Kernel.Api.Index
{
	...
	/// each commit, created from <seealso cref="Neo4Net.kernel.api.index.IndexAccessor"/>.
	/// 
	...
	/// </summary>
	public interface IIndexUpdater : IDisposable
	{
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void process(IndexEntryUpdate<?> update) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		 void process<T1>( IndexEntryUpdate<T1> update );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void close() throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
		 void Close();
	}
