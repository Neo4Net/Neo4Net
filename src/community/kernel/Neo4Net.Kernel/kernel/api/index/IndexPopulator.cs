...
//ORIGINAL LINE: void add(java.util.Collection<? extends IndexEntryUpdate<?>> updates) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void verifyDeferredConstraints(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
...
//		 default Neo4Net.Kernel.Api.StorageEngine.schema.PopulationProgress progress(Neo4Net.Kernel.Api.StorageEngine.schema.PopulationProgress scanProgress)
	//	 {
	//		  return scanProgress;
	//	 }

//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//		 default void scanCompleted(Neo4Net.kernel.impl.api.index.PhaseTracker phaseTracker) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException
	//	 { // no-op by default
	//	 }
	}
