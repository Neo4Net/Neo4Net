...
//	import static Neo4Net.helpers.collection.Iterators.emptyResourceIterator;
	...
	public interface IIndexAccessor : System.IDisposable, IndexConfigProvider, ConsistencyCheckable
	{
		 ...
		 /// </summary>
		 /// <param name="ioLimiter"> The <seealso cref="IOLimiter"/> to use for implementations living on top of <seealso cref="Neo4Net.io.pagecache.PageCache"/>. </param>
...
//		 default void validateBeforeCommit(Neo4Net.values.storable.Value[] tuple)
	//	 {
