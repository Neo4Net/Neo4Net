...
namespace Neo4Net.Kernel.Api.Exceptions.schema
{
	...
	public class DropIndexFailureException : SchemaKernelException
	{
		 ...
		 public DropIndexFailureException( SchemaDescriptor descriptor, SchemaKernelException cause ) : base( Neo4Net.kernel.api.exceptions.Status_Schema.IndexDropFailed, format( MESSAGE, descriptor.UserDescription( SchemaUtil.idTokenNameLookup ), cause.Message ), cause )
		 {
