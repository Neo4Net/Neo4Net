...
namespace Neo4Net.Kernel.spi.explicitindex
{
	...
	/// </summary>
	public interface ExplicitIndexProviderTransaction : System.IDisposable
	{
		 ExplicitIndex NodeIndex( string indexName, IDictionary<string, string> configuration );

		 ExplicitIndex RelationshipIndex( string indexName, IDictionary<string, string> configuration );
