...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.extension.KernelExtensionFailureStrategies.fail;
...
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.entry.LogEntryReader<Neo4Net.kernel.impl.transaction.log.ReadableClosablePositionAwareChannel> logEntryReader = new Neo4Net.kernel.impl.transaction.log.entry.VersionAwareLogEntryReader<>();
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final NeoStoreKernelModule kernelModule = buildKernel(logFiles, transactionLogModule.transactionAppender(), dataSourceDependencies.resolveDependency(Neo4Net.kernel.impl.api.index.IndexingService.class), databaseSchemaState, dataSourceDependencies.resolveDependency(Neo4Net.kernel.api.labelscan.LabelScanStore.class), storageEngine, indexConfigStore, transactionIdStore, databaseAvailabilityGuard, clock, nodePropertyAccessor);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.pruning.LogPruning logPruning = new Neo4Net.kernel.impl.transaction.log.pruning.LogPruningImpl(fs, logFiles, logProvider, new Neo4Net.kernel.impl.transaction.log.pruning.LogPruneStrategyFactory(), clock, config);
			  LogPruning logPruning = new LogPruningImpl( _fs, logFiles, logProvider, new LogPruneStrategyFactory(), _clock, config );

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.rotation.LogRotation logRotation = new Neo4Net.kernel.impl.transaction.log.rotation.LogRotationImpl(monitors.newMonitor(Neo4Net.kernel.impl.transaction.log.rotation.LogRotation_Monitor.class), logFiles, databaseHealth);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.TransactionAppender appender = life.add(new Neo4Net.kernel.impl.transaction.log.BatchingTransactionAppender(logFiles, logRotation, transactionMetadataCache, transactionIdStore, explicitIndexTransactionOrdering, databaseHealth));
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.LogicalTransactionStore logicalTransactionStore = new Neo4Net.kernel.impl.transaction.log.PhysicalLogicalTransactionStore(logFiles, transactionMetadataCache, logEntryReader, monitors, failOnCorruptedLogFiles);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.log.checkpoint.CheckPointerImpl checkPointer = new Neo4Net.kernel.impl.transaction.log.checkpoint.CheckPointerImpl(transactionIdStore, threshold, storageEngine, logPruning, appender, databaseHealth, logProvider, tracers.checkPointTracer, ioLimiter, storeCopyCheckPointMutex);
...
//ORIGINAL LINE: private void buildRecovery(final Neo4Net.io.fs.FileSystemAbstraction fileSystemAbstraction, Neo4Net.kernel.impl.transaction.log.TransactionIdStore transactionIdStore, Neo4Net.kernel.recovery.LogTailScanner tailScanner, Neo4Net.kernel.recovery.RecoveryMonitor recoveryMonitor, Neo4Net.kernel.recovery.RecoveryStartInformationProvider.Monitor positionMonitor, final Neo4Net.kernel.impl.transaction.log.files.LogFiles logFiles, Neo4Net.Kernel.Api.StorageEngine.StorageEngine storageEngine, Neo4Net.kernel.impl.transaction.log.LogicalTransactionStore logicalTransactionStore, Neo4Net.kernel.impl.transaction.log.LogVersionRepository logVersionRepository)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.api.KernelImpl kernel = new Neo4Net.kernel.impl.api.KernelImpl(kernelTransactions, hooks, databaseHealth, transactionMonitor, procedures, config);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.kernel.impl.transaction.state.NeoStoreFileListing fileListing = new Neo4Net.kernel.impl.transaction.state.NeoStoreFileListing(databaseLayout, logFiles, labelScanStore, indexingService, explicitIndexProvider, storageEngine);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.graphdb.ResourceIterator<Neo4Net.Kernel.Api.StorageEngine.StoreFileMetadata> listStoreFiles(boolean includeLogs) throws java.io.IOException
		 public virtual IResourceIterator<StoreFileMetadata> ListStoreFiles( bool includeLogs )
		 {
...
//ORIGINAL LINE: @VisibleForTesting public Neo4Net.kernel.lifecycle.LifeSupport getLife()
