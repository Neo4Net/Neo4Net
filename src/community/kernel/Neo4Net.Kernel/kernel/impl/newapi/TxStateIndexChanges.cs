...
//ORIGINAL LINE: org.eclipse.collections.impl.UnmodifiableMap<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> updates = txState.getIndexUpdates(descriptor.schema());
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.NavigableMap<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> sortedUpdates = txState.getSortedIndexUpdates(descriptor.schema());
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Map<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> inRange = sortedUpdates.subMap(selectedLower, selectedIncludeLower, selectedUpper, selectedIncludeUpper);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> entry : inRange.entrySet())
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> entry : sortedUpdates.subMap(floor, MAX_STRING_TUPLE).entrySet())
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> entry : sortedUpdates.tailMap(floor).entrySet())
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Map<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> updates = getUpdates(txState, descriptor, indexOrder);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> entry : updates.entrySet())
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private static java.util.Map<org.Neo4Net.values.storable.ValueTuple,? extends org.Neo4Net.Kernel.Api.StorageEngine.TxState.LongDiffSets> getUpdates(org.Neo4Net.Kernel.Api.StorageEngine.TxState.ReadableTransactionState txState, org.Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor descriptor, org.Neo4Net.Kernel.Api.Internal.IndexOrder indexOrder)
