...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.helpers.collection.Iterators.singleOrNull;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.register.Registers.newDoubleLongRegister;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.Kernel.Api.StorageEngine.TxState.TxStateVisitor_Fields.EMPTY;
...
//ORIGINAL LINE: public Neo4Net.Kernel.Api.StorageEngine.schema.IndexReader indexReader(Neo4Net.Kernel.Api.Internal.IndexReference index, boolean fresh) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: ExplicitIndex explicitNodeIndex(String indexName) throws Neo4Net.Kernel.Api.Internal.Exceptions.explicitindex.ExplicitIndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: ExplicitIndex explicitRelationshipIndex(String indexName) throws Neo4Net.Kernel.Api.Internal.Exceptions.explicitindex.ExplicitIndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.Map<String,String> nodeExplicitIndexGetConfiguration(String indexName) throws Neo4Net.Kernel.Api.Internal.Exceptions.explicitindex.ExplicitIndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.Map<String,String> relationshipExplicitIndexGetConfiguration(String indexName) throws Neo4Net.Kernel.Api.Internal.Exceptions.explicitindex.ExplicitIndexNotFoundKernelException
...
//ORIGINAL LINE: java.util.Iterator<? extends Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> iterator = reader.indexesGetForLabel(labelId);
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Iterator<? extends Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> iterator = reader.indexesGetForRelationshipType(relationshipType);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Iterator<? extends Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> iterator = indexesGetAll(storageReader);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Iterator<? extends Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> indexesGetAll(Neo4Net.Kernel.Api.StorageEngine.StorageSchemaReader reader)
		 internal virtual IEnumerator<IndexDescriptor> IndexesGetAll( StorageSchemaReader reader )
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Iterator<? extends Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> iterator = reader.indexesGetAll();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.InternalIndexState indexGetState(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.StorageEngine.schema.PopulationProgress indexGetPopulationProgress(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.Kernel.Api.StorageEngine.schema.PopulationProgress indexGetPopulationProgress(Neo4Net.Kernel.Api.StorageEngine.StorageSchemaReader reader, Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public long indexGetCommittedId(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.kernel.api.exceptions.schema.SchemaRuleNotFoundException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public String indexGetFailure(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public double indexUniqueValuesSelectivity(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public long indexSize(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public long nodesCountIndexed(Neo4Net.Kernel.Api.Internal.IndexReference index, long nodeId, int propertyKeyId, Neo4Net.values.storable.Value value) throws Neo4Net.Kernel.Api.Internal.Exceptions.KernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.register.Register_DoubleLongRegister indexUpdatesAndSize(Neo4Net.Kernel.Api.Internal.IndexReference index, Neo4Net.register.Register_DoubleLongRegister target) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.register.Register_DoubleLongRegister indexSample(Neo4Net.Kernel.Api.Internal.IndexReference index, Neo4Net.register.Register_DoubleLongRegister target) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.Kernel.Api.Internal.InternalIndexState indexGetState(Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor descriptor) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.Kernel.Api.Internal.InternalIndexState indexGetState(Neo4Net.Kernel.Api.StorageEngine.StorageSchemaReader reader, Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor descriptor) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private boolean checkIndexState(Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor index, Neo4Net.Kernel.Api.StorageEngine.TxState.DiffSets<Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor> diffSet) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: String indexGetFailure(Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor descriptor) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.procs.ProcedureHandle procedureGet(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallRead(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallReadOverride(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallWrite(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallWriteOverride(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallSchema(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallSchemaOverride(int id, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallRead(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallReadOverride(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallWrite(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallWriteOverride(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallSchema(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCallSchemaOverride(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] arguments, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext context) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.values.AnyValue functionCall(int id, Neo4Net.values.AnyValue[] arguments) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.values.AnyValue functionCall(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Neo4Net.values.AnyValue[] arguments) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.values.AnyValue functionCallOverride(int id, Neo4Net.values.AnyValue[] arguments) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.values.AnyValue functionCallOverride(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Neo4Net.values.AnyValue[] arguments) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunction(int id) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunction(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunctionOverride(int id) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunctionOverride(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
		 ...
		 public override IValueMapper<object> ValueMapper()
		 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> callProcedure(int id, Object[] input, final Neo4Net.Kernel.Api.Internal.security.AccessMode override, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext procedureCallContext) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
...
//ORIGINAL LINE: final Neo4Net.Kernel.Api.Internal.security.SecurityContext procedureSecurityContext = ktx.securityContext().withMode(override);
			  SecurityContext procedureSecurityContext = Ktx.securityContext().withMode(@override);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> procedureCall;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.collection.RawIterator<Object[],Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException> callProcedure(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Object[] input, final Neo4Net.Kernel.Api.Internal.security.AccessMode override, Neo4Net.Kernel.Api.Internal.procs.ProcedureCallContext procedureCallContext) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public boolean hasNext() throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
			 public bool hasNext()
			 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public Object[] next() throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
			 public object[] next()
			 {
				  using ( Neo4Net.Kernel.Api.KernelTransaction_Revertable ignore = _outerInstance.ktx.overrideWith( _procedureSecurityContext ) )
				  {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.values.AnyValue callFunction(int id, Neo4Net.values.AnyValue[] input, final Neo4Net.Kernel.Api.Internal.security.AccessMode mode) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.values.AnyValue callFunction(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, Neo4Net.values.AnyValue[] input, final Neo4Net.Kernel.Api.Internal.security.AccessMode mode) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunction(int id, final Neo4Net.Kernel.Api.Internal.security.AccessMode mode) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.Kernel.Api.Internal.procs.UserAggregator aggregationFunction(Neo4Net.Kernel.Api.Internal.procs.QualifiedName name, final Neo4Net.Kernel.Api.Internal.security.AccessMode mode) throws Neo4Net.Kernel.Api.Internal.Exceptions.ProcedureException
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
		 ...
		 private BasicContext PrepareContext( SecurityContext securityContext, ProcedureCallContext procedureCallContext )
		 {
			  ...
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.KernelTransaction, Ktx );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.DatabaseApi, _dataSourceDependencies.resolveDependency( typeof( GraphDatabaseAPI ) ) );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.DependencyResolver, _dataSourceDependencies );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.Thread, Thread.CurrentThread );
			  ClockContext clocks = Ktx.clocks();
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.SystemClock, clocks.SystemClock() );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.StatementClock, clocks.StatementClock() );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.TransactionClock, clocks.TransactionClock() );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.SecurityContext, securityContext );
			  ctx.Put( Neo4Net.Kernel.Api.Procs.Context_Fields.ProcedureCallContext, procedureCallContext );
			  return ctx;
		 }

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: static void assertValidIndex(Neo4Net.Kernel.Api.Internal.IndexReference index) throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException
