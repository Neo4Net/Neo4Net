...
//ORIGINAL LINE: java.util.Map<Neo4Net.values.storable.ValueGroup,java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>>> batchMap = new java.util.HashMap<>();
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>> batch = batchMap.computeIfAbsent(valueGroup, k -> new java.util.ArrayList<>());
					IList<IndexEntryUpdate<object>> batch = batchMap.computeIfAbsent( valueGroup, k => new List<IndexEntryUpdate<object>>() );
					batch.Add( update );
			  }
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<Neo4Net.values.storable.ValueGroup,java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>>> entry : batchMap.entrySet())
