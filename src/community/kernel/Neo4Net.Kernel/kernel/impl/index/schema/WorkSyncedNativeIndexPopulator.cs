...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void process(java.util.Collection<? extends Neo4Net.kernel.api.index.IndexEntryUpdate<?>> indexEntryUpdates) throws Exception
...
//ORIGINAL LINE: private final java.util.Collection<? extends Neo4Net.kernel.api.index.IndexEntryUpdate<?>> updates;
			  ...
			  {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.ArrayList<Neo4Net.kernel.api.index.IndexEntryUpdate<?>> combined = new java.util.ArrayList<>(updates);
