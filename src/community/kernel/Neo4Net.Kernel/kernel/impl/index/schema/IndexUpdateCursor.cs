...
//	import static Neo4Net.kernel.impl.index.schema.IndexUpdateStorage.STOP_TYPE;

	/// <summary>
	/// Cursor over serialized <seealso cref="Neo4Net.kernel.api.index.IndexEntryUpdate"/> represented by <seealso cref="UpdateMode"/>, 2x<seealso cref="KEY"/> and <seealso cref="VALUE"/>.
