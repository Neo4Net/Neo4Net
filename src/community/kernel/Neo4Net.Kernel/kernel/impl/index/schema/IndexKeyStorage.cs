...
//ORIGINAL LINE: private final Neo4Net.index.internal.gbptree.Layout<KEY,?> layout;
		 private readonly Layout<KEY, ?> _layout;

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: IndexKeyStorage(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File file, ByteBufferFactory.Allocator byteBufferFactory, int blockSize, Neo4Net.index.internal.gbptree.Layout<KEY,?> layout) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void add(KEY key, Neo4Net.io.pagecache.PageCursor pageCursor) throws java.io.IOException
