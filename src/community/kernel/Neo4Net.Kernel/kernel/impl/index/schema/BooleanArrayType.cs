...
//	import static Neo4Net.kernel.impl.index.schema.GenericKey.TRUE;
	...
	internal class BooleanArrayType : AbstractArrayType<bool>
	{
		 ...
		 internal BooleanArrayType( sbyte typeId ) : base( ValueGroup.BOOLEAN_ARRAY, typeId, ( o1, o2, i ) -> BooleanType.Compare( o1.long0Array[i], o2.long0Array[i] ), null, ( c, k, i ) -> BooleanType.put( c, k.long0Array[i] ), BooleanType.read, null, Neo4Net.values.storable.ValueWriter_ArrayType.Boolean )
		 {
		 }
