...
//ORIGINAL LINE: public static <T, E extends Exception> void forAll(Neo4Net.function.ThrowingConsumer<T,E> consumer, Iterable<T> subjects) throws E
		 ...
		 /// <exception cref="E"> if consumption fails with this exception </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static <T, E extends Exception> void forAll(Neo4Net.function.ThrowingConsumer<T,E> consumer, T[] subjects) throws E
