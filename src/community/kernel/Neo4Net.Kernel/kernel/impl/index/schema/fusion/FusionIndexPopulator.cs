...
//ORIGINAL LINE: LazyInstanceSelector<java.util.Collection<Neo4Net.kernel.api.index.IndexEntryUpdate<?>>> batchSelector = new LazyInstanceSelector<>(slot -> new java.util.ArrayList<>());
...
//ORIGINAL LINE: for (Neo4Net.kernel.api.index.IndexEntryUpdate<?> update : updates)
			  ...
			  {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Collection<Neo4Net.kernel.api.index.IndexEntryUpdate<?>> batch = batchSelector.getIfInstantiated(slot);
