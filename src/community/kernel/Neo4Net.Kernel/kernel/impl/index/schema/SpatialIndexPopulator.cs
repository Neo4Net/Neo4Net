...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.index.schema.fusion.FusionIndexSampler.combineSamples;
...
//ORIGINAL LINE: java.util.Map<Neo4Net.values.storable.CoordinateReferenceSystem,java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>>> batchMap = new java.util.HashMap<>();
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>> batch = batchMap.computeIfAbsent(point.getCoordinateReferenceSystem(), k -> new java.util.ArrayList<>());
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<Neo4Net.values.storable.CoordinateReferenceSystem,java.util.List<Neo4Net.kernel.api.index.IndexEntryUpdate<?>>> entry : batchMap.entrySet())
