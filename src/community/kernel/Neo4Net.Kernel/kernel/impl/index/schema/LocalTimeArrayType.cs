...
namespace Neo4Net.Kernel.Impl.Index.Schema
{
	...
	internal class LocalTimeArrayType : AbstractArrayType<LocalTime>
	{
		 ...
		 internal LocalTimeArrayType( sbyte typeId ) : base( ValueGroup.LOCAL_TIME_ARRAY, typeId, ( o1, o2, i ) -> LocalTimeType.Compare( o1.long0Array[i], o2.long0Array[i] ), ( k, i ) -> LocalTimeType.AsValueRaw( k.long0Array[i] ), ( c, k, i ) -> LocalTimeType.put( c, k.long0Array[i] ), LocalTimeType.read, LocalTime[]::new, Neo4Net.values.storable.ValueWriter_ArrayType.LocalTime )
		 {
