...
namespace Neo4Net.Kernel.impl.index.labelscan
{
	...
	using TreeFileNotFoundException = Neo4Net.Index.Internal.gbptree.TreeFileNotFoundException;
...
//ORIGINAL LINE: public void start() throws java.io.IOException
		 public override void Start()
		 {
			  if ( _needsRebuild && !_readOnly )
			  {
					...
					_index.checkpoint( Neo4Net.Io.pagecache.IOLimiter_Fields.Unlimited, _writeClean );
