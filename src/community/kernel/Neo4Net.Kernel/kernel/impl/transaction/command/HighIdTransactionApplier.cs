...
//ORIGINAL LINE: private final java.util.Map<Neo4Net.kernel.impl.store.RecordStore<?>,HighId> highIds = new java.util.HashMap<>();
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (java.util.Map.Entry<Neo4Net.kernel.impl.store.RecordStore<?>,HighId> highId : highIds.entrySet())
