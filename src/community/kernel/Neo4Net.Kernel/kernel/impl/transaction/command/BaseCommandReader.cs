...
//ORIGINAL LINE: public final Command read(Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected abstract Command read(byte commandType, Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException;
		 protected internal abstract Command Read( sbyte commandType, ReadableChannel channel );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected java.io.IOException unknownCommandType(byte commandType, Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException
