...
//ORIGINAL LINE: Neo4Net.kernel.impl.transaction.log.ReadableLogChannel getReader(Neo4Net.kernel.impl.transaction.log.LogPosition position) throws java.io.IOException;
		 ...
		 /// <exception cref="IOException"> on I/O error. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.kernel.impl.transaction.log.ReadableLogChannel getReader(Neo4Net.kernel.impl.transaction.log.LogPosition position, Neo4Net.kernel.impl.transaction.log.LogVersionBridge logVersionBridge) throws java.io.IOException;
		 ReadableLogChannel GetReader( LogPosition position, LogVersionBridge logVersionBridge );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void accept(LogFile_LogFileVisitor visitor, Neo4Net.kernel.impl.transaction.log.LogPosition startingFromPosition) throws java.io.IOException;
...
//ORIGINAL LINE: void rotate() throws java.io.IOException;
	 ...
	 {
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: boolean visit(Neo4Net.kernel.impl.transaction.log.ReadableClosablePositionAwareChannel channel) throws java.io.IOException;
