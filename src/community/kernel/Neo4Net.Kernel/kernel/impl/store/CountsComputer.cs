...
namespace Neo4Net.Kernel.impl.store
{
	...
	using NodeCountsStage = Neo4Net.@unsafe.Impl.Batchimport.NodeCountsStage;
	using RelationshipCountsStage = Neo4Net.@unsafe.Impl.Batchimport.RelationshipCountsStage;
...
//	import static Neo4Net.@unsafe.impl.batchimport.staging.ExecutionSupervisors.superviseDynamicExecution;
	...
	public class CountsComputer : DataInitializer<Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater>
	{
		 public static void RecomputeCounts( NeoStores stores, PageCache pageCache, DatabaseLayout databaseLayout )
		 {
			  ...
			  using ( Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater updater = Counts.reset( metaDataStore.LastCommittedTransactionId ) )
			  {
		 ...
		 public override void Initialize( Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater countsUpdater )
		 {
		 ...
		 private void PopulateCountStore( Neo4Net.Kernel.Impl.Api.CountsAccessor_Updater countsUpdater )
		 {
