...
//       BOOLEAN(PropertyType.BOOL, 1, Boolean.class, boolean.class) { int getRequiredBits(Object array, int arrayLength) { return 1; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(boolean value : (boolean[]) array) { result.put(value ? 1 : 0, 1); } } else { for(boolean value : (System.Nullable<bool>[]) array) { result.put(value ? 1 : 0, 1); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_BOOLEAN_ARRAY; } final boolean[] result = new boolean[length]; for(int i = 0; i < length; i++) { result[i] = bits.getByte(requiredBits) != 0; } return Neo4Net.values.storable.Values.booleanArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_BOOLEAN_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       BYTE(PropertyType.BYTE, 8, Byte.class, byte.class) { int getRequiredBits(byte value) { long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & value) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(byte value : (byte[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(byte value : (System.Nullable<sbyte>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(byte b : (byte[]) array) { result.put(b, requiredBits); } } else { for(byte b : (System.Nullable<sbyte>[]) array) { result.put(b, requiredBits); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_BYTE_ARRAY; } final byte[] result = new byte[length]; for(int i = 0; i < length; i++) { result[i] = bits.getByte(requiredBits); } return Neo4Net.values.storable.Values.byteArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_BYTE_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       SHORT(PropertyType.SHORT, 16, Short.class, short.class) { int getRequiredBits(short value) { long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & value) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(short value : (short[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(short value : (System.Nullable<short>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(short value : (short[]) array) { result.put(value, requiredBits); } } else { for(short value : (System.Nullable<short>[]) array) { result.put(value, requiredBits); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_SHORT_ARRAY; } final short[] result = new short[length]; for(int i = 0; i < length; i++) { result[i] = bits.getShort(requiredBits); } return Neo4Net.values.storable.Values.shortArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_SHORT_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       CHAR(PropertyType.CHAR, 16, Character.class, char.class) { int getRequiredBits(char value) { long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & value) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(char value : (char[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(char value : (System.Nullable<char>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(char value : (char[]) array) { result.put(value, requiredBits); } } else { for(char value : (System.Nullable<char>[]) array) { result.put(value, requiredBits); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_CHAR_ARRAY; } final char[] result = new char[length]; for(int i = 0; i < length; i++) { result[i] = (char) bits.getShort(requiredBits); } return Neo4Net.values.storable.Values.charArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_CHAR_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       INT(PropertyType.INT, 32, Integer.class, int.class) { int getRequiredBits(int value) { long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & value) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(int value : (int[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(int value : (System.Nullable<int>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(int value : (int[]) array) { result.put(value, requiredBits); } } else { for(int value : (System.Nullable<int>[]) array) { result.put(value, requiredBits); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_INT_ARRAY; } final int[] result = new int[length]; for(int i = 0; i < length; i++) { result[i] = bits.getInt(requiredBits); } return Neo4Net.values.storable.Values.intArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_INT_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       LONG(PropertyType.LONG, 64, Long.class, long.class) { public int getRequiredBits(long value) { long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & value) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(long value : (long[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(long value : (System.Nullable<long>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(long value : (long[]) array) { result.put(value, requiredBits); } } else { for(long value : (System.Nullable<long>[]) array) { result.put(value, requiredBits); } } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_LONG_ARRAY; } final long[] result = new long[length]; for(int i = 0; i < length; i++) { result[i] = bits.getLong(requiredBits); } return Neo4Net.values.storable.Values.longArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_LONG_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       FLOAT(PropertyType.FLOAT, 32, Float.class, float.class) { int getRequiredBits(float value) { int v = Float.floatToIntBits(value); long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & v) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(float value : (float[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(float value : (System.Nullable<float>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(float value : (float[]) array) { result.put(Float.floatToIntBits(value), requiredBits); } } else { for(float value : (System.Nullable<float>[]) array) { result.put(Float.floatToIntBits(value), requiredBits); } } } public void writeAll(Object array, byte[] result, int offset) { if(isPrimitive(array)) { float[] values = (float[]) array; for(int i = 0; i < values.length; i++) { writeFloat(values[i], result, offset + i * 4); } } else { Float[] values = (System.Nullable<float>[]) array; for(int i = 0; i < values.length; i++) { writeFloat(values[i], result, offset + i * 4); } } } private void writeFloat(float floaValue, byte[] result, int offset) { long value = Float.floatToIntBits(floaValue); for(int b = 0; b < 4; b++) { result[offset + b] = (byte)((value >> (b * 8)) & 0xFFL); } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_FLOAT_ARRAY; } final float[] result = new float[length]; for(int i = 0; i < length; i++) { result[i] = Float.intBitsToFloat(bits.getInt(requiredBits)); } return Neo4Net.values.storable.Values.floatArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_FLOAT_ARRAY; } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       DOUBLE(PropertyType.DOUBLE, 64, Double.class, double.class) { int getRequiredBits(double value) { long v = Double.doubleToLongBits(value); long mask = 1L << maxBits - 1; for(int i = maxBits; i > 0; i--, mask >>= 1) { if((mask & v) != 0) { return i; } } return 1; } int getRequiredBits(Object array, int arrayLength) { int highest = 1; if(isPrimitive(array)) { for(double value : (double[]) array) { highest = Math.max(getRequiredBits(value), highest); } } else { for(double value : (System.Nullable<double>[]) array) { highest = Math.max(getRequiredBits(value), highest); } } return highest; } public void writeAll(Object array, int length, int requiredBits, Neo4Net.kernel.impl.util.Bits result) { if(isPrimitive(array)) { for(double value : (double[]) array) { result.put(Double.doubleToLongBits(value), requiredBits); } } else { for(double value : (System.Nullable<double>[]) array) { result.put(Double.doubleToLongBits(value), requiredBits); } } } public void writeAll(Object array, byte[] result, int offset) { if(isPrimitive(array)) { double[] values = (double[]) array; for(int i = 0; i < values.length; i++) { writeDouble(values[i], result, offset + i * 8); } } else { Double[] values = (System.Nullable<double>[]) array; for(int i = 0; i < values.length; i++) { writeDouble(values[i], result, offset + i * 8); } } } private void writeDouble(double doubleValue, byte[] result, int offset) { long value = Double.doubleToLongBits(doubleValue); for(int b = 0; b < 8; b++) { result[offset + b] = (byte)((value >> (b * 8)) & 0xFFL); } } public Neo4Net.values.storable.ArrayValue createArray(int length, Neo4Net.kernel.impl.util.Bits bits, int requiredBits) { if(length == 0) { return Neo4Net.values.storable.Values.EMPTY_DOUBLE_ARRAY; } final double[] result = new double[length]; for(int i = 0; i < length; i++) { result[i] = Double.longBitsToDouble(bits.getLong(requiredBits)); } return Neo4Net.values.storable.Values.doubleArray(result); } public Neo4Net.values.storable.ArrayValue createEmptyArray() { return Neo4Net.values.storable.Values.EMPTY_DOUBLE_ARRAY; } };
