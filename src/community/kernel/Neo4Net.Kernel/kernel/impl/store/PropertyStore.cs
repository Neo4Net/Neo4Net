...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.impl.store.NoStoreHeaderFormat.NO_STORE_HEADER_FORMAT;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: public <FAILURE extends Exception> void accept(RecordStore_Processor<FAILURE> processor, Neo4Net.kernel.impl.store.record.PropertyRecord record) throws FAILURE
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public void writePoint(Neo4Net.values.storable.CoordinateReferenceSystem crs, double[] coordinate) throws IllegalArgumentException
