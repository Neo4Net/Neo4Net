...
//ORIGINAL LINE: READ_ONLY_CONCURRENT_HASH_MAP { @Override public <Key> ActiveState<Key> open(ReadableState<Key> store, java.io.File file, Neo4Net.io.pagecache.tracing.cursor.context.VersionContextSupplier versionContextSupplier) { return new ConcurrentMapState<Key>(store, file, Neo4Net.io.pagecache.tracing.cursor.context.EmptyVersionContextSupplier.EMPTY) { @Override protected boolean hasChanges() { return false; } }; } }
