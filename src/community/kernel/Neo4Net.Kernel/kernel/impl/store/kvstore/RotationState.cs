...
//ORIGINAL LINE: final EntryUpdater<Key> pre = preState.updater(version, lock);
			  ...
			  private class EntryUpdaterAnonymousInnerClass : EntryUpdater<Key>
			  {
				  ...
				  private Neo4Net.Kernel.impl.store.kvstore.EntryUpdater<Key> _post;
				  private Neo4Net.Kernel.impl.store.kvstore.EntryUpdater<Key> _pre;

				  public EntryUpdaterAnonymousInnerClass( Rotation<Key> outerInstance, Lock @lock, Neo4Net.Kernel.impl.store.kvstore.EntryUpdater<Key> post, Neo4Net.Kernel.impl.store.kvstore.EntryUpdater<Key> pre ) : base( @lock )
				  {
