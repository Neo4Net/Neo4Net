...
//ORIGINAL LINE: public final KeyValueStoreFile createStore(Neo4Net.io.fs.FileSystemAbstraction fs, Neo4Net.io.pagecache.PageCache pages, java.io.File path, int keySize, int valueSize, Headers headers, DataProvider data) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public final void createEmptyStore(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File path, int keySize, int valueSize, Headers headers) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public final KeyValueStoreFile openStore(Neo4Net.io.fs.FileSystemAbstraction fs, Neo4Net.io.pagecache.PageCache pages, java.io.File path) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private KeyValueStoreFile create(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File path, Neo4Net.io.pagecache.PageCache pages, int keySize, int valueSize, Headers headers, DataProvider dataProvider) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private KeyValueWriter newWriter(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File path, ReadableBuffer formatSpecifier, Neo4Net.io.pagecache.PageCache pages, int pageSize, int keySize, int valueSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private KeyValueStoreFile open(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File path, Neo4Net.io.pagecache.PageCache pages) throws java.io.IOException
