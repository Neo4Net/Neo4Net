...
//ORIGINAL LINE: public final Neo4Net.helpers.collection.Pair<java.io.File, KeyValueStoreFile> open() throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public final Neo4Net.helpers.collection.Pair<java.io.File, KeyValueStoreFile> create(DataProvider initialData, long version) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public final Neo4Net.helpers.collection.Pair<java.io.File, KeyValueStoreFile> next(java.io.File file, Headers headers, DataProvider data) throws java.io.IOException
