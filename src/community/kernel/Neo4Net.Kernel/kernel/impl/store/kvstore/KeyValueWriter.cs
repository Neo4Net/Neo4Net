...
//ORIGINAL LINE: public static KeyValueWriter create(MetadataCollector metadata, Neo4Net.io.fs.FileSystemAbstraction fs, Neo4Net.io.pagecache.PageCache pages, java.io.File path, int pageSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: static Writer create(Neo4Net.io.fs.FileSystemAbstraction fs, Neo4Net.io.pagecache.PageCache pages, java.io.File path, int pageSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: PageWriter(Neo4Net.io.pagecache.PagedFile file) throws java.io.IOException
