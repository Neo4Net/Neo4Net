...
namespace Neo4Net.Kernel.impl.store
{
	...
	using ArrayQueueOutOfOrderSequence = Neo4Net.Kernel.impl.util.ArrayQueueOutOfOrderSequence;
	using Bits = Neo4Net.Kernel.impl.util.Bits;
	using OutOfOrderSequence = Neo4Net.Kernel.impl.util.OutOfOrderSequence;
...
//ORIGINAL LINE: protected void initialiseNewStoreFile(org.neo4j.io.pagecache.PagedFile file) throws java.io.IOException
		 protected internal override void InitializeNewStoreFile( PagedFile file )
		 {
			  ...
			  SetUpgradeTransaction( Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_ID, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_CHECKSUM, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_COMMIT_TIMESTAMP );
			  CurrentLogVersion = 0;
			  SetLastCommittedAndClosedTransactionId( Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_ID, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_CHECKSUM, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_COMMIT_TIMESTAMP, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BaseTxLogByteOffset, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_LOG_VERSION );
...
//ORIGINAL LINE: private void readAllFields(org.neo4j.io.pagecache.PageCursor cursor) throws java.io.IOException
		 private void ReadAllFields( PageCursor cursor )
		 {
			  do
			  {
					...
					_highestCommittedTransaction.set( lastCommittedTxId, GetRecordValue( cursor, Position.LastTransactionChecksum ), GetRecordValue( cursor, Position.LastTransactionCommitTimestamp, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.UNKNOWN_TX_COMMIT_TIMESTAMP ) );
					_upgradeCommitTimestampField = GetRecordValue( cursor, Position.UpgradeTransactionCommitTimestamp, Neo4Net.Kernel.impl.transaction.log.TransactionIdStore_Fields.BASE_TX_COMMIT_TIMESTAMP );
...
//ORIGINAL LINE: public void logRecords(final org.neo4j.logging.Logger msgLog)
		 ...
		 public override void Accept<FAILURE>( Neo4Net.Kernel.impl.store.RecordStore_Processor<FAILURE> processor, MetaDataRecord record ) where FAILURE : Exception
		 {
