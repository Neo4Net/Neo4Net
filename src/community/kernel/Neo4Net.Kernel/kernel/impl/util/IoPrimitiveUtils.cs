...
//ORIGINAL LINE: public static String readString(Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel, int length) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static void write3bLengthAndString(Neo4Net.Kernel.Api.StorageEngine.WritableChannel channel, String string) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static String read3bLengthAndString(Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static void write2bLengthAndString(Neo4Net.Kernel.Api.StorageEngine.WritableChannel channel, String string) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static String read2bLengthAndString(Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static java.util.Map<String, String> read2bMap(Neo4Net.Kernel.Api.StorageEngine.ReadableChannel channel) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static void writeLengthAndString(Neo4Net.io.fs.StoreChannel channel, ByteBuffer buffer, String value) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void writeChars(Neo4Net.io.fs.StoreChannel channel, ByteBuffer buffer, char[] chars) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static void writeInt(Neo4Net.io.fs.StoreChannel channel, ByteBuffer buffer, int value) throws java.io.IOException
