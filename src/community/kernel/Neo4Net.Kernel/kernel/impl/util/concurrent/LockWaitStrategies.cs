...
//ORIGINAL LINE: SPIN { @Override public void apply(long iteration) throws org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException { } },
		 SPIN { public void apply( long iteration ) throws AcquireLockTimeoutException { } },
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: YIELD { @Override public void apply(long iteration) throws org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException { Thread.yield(); } },
		 YIELD
		 {
			 public void apply( long iteration ) throws AcquireLockTimeoutException { Thread.yield(); }
		 },
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: INCREMENTAL_BACKOFF { private static final int spinIterations = 1000; private static final long multiplyUntilIteration = spinIterations + 2; @Override public void apply(long iteration) throws org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException { if(iteration < spinIterations) { SPIN.apply(iteration); return; } try { if(iteration < multiplyUntilIteration) { Thread.sleep(0, 1 << (iteration - spinIterations)); } else { Thread.sleep(0, 500); } } catch(InterruptedException e) { Thread.interrupted(); throw new org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException(e, "Interrupted while waiting.", Interrupted); } } },
		 INCREMENTAL_BACKOFF
		 {
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: NO_WAIT { @Override public void apply(long iteration) throws org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException { throw new org.Neo4Net.Kernel.Api.StorageEngine.lock.AcquireLockTimeoutException("Cannot acquire lock, and refusing to wait.", org.Neo4Net.kernel.api.exceptions.Status_Transaction.DeadlockDetected); } }
		 NO_WAIT
		 {
