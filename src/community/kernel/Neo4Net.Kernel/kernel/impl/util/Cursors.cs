...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") public static <T> Neo4Net.cursor.Cursor<T> empty()
...
//ORIGINAL LINE: public static <E extends Exception> int count(Neo4Net.cursor.RawCursor<?,E> cursor) throws E
