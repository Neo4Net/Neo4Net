...
//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		 ...
		 /// <seealso cref="Neo4Net.kernel.impl.locking.community.RWLock.TxLockElement"/> will be marked as terminated.
...
//ORIGINAL LINE: synchronized boolean acquireReadLock(Neo4Net.Kernel.Api.StorageEngine.lock.LockTracer tracer, Object tx) throws Neo4Net.kernel.DeadlockDetectedException
...
//JAVA TO C# CONVERTER TODO TASK: .NET enumerators are read-only:
		 ...
		 /// <exception cref="DeadlockDetectedException"> if a deadlock is detected </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: synchronized boolean acquireWriteLock(Neo4Net.Kernel.Api.StorageEngine.lock.LockTracer tracer, Object tx) throws Neo4Net.kernel.DeadlockDetectedException
