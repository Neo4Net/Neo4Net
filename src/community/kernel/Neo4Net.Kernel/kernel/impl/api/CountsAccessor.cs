...
namespace Neo4Net.Kernel.Impl.Api
{
	...
	public interface ICountsAccessor : CountsVisitor_Visitable
	{
	 ...
	 public interface ICountsAccessor_Updater : IDisposable
	 {
	 ...
	 public interface ICountsAccessor_IndexStatsUpdater : IDisposable
	 {
