...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void force(Neo4Net.io.pagecache.IOLimiter ioLimiter) throws java.io.IOException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.Kernel.Api.StorageEngine.schema.IndexReader newReader() throws Neo4Net.Kernel.Api.Internal.Exceptions.Schema.IndexNotFoundKernelException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: boolean awaitStoreScanCompleted(long time, java.util.concurrent.TimeUnit unit) throws Neo4Net.kernel.api.exceptions.index.IndexPopulationFailedKernelException, InterruptedException;
		 bool AwaitStoreScanCompleted( long time, TimeUnit unit );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void activate() throws Neo4Net.kernel.api.exceptions.index.IndexActivationFailedKernelException;
		 void Activate();

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void validate() throws Neo4Net.kernel.api.exceptions.index.IndexPopulationFailedKernelException, Neo4Net.kernel.api.exceptions.schema.UniquePropertyValueValidationException;
		 void Validate();
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Neo4Net.graphdb.ResourceIterator<java.io.File> snapshotFiles() throws java.io.IOException;
		 IResourceIterator<File> SnapshotFiles();

//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//		 default void verifyDeferredConstraints(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor accessor) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException, java.io.IOException
	//	 {
