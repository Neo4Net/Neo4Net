...
//ORIGINAL LINE: TransactionApplier startTx(org.Neo4Net.storageengine.api.CommandsToApply transaction) throws java.io.IOException;
		 ...
		 /// <exception cref="IOException"> on error. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: TransactionApplier startTx(org.Neo4Net.storageengine.api.CommandsToApply transaction, org.Neo4Net.kernel.impl.locking.LockGroup lockGroup) throws java.io.IOException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public TransactionApplier startTx(org.Neo4Net.storageengine.api.CommandsToApply transaction, org.Neo4Net.kernel.impl.locking.LockGroup lockGroup) throws java.io.IOException
