...
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.NodeRecord,Void> nodeLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.NodeRecord> store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.PropertyRecord,Neo4Net.kernel.impl.store.record.PrimitiveRecord> propertyLoader(final Neo4Net.kernel.impl.store.PropertyStore store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.RelationshipRecord,Void> relationshipLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.RelationshipRecord> store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.RelationshipGroupRecord,int> relationshipGroupLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.RelationshipGroupRecord> store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.SchemaRecord,Neo4Net.Kernel.Api.StorageEngine.schema.SchemaRule> schemaRuleLoader(final Neo4Net.kernel.impl.store.SchemaStore store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.PropertyKeyTokenRecord,Void> propertyKeyTokenLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.PropertyKeyTokenRecord> store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.LabelTokenRecord,Void> labelTokenLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.LabelTokenRecord> store)
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: public static Neo4Net.kernel.impl.transaction.state.RecordAccess_Loader<Neo4Net.kernel.impl.store.record.RelationshipTypeTokenRecord,Void> relationshipTypeTokenLoader(final Neo4Net.kernel.impl.store.RecordStore<Neo4Net.kernel.impl.store.record.RelationshipTypeTokenRecord> store)
		 ...
		 protected internal static RECORD AndMarkAsCreated<RECORD>( RECORD record ) where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
		 {
			  record.setCreated();
			  return record;
		 }
