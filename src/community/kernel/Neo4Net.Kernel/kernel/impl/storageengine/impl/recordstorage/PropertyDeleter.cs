...
namespace Neo4Net.Kernel.impl.storageengine.impl.recordstorage
{
	...
	public class PropertyDeleter
	{
		 ...
		 public virtual bool RemovePropertyIfExists<P>( RecordAccess_RecordProxy<P, Void> primitiveProxy, int propertyKey, RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords ) where P : Neo4Net.Kernel.Impl.Store.Records.PrimitiveRecord
		 {
		 ...
		 public virtual void RemoveProperty<P>( RecordAccess_RecordProxy<P, Void> primitiveProxy, int propertyKey, RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords ) where P : Neo4Net.Kernel.Impl.Store.Records.PrimitiveRecord
		 {
			  PrimitiveRecord primitive = primitiveProxy.ForReadingData();
		 ...
		 private void RemoveProperty<P>( RecordAccess_RecordProxy<P, Void> primitiveProxy, int propertyKey, RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords, PrimitiveRecord primitive, long propertyId ) where P : Neo4Net.Kernel.Impl.Store.Records.PrimitiveRecord
		 {
		 ...
		 private void UnlinkPropertyRecord<P>( PropertyRecord propRecord, RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords, RecordAccess_RecordProxy<P, Void> primitiveRecordChange ) where P : Neo4Net.Kernel.Impl.Store.Records.PrimitiveRecord
		 {
