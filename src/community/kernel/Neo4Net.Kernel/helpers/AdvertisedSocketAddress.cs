...
{
	public class AdvertisedSocketAddress : SocketAddress
	{
		 public AdvertisedSocketAddress( string hostname, int port ) : base( hostname, port )
		 {
		 }

		 /// <summary>
		 /// Textual representation format for an advertised socket address. </summary>
