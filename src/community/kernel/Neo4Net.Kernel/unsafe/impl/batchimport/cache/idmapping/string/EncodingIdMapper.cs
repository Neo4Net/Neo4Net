...
//	import static Neo4Net.@unsafe.impl.batchimport.cache.idmapping.@string.ParallelSort.DEFAULT;
	...
	/// - input id:
	///       An id coming from the user that is associated with a Neo4Net id by calling <seealso cref="put(object, long, Group)"/>.
	///       the first argument is the id that the user specified, the second is the Neo4Net id that user id will
	///       be associated with.
	/// - encoder:
	...
	/// - data cache:
	///       An array of eIds. eIds are added in the order of Neo4Net ids, i.e. in the order in which they are put.
	/// - tracker cache:
