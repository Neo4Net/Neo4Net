...
//ORIGINAL LINE: public Iterable<Neo4Net.helpers.collection.Pair<Step<?>,float>> stepsOrderedBy(final Neo4Net.unsafe.impl.batchimport.stats.Key stat, final boolean trueForAscending)
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: return () -> new Neo4Net.helpers.collection.PrefetchingIterator<Neo4Net.helpers.collection.Pair<Step<?>,float>>()
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: protected Neo4Net.helpers.collection.Pair<Step<?>,float> fetchNextOrNull()
