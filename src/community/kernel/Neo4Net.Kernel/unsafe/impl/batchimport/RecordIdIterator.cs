...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.collection.PrimitiveLongCollections.range;
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//		 static RecordIdIterator allIn(Neo4Net.kernel.impl.store.RecordStore<JavaToDotNetGenericWildcard extends Neo4Net.kernel.impl.store.record.AbstractBaseRecord> store, Configuration config)
	//	 {
	//		  return forwards(store.getNumberOfReservedLowIds(), store.getHighId(), config);
	//	 }

//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java static interface methods:
//		 static RecordIdIterator allInReversed(Neo4Net.kernel.impl.store.RecordStore<JavaToDotNetGenericWildcard extends Neo4Net.kernel.impl.store.record.AbstractBaseRecord> store, Configuration config)
	//	 {
