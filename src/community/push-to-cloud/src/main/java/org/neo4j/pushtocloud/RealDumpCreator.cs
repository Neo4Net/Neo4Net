...
//ORIGINAL LINE: public void dumpDatabase(String database, java.nio.file.Path targetDumpFile) throws Neo4Net.commandline.admin.CommandFailed, Neo4Net.commandline.admin.IncorrectUsage
