...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void init(Neo4Net.bolt.v1.transport.socket.client.TransportConnection client) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void createAndRollback(Neo4Net.bolt.v1.transport.socket.client.TransportConnection client) throws Exception
