...
//	import static org.junit.Assert.fail;
	...
	public abstract class TraversalTestBase : AbstractNeo4NetTestCase
	{
		 ...
		 {
			 IResourceIterable<Node> allNodes = GraphDb.AllNodes;
			  using ( IResourceIterator<Node> nodeIterator = allNodes.GetEnumerator() )
			  {
...
//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
//ORIGINAL LINE: public RelationshipRepresentation(Representation<? super Neo4Net.graphdb.Node> nodes)
...
//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
//ORIGINAL LINE: public NodePathRepresentation(Representation<? super Neo4Net.graphdb.Node> nodes)
