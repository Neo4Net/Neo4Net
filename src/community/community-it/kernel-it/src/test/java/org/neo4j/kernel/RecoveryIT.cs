...
//ORIGINAL LINE: public org.Neo4Net.graphdb.GraphDatabaseService newDatabase(@Nonnull Config config)
		 ...
		 private static void AssertSameStoreContents<RECORD>( RecordStore<RECORD> store1, RecordStore<RECORD> store2 ) where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord
		 {
