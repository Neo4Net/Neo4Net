...
//ORIGINAL LINE: @Test public void shouldTerminateWhenCallingMethodsOnIndexDefinitions()
		 ...
		 protected internal override IndexDefinition ObtainEntityInTransaction( IGraphDatabaseService IGraphDatabaseService )
		 {
			  return IGraphDatabaseService.Schema().indexFor(Label.label("Label")).on("property").create();
		 }
	}
