...
//ORIGINAL LINE: final Neo4Net.cypher.internal.javacompat.ExecutionResult result = result("node", n);
...
//ORIGINAL LINE: @Test public void testEscapingOfRelationshipStringPropertyValue()
		 public virtual void TestEscapingOfRelationshipStringPropertyValue()
		 {
			  Node n = _gdb.createNode();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Relationship rel = n.createRelationshipTo(n, Neo4Net.graphdb.RelationshipType.withName("REL"));
			  Relationship rel = n.CreateRelationshipTo( n, RelationshipType.withName( "REL" ) );
			  rel.SetProperty( "name", "Brutus \"Brutal\" Howell" );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.cypher.internal.javacompat.ExecutionResult result = result("rel", rel);
...
//ORIGINAL LINE: @Test public void testExportIndexesViaCypherResult()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Label label = Neo4Net.graphdb.Label.label("Foo");
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Relationship rel = n1.createRelationshipTo(n2, Neo4Net.graphdb.RelationshipType.withName("REL"));
			  Relationship rel = n1.CreateRelationshipTo( n2, RelationshipType.withName( "REL" ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Path path = new Neo4Net.graphalgo.impl.util.PathImpl.Builder(n1).push(rel).build();
			  Path path = ( new PathImpl.Builder( n1 ) ).push( rel ).build();
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.cypher.internal.javacompat.ExecutionResult result = result("path", path);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") private Neo4Net.cypher.internal.javacompat.ExecutionResult result(String column, Object value)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.ResourceIterator<java.util.Map<String, Object>> iterator = new Neo4Net.graphdb.ResourceIterator<java.util.Map<String, Object>>()
			  IResourceIterator<IDictionary<string, object>> iterator = new ResourceIteratorAnonymousInnerClass( this, inner );
...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
		 ...
		 private class ResourceIteratorAnonymousInnerClass : IResourceIterator<IDictionary<string, object>>
		 {
...
//ORIGINAL LINE: @Test public void testFromSimpleGraph()
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Node n0 = gdb.createNode();
			  Node n0 = _gdb.createNode();

//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Node n1 = gdb.createNode();
			  Node n1 = _gdb.createNode();
			  n1.SetProperty( "name", "Node1" );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.graphdb.Relationship relationship = n0.createRelationshipTo(n1, Neo4Net.graphdb.RelationshipType.withName("REL"));
