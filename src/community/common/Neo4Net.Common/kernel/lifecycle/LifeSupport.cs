...
namespace Neo4Net.Kernel.Lifecycle
{
   ...
   /// </para>
   /// </summary>
   public class LifeSupport : ILifecycle
   {
            ...
            if (_status == LifecycleStatus.None)
            {
               ...
               foreach (LifecycleInstance instance in _instances)
               {
                  ...
                  catch (LifecycleException e)
                  {
                     ...
                     {
                        //$!!$ tac e.AddSuppressed(shutdownErr);
                     }
      ...
      public virtual T setLast<T>(T instance) where T : ILifecycle
      {
         lock (this)
         {
            if (_last != null)
      ...
      private LifecycleInstance AddNewComponent<T>(T instance) where T : ILifecycle
      {
      ...
      private void ValidateNotAlreadyPartOfLifecycle(ILifecycle instance)
      {
      ...
      public virtual bool Remove(ILifecycle instance)
      {
         lock (this)
         {
      ...
      public virtual IList<ILifecycle> LifecycleInstances
      {
         get
         {
      ...
      private LifecycleStatus ChangedStatus(ILifecycle instance, LifecycleStatus oldStatus, LifecycleStatus newStatus)
      {
      ...
      private class LifecycleInstance : ILifecycle
      {
         private readonly LifeSupport _outerInstance;

         internal ILifecycle Instance;
         internal LifecycleStatus CurrentStatus = LifecycleStatus.None;
         internal Exception AddedWhere;

         internal LifecycleInstance(LifeSupport outerInstance, ILifecycle instance)
         {
         ...
         public virtual bool IsInstance(ILifecycle instance)
         {
