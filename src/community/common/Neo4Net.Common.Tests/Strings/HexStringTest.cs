...
namespace Neo4Net.Strings
{
   ...
   internal class HexStringTest
   {
      ...
      [Fact] //ORIGINAL LINE: @Test void shouldEncodeBytesToString()
      ...
      //JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
      [Fact] //ORIGINAL LINE: @Test void shouldEncodeEmptyBytesToEmptyString()
      ...
      //JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
      [Fact] //ORIGINAL LINE: @Test void shouldDecodeStringToBytes()
      ...
      //JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
      [Fact] //ORIGINAL LINE: @Test void shouldDecodeEmptyStringToEmptyBytes()
