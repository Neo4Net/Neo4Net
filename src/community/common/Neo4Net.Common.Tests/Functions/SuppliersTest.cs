...
namespace Neo4Net.Functions
{
   ...
   public class SuppliersTest
   {
      ...
      [Fact] //ORIGINAL LINE: @Test void adaptedSupplierShouldOnlyCallAdaptorOnceForEachNewInstance()
      ...
      //JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
      [Fact] //ORIGINAL LINE: @Test void correctlyReportNotInitializedSuppliers()
      internal virtual void CorrectlyReportNotInitializedSuppliers()
      {
      ...
      //JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
      [Fact] //ORIGINAL LINE: @Test void correctlyReportInitializedSuppliers()
      internal virtual void CorrectlyReportInitializedSuppliers()
      {
         //JAVA TO C# CONVERTER TODO TASK: Method reference constructor syntax is not converted by Java to C# Converter:
         Suppliers.Lazy<object> lazySingleton = Suppliers.LazySingleton(object::new );
         lazySingleton.get();
         assertTrue(lazySingleton.Initialized);
      }
   }
}