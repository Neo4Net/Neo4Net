...
//ORIGINAL LINE: void verifyUniqueness(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor accessor, int[] propertyKeyIds) throws java.io.IOException, Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void verifyUniqueness(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor accessor, int[] propertyKeyIds, java.util.List<Neo4Net.values.storable.Value[]> updatedValueTuples) throws java.io.IOException, Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException;
