...
//ORIGINAL LINE: void verify(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor accessor, int[] propKeyIds) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException, java.io.IOException;
		 ...
		 /// <exception cref="IOException"> when Lucene throws <seealso cref="IOException"/>. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void verify(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor accessor, int[] propKeyIds, java.util.List<Neo4Net.values.storable.Value[]> updatedValueTuples) throws Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException, java.io.IOException;
