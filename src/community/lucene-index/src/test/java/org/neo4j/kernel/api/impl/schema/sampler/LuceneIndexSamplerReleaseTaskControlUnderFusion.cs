...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.Kernel.Api.Internal.IndexCapability.NO_CAPABILITY;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: @Rule public Neo4Net.test.rule.fs.FileSystemRule fs = new Neo4Net.test.rule.fs.EphemeralFileSystemRule();
		 public FileSystemRule Fs = new EphemeralFileSystemRule();

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Rule public Neo4Net.test.rule.TestDirectory dir = Neo4Net.test.rule.TestDirectory.testDirectory(fs.get());
...
//ORIGINAL LINE: @Before public void setup()
		 ...
		 /// This was a problem for <seealso cref="LuceneIndexSampler"/>. It owns a <seealso cref="Neo4Net.helpers.TaskControl"/> that it will try to release in try-finally
		 /// in <seealso cref="LuceneIndexSampler.sampleIndex()"/>. But it never gets here because a prior <seealso cref="IndexSampler"/> fails.
		 /// </para>
		 /// <para>
		 /// Because the <seealso cref="Neo4Net.helpers.TaskControl"/> was never released the lucene accessor would block forever, waiting for
		 ...
		 /// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test(timeout = 5_000L) public void failedIndexSamplingMustNotPreventIndexDrop() throws java.io.IOException, Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void makeSureIndexHasSomeData(Neo4Net.kernel.api.index.IndexProvider provider) throws java.io.IOException, Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException
