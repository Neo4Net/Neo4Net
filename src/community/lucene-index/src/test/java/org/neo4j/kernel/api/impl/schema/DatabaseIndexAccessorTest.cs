...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(0) public Neo4Net.Kernel.Api.StorageEngine.schema.IndexDescriptor index;
		 public IndexDescriptor Index;
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(1) public Neo4Net.function.IOFunction<Neo4Net.kernel.api.impl.index.storage.DirectoryFactory,LuceneIndexAccessor> accessorFactory;
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private Neo4Net.kernel.api.index.IndexEntryUpdate<?> remove(long nodeId, Object value)
