...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void runUniquenessVerification(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor, org.apache.lucene.search.IndexSearcher indexSearcher) throws java.io.IOException, Neo4Net.kernel.api.exceptions.index.IndexEntryConflictException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertNoDuplicates(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertNoDuplicatesCreated(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor, java.util.List<Neo4Net.values.storable.Value[]> updatedPropertyValues) throws Exception
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertHasDuplicates(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void assertDuplicatesCreated(Neo4Net.Kernel.Api.StorageEngine.NodePropertyAccessor nodePropertyAccessor, java.util.List<Neo4Net.values.storable.Value[]> updatedPropertyValues) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private Neo4Net.kernel.api.impl.schema.verification.UniquenessVerifier newSimpleUniquenessVerifier() throws java.io.IOException
