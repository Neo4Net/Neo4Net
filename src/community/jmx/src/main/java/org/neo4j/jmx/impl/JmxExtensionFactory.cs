...
//ORIGINAL LINE: @Service.Implementation(KernelExtensionFactory.class) @Deprecated public final class JmxExtensionFactory extends Neo4Net.kernel.extension.KernelExtensionFactory<JmxExtensionFactory.Dependencies>
	[Obsolete]
