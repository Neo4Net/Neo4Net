...
//ORIGINAL LINE: void create(Neo4Net.kernel.impl.security.User user) throws Neo4Net.kernel.api.exceptions.InvalidArgumentsException, java.io.IOException;
		 ...
		 /// <exception cref="IOException"> if the underlying storage for users fails </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void setUsers(ListSnapshot<Neo4Net.kernel.impl.security.User> users) throws Neo4Net.kernel.api.exceptions.InvalidArgumentsException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void update(Neo4Net.kernel.impl.security.User existingUser, Neo4Net.kernel.impl.security.User updatedUser) throws Neo4Net.server.security.auth.exception.ConcurrentModificationException, java.io.IOException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: boolean delete(Neo4Net.kernel.impl.security.User user) throws java.io.IOException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void assertValidUsername(String username) throws Neo4Net.kernel.api.exceptions.InvalidArgumentsException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: ListSnapshot<Neo4Net.kernel.impl.security.User> getPersistedSnapshot() throws java.io.IOException;
