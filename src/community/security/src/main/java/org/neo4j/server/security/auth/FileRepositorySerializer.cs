...
//ORIGINAL LINE: public static void WriteToFile(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File file, byte[] bytes) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public static java.util.List<String> readFromFile(Neo4Net.io.fs.FileSystemAbstraction fs, java.io.File file) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public void saveRecordsToFile(Neo4Net.io.fs.FileSystemAbstraction fileSystem, java.io.File recordsFile, java.util.Collection<S> records) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected java.io.File getTempFile(Neo4Net.io.fs.FileSystemAbstraction fileSystem, java.io.File recordsFile) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.List<S> loadRecordsFromFile(Neo4Net.io.fs.FileSystemAbstraction fileSystem, java.io.File recordsFile) throws java.io.IOException, Neo4Net.server.security.auth.exception.FormatException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.List<S> deserializeRecords(byte[] bytes) throws Neo4Net.server.security.auth.exception.FormatException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.List<S> deserializeRecords(java.util.List<String> lines) throws Neo4Net.server.security.auth.exception.FormatException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected abstract S deserializeRecord(String line, int lineNumber) throws Neo4Net.server.security.auth.exception.FormatException;
