...
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Stop extends org.Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider
	public class Stop : AnalyzerProvider
	{
