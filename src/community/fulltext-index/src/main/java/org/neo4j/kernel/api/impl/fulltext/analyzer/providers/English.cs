...
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class English extends org.Neo4Net.graphdb.index.fulltext.AnalyzerProvider
	public class English : AnalyzerProvider
	{
