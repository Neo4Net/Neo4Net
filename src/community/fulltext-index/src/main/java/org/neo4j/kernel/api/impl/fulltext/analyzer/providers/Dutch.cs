...
namespace Neo4Net.Kernel.Api.Impl.Fulltext.analyzer.providers
{
	...
	using DutchAnalyzer = org.apache.lucene.analysis.nl.DutchAnalyzer;

	using AnalyzerProvider = Neo4Net.GraphDb.index.fulltext.AnalyzerProvider;
	using Service = Neo4Net.Helpers.Service;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Dutch extends org.Neo4Net.graphdb.index.fulltext.AnalyzerProvider
	public class Dutch : AnalyzerProvider
	{
