...
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Classic extends org.Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider
	public class Classic : AnalyzerProvider
	{
