...
namespace Neo4Net.Kernel.Api.Impl.Fulltext.analyzer.providers
{
	...
	using SpanishAnalyzer = org.apache.lucene.analysis.es.SpanishAnalyzer;

	using AnalyzerProvider = Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider;
	using Service = Neo4Net.Helpers.Service;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Spanish extends org.Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider
	public class Spanish : AnalyzerProvider
	{
