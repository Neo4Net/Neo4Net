...
namespace Neo4Net.Kernel.Api.Impl.Fulltext.analyzer.providers
{
	...
	using TurkishAnalyzer = org.apache.lucene.analysis.tr.TurkishAnalyzer;

	using AnalyzerProvider = Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider;
	using Service = Neo4Net.Helpers.Service;

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Turkish extends org.Neo4Net.GraphDb.Index.fulltext.AnalyzerProvider
	public class Turkish : AnalyzerProvider
	{
