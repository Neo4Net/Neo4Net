...
//ORIGINAL LINE: @Service.Implementation(AnalyzerProvider.class) public class Standard extends org.Neo4Net.graphdb.index.fulltext.AnalyzerProvider
	public class Standard : AnalyzerProvider
	{
		 public const string STANDARD_ANALYZER_NAME = "standard";

		 public Standard() : base(STANDARD_ANALYZER_NAME)
		 {
		 }
