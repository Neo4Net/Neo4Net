...
//ORIGINAL LINE: @Service.Implementation(RepresentationFormat.class) public class StreamingJsonFormat extends Neo4Net.server.rest.repr.RepresentationFormat implements Neo4Net.server.rest.repr.StreamingFormat
	public class StreamingJsonFormat : RepresentationFormat, StreamingFormat
	{

		 private readonly JsonFactory _factory;

		 public StreamingJsonFormat() : base(Neo4Net.server.rest.repr.StreamingFormat_Fields.MediaType)
		 {
...
//ORIGINAL LINE: public java.net.URI readUri(String input) throws Neo4Net.server.rest.repr.BadInputException
		 ...
		 public class StreamingRepresentationFormat : RepresentationFormat
		 {
			  ...
			  public StreamingRepresentationFormat( JsonGenerator g, InputFormat inputFormat ) : base( Neo4Net.server.rest.repr.StreamingFormat_Fields.MediaType )
			  {
					this.G = g;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.List<Object> readList(String input) throws Neo4Net.server.rest.repr.BadInputException
			  public override IList<object> ReadList( string input )
			  {
