...
//ORIGINAL LINE: private final java.util.List<Neo4Net.server.plugins.Injectable<?>> injectables = new java.util.ArrayList<>();
...
//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the java.util.Collection 'removeAll' method:
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Collection<Neo4Net.server.database.InjectableProvider<?>> injectableProviders = mergeInjectables(defaultInjectables, injectables);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: private java.util.Collection<Neo4Net.server.database.InjectableProvider<?>> mergeInjectables(java.util.Collection<Neo4Net.server.database.InjectableProvider<?>> defaultInjectables, java.util.Collection<Neo4Net.server.plugins.Injectable<?>> injectables)
		 ...
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Collection<Neo4Net.server.database.InjectableProvider<?>> injectableProviders = new java.util.ArrayList<>();
			  ...
			  {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: for (Neo4Net.server.plugins.Injectable<?> injectable : injectables)
