...
namespace Neo4Net.Server.plugins
{
	...
	internal class ShortTypeCaster : TypeCaster
	{
...
//ORIGINAL LINE: @Override @SuppressWarnings("boxing") short[] convert(Object[] data)
		 internal override short[] Convert( object[] data )
		 {
