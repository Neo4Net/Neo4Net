...
//           NODE(Neo4Net.server.rest.repr.Representation.NODE) { String render(java.util.Map<String, Object> serialized) { String javascript = ""; StringBuilder builder = Neo4Net.server.rest.domain.HtmlHelper.start(Neo4Net.server.rest.domain.HtmlHelper.ObjectType.NODE, javascript); Neo4Net.server.rest.domain.HtmlHelper.append(builder, java.util.Collections.singletonMap("data", serialized.get("data")), Neo4Net.server.rest.domain.HtmlHelper.ObjectType.NODE); builder.append("<form action='javascript:Neo4NetHtmlBrowse.getRelationships();'>"); builder.append("<fieldset><legend>Get relationships</legend>\n"); builder.append("<label for='direction'>with direction</label>\n" + "<select id='direction'>"); builder.append("<option value='").append(serialized.get("all_typed_relationships")).append("'>all</option>"); builder.append("<option value='").append(serialized.get("incoming_typed_relationships")).append("'>in</option>"); builder.append("<option value='").append(serialized.get("outgoing_typed_relationships")).append("'>out</option>"); builder.append("</select>\n"); builder.append("<label for='types'>for type(s)</label><select id='types' multiple='multiple'>"); for(String relationshipType : (java.util.List<String>) serialized.get("relationship_types")) { builder.append("<option selected='selected' value='").append(relationshipType).append("'>"); builder.append(relationshipType).append("</option>"); } builder.append("</select>\n"); builder.append("<button>Get</button>\n"); builder.append("</fieldset></form>\n"); return Neo4Net.server.rest.domain.HtmlHelper.end(builder); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           RELATIONSHIP(Neo4Net.server.rest.repr.Representation.RELATIONSHIP) { String render(java.util.Map<String, Object> serialized) { java.util.Map<Object, Object> map = new java.util.LinkedHashMap<>(); transfer(serialized, map, "type", "data", "start", "end"); return Neo4Net.server.rest.domain.HtmlHelper.from(map, Neo4Net.server.rest.domain.HtmlHelper.ObjectType.RELATIONSHIP); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           NODE_INDEXES(Neo4Net.server.rest.repr.Representation.NODE_INDEXES) { String render(java.util.Map<String, Object> serialized) { return renderIndex(serialized); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           RELATIONSHIP_INDEXES(Neo4Net.server.rest.repr.Representation.RELATIONSHIP_INDEXES) { String render(java.util.Map<String, Object> serialized) { return renderIndex(serialized); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           GRAPHDB(Neo4Net.server.rest.repr.Representation.GRAPHDB) { String render(java.util.Map<String, Object> serialized) { java.util.Map<Object, Object> map = new java.util.HashMap<>(); transfer(serialized, map, "index", "node_index", "relationship_index"); return Neo4Net.server.rest.domain.HtmlHelper.from(map, Neo4Net.server.rest.domain.HtmlHelper.ObjectType.ROOT); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           EXCEPTION(Neo4Net.server.rest.repr.Representation.EXCEPTION) { String render(java.util.Map<String, Object> serialized) { StringBuilder IEntity = new StringBuilder("<html>"); IEntity.append("<head><title>Error</title></head><body>"); Object subjectOrNull = serialized.get("message"); if(subjectOrNull != null) { IEntity.append("<p><pre>").append(subjectOrNull).append("</pre></p>"); } IEntity.append("<p><pre>").append(serialized.get("exception")); java.util.List<Object> tb = (java.util.List<Object>) serialized.get("stackTrace"); if(tb != null) { for(Object el : tb) { IEntity.append("\n\tat " + el); } } IEntity.append("</pre></p>").append("</body></html>"); return IEntity.toString(); } };
		 ...
		 {
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           NODES { String render(java.util.List<Object> data) { StringBuilder builder = Neo4Net.server.rest.domain.HtmlHelper.start("Index hits", null); if(data.isEmpty()) { Neo4Net.server.rest.domain.HtmlHelper.appendMessage(builder, "No index hits"); return Neo4Net.server.rest.domain.HtmlHelper.end(builder); } else { for(java.util.Map<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard> serialized : (java.util.List<java.util.Map<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard>>)(java.util.List<JavaToDotNetGenericWildcard>) data) { java.util.Map<Object, Object> map = new java.util.LinkedHashMap<>(); transfer(serialized, map, "self", "data"); Neo4Net.server.rest.domain.HtmlHelper.append(builder, map, Neo4Net.server.rest.domain.HtmlHelper.ObjectType.NODE); } return Neo4Net.server.rest.domain.HtmlHelper.end(builder); } } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           RELATIONSHIPS { String render(java.util.List<Object> data) { if(data.isEmpty()) { StringBuilder builder = Neo4Net.server.rest.domain.HtmlHelper.start(Neo4Net.server.rest.domain.HtmlHelper.ObjectType.RELATIONSHIP, null); Neo4Net.server.rest.domain.HtmlHelper.appendMessage(builder, "No relationships found"); return Neo4Net.server.rest.domain.HtmlHelper.end(builder); } else { java.util.Collection<Object> list = new java.util.ArrayList<>(); for(java.util.Map<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard> serialized : (java.util.List<java.util.Map<JavaToDotNetGenericWildcard, JavaToDotNetGenericWildcard>>)(java.util.List<JavaToDotNetGenericWildcard>) data) { java.util.Map<Object, Object> map = new java.util.LinkedHashMap<>(); transfer(serialized, map, "self", "type", "data", "start", "end"); list.add(map); } return Neo4Net.server.rest.domain.HtmlHelper.from(list, Neo4Net.server.rest.domain.HtmlHelper.ObjectType.RELATIONSHIP); } } };
