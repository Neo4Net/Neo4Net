...
//ORIGINAL LINE: protected static Neo4Net.function.ThrowingConsumer<javax.servlet.http.HttpServletResponse, java.io.IOException> unauthorizedAccess(final String message)
