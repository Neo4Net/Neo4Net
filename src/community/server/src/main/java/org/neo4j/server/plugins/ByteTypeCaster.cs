...
namespace Neo4Net.Server.plugins
{
	...
	internal class ByteTypeCaster : TypeCaster
	{
...
//ORIGINAL LINE: @Override @SuppressWarnings("boxing") byte[] convert(Object[] data)
		 internal override sbyte[] Convert( object[] data )
		 {
			  sbyte?[] incoming = ( sbyte?[] ) data;
			  sbyte[] result = new sbyte[incoming.Length];
