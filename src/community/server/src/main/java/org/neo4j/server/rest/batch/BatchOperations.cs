...
//ORIGINAL LINE: protected void addHeaders(final Neo4Net.server.rest.web.InternalJettyServletRequest res, final javax.ws.rs.core.HttpHeaders httpHeaders)
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected void performRequest(javax.ws.rs.core.UriInfo uriInfo, String method, String path, String body, System.Nullable<int> id, javax.ws.rs.core.HttpHeaders httpHeaders, java.util.Map<int, String> locations, Neo4Net.server.rest.web.InternalJettyServletRequest.RequestData requestData) throws java.io.IOException, javax.servlet.ServletException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected abstract void invoke(String method, String path, String body, System.Nullable<int> id, java.net.URI targetUri, Neo4Net.server.rest.web.InternalJettyServletRequest req, Neo4Net.server.rest.web.InternalJettyServletResponse res) throws java.io.IOException, javax.servlet.ServletException;
