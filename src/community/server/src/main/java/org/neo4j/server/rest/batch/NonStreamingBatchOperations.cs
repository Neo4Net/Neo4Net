...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: protected void invoke(String method, String path, String body, System.Nullable<int> id, java.net.URI targetUri, Neo4Net.server.rest.web.InternalJettyServletRequest req, Neo4Net.server.rest.web.InternalJettyServletResponse res) throws java.io.IOException, javax.servlet.ServletException
