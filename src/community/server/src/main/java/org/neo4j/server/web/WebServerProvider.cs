...
//ORIGINAL LINE: @Provider public class WebServerProvider extends Neo4Net.server.database.InjectableProvider<WebServer>
	public class WebServerProvider : InjectableProvider<WebServer>
	{

		 private readonly WebServer _server;

		 public WebServerProvider( WebServer server ) : base( typeof( WebServer ) )
		 {
			  this._server = server;
		 }
