...
//ORIGINAL LINE: void addJAXRSPackages(java.util.List<String> packageNames, String serverMountPoint, java.util.Collection<Neo4Net.server.plugins.Injectable<?>> injectables);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: void addJAXRSClasses(java.util.List<String> classNames, String serverMountPoint, java.util.Collection<Neo4Net.server.plugins.Injectable<?>> injectables);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: void setDefaultInjectables(java.util.Collection<Neo4Net.server.database.InjectableProvider<?>> defaultInjectables);
