...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.EMPTY;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.FALSE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.INTEGER;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.kernel.configuration.Settings.NORMALIZED_RELATIVE_URI;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: @Description("Maximum request header size") @Internal public static final Neo4Net.graphdb.config.Setting<int> maximum_request_header_size = setting("unsupported.dbms.max_http_request_header_size", INTEGER, "20480");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("Maximum response header size") @Internal public static final Neo4Net.graphdb.config.Setting<int> maximum_response_header_size = setting("unsupported.dbms.max_http_response_header_size", INTEGER, "20480");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("If execution time limiting is enabled in the database, this configures the maximum request execution time. " + "Please use dbms.transaction.timeout instead.") @Internal @Deprecated public static final Neo4Net.graphdb.config.Setting<java.time.Duration> webserver_limit_execution_time = setting("unsupported.dbms" + ".executiontime_limit.time", DURATION, NO_DEFAULT);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<java.util.List<String>> console_module_engines = setting("unsupported.dbms.console_module.engines", STRING_LIST, "SHELL");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Enable GC Logging") public static final Neo4Net.graphdb.config.Setting<bool> gc_logging_enabled = setting("dbms.logs.gc.enabled", BOOLEAN, FALSE);
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("GC Logging Options") public static final Neo4Net.graphdb.config.Setting<String> gc_logging_options = setting("dbms.logs.gc.options", STRING, "" + "-XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCApplicationStoppedTime " + "-XX:+PrintPromotionFailure -XX:+PrintTenuringDistribution");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Number of GC logs to keep.") public static final Neo4Net.graphdb.config.Setting<int> gc_logging_rotation_keep_number = setting("dbms.logs.gc.rotation.keep_number", INTEGER, "5");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Size of each GC log that is kept.") public static final Neo4Net.graphdb.config.Setting<long> gc_logging_rotation_size = buildSetting("dbms.logs.gc.rotation.size", BYTES, "20m").constraint(range(0L, Long.MAX_VALUE)).build();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Path of the run directory. This directory holds Neo4Net's runtime state, such as a pidfile when it " + "is running in the background. The pidfile is created when starting Neo4Net and removed when stopping it." + " It may be placed on an in-memory filesystem such as tmpfs.") public static final Neo4Net.graphdb.config.Setting<java.io.File> run_directory = pathSetting("dbms.directories.run", "run");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Path of the lib directory") public static final Neo4Net.graphdb.config.Setting<java.io.File> lib_directory = pathSetting("dbms.directories.lib", "lib");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("Commands to be run when Neo4Net Browser successfully connects to this server. Separate multiple " + "commands with semi-colon.") public static final Neo4Net.graphdb.config.Setting<String> browser_postConnectCmd = setting("browser.post_connect_cmd", STRING, "");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<java.net.URI> rest_api_path = setting("unsupported.dbms.uris.rest", NORMALIZED_RELATIVE_URI, "/db/data");
		 public static final Setting<URI> RestApiPath = setting( "unsupported.dbms.uris.rest", NORMALIZED_RELATIVE_URI, "/db/data" );

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<java.net.URI> management_api_path = setting("unsupported.dbms.uris.management", NORMALIZED_RELATIVE_URI, "/db/manage");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<java.net.URI> browser_path = setting("unsupported.dbms.uris.browser", Neo4Net.kernel.configuration.Settings.URI, "/browser/");
		 public static final Setting<URI> BrowserPath = setting( "unsupported.dbms.uris.browser", Settings.URI, "/browser/" );

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<bool> wadl_enabled = setting("unsupported.dbms.wadl_generation_enabled", BOOLEAN, FALSE);
		 public static final Setting<bool> WadlEnabled = setting( "unsupported.dbms.wadl_generation_enabled", BOOLEAN, FALSE );

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<bool> console_module_enabled = setting("unsupported.dbms.console_module.enabled", BOOLEAN, TRUE);
		 public static final Setting<bool> ConsoleModuleEnabled = setting( "unsupported.dbms.console_module.enabled", BOOLEAN, TRUE );

//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<bool> jmx_module_enabled = setting("unsupported.dbms.jmx_module.enabled", BOOLEAN, TRUE);
