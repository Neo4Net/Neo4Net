...
//ORIGINAL LINE: java.util.Collection<?> result = (java.util.Collection<?>) org.Neo4Net.server.rest.domain.JsonHelper.readJson(response);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: java.util.Map<?, ?> path = org.Neo4Net.server.rest.domain.JsonHelper.jsonToMap(response);
...
//ORIGINAL LINE: private void assertThatPathHasLength(final java.util.Map<?, ?> path, final int length)
	...
	//
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Graph(nodes = { @NODE(name = "a", setNameProperty = true), @NODE(name = "b", setNameProperty = true), @NODE(name = "c", setNameProperty = true), @NODE(name = "d", setNameProperty = true), @NODE(name = "e", setNameProperty = true), @NODE(name = "f", setNameProperty = true) }, relationships = { @REL(start = "a", end = "b", type = "to", properties = { @PROP(key = "cost", value = "1.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "a", end = "c", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "a", end = "f", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "c", end = "d", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "d", end = "e", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "b", end = "e", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "f", end = "e", type = "to", properties = { @PROP(key = "cost", value = "1.2", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }) }) @Title("Execute a Dijkstra algorithm and get a single path") @Documented("This example is running a Dijkstra algorithm over a graph with different\n" + "cost properties on different relationships. Note that the request URI\n" + "ends with +/path+ which means a single path is what we want here.") public void shouldGetCorrectDijkstraPathWithWeights() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
...
//ORIGINAL LINE: java.util.Map<?, ?> path = org.Neo4Net.server.rest.domain.JsonHelper.jsonToMap(response);
	...
	//
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Graph(nodes = { @NODE(name = "a", setNameProperty = true), @NODE(name = "b", setNameProperty = true), @NODE(name = "c", setNameProperty = true), @NODE(name = "d", setNameProperty = true), @NODE(name = "e", setNameProperty = true), @NODE(name = "f", setNameProperty = true) }, relationships = { @REL(start = "a", end = "b", type = "to", properties = { @PROP(key = "cost", value = "1.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "a", end = "c", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "a", end = "f", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "c", end = "d", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "d", end = "e", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "b", end = "e", type = "to", properties = { @PROP(key = "cost", value = "0.5", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }), @REL(start = "f", end = "e", type = "to", properties = { @PROP(key = "cost", value = "1.0", type = org.Neo4Net.test.GraphDescription.PropType.DOUBLE) }) }) @Title("Execute a Dijkstra algorithm and get multiple paths") @Documented("This example is running a Dijkstra algorithm over a graph with different\n" + "cost properties on different relationships. Note that the request URI\n" + "ends with +/paths+ which means we want multiple paths returned, in case\n" + "they exist.") public void shouldGetCorrectDijkstraPathsWithWeights() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
	...
	//
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test @Graph(nodes = { @NODE(name = "a", setNameProperty = true), @NODE(name = "b", setNameProperty = true), @NODE(name = "c", setNameProperty = true), @NODE(name = "d", setNameProperty = true), @NODE(name = "e", setNameProperty = true), @NODE(name = "f", setNameProperty = true) }, relationships = { @REL(start = "a", end = "b", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "a", end = "c", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "a", end = "f", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "c", end = "d", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "d", end = "e", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "b", end = "e", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }), @REL(start = "f", end = "e", type = "to", properties = { @PROP(key = "cost", value = "1", type = org.Neo4Net.test.GraphDescription.PropType.INTEGER) }) }) @Title("Execute a Dijkstra algorithm with equal weights on relationships") @Documented("The following is executing a Dijkstra search on a graph with equal\n" + "weights on all relationships. This example is included to show the\n" + "difference when the same graph structure is used, but the path weight is\n" + "equal to the number of hops.") public void shouldGetCorrectDijkstraPathsWithEqualWeightsWithDefaultCost() throws Exception
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
...
//JAVA TO C# CONVERTER WARNING: 'final' parameters are ignored unless the option to convert to C# 7.2 'in' parameters is selected:
//ORIGINAL LINE: private long nodeId(final java.util.Map<String, org.Neo4Net.graphdb.Node> map, final String string)
