...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 public virtual void IncludeQueryStatistics()
		 {
			  ...
			  // Then
			  IDictionary<string, object> IEntity = jsonToMap( response.Entity() );
			  AssertNoErrors( IEntity );
			  IDictionary<string, object> firstResult = ( ( IList<IDictionary<string, object>> ) IEntity["results"] )[0];
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private long expirationTime(java.util.Map<String, Object> IEntity) throws java.text.ParseException
		 private long ExpirationTime( IDictionary<string, object> IEntity )
		 {
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: String timestampString = (String)((java.util.Map<?, ?>) IEntity.get("transaction")).get("expires");
			  string timestampString = ( string )( ( IDictionary<object, ?> ) IEntity["transaction"] )["expires"];
