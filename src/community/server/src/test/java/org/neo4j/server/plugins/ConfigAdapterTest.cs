...
//ORIGINAL LINE: final Object propertyValue = wrappingConfiguration.getProperty(Neo4Net.server.configuration.ServerSettings.rest_api_path.name());
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Object dataPath = wrappingConfiguration.getProperty(Neo4Net.server.configuration.ServerSettings.rest_api_path.name());
