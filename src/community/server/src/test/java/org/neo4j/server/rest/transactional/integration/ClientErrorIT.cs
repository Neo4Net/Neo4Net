...
//ORIGINAL LINE: @RunWith(Parameterized.class) public class ClientErrorIT extends Neo4Net.server.rest.AbstractRestFunctionalTestBase
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Parameterized.Parameter(1) public Neo4Net.kernel.api.exceptions.Status errorStatus;
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Test public void clientErrorShouldRollbackTheTransaction() throws Neo4Net.server.rest.domain.JsonParseException
