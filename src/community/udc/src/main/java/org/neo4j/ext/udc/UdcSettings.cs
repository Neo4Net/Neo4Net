...
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<int> first_delay = buildSetting("unsupported.dbms.udc.first_delay", INTEGER, System.Convert.ToString(10 * 1000 * 60)).constraint(min(1)).build();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<int> interval = buildSetting("unsupported.dbms.udc.interval", INTEGER, System.Convert.ToString(1000 * 60 * 60 * 24)).constraint(min(1)).build();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<Neo4Net.helpers.HostnamePort> udc_host = setting("unsupported.dbms.udc.host", HOSTNAME_PORT, "udc.Neo4Net.org");
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<String> udc_source = buildSetting("unsupported.dbms.udc.source", STRING, "maven").constraint(illegalValueMessage("Must be a valid source", matches(ANY))).build();
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Internal public static final Neo4Net.graphdb.config.Setting<String> udc_registration_key = buildSetting("unsupported.dbms.udc.reg", STRING, "unreg").constraint(illegalValueMessage("Must be a valid registration id", matches(ANY))).build();
