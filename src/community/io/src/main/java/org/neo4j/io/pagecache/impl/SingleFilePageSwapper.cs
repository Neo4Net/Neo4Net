...
namespace Neo4Net.Io.pagecache.impl
{
	...
	public class SingleFilePageSwapper : PageSwapper
	{
		 ...
		 private static readonly int _globalChannelStripePower = Integer.getInteger( "Neo4Net.io.pagecache.implSingleFilePageSwapper.channelStripePower", DefaultChannelStripePower() );

		 // Exponent of 2 of how many consecutive pages go to the same stripe
		 private static readonly int _channelStripeShift = Integer.getInteger( "Neo4Net.io.pagecache.implSingleFilePageSwapper.channelStripeShift", 4 );
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public SingleFilePageSwapper(java.io.File file, Neo4Net.io.fs.FileSystemAbstraction fs, int filePageSize, Neo4Net.io.pagecache.PageEvictionCallback onEviction, boolean noChannelStriping) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private int swapIn(Neo4Net.io.fs.StoreChannel channel, long bufferAddress, int bufferSize, long fileOffset, int filePageSize) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private int swapOut(long bufferAddress, long fileOffset, Neo4Net.io.fs.StoreChannel channel) throws java.io.IOException
