...
namespace Neo4Net.Io.pagecache
{
	...
	public interface PagedFile : IDisposable
	{
		 ...
		 /// <para>
		 /// This implies <seealso cref="Neo4Net.io.pagecache.PagedFile.PF_NO_GROW"/>, since
		 ...
		 ///     }
		 /// </code></pre>
		 /// <seealso cref="Neo4Net.io.pagecache.PageCursor PageCursors"/> are <seealso cref="IDisposable"/>, so interacting with them
		 ...
		 /// will return the <seealso cref="Neo4Net.io.pagecache.PageCursor.UNBOUND_PAGE_ID"/> constant, and attempts at reading from
		 ...
		 /// <seealso cref="Neo4Net.io.pagecache.PagedFile.PF_SHARED_WRITE_LOCK"/> or
		 /// <seealso cref="Neo4Net.io.pagecache.PagedFile.PF_SHARED_READ_LOCK"/>.
		 /// </para>
		 /// <para>
