...
namespace Neo4Net.Adversaries.fs
{
	...
	using AdversarialFileWatcher = Neo4Net.Adversaries.watcher.AdversarialFileWatcher;
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public class AdversarialFileSystemAbstraction implements Neo4Net.io.fs.FileSystemAbstraction
