...
//ORIGINAL LINE: private Neo4Net.graphdb.mockfs.DelegatingFileSystemAbstraction writeAndForceCountingFs(final java.util.concurrent.atomic.AtomicInteger writeCounter, final java.util.concurrent.atomic.AtomicInteger forceCounter)
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyOnReadCursor(Neo4Net.function.ThrowingConsumer<PageCursorAction,java.io.IOException> testTemplate) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyOnWriteCursor(Neo4Net.function.ThrowingConsumer<PageCursorAction,java.io.IOException> testTemplate) throws java.io.IOException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private void verifyNoFaultAccessToPagesNotInMemory(Neo4Net.io.pagecache.tracing.DefaultPageCacheTracer cacheTracer, Neo4Net.io.pagecache.tracing.cursor.DefaultPageCursorTracerSupplier cursorTracerSupplier, PageCursor nofault) throws java.io.IOException
