...
namespace Neo4Net.Test.rule.fs
{
	...
	public abstract class FileSystemRule<FS> : ExternalResource, FileSystemAbstraction, System.Func<FileSystemAbstraction> where FS : Neo4Net.Io.fs.FileSystemAbstraction
	{
