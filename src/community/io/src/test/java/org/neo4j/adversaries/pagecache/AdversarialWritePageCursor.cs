...
namespace Neo4Net.Adversaries.pagecache
{
	...
	/// See <seealso cref="Neo4Net.io.pagecache.PagedFile.PF_SHARED_WRITE_LOCK"/> flag.
	/// </para>
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") class AdversarialWritePageCursor extends Neo4Net.io.pagecache.impl.DelegatingPageCursor
