...
namespace Neo4Net.Values.Storable
{
	...
	public class LocalDateTimeArray : TemporalArray<DateTime, LocalDateTimeValue>
	{
		 private readonly DateTime[] _value;

		 internal LocalDateTimeArray( DateTime[] value )
		 {
			  Debug.Assert( value != null );
			  this._value = value;
		 }

		 protected internal override DateTime[] Value()
		 {
			  return _value;
		 }
		 ...
		 public override bool Equals( DateTime[] x )
		 {
...
//ORIGINAL LINE: public <E extends Exception> void writeTo(ValueWriter<E> writer) throws E
		 ...
		 {
			  WriteTo( writer, ValueWriter_ArrayType.LocalDateTime,_value );
		 }

		 public override ValueGroup ValueGroup()
		 {
			  return ValueGroup.LocalDateTimeArray;
		 }
