...
namespace Neo4Net.Values.Storable
{
	...
	public class TimeArray : TemporalArray<OffsetTime, TimeValue>
	{
		 private readonly OffsetTime[] _value;

		 internal TimeArray( OffsetTime[] value )
		 {
			  Debug.Assert( value != null );
			  this._value = value;
		 }

		 protected internal override OffsetTime[] Value()
		 {
			  return _value;
		 }
		 ...
		 public override bool Equals( OffsetTime[] x )
		 {
...
//ORIGINAL LINE: public <E extends Exception> void writeTo(ValueWriter<E> writer) throws E
		 ...
		 {
			  WriteTo( writer, ValueWriter_ArrayType.ZonedTime,_value );
		 }

		 public override ValueGroup ValueGroup()
		 {
			  return ValueGroup.ZonedTimeArray;
		 }
