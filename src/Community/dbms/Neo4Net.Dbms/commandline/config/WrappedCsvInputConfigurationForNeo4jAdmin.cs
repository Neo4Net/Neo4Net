...
namespace Neo4Net.Dbms.CommandLine.Config
{
	...
	public class WrappedCsvInputConfigurationForNeo4NetAdmin : Neo4Net.@unsafe.Impl.Batchimport.input.csv.Configuration_Overridden
	{
		 public WrappedCsvInputConfigurationForNeo4NetAdmin( Configuration defaults ) : base( defaults )
		 {
		 }
