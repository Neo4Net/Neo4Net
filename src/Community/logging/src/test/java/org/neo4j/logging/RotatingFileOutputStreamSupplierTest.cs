...
namespace Neo4Net.Logging
{
	...
	using AdversarialOutputStream = Neo4Net.Adversaries.fs.AdversarialOutputStream;
	...
	using RotationListener = Neo4Net.Logging.RotatingFileOutputStreamSupplier.RotationListener;
