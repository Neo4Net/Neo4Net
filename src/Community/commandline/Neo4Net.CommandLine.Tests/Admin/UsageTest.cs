...
//ORIGINAL LINE: final Usage usage = new Usage("Neo4Net-admin", new CannedLocator(commands));
			  Usage usage = new Usage( "Neo4Net-admin", new CannedLocator( commands ) );
			  ...
			  ordered.verify( @out ).accept( "usage: Neo4Net-admin bam " );
			  ordered.verify( @out ).accept( "" );
			  ordered.verify( @out ).accept( "environment variables:" );
			  ordered.verify( @out ).accept( "    Neo4Net_CONF    Path to directory which contains Neo4Net.conf." );
			  ordered.verify( @out ).accept( "    Neo4Net_DEBUG   Set to anything to enable debug output." );
			  ordered.verify( @out ).accept( "    Neo4Net_HOME    Neo4Net home directory." );
...
//ORIGINAL LINE: final Usage usage = new Usage("Neo4Net-admin", new CannedLocator(commands));
			  ...
			  InOrder ordered = inOrder( @out );
			  ordered.verify( @out ).accept( "usage: Neo4Net-admin <command>" );
			  ordered.verify( @out ).accept( "" );
			  ordered.verify( @out ).accept( "Manage your Neo4Net instance." );
			  ordered.verify( @out ).accept( "" );
			  ...
			  ordered.verify( @out ).accept( "" );
			  ordered.verify( @out ).accept( "Use Neo4Net-admin help <command> for more details." );
