...
//ORIGINAL LINE: public static void wrapIOException(java.io.IOException e) throws org.Neo4Net.commandline.admin.CommandFailed
		 ...
		 /// <returns> the version of Neo4Net as defined during the build </returns>
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Nonnull public static String Neo4NetVersion()
		 public static string Neo4NetVersion()
		 {
			  ...
			  try
			  {
					...
					return props.getProperty( "Neo4NetVersion" );
			  }
			  catch ( IOException e )
			  {
...
//ORIGINAL LINE: private static void loadProperties(java.util.Properties props) throws java.io.IOException
		 ...
		 {
			  using ( Stream resource = typeof( Utils ).getResourceAsStream( "/org/Neo4Net/commandline/build.properties" ) )
			  {
					props.load( resource );
			  }
		 }
