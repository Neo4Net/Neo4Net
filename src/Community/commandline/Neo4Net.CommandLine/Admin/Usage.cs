...
//ORIGINAL LINE: final CommandUsage commandUsage = new CommandUsage(command, scriptName);
		 ...
		 public virtual void Print( System.Action<string> output )
		 {
			  ...
			  output( "" );
			  output( "Manage your Neo4Net instance." );
			  output( "" );
		 ...
		 internal static void PrintEnvironmentVariables( System.Action<string> output )
		 {
			  ...
			  output( "    Neo4Net_CONF    Path to directory which contains Neo4Net.conf." );
			  output( "    Neo4Net_DEBUG   Set to anything to enable debug output." );
			  output( "    Neo4Net_HOME    Neo4Net home directory." );
