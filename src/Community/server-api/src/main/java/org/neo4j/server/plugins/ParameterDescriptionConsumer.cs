...
namespace Neo4Net.Server.plugins
{
	...
	{
		 [Obsolete]
		 void DescribeParameter( string name, Type type, bool optional, string description );

		 [Obsolete]
		 void DescribeListParameter( string name, Type type, bool optional, string description );
	}
