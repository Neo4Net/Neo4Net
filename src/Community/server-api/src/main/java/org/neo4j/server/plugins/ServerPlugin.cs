...
namespace Neo4Net.Server.plugins
{
	...
	/// <seealso cref="ServerPlugin"/>, e.g. <code>com.example.MyNeo4jServerExtension</code>
	...
	/// currently:
	/// <ul>
	/// <li><seealso cref="org.neo4j.graphdb.GraphDatabaseService"/> - a general extension
	/// method to the server</li>
	/// <li><seealso cref="org.neo4j.graphdb.Node"/> - an extension method for a node</li>
	/// <li><seealso cref="org.neo4j.graphdb.Relationship"/> - an extension method for a
	/// relationship</li>
	/// </ul>
	...
	public abstract class ServerPlugin
	{
		 ...
		 /// </summary>
		 /// <param name="extender">     the collection of <seealso cref="org.neo4j.server.plugins.PluginPoint"/>s for this
		 ///                     <seealso cref="org.neo4j.server.plugins.ServerPlugin"/>.
		 ///  </param>
		 [Obsolete]
