...
//ORIGINAL LINE: abstract T parse(Object value) throws org.neo4j.kernel.api.exceptions.InvalidArgumentsException;
			  internal abstract T Parse( object value );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: T parseOrDefault(java.util.Map<String,Object> valueMap) throws org.neo4j.kernel.api.exceptions.InvalidArgumentsException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: Integer parse(Object value) throws org.neo4j.kernel.api.exceptions.InvalidArgumentsException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private int asInteger(Object value) throws org.neo4j.kernel.api.exceptions.InvalidArgumentsException
