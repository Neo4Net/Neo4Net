...
namespace Neo4Net.Bolt.runtime
{
	...
	public interface BoltStateMachineFactory
	{
		 ...
		 /// </summary>
		 /// <param name="protocolVersion"> used to select state machine version </param>
		 /// <param name="boltChannel"> channel over which Bolt massages can be exchanged </param>
		 /// <returns> new <seealso cref="BoltStateMachine"/> instance </returns>
