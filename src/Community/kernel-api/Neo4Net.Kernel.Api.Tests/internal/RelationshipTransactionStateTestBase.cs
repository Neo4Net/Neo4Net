...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private void AssertRelationships( RelationshipDirection direction, RelationshipGroupCursor group, RelationshipTraversalCursor traversal, params long[] relationships )
		 {
			  switch ( direction )
			  {
			  case Neo4Net.Kernel.Api.Internal.RelationshipTransactionStateTestBase.RelationshipDirection.Out:
					group.Outgoing( traversal );
					break;
			  case Neo4Net.Kernel.Api.Internal.RelationshipTransactionStateTestBase.RelationshipDirection.In:
					group.Incoming( traversal );
					break;
			  case Neo4Net.Kernel.Api.Internal.RelationshipTransactionStateTestBase.RelationshipDirection.Loop:
