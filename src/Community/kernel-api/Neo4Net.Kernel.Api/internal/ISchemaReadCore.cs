...
namespace Neo4Net.Kernel.Api.Internal
{
	...
	/// </summary>
	public interface ISchemaReadCore
	{
		 /// <summary>
		 ...
		 IIndexReference Index( SchemaDescriptor schema );
		 ...
		 IEnumerator<IIndexReference> IndexesGetForLabel( int labelId );
		 ...
		 IEnumerator<IIndexReference> IndexesGetForRelationshipType( int relationshipType );

		 /// <summary>
		 /// Returns all indexes used in the database
		 /// </summary>
		 /// <returns> all indexes used in the database </returns>
		 IEnumerator<IIndexReference> IndexesGetAll();
