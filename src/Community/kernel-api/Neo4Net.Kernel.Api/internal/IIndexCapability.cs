...
namespace Neo4Net.Kernel.Api.Internal
{
   ...
   /// </summary>
   public interface IIndexCapability
   {
      /// <summary>
      /// What possible orderings is this index capable to provide for a query on given combination of <seealso cref="ValueCategory"/>.
      /// Ordering of ValueCategory correspond to ordering of related <seealso cref="IIndexReference.properties()"/>.
      /// </summary>
      ...
      /// must correspond to related <seealso cref="IIndexReference.properties()"/>. A {@code null} value in the array
      ...
      /// ordering is possible or if length of {@code valueCategories} and <seealso cref="IIndexReference.properties()"/> differ. </returns>
      ...
      /// Ordering of ValueCategory correspond to ordering of {@code properties} in related <seealso cref="IIndexReference"/>.
      /// </summary>
      /// <param name="valueCategories"> Ordered array of <seealso cref="ValueCategory ValueCategories"/> for which index should be queried. Note that valueCategory
      /// must correspond to related <seealso cref="IIndexReference.properties()"/>. <seealso cref="ValueCategory.UNKNOWN"/> can be used as a wildcard for
      ...
      /// {@code valueCategories} and <seealso cref="IIndexReference.properties()"/> differ <seealso cref="IndexValueCapability.NO"/> is returned. </returns>
      ...
      //JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
      //		 default boolean singleWildcard(Neo4Net.values.storable.ValueCategory[] valueCategories)
      //	 {
