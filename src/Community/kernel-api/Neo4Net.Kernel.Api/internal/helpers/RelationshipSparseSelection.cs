...
namespace Neo4Net.Kernel.Api.Internal.Helpers
{
	...
	internal abstract class RelationshipSparseSelection
	{
		 ...
		 protected internal IRelationshipTraversalCursor Cursor;
		 private int[] _types;
		 ...
		 /// </summary>
		 /// <param name="relationshipCursor"> Relationship traversal ICursor to use. Pre-initialized on node. </param>
		 public void Outgoing( IRelationshipTraversalCursor relationshipCursor )
		 {
		 ...
		 public void Outgoing( IRelationshipTraversalCursor relationshipCursor, int[] types )
		 {
		 ...
		 /// </summary>
		 /// <param name="relationshipCursor"> Relationship traversal ICursor to use. Pre-initialized on node. </param>
		 public void Incoming( IRelationshipTraversalCursor relationshipCursor )
		 {
		 ...
		 /// <param name="relationshipCursor"> Relationship traversal ICursor to use. Pre-initialized on node. </param>
		 /// <param name="types"> Relationship types to traverse </param>
		 public void Incoming( IRelationshipTraversalCursor relationshipCursor, int[] types )
		 {
		 ...
		 /// </summary>
		 /// <param name="relationshipCursor"> Relationship traversal ICursor to use. Pre-initialized on node. </param>
		 public void All( IRelationshipTraversalCursor relationshipCursor )
		 {
		 ...
		 /// <param name="relationshipCursor"> Relationship traversal ICursor to use. Pre-initialized on node. </param>
		 /// <param name="types"> Relationship types to traverse </param>
		 public void All( IRelationshipTraversalCursor relationshipCursor, int[] types )
		 {
			  Init( relationshipCursor, types, Dir.Both );
		 }

		 private void Init( IRelationshipTraversalCursor relationshipCursor, int[] types, Dir targetDirection )
		 {
