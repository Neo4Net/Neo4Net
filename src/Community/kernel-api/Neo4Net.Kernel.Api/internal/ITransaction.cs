...
namespace Neo4Net.Kernel.Api.Internal
{
   ...
   public interface ITransaction : IDisposable
   {
      ...
      IExplicitIndexWrite IndexWrite();

      /// <returns> Token read operations </returns>
      ITokenRead TokenRead();

      /// <returns> Token read operations </returns>
      ITokenWrite TokenWrite();
      ...
      /// <returns> The ICursor factory </returns>
      ...
      IExecutionStatistics ExecutionStatistics();
