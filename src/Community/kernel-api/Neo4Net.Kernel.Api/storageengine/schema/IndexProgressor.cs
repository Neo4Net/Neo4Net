...
namespace Neo4Net.Kernel.Api.StorageEngine.schema
{
	...
	using ILabelSet = Neo4Net.Kernel.Api.Internal.ILabelSet;
	using Value = Neo4Net.Values.Storable.Value;

	/// <summary>
	/// The index progressor is a ICursor like class, which allows controlled progression through the entries of an index.
