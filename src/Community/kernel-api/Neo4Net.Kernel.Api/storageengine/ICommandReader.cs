...
namespace Neo4Net.Kernel.Api.StorageEngine
{
	...
	/// <summary>
	/// Reads <seealso cref="StorageCommand commands"/> from a <seealso cref="IReadableChannel channel"/>.
	/// Instances must handle concurrent threads calling it with potentially different channels.
	/// </summary>
	public interface ICommandReader
	{
		 /// <summary>
		 /// Reads the next <seealso cref="StorageCommand"/> from <seealso cref="IReadableChannel channel"/>.
		 /// </summary>
		 /// <param name="channel"> <seealso cref="IReadableChannel"/> to read from. </param>
...
//ORIGINAL LINE: StorageCommand read(ReadableChannel channel) throws java.io.IOException;
		 StorageCommand Read( IReadableChannel channel );
	}
