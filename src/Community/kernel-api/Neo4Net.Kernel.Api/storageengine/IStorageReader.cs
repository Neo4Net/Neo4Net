...
namespace Neo4Net.Kernel.Api.StorageEngine
{
	...
	/// </para>
	/// </summary>
	public interface IStorageReader : IDisposable, IStorageSchemaReader
	{
		 /// <summary>
...
//ORIGINAL LINE: <EXCEPTION extends Exception> void relationshipVisit(long relationshipId, RelationshipVisitor<EXCEPTION> relationshipVisitor) throws org.Neo4Net.Kernel.Api.Internal.Exceptions.EntityNotFoundException, EXCEPTION;
		 ...
		 IStorageRelationshipGroupCursor AllocateRelationshipGroupCursor();
		 ...
		 IStorageRelationshipTraversalCursor AllocateRelationshipTraversalCursor();
		 ...
		 IStorageRelationshipScanCursor AllocateRelationshipScanCursor();
		 ...
		 IStorageSchemaReader SchemaSnapshot();
	}
