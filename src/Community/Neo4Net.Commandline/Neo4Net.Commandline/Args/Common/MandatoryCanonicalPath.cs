...
namespace Neo4Net.Commandline.Args.Common
{
	...
	public class MandatoryCanonicalPath : MandatoryNamedArg
	{

		 public MandatoryCanonicalPath( string name, string exampleValue, string description ) : base( name, exampleValue, description )
		 {
		 }
