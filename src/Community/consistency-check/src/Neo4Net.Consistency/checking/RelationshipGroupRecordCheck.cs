...
//           OUT { public long valueFrom(Neo4Net.kernel.impl.store.record.RelationshipGroupRecord record) { return record.getFirstOut(); } protected void relationshipNotInUse(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstOutgoingRelationshipNotInUse(); } protected void relationshipNotFirstInChain(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstOutgoingRelationshipNotFirstInChain(); } protected boolean isFirstInChain(Neo4Net.kernel.impl.store.record.RelationshipRecord relationship) { return relationship.isFirstInFirstChain(); } protected void relationshipOfOtherType(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstOutgoingRelationshipOfOfOtherType(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           IN { public long valueFrom(Neo4Net.kernel.impl.store.record.RelationshipGroupRecord record) { return record.getFirstIn(); } protected void relationshipNotInUse(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstIncomingRelationshipNotInUse(); } protected void relationshipNotFirstInChain(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstIncomingRelationshipNotFirstInChain(); } protected boolean isFirstInChain(Neo4Net.kernel.impl.store.record.RelationshipRecord relationship) { return relationship.isFirstInSecondChain(); } protected void relationshipOfOtherType(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstIncomingRelationshipOfOfOtherType(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           LOOP { public long valueFrom(Neo4Net.kernel.impl.store.record.RelationshipGroupRecord record) { return record.getFirstLoop(); } protected void relationshipNotInUse(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstLoopRelationshipNotInUse(); } protected void relationshipNotFirstInChain(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstLoopRelationshipNotFirstInChain(); } protected boolean isFirstInChain(Neo4Net.kernel.impl.store.record.RelationshipRecord relationship) { return relationship.isFirstInFirstChain() && relationship.isFirstInSecondChain(); } protected void relationshipOfOtherType(Neo4Net.consistency.report.ConsistencyReport_RelationshipGroupConsistencyReport report) { report.firstLoopRelationshipOfOfOtherType(); } };
