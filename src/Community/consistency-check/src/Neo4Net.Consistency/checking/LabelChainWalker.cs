...
//ORIGINAL LINE: final Neo4Net.kernel.impl.store.record.DynamicRecord nextRecord = recordIds.get(nextBlock);
		 ...
		 public interface Validator<RECORD, REPORT> where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport
		 {
