...
//ORIGINAL LINE: engine.comparativeCheck(records.node(nodeId), new Neo4Net.consistency.checking.full.NodeInUseWithCorrectLabelsCheck<>(labels, COMPLETE_ALL_TOKENS, true));
