...
//           PREV(Neo4Net.kernel.impl.store.record.Record.NO_PREVIOUS_PROPERTY) { public long valueFrom(Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getPrevProp(); } public long otherReference(Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getNextProp(); } public void notInUse(Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.prevNotInUse(property); } public void noBackReference(Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.previousDoesNotReferenceBack(property); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//           NEXT(Neo4Net.kernel.impl.store.record.Record.NO_NEXT_PROPERTY) { public long valueFrom(Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getNextProp(); } public long otherReference(Neo4Net.kernel.impl.store.record.PropertyRecord record) { return record.getPrevProp(); } public void notInUse(Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.nextNotInUse(property); } public void noBackReference(Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.kernel.impl.store.record.PropertyRecord property) { report.nextDoesNotReferenceBack(property); } };
...
//ORIGINAL LINE: private static ComparativeRecordChecker<Neo4Net.kernel.impl.store.record.PropertyRecord, Neo4Net.kernel.impl.store.record.PropertyKeyTokenRecord, Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport> propertyKey(final Neo4Net.kernel.impl.store.record.PropertyBlock block)
