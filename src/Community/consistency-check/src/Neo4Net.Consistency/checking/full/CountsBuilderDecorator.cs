...
//	import static Neo4Net.consistency.checking.cache.CacheSlots_NodeLabel_Fields.SLOT_IN_USE;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.consistency.checking.cache.CacheSlots_NodeLabel_Fields.SLOT_LABEL_FIELD;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
//	import static Neo4Net.consistency.checking.full.NodeLabelReader.getListOfLabels;
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to C#:
...
//ORIGINAL LINE: public void checkCounts(Neo4Net.kernel.impl.api.CountsAccessor counts, final Neo4Net.consistency.report.ConsistencyReporter reporter, Neo4Net.helpers.progress.ProgressMonitorFactory progressFactory)
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final Neo4Net.helpers.progress.ProgressListener listener = progressFactory.singlePart("Checking node and relationship counts", total);
