...
//       NODES { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getNodeStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       RELATIONSHIPS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getRelationshipStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       PROPERTIES { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getPropertyStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       PROPERTY_KEYS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getPropertyKeyTokenStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       STRINGS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getNodeStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       ARRAYS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getNodeStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       LABELS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getLabelTokenStore(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       RELATIONSHIP_GROUPS { RecordStore<JavaToDotNetGenericWildcard> getRecordStore(Neo4Net.kernel.impl.store.StoreAccess storeAccess) { return storeAccess.getRelationshipGroupStore(); } };
