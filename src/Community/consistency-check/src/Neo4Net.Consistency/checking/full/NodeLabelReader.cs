...
//	import static Neo4Net.kernel.impl.store.record.RecordLoad.FORCE;
	...
	public class NodeLabelReader
	{
		 ...
		 public static ISet<long> GetListOfLabels<RECORD, REPORT>( NodeRecord nodeRecord, RecordAccess records, CheckerEngine<RECORD, REPORT> engine ) where RECORD : Neo4Net.Kernel.Impl.Store.Records.AbstractBaseRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport
		 {
...
//ORIGINAL LINE: engine.comparativeCheck(firstRecordReference, new Neo4Net.consistency.checking.LabelChainWalker<>(new Neo4Net.consistency.checking.LabelChainWalker.Validator<RECORD, REPORT>()
