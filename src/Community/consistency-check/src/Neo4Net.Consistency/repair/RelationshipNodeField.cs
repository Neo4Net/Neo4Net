...
//       FIRST { public long get(Neo4Net.kernel.impl.store.record.RelationshipRecord rel) { return rel.getFirstNode(); } },
//JAVA TO C# CONVERTER TODO TASK: Enum value-specific class bodies are not converted by Java to C# Converter:
//       SECOND { public long get(Neo4Net.kernel.impl.store.record.RelationshipRecord rel) { return rel.getSecondNode(); } };
