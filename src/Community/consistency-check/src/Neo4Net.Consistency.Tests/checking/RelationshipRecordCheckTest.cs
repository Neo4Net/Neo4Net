...
namespace Neo4Net.Consistency.checking
{
	...
	using RelationshipField = Neo4Net.Consistency.checking.RelationshipRecordCheck.RelationshipField;
	using RelationshipTypeField = Neo4Net.Consistency.checking.RelationshipRecordCheck.RelationshipTypeField;
