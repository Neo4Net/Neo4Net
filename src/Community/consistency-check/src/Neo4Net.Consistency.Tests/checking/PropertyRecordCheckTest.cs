...
//	import static org.mockito.Mockito.verifyNoMoreInteractions;
	...
	{
		 internal PropertyRecordCheckTest() : base(new PropertyRecordCheck(), typeof(Neo4Net.consistency.report.ConsistencyReport_PropertyConsistencyReport), new int[0])
		 {
		 }
...
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.GeometryType.encodePoint(keyId, Neo4Net.values.storable.CoordinateReferenceSystem.WGS84, new double[] { 1.0, 2.0 });
...
//ORIGINAL LINE: @Test void shouldReportTooHighDateRecord()
		 internal virtual void ShouldReportTooHighDateRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDate(keyId, java.time.LocalDate.MAX.toEpochDay() + 1);
...
//ORIGINAL LINE: @Test void shouldReportTooHighLocalTimeRecord()
		 internal virtual void ShouldReportTooHighLocalTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeLocalTime(keyId, java.time.LocalTime.MAX.toNanoOfDay() + 1);
...
//ORIGINAL LINE: @Test void shouldReportTooHighNanoLocalDateTimeRecord()
		 internal virtual void ShouldReportTooHighNanoLocalDateTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeLocalDateTime(keyId, 1, 1_000_000_000);
...
//ORIGINAL LINE: @Test void shouldReportTooHighEpochSecondLocalDateTimeRecord()
		 internal virtual void ShouldReportTooHighEpochSecondLocalDateTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeLocalDateTime(keyId, java.time.Instant.MAX.getEpochSecond() + 1,1);
...
//ORIGINAL LINE: @Test void shouldReportTooHighNanoDateTimeRecord()
		 internal virtual void ShouldReportTooHighNanoDateTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDateTime(keyId, 1, 1_000_000_000, 0);
...
//ORIGINAL LINE: @Test void shouldReportTooHighEpochSecondDateTimeRecord()
		 internal virtual void ShouldReportTooHighEpochSecondDateTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDateTime(keyId, java.time.Instant.MAX.getEpochSecond() + 1,1, 0);
...
//ORIGINAL LINE: @Test void shouldReportTooHighNanoDateTimeRecordWithNamedTZ()
		 internal virtual void ShouldReportTooHighNanoDateTimeRecordWithNamedTZ()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDateTime(keyId, 1, 1_000_000_000, "Europe/London");
...
//ORIGINAL LINE: @Test void shouldReportTooHighEpochSecondDateTimeRecordWithNamedTZ()
		 internal virtual void ShouldReportTooHighEpochSecondDateTimeRecordWithNamedTZ()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDateTime(keyId, java.time.Instant.MAX.getEpochSecond() + 1,1, "Europe/London");
...
//ORIGINAL LINE: @Test void shouldReportTooHighOffsetSecondDateTimeRecord()
		 internal virtual void ShouldReportTooHighOffsetSecondDateTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeDateTime(keyId, 1,1, java.time.ZoneOffset.MAX.getTotalSeconds() + 1);
...
//ORIGINAL LINE: @Test void shouldReportTooHighNanoTimeRecord()
		 internal virtual void ShouldReportTooHighNanoTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeTime(keyId, java.time.LocalTime.MAX.toNanoOfDay() + 1, 0);
...
//ORIGINAL LINE: @Test void shouldReportTooHighOffsetSecondTimeRecord()
		 internal virtual void ShouldReportTooHighOffsetSecondTimeRecord()
		 {
			  ...
			  Add( InUse( new PropertyKeyTokenRecord( keyId ) ) );
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final long[] longs = Neo4Net.kernel.impl.store.TemporalType.encodeTime(keyId, 1, java.time.ZoneOffset.MAX.getTotalSeconds() + 1);
