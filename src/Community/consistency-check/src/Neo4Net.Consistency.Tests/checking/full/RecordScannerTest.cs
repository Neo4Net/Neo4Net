...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unchecked") Neo4Net.helpers.collection.BoundedIterable<int> store = mock(Neo4Net.helpers.collection.BoundedIterable.class);
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: private static void verifyProcessCloseAndDone(RecordProcessor<int> recordProcessor, Neo4Net.helpers.collection.BoundedIterable<int> store, Neo4Net.helpers.progress.ProgressListener progressListener) throws Exception
