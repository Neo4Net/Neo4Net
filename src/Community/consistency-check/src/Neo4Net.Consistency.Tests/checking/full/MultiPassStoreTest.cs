...
//ORIGINAL LINE: protected abstract Neo4Net.consistency.store.RecordReference<? extends Neo4Net.kernel.impl.store.record.AbstractBaseRecord> record(Neo4Net.consistency.store.RecordAccess filter, long id);
