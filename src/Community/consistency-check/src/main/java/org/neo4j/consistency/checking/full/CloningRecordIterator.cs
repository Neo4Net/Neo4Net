...
namespace Neo4Net.Consistency.checking.full
{
	...
	public class CloningRecordIterator<R> : PrefetchingResourceIterator<R> where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	{
...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
		 ...
		 public static IEnumerator<R> Cloned<R>( IEnumerator<R> iterator ) where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		 {
