...
namespace Neo4Net.Consistency.store
{
	...
	public interface RecordReference<RECORD> where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	{
		 void Dispatch( PendingReferenceCheck<RECORD> reporter );
	}

	 public class RecordReference_SkippingReference<RECORD> : RecordReference<RECORD> where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	 {
...
//ORIGINAL LINE: @SuppressWarnings("unchecked") public static <RECORD extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord> RecordReference_SkippingReference<RECORD> skipReference()
		  public static RecordReference_SkippingReference<RECORD> SkipReference<RECORD>() where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		  {
				return Instance;
		  }
