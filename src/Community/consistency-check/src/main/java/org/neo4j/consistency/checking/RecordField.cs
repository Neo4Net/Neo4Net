...
namespace Neo4Net.Consistency.checking
{
	...
	public interface RecordField<RECORD, REPORT> where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport
	{
