...
//           NEXT(org.neo4j.kernel.impl.store.record.Record.NO_NEXT_PROPERTY) { public long valueFrom(org.neo4j.kernel.impl.store.record.PropertyRecord record) { return record.getNextProp(); } public long otherReference(org.neo4j.kernel.impl.store.record.PropertyRecord record) { return record.getPrevProp(); } public void notInUse(org.neo4j.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.neo4j.kernel.impl.store.record.PropertyRecord property) { report.nextNotInUse(property); } public void noBackReference(org.neo4j.consistency.report.ConsistencyReport_PropertyConsistencyReport report, org.neo4j.kernel.impl.store.record.PropertyRecord property) { report.nextDoesNotReferenceBack(property); } };
			  ...
			  internal readonly Neo4Net.Kernel.impl.store.record.Record NONE;

			  PropertyField( Neo4Net.Kernel.impl.store.record.Record none ) { this.NONE = none; } public abstract long otherReference( Neo4Net.Kernel.impl.store.record.PropertyRecord record );

			  public void checkReference( Neo4Net.Kernel.impl.store.record.PropertyRecord record, Neo4Net.Kernel.impl.store.record.PropertyRecord referred, CheckerEngine<Neo4Net.Kernel.impl.store.record.PropertyRecord, Neo4Net.Consistency.report.ConsistencyReport_PropertyConsistencyReport> engine, Neo4Net.Consistency.store.RecordAccess records )
			  {
			  ...
			  abstract void notInUse( Neo4Net.Consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.Kernel.impl.store.record.PropertyRecord property );

			  public abstract void noBackReference( Neo4Net.Consistency.report.ConsistencyReport_PropertyConsistencyReport report, Neo4Net.Kernel.impl.store.record.PropertyRecord property );
