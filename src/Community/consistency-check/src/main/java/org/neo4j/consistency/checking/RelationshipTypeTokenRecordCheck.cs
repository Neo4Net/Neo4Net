...
namespace Neo4Net.Consistency.checking
{
	...
	public class RelationshipTypeTokenRecordCheck : TokenRecordCheck<RelationshipTypeTokenRecord, Neo4Net.Consistency.report.ConsistencyReport_RelationshipTypeConsistencyReport>
	{
		 ...
		 internal override void NameNotInUse( Neo4Net.Consistency.report.ConsistencyReport_RelationshipTypeConsistencyReport report, DynamicRecord name )
		 {
			  report.NameBlockNotInUse( name );
		 }

		 internal override void EmptyName( Neo4Net.Consistency.report.ConsistencyReport_RelationshipTypeConsistencyReport report, DynamicRecord name )
		 {
