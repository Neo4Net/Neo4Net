...
namespace Neo4Net.Consistency.checking.full
{
	...
	public class NodeInUseWithCorrectLabelsCheck <RECORD, REPORT> : ComparativeRecordChecker<RECORD, NodeRecord, REPORT> where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport_NodeInUseWithCorrectLabelsReport
	{
