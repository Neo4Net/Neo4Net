...
namespace Neo4Net.Consistency.checking
{
	...
	public class ChainCheck<RECORD, REPORT> : ComparativeRecordChecker<RECORD, PropertyRecord, REPORT> where RECORD : Neo4Net.Kernel.impl.store.record.PrimitiveRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport_PrimitiveConsistencyReport
	{
