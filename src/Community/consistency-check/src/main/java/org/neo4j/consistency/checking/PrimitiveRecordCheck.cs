...
namespace Neo4Net.Consistency.checking
{
	...
	public abstract class PrimitiveRecordCheck <RECORD, REPORT> : OwningRecordCheck<RECORD, REPORT> where RECORD : Neo4Net.Kernel.impl.store.record.PrimitiveRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport_PrimitiveConsistencyReport
	{
