...
//ORIGINAL LINE: public java.util.Iterator<org.neo4j.kernel.impl.store.record.PropertyRecord> rawPropertyChain(final long firstId)
		 ...
		 internal virtual DirectRecordReference<RECORD> ReferenceTo<RECORD>( RecordStore<RECORD> store, long id ) where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		 {
