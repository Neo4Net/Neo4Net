...
namespace Neo4Net.Consistency.checking
{
	...
	internal abstract class TokenRecordCheck<RECORD, REPORT> : RecordCheck<RECORD, REPORT>, ComparativeRecordChecker<RECORD, DynamicRecord, REPORT> where RECORD : Neo4Net.Kernel.impl.store.record.TokenRecord where REPORT : Neo4Net.Consistency.report.ConsistencyReport
	{
