...
//ORIGINAL LINE: public void apply(W work) throws java.util.concurrent.ExecutionException
		 ...
		 private class AsyncApplyAnonymousInnerClass : AsyncApply
		 {
			 ...
			 private Neo4Net.Util.concurrent.WorkSync.WorkUnit<Material, W> _unit;
			 private Exception _initialThrowable;

			 public AsyncApplyAnonymousInnerClass( WorkSync<Material, W> outerInstance, Neo4Net.Util.concurrent.WorkSync.WorkUnit<Material, W> unit, Exception initialThrowable )
			 {
