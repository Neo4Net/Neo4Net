...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 ...
		 private class AddWorkAnonymousInnerClass : AddWork
		 {
			 ...
			 private Neo4Net.Util.concurrent.BinaryLatch _startLatch;
			 private Neo4Net.Util.concurrent.BinaryLatch _blockLatch;

			 public AddWorkAnonymousInnerClass( WorkSyncTest outerInstance, Neo4Net.Util.concurrent.BinaryLatch startLatch, Neo4Net.Util.concurrent.BinaryLatch blockLatch ) : base( 1 )
			 {
