...
namespace Neo4Net.GraphDb.Resources
{
	...
	/// The resource may also be released eagerly by explicitly calling <seealso cref="Neo4Net.GraphDb.ResourceIterator.close()"/>
	/// or by exhausting the iterator.
	/// </summary>
	/// @param <T> type of values returned by this Iterator
	/// </param>
	/// <seealso cref= ResourceIterable </seealso>
	public interface IResourceIterator<T> : IEnumerator<T>, IResource
	{
		 /// <summary>
...
//JAVA TO C# CONVERTER TODO TASK: There is no equivalent in C# to Java default interface methods:
//		 default <R> IResourceIterator<R> map(System.Func<T, R> map)
	//	 {
	//		  return new IResourceIterator<R>()
	//		  {
