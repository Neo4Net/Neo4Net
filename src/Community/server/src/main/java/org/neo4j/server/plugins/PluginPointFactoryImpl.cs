...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
		 ...
		 {
			 public ListParameterExtractorAnonymousInnerClass( Neo4Net.Server.plugins.TypeCaster caster, Type component, Parameter parameter, Description description ) : base( caster, component, parameter, description )
			 {
			 }
		 ...
		 {
			 public ListParameterExtractorAnonymousInnerClass2( Neo4Net.Server.plugins.TypeCaster caster, Type component, Parameter parameter, Description description ) : base( caster, component, parameter, description )
			 {
			 }
		 ...
		 {
			 public ListParameterExtractorAnonymousInnerClass3( Neo4Net.Server.plugins.TypeCaster caster, UnknownType getComponentType, Parameter parameter, Description description ) : base( caster, getComponentType, parameter, description )
			 {
			 }
		 ...
		 {
			 public ListParameterExtractorAnonymousInnerClass4( Neo4Net.Server.plugins.TypeCaster caster, Parameter parameter, Description description ) : base( caster, ( Type ) component, parameter, description )
			 {
			 }
