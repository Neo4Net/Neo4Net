...
//ORIGINAL LINE: public static PrimitiveLongResourceIterator iterator(org.neo4j.graphdb.Resource resource, final long... items)
		 ...
		 private class PrimitiveLongFilteringResourceIteratorAnonymousInnerClass : PrimitiveLongFilteringResourceIterator
		 {
			 ...
			 public PrimitiveLongFilteringResourceIteratorAnonymousInnerClass( Neo4Net.Collection.PrimitiveLongResourceIterator source, System.Func<long, bool> filter ) : base( source )
			 {
				 this._filter = filter;
			 }
