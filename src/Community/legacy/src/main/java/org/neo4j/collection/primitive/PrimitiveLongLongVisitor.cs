...
{
	public interface PrimitiveLongLongVisitor<E> where E : Exception
	{
		 /// <summary>
...
//ORIGINAL LINE: boolean visited(long key, long value) throws E;
		 bool Visited( long key, long value );
	}
