...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailNicelyWhenUnsafeAPISafeMode()
		 {
			  ...
			  verify( _log ).warn( NotAvailableMessage( "org.neo4j.kernel.impl.proc.listCoolPeople" ) );
			  ...
			  {
					assertThat( e.Message, NotAvailableMessageMatcher( "org.neo4j.kernel.impl.proc.listCoolPeople" ) );
			  }
		 }
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
		 public virtual void ShouldFailNicelyWhenAllUsesUnsafeAPI()
		 {
			  ...
			  verify( _log ).warn( NotAvailableMessage( "org.neo4j.kernel.impl.proc.safeUserFunctionInUnsafeAPIClass" ) );
			  verify( _log ).warn( NotAvailableMessage( "org.neo4j.kernel.impl.proc.listCoolPeopleProcedure" ) );
