...
namespace Neo4Net.Kernel.impl.storemigration
{
	...
	internal sealed class MigrationStatus
	{
		 ...
		 private static Neo4Net.Helpers.Collection.Pair<string, string> ReadFromFile( Neo4Net.Io.fs.FileSystemAbstraction fs, java.io.File file, MigrationStatus expectedSate )
		 {
			  try
			  {
