...
//	import static org.neo4j.kernel.impl.index.schema.NumberType.numberKeySize;
	...
	internal class NumberArrayType : AbstractArrayType<Number>
	{
		 ...
		 internal override bool ReadValue( PageCursor cursor, int size, GenericKey into )
		 {
			  ...
			  Neo4Net.Values.Storable.ValueWriter_ArrayType numberType = NumberArrayTypeOf( ( sbyte ) into.Long1 );
			  if ( numberType == null )
			  {
		 ...
		 internal override void InitializeAsLowest( GenericKey state )
		 {
			  ...
			  InitializeArray( state, 0, Neo4Net.Values.Storable.ValueWriter_ArrayType.Byte );
		 }
		 ...
		 private static Neo4Net.Values.Storable.ValueWriter_ArrayType NumberArrayTypeOf( sbyte numberType )
		 {
			  switch ( numberType )
			  {
			  case RawBits.BYTE:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Byte;
			  case RawBits.SHORT:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Short;
			  case RawBits.INT:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Int;
			  case RawBits.LONG:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Long;
			  case RawBits.FLOAT:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Float;
			  case RawBits.DOUBLE:
					return Neo4Net.Values.Storable.ValueWriter_ArrayType.Double;
			  default:
					// bad read, hopefully
					return null;
			  }
