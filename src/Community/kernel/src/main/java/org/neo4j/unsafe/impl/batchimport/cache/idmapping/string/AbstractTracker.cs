...
{
	using Neo4Net.@unsafe.Impl.Batchimport.cache;
	...
	internal abstract class AbstractTracker<ARRAY> : Tracker where ARRAY : Neo4Net.@unsafe.Impl.Batchimport.cache.NumberArray
	{
