...
//	import static org.neo4j.helpers.ArrayUtil.array;
	...
	/// </summary>
	public class RelationshipLinkingProgress : StatsProvider, Stat
	{
		 private readonly Key[] _keys = array( Keys.progress );
		 private readonly LongAdder _progress = new LongAdder();
