...
namespace Neo4Net.Kernel.impl.store
{
	...
	public interface RecordStore<RECORD> : IdSequence where RECORD : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	{
...
//ORIGINAL LINE: RECORD getRecord(long id, RECORD target, org.neo4j.kernel.impl.store.record.RecordLoad mode) throws InvalidRecordException;
		 ...
		 /// <exception cref="InvalidRecordException"> if record not in use and the {@code mode} allows for throwing. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void getRecordByCursor(long id, RECORD target, org.neo4j.kernel.impl.store.record.RecordLoad mode, org.neo4j.io.pagecache.PageCursor cursor) throws InvalidRecordException;
		 ...
		 /// <exception cref="InvalidRecordException"> if record not in use and the {@code mode} allows for throwing. </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void nextRecordByCursor(RECORD target, org.neo4j.kernel.impl.store.record.RecordLoad mode, org.neo4j.io.pagecache.PageCursor cursor) throws InvalidRecordException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: java.util.List<RECORD> getRecords(long firstId, org.neo4j.kernel.impl.store.record.RecordLoad mode) throws InvalidRecordException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: <EXCEPTION extends Exception> void scanAllRecords(org.neo4j.helpers.collection.Visitor<RECORD,EXCEPTION> visitor) throws EXCEPTION;
...
//		 static <R> R getRecord(RecordStore<R> store, long id, org.neo4j.kernel.impl.store.record.RecordLoad mode)
	//	 {
...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
	 ...
	 public class RecordStore_Delegator<R> : RecordStore<R> where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
	 {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public void getRecordByCursor(long id, R target, org.neo4j.kernel.impl.store.record.RecordLoad mode, org.neo4j.io.pagecache.PageCursor cursor) throws InvalidRecordException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public void nextRecordByCursor(R target, org.neo4j.kernel.impl.store.record.RecordLoad mode, org.neo4j.io.pagecache.PageCursor cursor) throws InvalidRecordException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public java.util.List<R> getRecords(long firstId, org.neo4j.kernel.impl.store.record.RecordLoad mode) throws InvalidRecordException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public <EXCEPTION extends Exception> void scanAllRecords(org.neo4j.helpers.collection.Visitor<R,EXCEPTION> visitor) throws EXCEPTION
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processSchema(RecordStore<org.neo4j.kernel.impl.store.record.DynamicRecord> store, org.neo4j.kernel.impl.store.record.DynamicRecord schema) throws FAILURE;
		  public abstract void ProcessSchema( RecordStore<DynamicRecord> store, DynamicRecord schema );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processNode(RecordStore<org.neo4j.kernel.impl.store.record.NodeRecord> store, org.neo4j.kernel.impl.store.record.NodeRecord node) throws FAILURE;
		  public abstract void ProcessNode( RecordStore<NodeRecord> store, NodeRecord node );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processRelationship(RecordStore<org.neo4j.kernel.impl.store.record.RelationshipRecord> store, org.neo4j.kernel.impl.store.record.RelationshipRecord rel) throws FAILURE;
		  public abstract void ProcessRelationship( RecordStore<RelationshipRecord> store, RelationshipRecord rel );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processProperty(RecordStore<org.neo4j.kernel.impl.store.record.PropertyRecord> store, org.neo4j.kernel.impl.store.record.PropertyRecord property) throws FAILURE;
		  public abstract void ProcessProperty( RecordStore<PropertyRecord> store, PropertyRecord property );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processString(RecordStore<org.neo4j.kernel.impl.store.record.DynamicRecord> store, org.neo4j.kernel.impl.store.record.DynamicRecord string, org.neo4j.kernel.impl.store.id.IdType idType) throws FAILURE;
		  public abstract void ProcessString( RecordStore<DynamicRecord> store, DynamicRecord @string, IdType idType );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processArray(RecordStore<org.neo4j.kernel.impl.store.record.DynamicRecord> store, org.neo4j.kernel.impl.store.record.DynamicRecord array) throws FAILURE;
		  public abstract void ProcessArray( RecordStore<DynamicRecord> store, DynamicRecord array );

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processLabelArrayWithOwner(RecordStore<org.neo4j.kernel.impl.store.record.DynamicRecord> store, org.neo4j.kernel.impl.store.record.DynamicRecord labelArray) throws FAILURE;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: public abstract void processRelationshipGroup(RecordStore<org.neo4j.kernel.impl.store.record.RelationshipGroupRecord> store, org.neo4j.kernel.impl.store.record.RelationshipGroupRecord record) throws FAILURE;
		  public abstract void ProcessRelationshipGroup( RecordStore<RelationshipGroupRecord> store, RelationshipGroupRecord record );

		  protected internal virtual R GetRecord<R>( RecordStore<R> store, long id, R into ) where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		  {
...
//ORIGINAL LINE: public <R extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord> void applyFiltered(RecordStore<R> store, System.Predicate<? super R>... filters) throws FAILURE
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		  public virtual void ApplyFiltered<R>( RecordStore<R> store, params System.Predicate<object>[] filters ) where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		  {
				Apply( store, Neo4Net.Helpers.progress.ProgressListener_Fields.None, filters );
		  }

//JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the Java 'super' constraint:
//ORIGINAL LINE: public <R extends org.neo4j.kernel.impl.store.record.AbstractBaseRecord> void applyFiltered(RecordStore<R> store, org.neo4j.helpers.progress.ProgressListener progressListener, System.Predicate<? super R>... filters) throws FAILURE
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		  public virtual void ApplyFiltered<R>( RecordStore<R> store, ProgressListener progressListener, params System.Predicate<object>[] filters ) where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		  {
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
		  internal virtual void Apply<R>( RecordStore<R> store, ProgressListener progressListener, params System.Predicate<object>[] filters ) where R : Neo4Net.Kernel.impl.store.record.AbstractBaseRecord
		  {
