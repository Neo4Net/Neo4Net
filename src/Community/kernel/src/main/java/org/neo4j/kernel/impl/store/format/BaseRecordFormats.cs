...
//	import static org.neo4j.helpers.ArrayUtil.contains;
	...
	public abstract class BaseRecordFormats : RecordFormats
	{
		...
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.DynamicRecord> Dynamic();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.RelationshipTypeTokenRecord> RelationshipTypeToken();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.PropertyKeyTokenRecord> PropertyKeyToken();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.LabelTokenRecord> LabelToken();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.PropertyRecord> Property();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.RelationshipRecord> Relationship();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.RelationshipGroupRecord> RelationshipGroup();
		public abstract RecordFormat<Neo4Net.Kernel.impl.store.record.NodeRecord> Node();
