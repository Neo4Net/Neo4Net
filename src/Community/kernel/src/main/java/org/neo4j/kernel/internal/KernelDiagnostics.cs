...
//JAVA TO C# CONVERTER TODO TASK: Method reference arbitrary object instance method syntax is not converted by Java to C# Converter:
						 MappedCandidates = java.util.org.neo4j.kernel.impl.store.StoreType.values().Where(StoreType::isRecordStore).Select(StoreType::getDatabaseFile).flatMap(layout.file).ToList();
