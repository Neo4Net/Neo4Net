...
namespace Neo4Net.Kernel.impl.storageengine.impl.recordstorage
{
	...
	public class PropertyCreator
	{
		 ...
		 public virtual void PrimitiveSetProperty<P>( RecordAccess_RecordProxy<P, Void> primitiveRecordChange, int propertyKey, Value value, RecordAccess<PropertyRecord, PrimitiveRecord> propertyRecords ) where P : Neo4Net.Kernel.impl.store.record.PrimitiveRecord
		 {
