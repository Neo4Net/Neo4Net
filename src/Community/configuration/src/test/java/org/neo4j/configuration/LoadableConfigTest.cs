...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @SuppressWarnings("unused") @Description("A private setting which is not accessible") private static final org.neo4j.graphdb.config.Setting<String> ignoredSetting = new StringSetting()
...
//JAVA TO C# CONVERTER TODO TASK: Most Java annotations will not have direct .NET equivalent attributes:
//ORIGINAL LINE: @Description("A dynamic string setting") @Dynamic public static final org.neo4j.graphdb.config.Setting<String> dynamic = new StringSetting()
