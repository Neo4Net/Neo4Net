...
//ORIGINAL LINE: abstract void checkForDuplicate(org.neo4j.values.storable.Value[] values, long nodeId) throws org.neo4j.kernel.api.exceptions.index.IndexEntryConflictException;
		 ...
		 /// <exception cref="IndexEntryConflictException"> </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: abstract void checkForDuplicate(org.neo4j.values.storable.Value value, long nodeId) throws org.neo4j.kernel.api.exceptions.index.IndexEntryConflictException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: void checkForDuplicate(org.neo4j.values.storable.Value value, long nodeId) throws org.neo4j.kernel.api.exceptions.index.IndexEntryConflictException
