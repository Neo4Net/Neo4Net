...
//ORIGINAL LINE: private static Configuration config(final int bufferSize)
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass( Neo4Net.Csv.Reader.Configuration configurationFields, int bufferSize ) : base( configurationFields.Default )
			 {
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass2 : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass2( Neo4Net.Csv.Reader.Configuration config, bool multiline ) : base( config )
			 {
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass3 : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass3( Neo4Net.Csv.Reader.Configuration config, bool legacyStyleQuoting ) : base( config )
			 {
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass4 : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass4( Neo4Net.Csv.Reader.Configuration config, char quoteCharacter ) : base( config )
			 {
		 ...
		 private class Configuration_OverriddenAnonymousInnerClass5 : Configuration_Overridden
		 {
			 ...
			 public Configuration_OverriddenAnonymousInnerClass5( Neo4Net.Csv.Reader.Configuration config, bool trimStrings ) : base( config )
			 {
