...
//ORIGINAL LINE: boolean seek(Mark mark, int untilChar) throws java.io.IOException;
		 ...
		 /// <exception cref="IllegalStateException"> if the <seealso cref="Extractor.extract(char[], int, int, bool, Neo4Net.values.storable.CSVHeaderInformation) extraction"/>
		 /// returns {@code false}. </exception>
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: <EXTRACTOR extends Extractor<?>> EXTRACTOR extract(Mark mark, EXTRACTOR extractor, Neo4Net.values.storable.CSVHeaderInformation optionalData);
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: boolean tryExtract(Mark mark, Extractor<?> extractor, Neo4Net.values.storable.CSVHeaderInformation optionalData);
