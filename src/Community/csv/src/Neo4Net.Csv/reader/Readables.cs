...
//ORIGINAL LINE: @SafeVarargs public static <IN,OUT> Neo4Net.collection.RawIterator<OUT,java.io.IOException> iterator(Neo4Net.function.ThrowingFunction<IN,OUT,java.io.IOException> converter, IN... items)
