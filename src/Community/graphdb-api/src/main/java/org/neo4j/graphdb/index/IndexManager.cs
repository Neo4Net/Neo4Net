...
namespace Neo4Net.Graphdb.index
{
	...
	/// <summary>
	/// A one stop shop for accessing <seealso cref="Index"/>s for <seealso cref="Node"/>s
	/// and <seealso cref="Relationship"/>s. An <seealso cref="IndexManager"/> is paired with a
	...
	public interface IndexManager
	{
		 ...
		 /// <summary>
		 /// Returns an <seealso cref="Index"/> for <seealso cref="Node"/>s with the name {@code indexName}.
		 ...
		 /// <returns> a named <seealso cref="Index"/> for <seealso cref="Node"/>s </returns>
		 [Obsolete]
		 Index<Node> ForNodes( string indexName, IDictionary<string, string> customConfiguration );

		 /// <summary>
		 /// Returns the names of all existing <seealso cref="Node"/> indexes.
		 /// Those names can then be used to get to the actual <seealso cref="Index"/>
		 /// instances.
		 /// </summary>
		 /// <returns> the names of all existing <seealso cref="Node"/> indexes. </returns>
		 [Obsolete]
		 ...
		 /// <summary>
		 /// Returns an <seealso cref="Index"/> for <seealso cref="Relationship"/>s with the name {@code indexName}.
		 /// If such an index doesn't exist it will be created with default configuration.
		 ...
		 /// should be case insensitive. The parameters given here (except "provider") are
		 /// only interpreted by the implementation represented by the provider. </param>
		 /// <returns> a named <seealso cref="Index"/> for <seealso cref="Relationship"/>s </returns>
		 [Obsolete]
		 RelationshipIndex ForRelationships( string indexName, IDictionary<string, string> customConfiguration );

		 /// <summary>
		 /// Returns the names of all existing <seealso cref="Relationship"/> indexes.
		 /// Those names can then be used to get to the actual <seealso cref="Index"/>
		 /// instances.
		 /// </summary>
		 /// <returns> the names of all existing <seealso cref="Relationship"/> indexes. </returns>
		 [Obsolete]
...
//ORIGINAL LINE: Map<String, String> getConfiguration(Index<? extends org.neo4j.graphdb.PropertyContainer> index);
		 [Obsolete]
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: String setConfiguration(Index<? extends org.neo4j.graphdb.PropertyContainer> index, String key, String value);
		 [Obsolete]
...
//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
//ORIGINAL LINE: String removeConfiguration(Index<? extends org.neo4j.graphdb.PropertyContainer> index, String key);
		 [Obsolete]
		 ...
		 AutoIndexer<Node> NodeAutoIndexer { get; }
