...
//ORIGINAL LINE: final java.util.Set<String> expectedTypes = new java.util.HashSet<>();
		 ...
		 private class PathEvaluator_AdapterAnonymousInnerClass6 : PathEvaluator_Adapter<STATE>
		 {
			 ...
			 public PathEvaluator_AdapterAnonymousInnerClass6( Neo4Net.Graphdb.traversal.Evaluation evaluationIfMatch, Neo4Net.Graphdb.traversal.Evaluation evaluationIfNoMatch, RelationshipType type )
			 {
...
//ORIGINAL LINE: final java.util.Set<org.neo4j.graphdb.Node> endNodes = new java.util.HashSet<>(asList(possibleEndNodes));
		 ...
		 private class PathEvaluator_AdapterAnonymousInnerClass8 : PathEvaluator_Adapter<STATE>
		 {
			 ...
			 public PathEvaluator_AdapterAnonymousInnerClass8( Neo4Net.Graphdb.traversal.Evaluation evaluationIfMatch, Neo4Net.Graphdb.traversal.Evaluation evaluationIfNoMatch, Node target )
			 {
				 this._evaluationIfMatch = evaluationIfMatch;
				 this._evaluationIfNoMatch = evaluationIfNoMatch;
				 this._target = target;
		 ...
		 private class PathEvaluator_AdapterAnonymousInnerClass9 : PathEvaluator_Adapter<STATE>
		 {
			 ...
			 public PathEvaluator_AdapterAnonymousInnerClass9( Neo4Net.Graphdb.traversal.Evaluation evaluationIfMatch, Neo4Net.Graphdb.traversal.Evaluation evaluationIfNoMatch, ISet<Node> endNodes )
			 {
				 this._evaluationIfMatch = evaluationIfMatch;
				 this._evaluationIfNoMatch = evaluationIfNoMatch;
