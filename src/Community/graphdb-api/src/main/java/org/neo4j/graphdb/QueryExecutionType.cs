...
namespace Neo4Net.Graphdb
{
	...
	/// <seealso cref="ExecutionPlanDescription.getProfilerStatistics() profiling information"/> from the execution of the query.
	/// </para>
	/// <para>
	...
	/// <seealso cref="Result.getExecutionPlanDescription() get a description of the plan"/> that <i>would</i> be executed
	...
	public sealed class QueryExecutionType
	{
		 ...
		 /// <seealso cref="ExecutionPlanDescription.getProfilerStatistics() contains profiling information"/>.
		 /// 
		 ...
		 /// <seealso cref="ExecutionPlanDescription description of the execution plan"/>.
		 /// 
		 ...
		 /// 
		 /// <seealso cref="Result"/><seealso cref="Result.getQueryStatistics() .getQueryStatistics()"/>{@link QueryStatistics#containsUpdates()
