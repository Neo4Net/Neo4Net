...
namespace Neo4Net.GraphDb.schema
{
	...
	public interface Schema
	{
		 ...
		 IndexCreator IndexFor( ILabel label );

		 /// <param name="label"> the <seealso cref="ILabel"/> to get <seealso cref="IndexDefinition indexes"/> for. </param>
		 /// <returns> all <seealso cref="IndexDefinition indexes"/> attached to the given <seealso cref="ILabel label"/>. </returns>
		 IEnumerable<IndexDefinition> GetIndexes( ILabel label );
		 ...
		 ConstraintCreator ConstraintFor( ILabel label );
		 ...
		 IEnumerable<ConstraintDefinition> GetConstraints( ILabel label );
		 ...
		 IEnumerable<ConstraintDefinition> GetConstraints( IRelationshipType type );
