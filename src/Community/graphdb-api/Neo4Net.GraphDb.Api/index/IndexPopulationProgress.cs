...
namespace Neo4Net.GraphDb.Index
{
    ...
    public class IndexPopulationProgress
    {
        ...
        public virtual float CompletedPercentage { get { return _totalCount > 0 ? ((float)(_completedCount * 100) / _totalCount) : 0.0f; } }
        ...
        public virtual long CompletedCount { get { return _completedCount; } }

        /// <returns> total number of items to index </returns>
        /// @deprecated since this number won't be reliable throughout a population and should therefore not be used.
        public virtual long TotalCount { get { return _totalCount; } }
