...
////////////////////	/// which
////////////////////	/// are specific to <seealso cref="IRelationship"/>s. Each of <seealso cref="get(string, object)"/>,
...
////////////////////	public interface ReadableRelationshipIndex : ReadableIndex<IRelationship>
////////////////////	{
////////////////////		 /// <summary>
...
////////////////////		 /// <param name="startNodeOrNull"> filter so that only <seealso cref="IRelationship"/>s with
////////////////////		 ///            that given start node will be returned. </param>
////////////////////		 /// <param name="endNodeOrNull"> filter so that only <seealso cref="IRelationship"/>s with that
...
////////////////////		 [Obsolete]
////////////////////		 IndexHits<IRelationship> Get( string key, object valueOrNull, INode startNodeOrNull, INode endNodeOrNull );
...
////////////////////		 ///         be called before disposing of the result. </returns>
////////////////////		 [Obsolete]
////////////////////		 IndexHits<IRelationship> Query( string key, object queryOrQueryObjectOrNull, INode startNodeOrNull, INode endNodeOrNull );
...
////////////////////		 ///         be called before disposing of the result. </returns>
////////////////////		 [Obsolete]
////////////////////		 IndexHits<IRelationship> Query( object queryOrQueryObjectOrNull, INode startNodeOrNull, INode endNodeOrNull );
////////////////////	}
