...
namespace Neo4Net.GraphDb.Exceptions
{
	...
	public class QueryExecutionException : Exception
	{
		 ...
		 /// <summary>
		 /// The Neo4Net error <a href="https://Neo4Net.com/docs/developer-manual/current/reference/status-codes/">status code</a>.
		 /// </summary>
		 /// <returns> the Neo4Net error status code. </returns>
