...
namespace Neo4Net.GraphDb
{
	...
	public interface IResult : IResourceIterator<IDictionary<string, object>>
	{
		 ...
		 IExecutionPlanDescription ExecutionPlanDescription { get; }
...
//ORIGINAL LINE: <VisitationException extends Exception> void accept(Result_ResultVisitor<VisitationException> visitor) throws VisitationException;
		 ...
		 /// <summary>
		 /// This is the visitor interface you need to implement to use the <seealso cref="IResult.accept(ResultVisitor)"/> method.
		 /// </summary>
	}
