...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    public interface IInitialBranchState<STATE>
    {
        ...
        IInitialBranchState<STATE> Reverse();
    ...
    public abstract class InitialBranchState_Adapter<STATE> : IInitialBranchState<STATE>
    {
        public abstract STATE InitialState(IPath path);

        public virtual IInitialBranchState<STATE> Reverse()
        {
            return this;
        }
    }
    ...
    public class InitialBranchState_State<STATE> : InitialBranchState_Adapter<STATE>
    {
        ...
        public override IInitialBranchState<STATE> Reverse()
        {
