...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    public sealed class Evaluation
    {
        ...
        private static readonly IList<Evaluation> _valueList = new List<Evaluation>();

        static Evaluation()
        {
            _valueList.Add(IncludeAndContinue);
            _valueList.Add(IncludeAndPrune);
            _valueList.Add(ExcludeAndContinue);
            _valueList.Add(ExcludeAndPrune);
        }
        ...
        private readonly bool _continues;
        ...
        public bool Includes => _includes;
        ...
        public bool Continues => _continues;
        ...
        {
            return includes ? (continues ? IncludeAndContinue : IncludeAndPrune) : (continues ? ExcludeAndContinue : ExcludeAndPrune);
        }
        ...
        {
            return includes ? IncludeAndContinue : ExcludeAndContinue;
        }
        ...
        {
            return continues ? IncludeAndContinue : IncludeAndPrune;
        }
        ...
        {
            foreach (Evaluation enumInstance in Evaluation._valueList)
            {
