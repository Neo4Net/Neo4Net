...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    public class LevelSelectorOrderer : AbstractSelectorOrderer<LevelSelectorOrderer.Entry>
    {
        ...
        public LevelSelectorOrderer(IBranchSelector startSelector, IBranchSelector endSelector, bool stopDescentOnResult, int maxDepth) : base(startSelector, endSelector)
        {
        ...
        public override ITraversalBranch Next(TraversalContext metadata)
        {
            ...
            IBranchSelector otherSelector = NextSelector();
