...
namespace Neo4Net.GraphDb.traversal
{
	...
	/// </summary>
	public interface TraversalBranch : IPath
	{
		 /// <summary>
		 ...
		 TraversalBranch Next( IPathExpander expander, TraversalContext metadata );
		 ...
		 /// <seealso cref="TraversalDescription.traverse(org.Neo4Net.graphdb.Node...)"/> </returns>
		 bool Includes();
