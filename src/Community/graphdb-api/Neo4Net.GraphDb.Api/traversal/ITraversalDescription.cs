...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    /// </para>
    /// </summary>
    public interface ITraversalDescription
    {
        /// <summary>
        /// Sets the <seealso cref="IUniquenessFactory"/> for creating the
        /// <seealso cref="UniquenessFilter"/> to use.
        /// </summary>
        /// <param name="uniqueness"> the <seealso cref="IUniquenessFactory"/> the creator
        ...
        ITraversalDescription Uniqueness(IUniquenessFactory uniqueness);
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Uniqueness(IUniquenessFactory uniqueness, object parameter);
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Evaluator(IEvaluator evaluator);
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Evaluator(IPathEvaluator evaluator);

        /// <summary>
        /// Sets the <seealso cref="IBranchOrderingPolicy"/> to use. A <seealso cref="IBranchSelector"/>
        ...
        /// </summary>
        /// <param name="selector"> the factory which creates the <seealso cref="IBranchSelector"/>
        /// to use with the traversal. </param>
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Order(IBranchOrderingPolicy selector);

        /// <summary>
        /// A convenience method for <seealso cref="order(IBranchOrderingPolicy)"/>
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription DepthFirst();
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription BreadthFirst();

        /// <summary>
        /// Adds {@code type} to the list of relationship types to traverse.
        /// There's no priority or order in which types to traverse.
        /// </summary>
        /// <param name="type"> the <seealso cref="IRelationshipType"/> to add to the list of types
        /// to traverse. </param>
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Relationships(IRelationshipType type);
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Relationships(IRelationshipType type, Direction direction);

        /// <summary>
        /// Sets the <seealso cref="PathExpander"/> as the expander of relationships,
        /// discarding all previous calls to
        /// <seealso cref="relationships(IRelationshipType)"/> and
        /// <seealso cref="relationships(IRelationshipType, Direction)"/> or any other expand method.
        /// </summary>
        ...
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription expand<STATE>(IPathExpander<STATE> expander, IInitialBranchState<STATE> initialState);
        ...
        /// <summary>
        /// Creates an identical <seealso cref="ITraversalDescription"/>, although reversed in
        /// how it traverses the graph.
        /// </summary>
        /// <returns> a new traversal description with the new modifications. </returns>
        ITraversalDescription Reverse();
