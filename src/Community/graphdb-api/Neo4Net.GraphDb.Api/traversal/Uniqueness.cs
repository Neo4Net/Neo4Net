...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    /// </summary>
    public sealed class Uniqueness : IUniquenessFactory
    {
        /// <summary>
        ...
        private static void acceptIntegerOrNull(Object parameter)
        {
            ...
            boolean isDecimalNumber = parameter instanceof Number && !(parameter instanceof float? || parameter instanceof double? ); if (!isDecimalNumber) { throw new IllegalArgumentException("Doesn't accept non-decimal values" + ", like '" + parameter + "'"); }
        }

		 = private new Uniqueness("private static void acceptNull(Object optionalParameter) { if(optionalParameter != null) { throw new IllegalArgumentException("Only accepts null parameter, was " + optionalParameter); } } private static void acceptIntegerOrNull(Object parameter) { if(parameter == null) { return; } boolean isDecimalNumber = parameter instanceof Number && !(parameter instanceof System.Nullable<float> || parameter instanceof System.Nullable<double>); if(!isDecimalNumber) { throw new IllegalArgumentException("Doesn't accept non - decimal values" + ", like '" + parameter + "'"); } }", InnerEnum.private static void acceptNull(Object optionalParameter)
