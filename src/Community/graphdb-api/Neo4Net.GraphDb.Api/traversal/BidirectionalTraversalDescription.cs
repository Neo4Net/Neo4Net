...
namespace Neo4Net.GraphDb.Traversal
{
   ...
   public interface BidirectionalTraversalDescription
   {
      ...
      /// branch collisions. </param>
      /// <returns> a new traversal description with the new modifications. </returns>
      BidirectionalTraversalDescription CollisionEvaluator(IPathEvaluator collisionEvaluator);
      ...
      /// <returns> a new traversal description with the new modifications. </returns>
      BidirectionalTraversalDescription SideSelector(ISideSelectorPolicy sideSelector, int maxDepth);
