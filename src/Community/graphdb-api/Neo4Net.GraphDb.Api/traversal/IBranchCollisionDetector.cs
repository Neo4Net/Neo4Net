...
namespace Neo4Net.GraphDb.Traversal
{
    ...
    /// </summary>
    public interface IBranchCollisionDetector
    {
        /// <summary>
        ...
        /// means the end side. Returns an <seealso cref="System.Collections.IEnumerable"/> of new unique <seealso cref="IPath"/>s if
