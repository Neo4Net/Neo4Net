...
namespace Neo4Net.GraphDb.traversal
{
	...
	public interface TraversalDescription
	{
		 ...
		 /// to traverse. </param>
		 /// <returns> a new traversal description with the new modifications. </returns>
		 TraversalDescription Relationships( IRelationshipType type );
		 ...
		 /// <returns> a new traversal description with the new modifications. </returns>
		 TraversalDescription Relationships( IRelationshipType type, Direction direction );
...
//ORIGINAL LINE: TraversalDescription expand(org.Neo4Net.graphdb.PathExpander<?> expander);
		 TraversalDescription expand<T1>( IPathExpander<T1> expander );
		 ...
		 /// <returns> a new traversal description with the new modifications. </returns>
		 TraversalDescription expand<STATE>( IPathExpander<STATE> expander, InitialBranchState<STATE> initialState );
