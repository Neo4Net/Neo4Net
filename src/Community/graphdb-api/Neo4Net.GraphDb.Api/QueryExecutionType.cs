...
namespace Neo4Net.GraphDb
{
   ...
   public sealed class QueryExecutionType
   {
      ...
      public sealed class QueryType
      {
         ...
         public static readonly QueryType  = private new QueryType( "", InnerEnum. );
         ...
         {
            _query = new QueryExecutionType(Execution.Query, this);
            _profiled = new QueryExecutionType(Execution.Profile, this);
            _explained = new QueryExecutionType(Execution.Explain, this);
      ...
      private sealed class Execution
      {
         ...
         public static readonly Execution  = private new Execution( "", InnerEnum. );
