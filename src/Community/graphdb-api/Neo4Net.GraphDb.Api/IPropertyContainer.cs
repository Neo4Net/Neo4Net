...
namespace Neo4Net.GraphDb
{
	...
	/// <summary>
	/// Defines a common API for handling properties on both <seealso cref="INode nodes"/> and
	/// <seealso cref="IRelationship relationships"/>.
	/// <para>
	...
	/// and <code>java.time.Period</code> which will be converted to a single Neo4Net <code>Duration</code>
	...
	{
		 /// <summary>
		 /// Get the <seealso cref="GraphDatabaseService"/> that this <seealso cref="INode"/> or
		 /// <seealso cref="IRelationship"/> belongs to.
		 /// </summary>
