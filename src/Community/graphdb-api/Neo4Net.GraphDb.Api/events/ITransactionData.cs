...
namespace Neo4Net.GraphDb.Events
{
   ...
   public interface ITransactionData
   {
      ...
      IEnumerable<IPropertyEntry<INode>> AssignedNodeProperties();
      ...
      /// overwritten by calling <seealso cref="INode.setProperty(string, object)"/> with a
      /// property that has a previous value, or if the property is explicitly
      /// removed by calling <seealso cref="INode.removeProperty(string)"/>. Only the values
      ...
      IEnumerable<IPropertyEntry<INode>> RemovedNodeProperties();
      ...
      IEnumerable<IRelationship> CreatedRelationships();
      ...
      IEnumerable<IRelationship> DeletedRelationships();

      /// <summary>
      /// Returns whether or not {@code relationship} is deleted in this
      /// transaction.
      /// </summary>
      /// <param name="relationship"> the <seealso cref="IRelationship"/> to check whether or not it
      ///            is deleted in this transaction. </param>
      /// <returns> whether or not {@code relationship} is deleted in this
      ///         transaction. </returns>
      bool IsDeleted(IRelationship relationship);
      ...
      IEnumerable<IPropertyEntry<IRelationship>> AssignedRelationshipProperties();
      ...
      /// overwritten by calling <seealso cref="IRelationship.setProperty(string, object)"/>
      /// with a property that has a previous value, or if the property is
      /// explicitly removed by calling <seealso cref="IRelationship.removeProperty(string)"/>
      ...
      IEnumerable<IPropertyEntry<IRelationship>> RemovedRelationshipProperties();
