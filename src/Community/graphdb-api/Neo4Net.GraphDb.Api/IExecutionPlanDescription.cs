...
namespace Neo4Net.GraphDb
{
   ...
   ///
   /// Execution plans form a tree of execution steps.  Each step is described by a <seealso cref="IExecutionPlanDescription"/> object.
   /// </summary>
   public interface IExecutionPlanDescription
   {
      /// <summary>
      ...
      IList<IExecutionPlanDescription> Children { get; }
      ...
      ///
      /// The <a href="https://Neo4Net.com/docs/developer-manual/current/cypher/execution-plans/">{@code PROFILE}</a> directive in Cypher
      ...
      IExecutionPlanDescription_ProfilerStatistics ProfilerStatistics { get; }
   ...
   public interface IExecutionPlanDescription_ProfilerStatistics
   {
