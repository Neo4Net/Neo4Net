...
namespace Neo4Net.GraphDb
{
   ...
   /// Along with <seealso cref="IRelationship relationships"/>, nodes are the core building
   ...
   /// <seealso cref="PropertyContainer"/>) and operations that deal with <seealso cref="ILabel labels"/>.
   /// </para>
   /// <para>
   ...
   /// </para>
   /// <para>
   /// A node's id is unique, but note the following: Neo4Net reuses its internal ids
   ...
   public interface INode : IEntity
   {
      ...
      ///            <seealso cref="IRelationship.getStartNode() start node"/> and <code>
      /// Direction.INCOMING</code>
      ///            means all relationships that have this node as
      ///            <seealso cref="IRelationship.getEndNode() end node"/> </param>
      /// <returns> all relationships with the given direction that are attached to
      ///         this node </returns>
      IEnumerable<IRelationship> GetRelationships(Direction dir);
      ...
      IEnumerable<IRelationship> GetRelationships(IRelationshipType type, Direction dir);
      ...
      ///         <code>false</code> otherwise </returns>
      bool HasRelationship(IRelationshipType type, Direction dir);
      ...
      ///            this node as <seealso cref="IRelationship.getStartNode() start node"/>
      ///            and <code>
      /// Direction.INCOMING</code> means a relationship that has
      ///            this node as <seealso cref="IRelationship.getEndNode() end node"/>) or
      ...
      IRelationship GetSingleRelationship(IRelationshipType type, Direction dir);
      ...
      int GetDegree(IRelationshipType type);
      ...
      int GetDegree(IRelationshipType type, Direction direction);

      /// <summary>
      /// Adds a <seealso cref="ILabel"/> to this node. If this node doesn't already have
      ...
      /// <summary>
      /// Removes a <seealso cref="ILabel"/> from this node. If this node doesn't have this label,
      /// nothing will happen.
      /// </summary>
